---
title: "Contract meta-peg-in-v2-06a-refund"
draft: true
---
...
Block height: 828139 (2025-03-23T02:13:56.000Z)

Source code: {{<contractref "meta-peg-in-v2-06a-refund" SP673Z4BPB4R73359K9HE55F2X91V5BJTN5SXZ5T meta-peg-in-v2-06a-refund>}}
...
* finalize-peg-in-refund _public_
* finalize-peg-in-refund-on-index _public_
* pause _public_
* set-fee-to-address _public_
* set-peg-in-fee _public_
* set-refund-per-token _public_
* transfer-all-to _public_
* transfer-all-to-many _public_
* create-order-refund-or-fail _read_only_
* decode-order-refund-from-reveal-tx-or-fail _read_only_
* decode-order-refund-or-fail _read_only_
...
* get-refund-per-token-or-default _read_only_
...
* validate-tx-refund _read_only_
