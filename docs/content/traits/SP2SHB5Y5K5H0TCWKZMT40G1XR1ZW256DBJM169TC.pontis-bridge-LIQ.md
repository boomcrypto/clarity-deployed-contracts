...
(define-data-var token-name (string-ascii 32) "LIQUIDIUM.TOKEN")
(define-data-var token-symbol (string-ascii 10) "LIQ")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmNmuqo4opeDWgpw18kGWTPpH1GDARi4aCVz4xDpdusZeG"))
;; 840010:907
