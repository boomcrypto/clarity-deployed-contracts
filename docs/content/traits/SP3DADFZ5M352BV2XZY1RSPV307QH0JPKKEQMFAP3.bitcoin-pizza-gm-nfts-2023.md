---
title: "Trait bitcoin-pizza-gm-nfts-2023"
draft: true
---
```
;; bitcoin-pizza-gm-nfts-2023
;; contractType: public

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token bitcoin-pizza-gm-nfts-2023 uint)
...
(define-data-var artist-address principal 'SP3DADFZ5M352BV2XZY1RSPV307QH0JPKKEQMFAP3)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmU9vuDrM3h92wvRi378sujb4ENmof5Twi5boNQHkPyEvw/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? bitcoin-pizza-gm-nfts-2023 next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? bitcoin-pizza-gm-nfts-2023 token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? bitcoin-pizza-gm-nfts-2023 token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? bitcoin-pizza-gm-nfts-2023 token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? bitcoin-pizza-gm-nfts-2023 id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? bitcoin-pizza-gm-nfts-2023 id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? bitcoin-pizza-gm-nfts-2023 id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u2303)
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u2987000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u1952000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u6000000)
...
;; Alt Minting Default
(define-data-var total-price-slime uint u78000000)
...
;; Alt Minting Default
(define-data-var total-price-alex uint u500000000)
