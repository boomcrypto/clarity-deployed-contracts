...
(define-fungible-token token-33)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-33 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-33)))
