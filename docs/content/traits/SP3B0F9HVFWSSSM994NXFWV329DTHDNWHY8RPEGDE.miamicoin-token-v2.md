---
title: "Trait miamicoin-token-v2"
draft: true
---
```
...
(define-constant TOKEN_URI u"https://cdn.citycoins.co/metadata/miamicoin.json") ;; utf-8 string with token metadata host
(define-constant TOKEN_NAME "miamicoin")
(define-constant TOKEN_SYMBOL "MIA")
...
(define-data-var TOKEN_AMOUNT uint u2400000000000)
...
(define-read-only (get-balance (who principal))
  (ok (ft-get-balance miamicoin who))
)
...
(begin
    ...
    ;; Transfer the tokens
    (let ((result (ft-transfer? miamicoin amount sender recipient)))
      (if (is-ok result)
        (begin
...
(define-public (miamicoin-genesis (recipients (list 1000 principal) ))
...
(begin
  (try! (ft-mint? miamicoin u500000000000000 CONTRACT_OWNER)) 
  ;; (try! (ft-mint? miamicoin u20000000000 'SP31GQBM80BBKWABPHGZPRY6W97QTNJX6Z39NZQHV)) 
  ;; (try! (ft-mint? miamicoin u100000000000 'ST18VZNQWK7R44BFN75X3RANYRAT4B9ZA8S47KZ24)) 
) 
