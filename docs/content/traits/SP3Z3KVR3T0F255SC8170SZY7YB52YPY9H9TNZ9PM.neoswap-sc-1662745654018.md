---
title: "Trait neoswap-sc-1662745654018"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP1XJ6GNTDVF6HR1VHPQDMFZJY87D9W6TGMH3QCP.meta-structures transfer u5 tx-sender agent-4)))
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u14180000 tx-sender agent-5)))
	)
