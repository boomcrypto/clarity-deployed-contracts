---
title: "Trait byzantion-auctions"
draft: true
---
```
...
(define-public (auction-ended (item-id uint))
  (let (
    ...
    (begin
        ...
        (try! (nft-mint? byzantion-auctions item-id buyer))
...
(define-public (burn (item-id uint))
  (let (
    ...
    (asserts! (not (is-eq (nft-get-owner? byzantion-auctions item-id) none)) (err ERR-TOKEN-NOT-MINTED))
    (if (is-eq tx-sender (unwrap-panic (nft-get-owner? byzantion-auctions item-id)))
      (begin
        (try! (nft-burn? byzantion-auctions item-id tx-sender))
        (ok true)
      )
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? byzantion-auctions id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? byzantion-auctions id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? byzantion-auctions id) (err ERR-NOT-FOUND)))
