...
(define-fungible-token whodl)

(define-data-var token-name (string-ascii 32) "Hodl on Stacks Wrapper")
(define-data-var token-symbol (string-ascii 32) "whodl")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-whodl.json"))
...
(define-read-only (get-base-token)
  'SP2VNZNV7SPZSRDK4FNXM0A0DA43Y16TC9J68Q7CB.hodl-on-stacks)

(define-read-only (get-base-decimals)
  (contract-call? 'SP2VNZNV7SPZSRDK4FNXM0A0DA43Y16TC9J68Q7CB.hodl-on-stacks get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP2VNZNV7SPZSRDK4FNXM0A0DA43Y16TC9J68Q7CB.hodl-on-stacks get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP2VNZNV7SPZSRDK4FNXM0A0DA43Y16TC9J68Q7CB.hodl-on-stacks transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
