...
(define-data-var url (string-ascii 256) "https://bafkreiacsqdoiw3s3qfq2vsrrccu6uxykdjmngn25fuy3buwj4rdv6ux4y.ipfs.dweb.link/")
...
(define-private (drop (to principal) (id uint))
  (begin (is-err (nft-mint? test-nft id to)) (+ id u1))
)
