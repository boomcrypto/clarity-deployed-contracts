---
title: "Trait neoswap-sc-1680037883236"
draft: true
---
```
;; multiway-swap
...
(define-private (release-escrow) 
    (begin
	(unwrap-panic (as-contract (contract-call? 'SPGGAEQWA7Y9HRZY5T0XJCEYEZ28J6RKCCC1HP9M.PaperPlanes transfer u115 tx-sender TRADER-2)))
