...
(define-constant revenue-in-stx u13811999100000)
(define-constant recovery-in-stx u91910032900000)
...
(define-public (execute (sender principal))
	(let (
			(collect (try! (fold check-err (collect-revenue revenue-list) (ok true))))
			(xusd-bal (unwrap-panic (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wxusd get-balance-fixed tx-sender)))
			(xbtc-bal (unwrap-panic (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wxbtc get-balance-fixed tx-sender))))		
		(try! (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex transfer-fixed u51930409990000 tx-sender 'SPFD5XBCJWX0RJP35N6YF4S32JWRVXKGZCQ0BX7S none))
		(try! (contract-call? 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.token-abtc transfer-fixed u24579232 tx-sender 'SPFD5XBCJWX0RJP35N6YF4S32JWRVXKGZCQ0BX7S none))
		(try! (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wxusd transfer-fixed xusd-bal tx-sender 'SP1ESCTF9029MH550RKNE8R4D62G5HBY8PBBAF2N8 none))
		(try! (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wxbtc transfer-fixed xbtc-bal tx-sender 'SP1ESCTF9029MH550RKNE8R4D62G5HBY8PBBAF2N8 none))
