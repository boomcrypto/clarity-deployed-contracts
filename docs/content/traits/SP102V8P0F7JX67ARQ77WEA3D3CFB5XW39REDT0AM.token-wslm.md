...
(define-data-var token-name (string-ascii 32) "Slime Wrapper")
(define-data-var token-symbol (string-ascii 32) "wslm")
...
(define-read-only (get-base-decimals)
  (contract-call? 'SP125J1ADVYWGWB9NQRCVGKYAG73R17ZNMV17XEJ7.slime-token get-decimals))
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP125J1ADVYWGWB9NQRCVGKYAG73R17ZNMV17XEJ7.slime-token get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP125J1ADVYWGWB9NQRCVGKYAG73R17ZNMV17XEJ7.slime-token transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
