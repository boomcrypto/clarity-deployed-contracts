...
(define-fungible-token wzilong)

(define-data-var token-name (string-ascii 32) "Zilong Wrapper")
(define-data-var token-symbol (string-ascii 32) "wzilong")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wzilong.json"))
...
(define-read-only (get-base-token)
  'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend)

(define-read-only (get-base-decimals)
  (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
