---
title: "Trait ffrriieedd-fried-bros-ascension"
draft: true
---
```
;; ffrriieedd-fried-bros-ascension
;; contractType: editions

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token ffrriieedd-fried-bros-ascension uint)
...
(define-data-var artist-address principal 'SP2QQH09E2VQVVXWPKWSCCRP1ARY7X2AYHXQ154CP)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmNiswEfPvDW5Za7bXuUWPmSPR1atkUuh2xyzLY2XWnVYt/")
(define-data-var mint-paused bool false)
(define-data-var premint-enabled bool false)
(define-data-var sale-enabled bool false)
(define-data-var metadata-frozen bool false)
(define-data-var airdrop-called bool false)
(define-data-var mint-cap uint u13)
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (or (is-eq (var-get mint-limit) u0) (<= next-id (var-get mint-limit)))
    (begin
      (unwrap! (nft-mint? ffrriieedd-fried-bros-ascension next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? ffrriieedd-fried-bros-ascension token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? ffrriieedd-fried-bros-ascension token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? ffrriieedd-fried-bros-ascension token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? ffrriieedd-fried-bros-ascension id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? ffrriieedd-fried-bros-ascension id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? ffrriieedd-fried-bros-ascension id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u5276)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u0) 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ))
      (map-set token-count 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ (+ (get-balance 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ) u1))
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u1) 'SP2QQH09E2VQVVXWPKWSCCRP1ARY7X2AYHXQ154CP))
      (map-set token-count 'SP2QQH09E2VQVVXWPKWSCCRP1ARY7X2AYHXQ154CP (+ (get-balance 'SP2QQH09E2VQVVXWPKWSCCRP1ARY7X2AYHXQ154CP) u1))
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u2) 'SP2791RKSYJJ39MVHC09J8NARWBMK5G9C79EJB0RV))
      (map-set token-count 'SP2791RKSYJJ39MVHC09J8NARWBMK5G9C79EJB0RV (+ (get-balance 'SP2791RKSYJJ39MVHC09J8NARWBMK5G9C79EJB0RV) u1))
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u3) 'SP2R3CHRAP1HE4M64X1NZXHZT41JG3XGNHJW4HX2W))
      (map-set token-count 'SP2R3CHRAP1HE4M64X1NZXHZT41JG3XGNHJW4HX2W (+ (get-balance 'SP2R3CHRAP1HE4M64X1NZXHZT41JG3XGNHJW4HX2W) u1))
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u4) 'SP2EMZSA1CQQCGJEQ9JSDBWBV0NFDJ59EH5P9E56V))
      (map-set token-count 'SP2EMZSA1CQQCGJEQ9JSDBWBV0NFDJ59EH5P9E56V (+ (get-balance 'SP2EMZSA1CQQCGJEQ9JSDBWBV0NFDJ59EH5P9E56V) u1))
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u5) 'SP342MMZRDFSC556F193N76D87SCTYX7SSHD8H3XD))
      (map-set token-count 'SP342MMZRDFSC556F193N76D87SCTYX7SSHD8H3XD (+ (get-balance 'SP342MMZRDFSC556F193N76D87SCTYX7SSHD8H3XD) u1))
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u6) 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ))
      (map-set token-count 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ (+ (get-balance 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ) u1))
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u7) 'SP2QQH09E2VQVVXWPKWSCCRP1ARY7X2AYHXQ154CP))
      (map-set token-count 'SP2QQH09E2VQVVXWPKWSCCRP1ARY7X2AYHXQ154CP (+ (get-balance 'SP2QQH09E2VQVVXWPKWSCCRP1ARY7X2AYHXQ154CP) u1))
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u8) 'SP2791RKSYJJ39MVHC09J8NARWBMK5G9C79EJB0RV))
      (map-set token-count 'SP2791RKSYJJ39MVHC09J8NARWBMK5G9C79EJB0RV (+ (get-balance 'SP2791RKSYJJ39MVHC09J8NARWBMK5G9C79EJB0RV) u1))
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u9) 'SP2R3CHRAP1HE4M64X1NZXHZT41JG3XGNHJW4HX2W))
      (map-set token-count 'SP2R3CHRAP1HE4M64X1NZXHZT41JG3XGNHJW4HX2W (+ (get-balance 'SP2R3CHRAP1HE4M64X1NZXHZT41JG3XGNHJW4HX2W) u1))
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u10) 'SP2EMZSA1CQQCGJEQ9JSDBWBV0NFDJ59EH5P9E56V))
      (map-set token-count 'SP2EMZSA1CQQCGJEQ9JSDBWBV0NFDJ59EH5P9E56V (+ (get-balance 'SP2EMZSA1CQQCGJEQ9JSDBWBV0NFDJ59EH5P9E56V) u1))
      (try! (nft-mint? ffrriieedd-fried-bros-ascension (+ last-nft-id u11) 'SP342MMZRDFSC556F193N76D87SCTYX7SSHD8H3XD))
      (map-set token-count 'SP342MMZRDFSC556F193N76D87SCTYX7SSHD8H3XD (+ (get-balance 'SP342MMZRDFSC556F193N76D87SCTYX7SSHD8H3XD) u1))
