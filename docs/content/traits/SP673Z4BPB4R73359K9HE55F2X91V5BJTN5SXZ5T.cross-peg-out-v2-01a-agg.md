---
title: "Trait cross-peg-out-v2-01a-agg"
draft: true
---
```
...
(define-public (transfer-to-swap (amount-in-fixed uint) (token-in-trait <ft-trait>) (token-out principal) (min-amount-out (optional uint)) (dest-chain-id uint) (success-settle { address: (buff 256), chain-id: (optional uint) }) (fail-settle { address: (buff 256), chain-id: (optional uint) }))
  (let (
      (sender tx-sender)
