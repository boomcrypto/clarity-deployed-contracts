---
title: "Trait zeropoints-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP7QQ9DV0DMV7YW4HR713MKBWADVA0BFC2J65PJT.zeropoints-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u9316770186335404)
    (var-set stx-balance u29333333)
