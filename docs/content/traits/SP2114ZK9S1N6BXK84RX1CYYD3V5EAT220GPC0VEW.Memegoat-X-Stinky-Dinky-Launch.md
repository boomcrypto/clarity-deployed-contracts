---
title: "Trait Memegoat-X-Stinky-Dinky-Launch"
draft: true
---
```

;; ---------------------------------------------------------
;; MEMEGOAT X STINKY DINKY LAUNCH
;; ---------------------------------------------------------
...
;; LAUNCHPAD DATA
(define-constant LISTING-ALLOCATION u2222222222000000)
(define-constant SALE-ALLOCATION u6666666666000000)
(define-constant LAUNCHPAD-TOKEN 'SP2114ZK9S1N6BXK84RX1CYYD3V5EAT220GPC0VEW.stinky-dinky)
...
(define-constant MIN-BUY u2500000)
(define-constant MAX-BUY u250000000)
(define-constant HARD-CAP u5555000000) 
(define-constant SOFT-CAP u3333000000)
(define-constant START-BLOCK u170308)
(define-constant END-BLOCK u172180)
...
(define-private (initialize)
  ...
  (begin
    ...
    (try! (contract-call? 'SP2114ZK9S1N6BXK84RX1CYYD3V5EAT220GPC0VEW.stinky-dinky transfer LISTING-ALLOCATION tx-sender LISTING-SIG-WALLET none))
    (try! (contract-call? 'SP2114ZK9S1N6BXK84RX1CYYD3V5EAT220GPC0VEW.stinky-dinky transfer SALE-ALLOCATION tx-sender LAUNCHPAD-ADDRESS none))
