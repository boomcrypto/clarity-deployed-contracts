...
(define-fungible-token token-17)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-17 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-17)))
