...
(define-fungible-token token-21)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-21 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-21)))
