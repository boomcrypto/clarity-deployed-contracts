---
title: "Trait sbtc-rollout-stxcity-dex"
draft: true
---
```
...
(define-constant STX_TARGET_AMOUNT u12000000000)
(define-constant VIRTUAL_STX_VALUE u2400000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u240000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP1JZA75FT9WRPB4RX4B3M3AKERP2S4WF28JXJ58V.sbtc-rollout-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u20987698876491)
    (var-set stx-balance u1406667)
