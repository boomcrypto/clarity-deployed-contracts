---
title: "Trait fak-dot-fun-faktory"
draft: true
---
```
...
(begin 
    ...
    (try! (ft-mint? fak u68961687931993 .fak-dot-fun-faktory-dex)) ;; supply-left
    (try! (ft-mint? fak u38312068007 tx-sender)) ;; ft-amount-bought

    
    ;; STX distribution (first buy premium fee)
    (try! (stx-transfer-to .fak-dot-fun-faktory-dex u666667)) ;; stx-in-dex
