---
title: "Trait keeper-1-helper-v-1-1"
draft: true
---
```
;; keeper-1-helper-v-1-1

;; Error constants
(define-constant ERR_NOT_AUTHORIZED (err u11001))
(define-constant ERR_INVALID_AMOUNT (err u11002))
(define-constant ERR_ALREADY_ADMIN (err u11003))
(define-constant ERR_ADMIN_LIMIT_REACHED (err u11004))
(define-constant ERR_ADMIN_NOT_IN_LIST (err u11005))
(define-constant ERR_CANNOT_REMOVE_CONTRACT_DEPLOYER (err u11006))
(define-constant ERR_KEEPER_STATUS (err u11007))
(define-constant ERR_INVALID_FEE (err u11008))
...
(define-public (get-action-a (amount uint))
  (let (
    ...
    ;; Get quote for psBTC to STX swap via XYK Core
    (quote-psbtc-to-stx (contract-call?
