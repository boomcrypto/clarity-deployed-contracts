...
(define-fungible-token token-22)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-22 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-22)))
