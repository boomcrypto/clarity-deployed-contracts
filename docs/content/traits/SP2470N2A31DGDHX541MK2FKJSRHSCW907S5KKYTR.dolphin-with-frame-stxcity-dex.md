---
title: "Trait dolphin-with-frame-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP2470N2A31DGDHX541MK2FKJSRHSCW907S5KKYTR.dolphin-with-frame-stxcity)
...
(var-set token-balance u997917678444312)
(var-set stx-balance u2086667)
