---
title: "Trait slack-faktory-dex"
draft: true
---
```

;; fb8c0d5dfe9fab3db820cc77fb527079800f81407a60c66bcce7ea8666324bf5
...
(define-constant DEX-TOKEN 'SP31ER8WTA6RM08Z0GNTY786T4PW6SYKFTNMTPRSV.slack-faktory)
(define-constant AUTHORIZED-CONTRACT 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.buy-with-velar-faktory)

;; token constants
(define-constant TARGET_STX u21000000000)
(define-constant FAK_STX u5250000000)
(define-constant GRAD-FEE u420000000)
...
;; boot dex
  (begin
    ...
    (var-set ft-balance u20997333670582)
