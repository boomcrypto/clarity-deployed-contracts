---
title: "Trait aib-faktory"
draft: true
---
```

;; 23a975ceb5bbf31aa0fd443d5533c605e39e22eca35ea5b7087b10633542ec7c
;; aib Powered By Faktory.fun v1.0 
...
(define-fungible-token aib MAX)
(define-constant MAX u1000000000000000)
(define-data-var contract-owner principal 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.aib-token-owner)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? aib amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? aib (/ (* MAX u80) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.ai-sbtc-treasury)) ;; 80% treasury
    (try! (ft-mint? aib (/ (* MAX u20) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.ai-sbtc-faktory-dex)) ;; 20% dex
