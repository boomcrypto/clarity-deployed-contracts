...
(define-fungible-token token-59)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-59 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-59)))
