---
title: "Trait xyk-sbtc-reader-pool-22-v-1-1"
draft: true
---
```
;; xyk-sbtc-reader-pool-22-v-1-1
...
;; Get total sBTC balance in sBTC-DOG XYK pool
(define-read-only (get-total-sbtc-balance)
  (let (
    ...
    (pool-sbtc-balance (unwrap! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token get-balance
                                'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-pool-sbtc-dog-v-1-1) ERR_NO_POOL_DATA))
  )
...
;; Get a user's sBTC balance in sBTC-DOG XYK pool
(define-read-only (get-user-sbtc-balance (user principal))
  (let (
    ;; Gather all pool data
    (pool-data (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-pool-sbtc-dog-v-1-1 get-pool) ERR_NO_POOL_DATA))
    ...
    (user-lp-balance (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-pool-sbtc-dog-v-1-1 get-balance
                              user) ERR_NO_USER_DATA))
    (user-staking-data (unwrap! (contract-call? 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.xyk-staking-sbtc-dog-v-1-1 get-user
                                user) ERR_NO_USER_DATA))
