---
title: "Trait ballot-vote-with-atalex-myiUP"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with atALEX) Approve Launch of Ordiswap on the ALEX Launchpad")
    (var-set description u"This proposal is to approve Ordiswap for the ALEX Decentralized Launchpad. Information on the project is available on the application form Ordiswap has submitted.Ordiswap Launchpad Application Form: https://docs.google.com/spreadsheets/d/1Yk0qpLPK76cR6DTaApV2153a98MryeN5oWjQ5XgQ6eY/edit?usp=sharingX/Twitter: https://twitter.com/OrdiswapLabsWebsite: https://ordiswap.fi/Linktree: https://linktr.ee/ordiswapVote to either approve or disapprove the project to launch on ALEX. The ALEX Lab Foundation does NOT spon")
    (var-set voting-system "fptp")
    (var-set options (list "8c82610b-2cf8-4a65-869c-0f8e75e77f53" "f0c39bc2-53be-4462-af3a-16a1999b6015"))
    (var-set start u133894)
    (var-set end u134326)
    (map-set results {id: "8c82610b-2cf8-4a65-869c-0f8e75e77f53"} {count: u0, name: u"Approve Launch of Ordiswap on the ALEX Launchpad"}) (map-set results {id: "f0c39bc2-53be-4462-af3a-16a1999b6015"} {count: u0, name: u"Disapprove Launch of Ordiswap on the ALEX Launchpad"})
```
