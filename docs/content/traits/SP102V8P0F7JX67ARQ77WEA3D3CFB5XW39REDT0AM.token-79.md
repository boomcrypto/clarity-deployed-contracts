...
(define-fungible-token token-79)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-79 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-79)))
