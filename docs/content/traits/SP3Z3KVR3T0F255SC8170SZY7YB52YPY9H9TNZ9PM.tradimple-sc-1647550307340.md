---
title: "Trait tradimple-sc-1647550307340"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-stacks-pixels transfer u742 tx-sender agent-1)))
		(as-contract (stx-transfer? u16300000 tx-sender agent-1)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u19500000 tx-sender agent-2)))
	)
