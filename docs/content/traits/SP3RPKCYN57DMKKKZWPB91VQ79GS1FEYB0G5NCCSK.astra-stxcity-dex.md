...
(define-constant allow-token 'SP3RPKCYN57DMKKKZWPB91VQ79GS1FEYB0G5NCCSK.astra-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u9881422924901186)
    (var-set stx-balance u12000000)
