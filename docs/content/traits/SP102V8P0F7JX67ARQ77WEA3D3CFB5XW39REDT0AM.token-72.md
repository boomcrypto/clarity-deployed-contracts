...
(define-fungible-token token-72)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-72 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-72)))
