...
(define-fungible-token token-75)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-75 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-75)))
