---
title: "Trait orbit-ai-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u200000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP3BJ0KSAF04HGFSBKHW4TMJ5MGAAADAHDFPPHF8M.orbit-ai-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u199766938571666)
    (var-set stx-balance u2333333)
