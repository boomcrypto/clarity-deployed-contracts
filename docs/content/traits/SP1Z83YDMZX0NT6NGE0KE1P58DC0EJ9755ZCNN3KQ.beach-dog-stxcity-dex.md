---
title: "Trait beach-dog-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u77777777000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP1Z83YDMZX0NT6NGE0KE1P58DC0EJ9755ZCNN3KQ.beach-dog-stxcity)
...
(var-set token-balance u70007000000000)
(var-set stx-balance u66600000)
