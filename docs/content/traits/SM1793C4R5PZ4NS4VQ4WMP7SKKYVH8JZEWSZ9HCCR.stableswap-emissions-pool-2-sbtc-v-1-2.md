---
title: "Trait stableswap-emissions-pool-2-sbtc-v-1-2"
draft: true
---
```

;; stableswap-emissions-pool-2-sbtc-v-1-2
...
(define-private (get-external-user-data (user principal) (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     .stableswap-staking-sbtc-pbtc-v-1-2 get-user-at-cycle
...
(define-private (get-external-cycle-data (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     .stableswap-staking-sbtc-pbtc-v-1-2 get-lp-staked-at-cycle
