---
title: "Trait brics1-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPZGSZB7FWVYKSZ6SEBNERSBHJRGE4ZJSXBC9Y0G.brics1-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u95693779904306224)
    (var-set stx-balance u18000000)
