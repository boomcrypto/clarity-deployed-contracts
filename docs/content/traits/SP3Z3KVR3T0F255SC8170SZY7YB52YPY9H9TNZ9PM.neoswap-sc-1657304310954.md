---
title: "Trait neoswap-sc-1657304310954"
draft: true
---
```
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u4230000 tx-sender agent-2)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u2418 tx-sender agent-5)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u4230000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
