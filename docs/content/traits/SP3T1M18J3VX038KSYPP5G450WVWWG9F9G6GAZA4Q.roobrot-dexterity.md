---
title: "Trait roobrot-dexterity"
draft: true
---
```
;; RooBrot - LP Token, AMM DEX and Hold-to-Earn Engine
;; SP3T1M18J3VX038KSYPP5G450WVWWG9F9G6GAZA4Q.roobrot-dexterity
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP3T1M18J3VX038KSYPP5G450WVWWG9F9G6GAZA4Q.roobrot-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    (sender tx-sender)
    (reserve-in (unwrap-panic (if forward (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.synthetic-roo get-balance CONTRACT) 
      (contract-call? 'SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.charisma-phoenix-stxcity get-balance CONTRACT))))
    (reserve-out (unwrap-panic (if forward (contract-call? 'SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.charisma-phoenix-stxcity get-balance CONTRACT) 
    ...
    (try! (if forward (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.synthetic-roo transfer amt-in sender CONTRACT none) 
      (contract-call? 'SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.charisma-phoenix-stxcity transfer amt-in sender CONTRACT none)))
    (try! (as-contract (if forward (contract-call? 'SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.charisma-phoenix-stxcity transfer amt-out CONTRACT sender none)
      (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.synthetic-roo transfer amt-out CONTRACT sender none))))
    (ok {amt-in: amt-in, amt-out: amt-out})))

(define-public (mint (who principal) (amount uint))
  (let (
    (reserve0 (unwrap-panic (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.synthetic-roo get-balance CONTRACT)))
    (reserve1 (unwrap-panic (contract-call? 'SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.charisma-phoenix-stxcity get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.synthetic-roo transfer token0-amount who CONTRACT none))
    (try! (contract-call? 'SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.charisma-phoenix-stxcity transfer token1-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.synthetic-roo transfer token0-amount CONTRACT who none)))
    (try! (as-contract (contract-call? 'SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.charisma-phoenix-stxcity transfer token1-amount CONTRACT who none)))
    (ok {token0-amount: token0-amount, token1-amount: token1-amount, lp-amount: amount})))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.synthetic-roo, token1: 'SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.charisma-phoenix-stxcity}))
...
(define-read-only (get-reserves)
  (ok {
    token0: (unwrap-panic (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.synthetic-roo get-balance CONTRACT)),
    token1: (unwrap-panic (contract-call? 'SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.charisma-phoenix-stxcity get-balance CONTRACT))
  }))
