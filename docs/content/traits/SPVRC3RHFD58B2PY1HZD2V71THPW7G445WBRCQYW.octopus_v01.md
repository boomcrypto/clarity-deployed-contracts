...
(begin
    (var-set
        vote_members
        (list 'SPVRC3RHFD58B2PY1HZD2V71THPW7G445WBRCQYW 'SP1MCDGYJ31M8N6944JFR9G39PG49VD1C981FJ56N 'SP3GPQ67G54F0JE6V8SG5F9QW2X12EWC28KCK9QSR)
    )
)
...
(define-public (deposit (amountSTSW uint))
    (let
        ...
        (asserts! (>= (unwrap-panic (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a get-balance contract-caller)) amountSTSW ) (err ERR_INSUFFICIENT_FUND_IN_WALLET))
        (try! (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a transfer amountSTSW (var-get operator) (as-contract tx-sender) none))
...
(define-public (withdraw (to_addr principal) (amountSTSW uint))
    (let
        ...
        (asserts! (>= (unwrap-panic (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a get-balance (as-contract tx-sender))) amountSTSW ) (err ERR_INSUFFICIENT_FUND_IN_CONTRACT))
        (try! (as-contract (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a transfer amountSTSW tx-sender to_addr none)))
