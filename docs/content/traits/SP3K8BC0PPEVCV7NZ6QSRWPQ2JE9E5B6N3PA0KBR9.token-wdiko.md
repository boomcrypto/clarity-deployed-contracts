...
(define-fungible-token wdiko)

(define-data-var token-name (string-ascii 32) "Wrapped DIKO")
(define-data-var token-symbol (string-ascii 10) "wdiko")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wdiko.json"))
...
(define-read-only (get-balance (account principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-token get-balance account)) (pow-decimals)) (pow u10 u6)))
)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    ...
    (contract-call? 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-token transfer (/ (* amount (pow u10 u6)) (pow-decimals)) sender recipient memo)
  )
)
