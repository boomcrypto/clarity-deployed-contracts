...
(define-fungible-token token-38)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-38 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-38)))
