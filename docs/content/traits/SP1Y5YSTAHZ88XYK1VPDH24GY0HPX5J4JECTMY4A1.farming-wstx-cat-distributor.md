---
title: "Trait farming-wstx-cat-distributor"
draft: true
---
```
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constants
(define-constant REWARD-TOKEN 'SP2EBPXW74DHJMZHXMT5NRMJS5CG5PR2RY4FKTHJC.crypto-adoption-token)
...
(define-public
  ...
  (let ((epoch (contract-call? .farming-wstx-cat-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .farming-wstx-cat-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .farming-wstx-cat-core current-epoch))
