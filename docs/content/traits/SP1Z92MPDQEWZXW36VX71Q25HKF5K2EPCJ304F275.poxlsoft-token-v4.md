...
(define-public (initialize (name-to-set (string-ascii 32)) (symbol-to-set (string-ascii 32)) (decimals-to-set uint) (uri-to-set (string-utf8 256))
  ...
  (begin
    (asserts! (is-eq contract-caller (unwrap-panic (contract-call? .stackswap-dao-v5g get-qualified-name-by-name "one-step-mint"))) (err ERR_PERMISSION_DENIED))
...
(contract-call? .stackswap-one-step-mint-v5h add-poxl-token (as-contract tx-sender))
```
