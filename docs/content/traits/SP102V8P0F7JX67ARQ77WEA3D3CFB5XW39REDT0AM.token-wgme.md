---
title: "Trait token-wgme"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token wgme)
(define-data-var token-name (string-ascii 32) "Gamestop Wrapper")
(define-data-var token-symbol (string-ascii 32) "wgme")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wgme.json"))
...
(define-read-only (get-base-decimals)
  (contract-call? 'SPA0SZQ6KCCYMJV5XVKSNM7Y1DGDXH39A11ZX2Y8.gamestop get-decimals))
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SPA0SZQ6KCCYMJV5XVKSNM7Y1DGDXH39A11ZX2Y8.gamestop get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SPA0SZQ6KCCYMJV5XVKSNM7Y1DGDXH39A11ZX2Y8.gamestop transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
