...
(define-fungible-token token-66)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-66 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-66)))
