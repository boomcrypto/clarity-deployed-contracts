---
title: "Trait pontis-bridge-FEHU"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "Z.Z.Z.Z.Z.FEHU.Z.Z.Z.Z.Z")
(define-data-var token-symbol (string-ascii 10) "FEHU")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmeoTccZqAcwhGrt9AnY2G6rULg5KWCewkTe3oGphPs5Fq"))
;; 840000:1
