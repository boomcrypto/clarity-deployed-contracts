...
(define-read-only (get-balance (who principal) )
 (ok (ft-get-balance ytoken who))
)
(define-read-only (get-total-supply)
 (ok (ft-get-supply ytoken))
)
...
(define-public (transfer
  ...
  (begin
    ...
    (asserts! 
      (is-ok (ft-transfer? ytoken amount sender recipient))
     err_transfer_failed
    )
...
(define-public (burn (amount uint) (owner principal))
  (begin
   ...
   (try!  (ft-burn? ytoken amount owner))
    (ok true)
  )
)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
