---
title: "Trait doughnut-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u1000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP1BFQGKX8EJVSTX8HSJ367HGC3TFFBRSQA1PPHET.doughnut-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u986809644419)
    (var-set stx-balance u5346667)
