...
(define-data-var token-name (string-ascii 32) "Good Karma")
(define-data-var token-symbol (string-ascii 10) "iGK")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://charisma.rocks/indexes/good-karma.json"))
...
(define-public (add-liquidity (amount uint))
    (let
        ...
        (try! (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.velar-token transfer amount-a tx-sender contract none))
...
(define-public (remove-liquidity (amount uint))
    (let
        ...
        (try! (as-contract (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.velar-token transfer amount-a contract sender none)))
