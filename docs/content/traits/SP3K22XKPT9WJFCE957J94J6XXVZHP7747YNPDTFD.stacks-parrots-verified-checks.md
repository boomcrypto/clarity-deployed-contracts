---
title: "Trait stacks-parrots-verified-checks"
draft: true
---
```
;; stacks-parrots-verified-checks
;; contractType: editions

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token stacks-parrots-verified-checks uint)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmTVbVXLVYRrppJbak7VBhYRM7AvWtDiFb3d1tj59ppQeD/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (or (is-eq (var-get mint-limit) u0) (<= next-id (var-get mint-limit)))
    (begin
      (unwrap! (nft-mint? stacks-parrots-verified-checks next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? stacks-parrots-verified-checks token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? stacks-parrots-verified-checks token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? stacks-parrots-verified-checks token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? stacks-parrots-verified-checks id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? stacks-parrots-verified-checks id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? stacks-parrots-verified-checks id) (err ERR-NOT-FOUND)))
...
(map-set mint-passes 'SP2Q9DCS01BNJEWZQND8Y8WAZDAEPE0BEWAM0E86G u1)
(map-set mint-passes 'SP000000000000000000002Q6VF78 u1)
(map-set mint-passes 'SP000000000000000000002Q6VF78 u1)
...
(map-set mint-passes 'SPEH20TBHSEZJTKTA8V3T70N8YHNR0ZVHE91ZET7 u1)
...
(map-set mint-passes 'SP2Z4GMM1KM7KEZEX112A9MPKE1MDDQ9W6PGTMAC3 u1)
(map-set mint-passes 'SP3HV4WQ6NZNJ9QPNP6RN5DCD6T0S9Z74K0MQX486 u1)
...
(map-set mint-passes 'SP3FHHC4Z80691E534724YXDP7W6Y5KXWPYQWXZVH u1)
(map-set mint-passes 'SP3KXV3J6MRHAH4H89MDS390X1KS0GQN4DWQ5RFVB u1)
(map-set mint-passes 'SP14PVWDVKVK1P1SZV72MJQMNX5N5XDZ8AGNG9M0C u1)
...
(map-set mint-passes 'SP3XMYSS7VHPQV9YP2083D3VN8VDH8ZYZYD7XAR6E u1)
(map-set mint-passes 'SP3SKH6YB515J76KVDHDHBTE2GQ4CV6QJHC5GJKRF u1)
(map-set mint-passes 'SP224YKZ55F25SBYVR8HZXQ7G89CC8WYKAGMZHQ0A u1)
(map-set mint-passes 'SP27E3TDKYNH3C11RBDFPD5WGR6FV0VN08RKX4D2N u1)
(map-set mint-passes 'SP2CHC7GM2Y8RMMSRC7DSDJW3Y7CNYC2Q9EVFSSHV u1)
(map-set mint-passes 'SP33G7CYV2ACDVKEK3HV5Q2M1EPJ4T2111HBVMD1T u1)
(map-set mint-passes 'SP1WYHPJJVN3P0PS32BMF33P6WVVK1SNRRS28ZF0G u1)
...
(map-set mint-passes 'SPPSKWJX6NE87G6CZ968M8E6Y7QNX6M4H5AMTSFD u1)
...
(map-set mint-passes 'SP6HYDNWHSSTZFS0HAR4FDRPXK3EK603S0BYJHFJ u1)
(map-set mint-passes 'SP2JMY6PG75AWQFJYYYRAEJNMZFHH46RHJWP5NWRY u1)
