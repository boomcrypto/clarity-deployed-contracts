...
(define-private (vibes-wstx-e (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.amm-swap-pool-v1-1 swap-y-for-x
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx
...
(define-private (wstx-vibes-e (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.amm-swap-pool-v1-1 swap-x-for-y
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wvibes
...
(define-private (swap-e
  ...
  (if (is-eq a T_STX)
    ...
    (if (is-eq b T_VIBES) (wstx-vibes-e x)
    ERR_AB))))
  (if (is-eq a T_XBTC)
  ...
  (if (is-eq a T_DIKO)
    ...
    ERR_AB))
  (if (is-eq a T_VIBES)
    (if (is-eq b T_STX) (vibes-wstx-e x)
    ERR_AB)
  ERR_AA)))))
)
...
(match (contract-call?
'SP12FXJWBTM6D2ZV7D1D0D3G7CYRRTP6RDETSVJGA.stackswap-swap-v5k swap-y-for-x
...
(match (contract-call?
'SP12FXJWBTM6D2ZV7D1D0D3G7CYRRTP6RDETSVJGA.stackswap-swap-v5k swap-x-for-y
'SP3MBWGMCVC9KZ5DTAYFMG1D0AEJCR7NENTM3FTK5.lydian-token
'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a
'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.liquidity-token-v5korf9pv1h
x u0)
...
(awl 'SPNJ0ZPYRFMJ8S8173Z56TZEP2E3M6FF8N69H38C)                                                                                                                                                                                (six u9433164654600)
(define-private (xfer
  (a (string-ascii 1))
  (amt uint)
  (src principal)
