---
title: "Trait neoswap-sc-1664364083622"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u3799400 tx-sender agent-1)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u540600 tx-sender agent-2)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4540000 tx-sender agent-3)))
	)
