---
title: "Trait flash-loan-user-fixed-to-amm-xusd-susdt"
draft: true
---
```
...
(define-public (execute (token <ft-trait>) (amount uint) (memo (optional (buff 16))))
    (let
        (   
            (swapped (try! (contract-call? .swap-helper-bridged-v1-1 swap-helper-from-amm .token-wxusd .token-wstx .token-susdt ONE_8 amount none)))
            (swapped-back (try! (contract-call? .amm-swap-pool-v1-1 swap-helper .token-susdt .token-wxusd u5000000 swapped none)))            
