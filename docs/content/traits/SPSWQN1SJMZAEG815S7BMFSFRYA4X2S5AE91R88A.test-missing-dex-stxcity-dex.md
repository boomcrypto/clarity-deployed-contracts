---
title: "Trait test-missing-dex-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u68686868686000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPSWQN1SJMZAEG815S7BMFSFRYA4X2S5AE91R88A.test-missing-dex-stxcity)
...
(var-set token-balance u68685723923934600)
(var-set stx-balance u66667)
