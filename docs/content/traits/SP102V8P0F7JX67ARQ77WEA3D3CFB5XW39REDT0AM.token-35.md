...
(define-fungible-token token-35)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-35 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-35)))
