---
title: "Trait ai-music-of-the-future-a-stacks-symphony"
draft: true
---
```
;; ai-music-of-the-future-a-stacks-symphony
;; contractType: editions

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token ai-music-of-the-future-a-stacks-symphony uint)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmSKrTLtCw8ChpjDJ6VwczvZMHkebpQmvABGBu9PmjX1cG/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (or (is-eq (var-get mint-limit) u0) (<= next-id (var-get mint-limit)))
    (begin
      (unwrap! (nft-mint? ai-music-of-the-future-a-stacks-symphony next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? ai-music-of-the-future-a-stacks-symphony token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? ai-music-of-the-future-a-stacks-symphony token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? ai-music-of-the-future-a-stacks-symphony token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? ai-music-of-the-future-a-stacks-symphony id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? ai-music-of-the-future-a-stacks-symphony id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? ai-music-of-the-future-a-stacks-symphony id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-alex uint u4000000000)
