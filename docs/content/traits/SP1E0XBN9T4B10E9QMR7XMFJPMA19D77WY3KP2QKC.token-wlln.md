...
(define-fungible-token wlln)

(define-data-var token-name (string-ascii 32) "long-live-nakamoto Wrapper")
(define-data-var token-symbol (string-ascii 32) "wlln")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wlln.json"))
...
(define-read-only (get-base-token)
  'SP11XNH1DR40PYSN8P3BCBNFY356TDFHS64XSRVPB.long-live-nakamoto)

(define-read-only (get-base-decimals)
  (contract-call? 'SP11XNH1DR40PYSN8P3BCBNFY356TDFHS64XSRVPB.long-live-nakamoto get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP11XNH1DR40PYSN8P3BCBNFY356TDFHS64XSRVPB.long-live-nakamoto get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP11XNH1DR40PYSN8P3BCBNFY356TDFHS64XSRVPB.long-live-nakamoto transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
