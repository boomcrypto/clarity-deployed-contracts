...
(define-non-fungible-token public-003 uint)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmS2uPMZ8wGCh5DDfRFEGG3h8zRZyDzL4cpuq3KeKWe8X4/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? public-003 next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? public-003 token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? public-003 token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? public-003 token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? public-003 id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? public-003 id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? public-003 id) (err ERR-NOT-FOUND)))
...
(define-data-var total-price-mia uint u1566)
...
(define-public (claim-two-mia) (mint-mia (list true true)))

(define-public (claim-three-mia) (mint-mia (list true true true)))

(define-public (claim-four-mia) (mint-mia (list true true true true)))

(define-public (claim-six-mia) (mint-mia (list true true true true true true)))

(define-public (claim-seven-mia) (mint-mia (list true true true true true true true)))

(define-public (claim-nine-mia) (mint-mia (list true true true true true true true true true)))

(define-public (claim-ten-mia) (mint-mia (list true true true true true true true true true true)))

(define-public (claim-fifteen-mia) (mint-mia (list true true true true true true true true true true true true true true true)))
...
;; Alt Minting Mintpass
(define-data-var total-price-nyc uint u1518)
...
(define-public (claim-two-nyc) (mint-nyc (list true true)))

(define-public (claim-three-nyc) (mint-nyc (list true true true)))

(define-public (claim-four-nyc) (mint-nyc (list true true true true)))

(define-public (claim-six-nyc) (mint-nyc (list true true true true true true)))

(define-public (claim-seven-nyc) (mint-nyc (list true true true true true true true)))

(define-public (claim-nine-nyc) (mint-nyc (list true true true true true true true true true)))

(define-public (claim-ten-nyc) (mint-nyc (list true true true true true true true true true true)))

(define-public (claim-fifteen-nyc) (mint-nyc (list true true true true true true true true true true true true true true true)))
...
;; Alt Minting Mintpass
(define-data-var total-price-usda uint u2000000)
