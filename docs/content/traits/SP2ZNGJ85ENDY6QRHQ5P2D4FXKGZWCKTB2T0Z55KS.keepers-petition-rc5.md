---
title: "Trait keepers-petition-rc5"
draft: true
---
```
...
(define-private (petition-action (sender principal))
  (let ((fatigue-response (unwrap-panic (contract-call? .fatigue-rc5 execute "BURN"))))
...
(define-private (handle-petition-attempt (sender principal))
  (begin
    (match (contract-call? .dungeon-keeper-rc6 transfer (var-get token-amount) (var-get token-principal) sender)
      success (begin 
