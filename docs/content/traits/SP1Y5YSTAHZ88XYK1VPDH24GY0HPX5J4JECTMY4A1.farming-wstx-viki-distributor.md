---
title: "Trait farming-wstx-viki-distributor"
draft: true
---
```
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constants
(define-constant REWARD-TOKEN 'SP31BV8VGBSGAR453P6PEQ9SB3AMYMZ1ATBPWDGKY.viking)
...
(define-public
  ...
  (let ((epoch (contract-call? .farming-wstx-viki-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .farming-wstx-viki-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .farming-wstx-viki-core current-epoch))
