---
title: "Trait pontis-bridge-SATOSHI"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "SATOSHI.NAKAMOTO")
(define-data-var token-symbol (string-ascii 10) "SATOSHI")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmdcFbyvYkeQUQjeHcHL4T94tp6FuBK7z4XSom4A4brY7b"))
;; 840000:22
