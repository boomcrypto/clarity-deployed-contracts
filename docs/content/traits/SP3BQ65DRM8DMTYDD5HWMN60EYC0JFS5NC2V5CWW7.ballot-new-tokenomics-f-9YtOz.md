---
title: "Trait ballot-new-tokenomics-f-9YtOz"
draft: true
---
```
    ...
    (var-set options (list "5ecff8fe-eb53-4ee2-975d-efc6e3be3646" "7767e800-2585-4a75-9573-c6574ece7d07" "be667090-e33e-473e-b864-74eb81924e4e"))
    (var-set start u85065)
    (var-set end u85870)
    (map-set results {id: "5ecff8fe-eb53-4ee2-975d-efc6e3be3646"} {count: u0, name: u"Yes, change from fixed emission to dynamic emissions"}) (map-set results {id: "7767e800-2585-4a75-9573-c6574ece7d07"} {count: u0, name: u"Yes, change from fixed emission to dynamic emissions"}) (map-set results {id: "be667090-e33e-473e-b864-74eb81924e4e"} {count: u0, name: u"Choice 3"})
```
