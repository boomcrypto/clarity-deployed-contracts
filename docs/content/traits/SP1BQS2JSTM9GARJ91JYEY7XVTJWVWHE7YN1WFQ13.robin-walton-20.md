        ...
        (let
            (
                ...
                (swapped-amounts-2 (if stackswap-inverse
                    (unwrap! (as-contract (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-swap-v5k swap-y-for-x stackswap-token-y-trait stackswap-token-x-trait stackswap-token-liquidity-trait y-amount u0)) (err ERR-SWAP-TWO-FAILED))
