---
title: "Trait toad-killer-stxcity-dex"
draft: true
---
```
...
(define-constant STX_TARGET_AMOUNT u20000000000)
(define-constant VIRTUAL_STX_VALUE u4000000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u400000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP1093PXJD0BB7KK6SPJB3TPQDRPE0VVK7PWY1FGR.toad-killer-stxcity)
...
(var-set token-balance u99800399201596816)
(var-set stx-balance u8000000)
