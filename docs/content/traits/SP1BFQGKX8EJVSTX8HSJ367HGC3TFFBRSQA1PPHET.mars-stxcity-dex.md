...
(define-constant allow-token 'SP1BFQGKX8EJVSTX8HSJ367HGC3TFFBRSQA1PPHET.mars-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u99838428143787310)
    (var-set stx-balance u6473333)
