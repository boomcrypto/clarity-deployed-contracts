...
(define-constant allow-token 'SP1X39D6HC50QNQWJ19WYAGRG8ATHTX0J4KJ538FS.water-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u9292035398230088)
    (var-set stx-balance u106666667)
