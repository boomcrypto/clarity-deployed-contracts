---
title: "Trait ststx-not"
draft: true
---
```
;; Nothing Community Pool
;; stSTX-NOT LP token with configurable metadata
...
(define-data-var token-symbol (string-ascii 10) "stSTX-NOT")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/ststx-not/metadata.json"))
