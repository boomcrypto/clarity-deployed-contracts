...
(define-trait bridge-trait-v2
	(
		...
		(mint-runes-batch-from-btc ((list 100 <bridge-ft-trait>) (list 100 uint) (list 100 principal) (list 100 (buff 36)) (buff 32) uint) (response bool uint))
		(mint-btc-from-btc (<bridge-ft-trait> uint principal (buff 36) (buff 32) uint) (response bool uint))
		(mint-ordinals-batch-from-btc (<bridge-nft-trait> (list 1000 uint) (list 1000 principal) (list 1000 (buff 36)) (buff 32) uint) (response bool uint))
