---
title: "Trait jittery-amber-hyena"
draft: true
---
```
...
(define-constant stackswap-swap-v5k 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-swap-v5k)
    ...
    (let
        ((swapped-amounts
            (try! (as-contract (if stackswap-inverse
                (contract-call? stackswap-swap-v5k swap-y-for-x
                    stackswap-token-x-trait
                    stackswap-token-y-trait
                    stackswap-token-liquidity-trait
                    dx
                    u0)
                (contract-call? stackswap-swap-v5k swap-x-for-y
                    stackswap-token-x-trait
                    stackswap-token-y-trait
                    stackswap-token-liquidity-trait
                    dx
...
(define-public (swap-help-b
    ...
    (liquidity-bc-trait <stackswap-liquidity-token>)
    ...
    (begin
        ...
        (let
            (
                ...
                (amount-c (unwrap-panic (swap-helper-a token-b-trait token-c-trait liquidity-bc-trait inverse-bc amount-b)))
                (amount-out (unwrap-panic (swap-helper-a token-c-trait token-d-trait liquidity-cd-trait inverse-cd amount-c)))
            )
