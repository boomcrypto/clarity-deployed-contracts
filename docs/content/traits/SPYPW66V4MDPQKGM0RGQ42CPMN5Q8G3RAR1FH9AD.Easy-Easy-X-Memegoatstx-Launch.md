---
title: "Trait Easy-Easy-X-Memegoatstx-Launch"
draft: true
---
```

;; ---------------------------------------------------------
;; MEMEGOAT X EASY EASY LAUNCH
;; ---------------------------------------------------------
...
;; LAUNCHPAD DATA
(define-constant LISTING-ALLOCATION u32000000000000)
(define-constant SALE-ALLOCATION u65000000000000)
(define-constant LAUNCHPAD-TOKEN 'SPYPW66V4MDPQKGM0RGQ42CPMN5Q8G3RAR1FH9AD.easy-easy)
...
(define-constant MIN-BUY u20000000)
(define-constant MAX-BUY u150000000)
(define-constant HARD-CAP u50000000000) 
(define-constant SOFT-CAP u2000000000)
(define-constant START-BLOCK u870614)
(define-constant END-BLOCK u924950)
