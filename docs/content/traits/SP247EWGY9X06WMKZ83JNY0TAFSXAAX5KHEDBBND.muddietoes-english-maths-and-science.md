---
title: "Trait muddietoes-english-maths-and-science"
draft: true
---
```
;; muddietoes-english-maths-and-science
;; contractType: editions

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token muddietoes-english-maths-and-science uint)
...
;; Internal variables
(define-data-var mint-limit uint u128)
(define-data-var last-id uint u1)
(define-data-var total-price uint u2800000)
(define-data-var artist-address principal 'SP80GBK11J82DJAT7C8B7YCKWFJ37D5V0SGWET16)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmNa6DHh5DDGsZuVz9LdcrWsbAxVBe444StaZJivzoeecF/")
(define-data-var mint-paused bool false)
(define-data-var premint-enabled bool false)
(define-data-var sale-enabled bool false)
(define-data-var metadata-frozen bool false)
(define-data-var airdrop-called bool false)
(define-data-var mint-cap uint u21)
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (or (is-eq (var-get mint-limit) u0) (<= next-id (var-get mint-limit)))
    (begin
      (unwrap! (nft-mint? muddietoes-english-maths-and-science next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? muddietoes-english-maths-and-science token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? muddietoes-english-maths-and-science token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? muddietoes-english-maths-and-science token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? muddietoes-english-maths-and-science id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? muddietoes-english-maths-and-science id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? muddietoes-english-maths-and-science id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-mega uint u2000)
