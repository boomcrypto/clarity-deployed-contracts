...
(define-private (handleSwapXForY (fromToken <ft-trait>) (toToken <ft-trait>) (lpToken <liquidity-token>) (dx uint) (minDy uint))
    (let
        ...
        ;; check pool exists
        (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-swap-v5k get-pair-details tokenXAddr tokenYAddr)
        ;; contract call do the real swap
        (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-swap-v5k swap-x-for-y tokenX tokenY lpToken dx minDy)
    )
)
...
(define-private (handleSwapYForX (fromToken <ft-trait>) (toToken <ft-trait>) (lpToken <liquidity-token>) (dx uint) (minDy uint))
    (let
        ...
        (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-swap-v5k get-pair-details tokenXAddr tokenYAddr)
        ;; contract call do the real swap
        (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-swap-v5k swap-y-for-x tokenX tokenY lpToken dx minDy)
    )
)
