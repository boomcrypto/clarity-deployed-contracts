---
title: "Trait dmgcream-dexterity"
draft: true
---
```
;; DMG-CREAM - LP Token, AMM DEX and Hold-to-Earn Engine
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.dmgcream-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    ...
    (reserve-in (unwrap-panic (if forward (contract-call? 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dme000-governance-token get-balance CONTRACT) 
      (contract-call? 'SP23QVH1RTFJ67B8AF8BH8AZNMXMHT0AK32PZ8Q4S.charisma-rules-stxcity get-balance CONTRACT))))
    (reserve-out (unwrap-panic (if forward (contract-call? 'SP23QVH1RTFJ67B8AF8BH8AZNMXMHT0AK32PZ8Q4S.charisma-rules-stxcity get-balance CONTRACT) 
    ...
    (try! (if forward (contract-call? 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dme000-governance-token transfer amt-in sender CONTRACT none) 
      (contract-call? 'SP23QVH1RTFJ67B8AF8BH8AZNMXMHT0AK32PZ8Q4S.charisma-rules-stxcity transfer amt-in sender CONTRACT none)))
    (try! (as-contract (if forward (contract-call? 'SP23QVH1RTFJ67B8AF8BH8AZNMXMHT0AK32PZ8Q4S.charisma-rules-stxcity transfer amt-out CONTRACT sender none)
...
(define-public (mint (who principal) (amount uint))
  (let (
    ...
    (reserve1 (unwrap-panic (contract-call? 'SP23QVH1RTFJ67B8AF8BH8AZNMXMHT0AK32PZ8Q4S.charisma-rules-stxcity get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SP23QVH1RTFJ67B8AF8BH8AZNMXMHT0AK32PZ8Q4S.charisma-rules-stxcity transfer token1-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SP23QVH1RTFJ67B8AF8BH8AZNMXMHT0AK32PZ8Q4S.charisma-rules-stxcity transfer token1-amount CONTRACT who none)))
    (ok {token0-amount: token0-amount, token1-amount: token1-amount, lp-amount: amount})))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dme000-governance-token, token1: 'SP23QVH1RTFJ67B8AF8BH8AZNMXMHT0AK32PZ8Q4S.charisma-rules-stxcity}))
...
(define-read-only (get-reserves)
  (ok {
    ...
    token1: (unwrap-panic (contract-call? 'SP23QVH1RTFJ67B8AF8BH8AZNMXMHT0AK32PZ8Q4S.charisma-rules-stxcity get-balance CONTRACT))
  }))
