---
title: "Trait jetbolt-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPF9CJH74ZMECP024C81BADPSN68824FBR0HZ5Z6.jetbolt-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u19601742377100)
    (var-set stx-balance u142666667)
