---
title: "Trait ballot-will-the-increas-ByGQD"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Will%20the%20increased%20transparency%20of%20US%20healthcare%20costs%20have%20an%20observable%20impact%20on%20the%20quality%20of%20care%20provided%20by%20hospitals%20and%20clinics%20by%20the%20end%20of%202028%3F")
    ...
    (var-set options (list "7fe8c390-08f8-4321-81a9-7039e3d42b63" "7c7ae274-add3-44af-8612-147c796f2ada" "036a9eed-f938-463a-b976-8d30228d8ede" "d2817e7f-ecb8-4ce9-a7d9-a47655342ca0"))
    (var-set start u188123)
    (var-set end u230889)
    (map-set results {id: "7fe8c390-08f8-4321-81a9-7039e3d42b63"} {count: u0, name: u"Yes"}) (map-set results {id: "7c7ae274-add3-44af-8612-147c796f2ada"} {count: u0, name: u"Probably%20yes"}) (map-set results {id: "036a9eed-f938-463a-b976-8d30228d8ede"} {count: u0, name: u"Probably%20not"}) (map-set results {id: "d2817e7f-ecb8-4ce9-a7d9-a47655342ca0"} {count: u0, name: u"No"})
```
