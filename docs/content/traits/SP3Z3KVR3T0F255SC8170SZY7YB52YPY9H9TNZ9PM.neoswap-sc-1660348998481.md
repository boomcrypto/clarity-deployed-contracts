---
title: "Trait neoswap-sc-1660348998481"
draft: true
---
```
...
(define-constant agent-13 'SPDBZ4HD77ETYV20Q002W1RSMSZYNX67K6Z4TXCE)
(define-constant agent-14 'SPSD045V9QSS72XB789194BPPD3RKG58M69212HM)
...
(begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u43400000 tx-sender agent-2)))
	)
	(unwrap-panic (begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u35000000 tx-sender agent-4)))
	)
	(unwrap-panic (begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP3EHPZ4WHQEKS97JEREXT511T2YEJ5Y9EJP7WNBX.stacks-bears transfer u21 tx-sender agent-13)))
	...
	(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u2882 tx-sender agent-14)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u9820000 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPDKRP4ESV0037MT3SX0WE817WVR9EQ9A0JBVRP4.atlantic-dolphins transfer u26 tx-sender agent-12)))
	(var-set agent-12-status false))
	true)
	(if (is-eq (var-get agent-13-status) true)
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u2292 tx-sender agent-13)))
		(unwrap-panic (as-contract (contract-call? 'SP3Z3GK22JHV7YYE479YVFAFQTX2XFSDJRPXG8GXF.posh-penguins transfer u68 tx-sender agent-13)))
		(as-contract (stx-transfer? u25500000 tx-sender agent-13)))
	)
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u2489 tx-sender agent-14)))
		(as-contract (stx-transfer? u890000 tx-sender agent-14)))
	)
