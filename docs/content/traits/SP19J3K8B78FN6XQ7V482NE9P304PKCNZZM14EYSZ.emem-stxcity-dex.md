...
(define-constant allow-token 'SP19J3K8B78FN6XQ7V482NE9P304PKCNZZM14EYSZ.emem-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u18901890189018)
    (var-set stx-balance u88800000)
