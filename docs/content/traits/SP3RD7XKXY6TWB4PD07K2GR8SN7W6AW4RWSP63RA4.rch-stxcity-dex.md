...
(define-constant allow-token 'SP3RD7XKXY6TWB4PD07K2GR8SN7W6AW4RWSP63RA4.rch-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u20499998210317)
    (var-set stx-balance u9756133)
