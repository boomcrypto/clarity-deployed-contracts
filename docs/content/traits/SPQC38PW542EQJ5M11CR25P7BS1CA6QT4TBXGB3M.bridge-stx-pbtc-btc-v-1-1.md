---
title: "Trait bridge-stx-pbtc-btc-v-1-1"
draft: true
---
```
;; bridge-stx-pbtc-btc-v-1-1
...
(define-public (get-helper-a (amount uint))
  (let (
    ...
    ;; Get quote for STX to pBTC swap via XYK Core
    (quote-stx-to-pbtc (try! (contract-call?
    ...
    (pontis-ft-fee (contract-call? 'SP14NS8MVBRHXMM96BQY0727AJ59SWPV7RMHC0NCG.pontis-bridge-fee-manager-3 calculate-btc-percent-fee quote-stx-to-pbtc))

    ;; Calculate amount bridged out after subtracting the percent fee
    (amount-after-pontis-ft-fee (- quote-stx-to-pbtc pontis-ft-fee))
  )
    ;; Return action data
    (ok {
      amount: amount,
      ...
      quote-stx-to-pbtc: quote-stx-to-pbtc,
...
(define-public (get-min-a)
  (let (
    ...
    (quote-pbtc-to-stx (try! (contract-call?
    ...
    (amount-with-pontis-stx-fee (+ quote-pbtc-to-stx pontis-stx-fee))
  )
    ;; Return action data
    (ok {
...
;; Swap STX to pBTC and then bridge out pBTC to specified Bitcoin address
(define-public (bridge-helper-a
  ...
  (let (
    ...
    ;; Perform STX to pBTC swap via XYK Core
    (swap-stx-to-pbtc (try! (contract-call?
    ...
    (bridge-btc-out (try! (pontis-bridge-btc-out swap-stx-to-pbtc btc-address pontis-btc-contract)))
  )
    (begin
      ...
      (print {
        ...
        data: {
          ...
          bridge-fee-amount: bridge-fee-amount,
          pontis-stx-fee: pontis-stx-fee,
          swap-stx-to-pbtc: swap-stx-to-pbtc,
