---
title: "Trait fak-faktory"
draft: true
---
```

;; 00df27aa545fa9e0ed14e886b331be890eb8829e76ed6add02d5a5fa9090891d
;; fak Powered By Faktory.fun v1.0 
...
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://szigdtxfspmofhxoytra.supabase.co/storage/v1/object/public/uri/koyur27g-metadata.json"))
...
(begin 
    ...
    (try! (ft-mint? FAK u1000000000000000 'SPW3QV5C6TWDEJPKJB5M0JY9HPVGECM6A2Y45978.fak-faktory-dex)) ;; supply-left
    ...
    (print { 
        ...
        name: "FAK",
        symbol: "FAK",
        token-uri: u"https://szigdtxfspmofhxoytra.supabase.co/storage/v1/object/public/uri/koyur27g-metadata.json", 
