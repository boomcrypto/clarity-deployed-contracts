---
title: "Trait marsdao-action-add-resource"
draft: true
---
```
...
(define-public (run (parameters (buff 2048)))
  (let
    ...
    (try! (contract-call? 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.marsdao-payments-invoices add-resource (get name paramsTuple) (get description paramsTuple) (get price paramsTuple) (get url paramsTuple)))
    (ok true)
  )
)
