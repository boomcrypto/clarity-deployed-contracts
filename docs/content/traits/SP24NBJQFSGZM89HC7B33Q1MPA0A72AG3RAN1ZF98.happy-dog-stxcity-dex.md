---
title: "Trait happy-dog-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP24NBJQFSGZM89HC7B33Q1MPA0A72AG3RAN1ZF98.happy-dog-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u9940357852882704)
    (var-set stx-balance u6000000)
