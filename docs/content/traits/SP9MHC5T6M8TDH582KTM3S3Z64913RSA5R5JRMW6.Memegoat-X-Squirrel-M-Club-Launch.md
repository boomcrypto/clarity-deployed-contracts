---
title: "Trait Memegoat-X-Squirrel-M-Club-Launch"
draft: true
---
```

;; ---------------------------------------------------------
;; MEMEGOAT X SQUIRREL M CLUB LAUNCH
;; ---------------------------------------------------------
...
(define-constant SALE-ALLOCATION u5000000000000000)
(define-constant LAUNCHPAD-TOKEN 'SP1GHMMZC2WKX7N63Z50E1SKW6S3JNQA4NH6WN7QF.squirrel-mclub)
...
(define-constant MAX-BUY u500000000)
(define-constant HARD-CAP u20000000000) 
(define-constant SOFT-CAP u10000000000)
(define-constant START-BLOCK u167574)
(define-constant END-BLOCK u169446)
...
(define-private (initialize)
  ...
  (begin
    ...
    (try! (contract-call? 'SP1GHMMZC2WKX7N63Z50E1SKW6S3JNQA4NH6WN7QF.squirrel-mclub transfer LISTING-ALLOCATION tx-sender LISTING-SIG-WALLET none))
    (try! (contract-call? 'SP1GHMMZC2WKX7N63Z50E1SKW6S3JNQA4NH6WN7QF.squirrel-mclub transfer SALE-ALLOCATION tx-sender LAUNCHPAD-ADDRESS none))
