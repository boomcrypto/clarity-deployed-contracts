...
(define-constant token-supply u21000000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP1P0KKJKD72R3FY29DG5E1VMJZQRQ0M2GP4KPA1F.luigi-stxcity)
...
(var-set token-balance u19427312775330396)
(var-set stx-balance u113333333)
