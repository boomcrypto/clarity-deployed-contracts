---
title: "Trait tradimple-sc-1645474910612"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u3300000 tx-sender agent-1)))
	)
	...
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.african-amazons transfer u6 tx-sender agent-3)))
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.citadels transfer u1668 tx-sender agent-5)))
