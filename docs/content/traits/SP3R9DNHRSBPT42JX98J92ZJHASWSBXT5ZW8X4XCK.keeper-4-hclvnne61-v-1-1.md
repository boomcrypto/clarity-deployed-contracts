---
title: "Trait keeper-4-hclvnne61-v-1-1"
draft: true
---
```
;; keeper-4-hclvnne61-v-1-1
...
(define-data-var owner-address principal 'SP34NJCCYANQR5YAY58JHX7AGCZ4E82EFYD0FR0TP)

;; Bitcoin address authorized to receive bridged rune tokens and bitcoin
(define-data-var bitcoin-address (buff 64) 0x3337463359505051713155787358703473566d525543544642795843687637697953)
