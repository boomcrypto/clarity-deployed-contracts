---
title: "Trait ballot-vote-with-autoal-ESBjP"
draft: true
---
```
    ...
    (define-private (get-voting-power-by-ft-holdings)
        (let
            (
                (ft-balance (unwrap-panic (contract-call? 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.auto-alex get-balance tx-sender)))
                (ft-decimals (unwrap-panic (contract-call? 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.auto-alex get-decimals)))
            )
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with AutoALEX) Proposal For Adjustment of ALEX Emissions")
    (var-set description u"We thank you for the feedback on Discord for the proposal to adjust ALEX emissions. We have listened to community input regarding token dilution and have revised the proposed emissions to increase by less than half of the initially proposed amount.The revised proposals balances minimizing emissions while maintaining the necessary incentives for Liquidity Providers needed to grow the new sUSDT liquidity pools. The vote will begin on Saturday, April 29th and will be open for one week. Governance will be deter")
    (var-set voting-system "fptp")
    (var-set options (list "baeb498d-a04c-4721-97b2-d8e77656a899" "71dcc5d8-05a9-4b9a-9830-ee2d4c48e6d1"))
    (var-set start u103773)
    (var-set end u104781)
    (map-set results {id: "baeb498d-a04c-4721-97b2-d8e77656a899"} {count: u0, name: u"For"}) (map-set results {id: "71dcc5d8-05a9-4b9a-9830-ee2d4c48e6d1"} {count: u0, name: u"Against"})
```
