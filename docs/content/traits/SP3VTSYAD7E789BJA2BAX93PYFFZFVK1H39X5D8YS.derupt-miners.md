...
;; Log Mine
(define-public (log-mine (miner principal) (cityName (string-ascii 10)) (mine-amounts (list 200 uint)))
  (let 
    ...
    (print { event: "mine", miner: miner, cityName: cityName,  mine-total: (fold + mine-amounts u0), mine-amounts: mine-amounts })
    (ok true)
  )
)
