...
```
    ...
    (var-set description u"JH%20tester")
    (var-set voting-system "fptp")
    (var-set options (list "8e0c8dad-5057-4f36-83ec-b830ab6b7a4b" "303d8842-c393-477e-8dc7-3e9b2d28649f"))
    (var-set start u479458)
    (var-set end u485000)
    (map-set results {id: "8e0c8dad-5057-4f36-83ec-b830ab6b7a4b"} {count: u0, name: u"pizza"}) (map-set results {id: "303d8842-c393-477e-8dc7-3e9b2d28649f"} {count: u0, name: u"hot%20dog"})
```
