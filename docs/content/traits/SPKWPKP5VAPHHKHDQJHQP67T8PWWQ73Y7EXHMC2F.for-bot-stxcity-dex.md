---
title: "Trait for-bot-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPKWPKP5VAPHHKHDQJHQP67T8PWWQ73Y7EXHMC2F.for-bot-stxcity)
...
(define-public (buy (token-trait <sip-010-trait>) (stx-amount uint) ) 
  (begin
    ...
    ;;   (try! (stx-transfer? stx-fee tx-sender STX_CITY_SWAP_FEE_WALLET))
      ...
      (try! (stx-transfer? u40000000 tx-sender (var-get TOKEN_OWNER)))
    ...
    (begin
        (let 
            (
                ...
                (res8 (transfer-token 'SP3VVPEFZNN84EGMD0GN4XWAZ4X5ZMWC852NGWVWN.stxoshi-stxcity))
            )
            (ok true)
        )
    )
