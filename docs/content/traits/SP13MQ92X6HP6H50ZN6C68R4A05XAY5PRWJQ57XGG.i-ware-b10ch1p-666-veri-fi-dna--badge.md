---
title: "Trait i-ware-b10ch1p-666-veri-fi-dna--badge"
draft: true
---
```
;; i-ware-b10ch1p-666-veri-fi-dna--badge
;; contractType: editions

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token i-ware-b10ch1p-666-veri-fi-dna--badge uint)
...
(define-data-var total-price uint u6660000)
(define-data-var artist-address principal 'SP13MQ92X6HP6H50ZN6C68R4A05XAY5PRWJQ57XGG)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/Qmc4aMy1d2r9acVKQdkzF8VpW1r5RZhpcTkqNDpUDAW883/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (or (is-eq (var-get mint-limit) u0) (<= next-id (var-get mint-limit)))
    (begin
      (unwrap! (nft-mint? i-ware-b10ch1p-666-veri-fi-dna--badge next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? i-ware-b10ch1p-666-veri-fi-dna--badge token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? i-ware-b10ch1p-666-veri-fi-dna--badge token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? i-ware-b10ch1p-666-veri-fi-dna--badge token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? i-ware-b10ch1p-666-veri-fi-dna--badge id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? i-ware-b10ch1p-666-veri-fi-dna--badge id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? i-ware-b10ch1p-666-veri-fi-dna--badge id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u656600000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u258900000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u223000000)
...
;; Alt Minting Default
(define-data-var total-price-alex uint u8700000000)
