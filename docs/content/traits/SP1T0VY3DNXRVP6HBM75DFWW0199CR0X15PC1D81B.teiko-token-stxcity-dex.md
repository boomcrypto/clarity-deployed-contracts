---
title: "Trait teiko-token-stxcity-dex"
draft: true
---
```
...
(define-constant STX_TARGET_AMOUNT u21000000000)
(define-constant VIRTUAL_STX_VALUE u4200000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u420000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP1T0VY3DNXRVP6HBM75DFWW0199CR0X15PC1D81B.teiko-token-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u20394635424695)
    (var-set stx-balance u124666667)
