---
title: "Trait cat-pepe-faktory"
draft: true
---
```

;; 0020725cf52c1f9bb8fcee3b282dac0ee8ed63a0c7da997450369dadf168203c
;; woof Powered By Faktory.fun v1.0 
...
(define-fungible-token WOOF MAX)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       (asserts! (is-eq tx-sender sender) (err ERR-NOT-AUTHORIZED))
        (ft-transfer? WOOF amount sender recipient)
    )
)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance WOOF account))
)
...
(begin 
    ...
    (try! (ft-mint? WOOF u69000000000000 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.cat-pepe-faktory-dex)) ;; supply-left
