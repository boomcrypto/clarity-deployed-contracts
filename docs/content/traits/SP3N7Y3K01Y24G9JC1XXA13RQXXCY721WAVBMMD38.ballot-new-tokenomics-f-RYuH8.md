---
title: "Trait ballot-new-tokenomics-f-RYuH8"
draft: true
---
```
    ...
    (var-set options (list "bc45cf53-e3e9-4494-938b-b2908aec1f08" "0d991e65-a8a5-40c0-a372-1ed06825c7a4"))
    (var-set start u85065)
    (var-set end u85870)
    (map-set results {id: "bc45cf53-e3e9-4494-938b-b2908aec1f08"} {count: u0, name: u"Yes, change from fixed emission to dynamic emissions"}) (map-set results {id: "0d991e65-a8a5-40c0-a372-1ed06825c7a4"} {count: u0, name: u"No, keep emissions fixed as they are"})
```
