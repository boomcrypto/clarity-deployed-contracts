---
title: "Trait the-kimchi-premium"
draft: true
---
```
;; Title: ALEX-sBTC ALEX Wrapper
...
(define-constant POOL-ID u125)                 ;; ALEX STX-CHA pool ID

(define-constant TOKEN-NAME "The Kimchi Premium")
(define-constant TOKEN-SYMBOL "KIMCHI")
(define-constant TOKEN-URI (some u"https://charisma.rocks/api/v0/metadata/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.the-kimchi-premium"))
...
(define-read-only (get-swap-quote (amount uint) (opcode (optional (buff 16))))
    (let (
        ...
        (alex-out (unwrap-panic (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.amm-pool-v2-01 get-helper
            (if is-a-in 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex 'SP1E0XBN9T4B10E9QMR7XMFJPMA19D77WY3KP2QKC.token-wsbtc)
            (if is-a-in 'SP1E0XBN9T4B10E9QMR7XMFJPMA19D77WY3KP2QKC.token-wsbtc 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex)
            ALEX-FACTOR
            (* amount AMOUNT-FACTOR)))))
        {
            dx: amount,
