---
title: "Trait asset-deployment-125"
draft: true
---
```
...
(define-constant new-curve-params
  {
    variable-rate-slope-1: u7500000,
    optimal-utilization-rate: u85000000,
  }
)
...
(define-public (run-update)
  (begin
    ...
    (try! (contract-call? .pool-reserve-data set-optimal-utilization-rate aeusdc-address (get optimal-utilization-rate new-curve-params)))
    (try! (contract-call? .pool-reserve-data set-optimal-utilization-rate usdh-address (get optimal-utilization-rate new-curve-params)))
    (try! (contract-call? .pool-reserve-data set-optimal-utilization-rate susdt-address (get optimal-utilization-rate new-curve-params)))
    (try! (contract-call? .pool-reserve-data set-optimal-utilization-rate usda-address (get optimal-utilization-rate new-curve-params)))
