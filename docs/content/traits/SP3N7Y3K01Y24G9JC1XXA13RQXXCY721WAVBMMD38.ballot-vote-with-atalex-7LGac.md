---
title: "Trait ballot-vote-with-atalex-7LGac"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with atALEX) Approve Launch of iZIP.AI on the ALEX Launchpad")
    (var-set description u"This proposal is to approve iZIP.AI for the ALEX Decentralized Launchpad. Information on the project is available on the application form iZIP.AI has submitted.iZIP.AI Launchpad Application Form: https://docs.google.com/spreadsheets/d/1iK3blv-jAxCkLlJ3fuBSuZGBMbeF1-pJZh-p8_DLg2U/edit#gid=2091054548X/Twitter: https://twitter.com/izipbrc20Website: https://izip.ai/Telegram: https://t.me/iZIP_Brc2Vote to either approve or disapprove the project to launch on ALEX. The ALEX Lab Foundation does NOT sponsor the pro")
    (var-set voting-system "fptp")
    (var-set options (list "3668afe5-02e9-4301-ab62-79864304f0ef" "d48a84ba-cece-4159-8c39-71c27985bdc3"))
    (var-set start u135819)
    (var-set end u136251)
    (map-set results {id: "3668afe5-02e9-4301-ab62-79864304f0ef"} {count: u0, name: u"Approve Launch of iZIP.AI on the ALEX Launchpad"}) (map-set results {id: "d48a84ba-cece-4159-8c39-71c27985bdc3"} {count: u0, name: u"Disapprove Launch of iZIP.AI on the ALEX Launchpad"})
```
