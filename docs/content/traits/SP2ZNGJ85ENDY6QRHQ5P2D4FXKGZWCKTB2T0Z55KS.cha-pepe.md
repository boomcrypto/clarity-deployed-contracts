---
title: "Trait cha-pepe"
draft: true
---
```
;; President Pepe
;; CHA-PEPE LP token with configurable metadata
...
(define-data-var token-symbol (string-ascii 10) "cPEPE")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/president-pepe/metadata.json"))
