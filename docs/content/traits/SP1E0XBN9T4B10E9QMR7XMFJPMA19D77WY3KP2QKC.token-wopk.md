...
(define-fungible-token wopk)

(define-data-var token-name (string-ascii 32) "OPK Wrapper")
(define-data-var token-symbol (string-ascii 32) "wopk")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wopk.json"))
...
(define-read-only (get-base-token)
  'SP1MYD1DXPVEKXFD2P9ZA8QVDZA4MXK212QW2A160.opk)

(define-read-only (get-base-decimals)
  (contract-call? 'SP1MYD1DXPVEKXFD2P9ZA8QVDZA4MXK212QW2A160.opk get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP1MYD1DXPVEKXFD2P9ZA8QVDZA4MXK212QW2A160.opk get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP1MYD1DXPVEKXFD2P9ZA8QVDZA4MXK212QW2A160.opk transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
