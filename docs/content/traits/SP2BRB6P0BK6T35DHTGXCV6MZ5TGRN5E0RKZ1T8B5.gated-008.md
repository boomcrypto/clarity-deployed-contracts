...
(define-data-var token-uri (string-ascii 246) "https://fuchsia-tropical-alligator-381.mypinata.cloud/ipfs/bafkreihcc5rocph3zhqujucnzzj62fsn4kygcfjkuvan3yznklav54jpq4")
...
(define-public (buy-in-ustx (token-id uint) (comm-trait <commission-trait>))
   (let 
       ...
       (begin
           (asserts! (is-eq (contract-of comm-trait) commission) (err ERR-WRONG-COMMISSION))
