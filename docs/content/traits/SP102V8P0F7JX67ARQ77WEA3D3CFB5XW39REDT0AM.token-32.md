...
(define-fungible-token token-32)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-32 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-32)))
