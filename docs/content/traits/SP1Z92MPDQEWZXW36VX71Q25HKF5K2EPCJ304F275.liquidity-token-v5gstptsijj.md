---
title: "Trait liquidity-token-v5gstptsijj"
draft: true
---
```
(impl-trait .liquidity-token-trait-v4b.liquidity-token-trait)
...
(define-public (mint (recipient principal) (amount uint))
  (begin
    ...
    (print amount)
    (asserts! (is-eq contract-caller (unwrap-panic (contract-call? .stackswap-dao-v5g get-qualified-name-by-name "swap"))) (err ERR_DAO_ACCESS))
...
(define-public (initialize (name-to-set (string-ascii 32)) (symbol-to-set (string-ascii 32)) (decimals-to-set uint) (uri-to-set (string-utf8 256)))
  (begin
    ...
    (print contract-caller)
    (asserts! (is-eq contract-caller (unwrap-panic (contract-call? .stackswap-dao-v5g get-qualified-name-by-name "one-step-mint"))) (err ERR_DAO_ACCESS))
...
(contract-call? .stackswap-one-step-mint-v5h add-liquidity-token (as-contract tx-sender))
