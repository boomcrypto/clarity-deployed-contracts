---
title: "Trait Marbling-wrapper"
draft: true
---
```
(use-trait commission-trait 'SPXG42Y7WDTMZF5MPV02C3AWY1VNP9FH9C23PRXH.commission-trait.commission)
...
(define-public (buy-item (collection <marketplace>) (item-id uint) (comm <commission-trait>) (referer uint))
    (let (
        (item (contract-call? 'SPXG42Y7WDTMZF5MPV02C3AWY1VNP9FH9C23PRXH.Marbling get-listing-in-ustx item-id))
