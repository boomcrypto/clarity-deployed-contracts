---
title: "Trait neoswap-sc-1657210926070"
draft: true
---
```
(use-trait nft 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-constant agent-1 'SP12R117AH334QAST6VF6129F33HYW8VKYR9FDRDS)
...
(define-constant agent-7 'SP25J2EJ4GNE42860RAZ2DF18X5JNKVMC0WRGV65R)
...
(define-constant agent-11 'SP363ECSA62Y3HTHD6NB70RY5WTVA113WJPGN7G6N)
...
(begin
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u4420000 tx-sender agent-2)))
	)
	(unwrap-panic (begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ.btc-pizza-day-porto-alegre transfer u57 tx-sender agent-3)))
		(as-contract (stx-transfer? u1300000 tx-sender agent-3)))
	)
	(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u1781 tx-sender agent-4)))
	...
	(unwrap-panic (as-contract (contract-call? 'SP2N3BAG4GBF8NHRPH6AY4YYH1SP6NK5TGCY7RDFA.stacks-mfers transfer u1083 tx-sender agent-7)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u7110000 tx-sender agent-8)))
	)
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPXM7A1WWQPS3R504SNGXERRHEKHZEGQE40DJGJY.stockings transfer u238 tx-sender agent-9)))
		(as-contract (stx-transfer? u30470000 tx-sender agent-9)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.magic-ape-school transfer u1358 tx-sender agent-10)))
	(unwrap-panic (as-contract (contract-call? 'SP2EK5VZQKRR1WYQ3F8MH86QDRDEHMC5WY6E3KA34.stacks-snail transfer u34 tx-sender agent-10)))
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u19900000 tx-sender agent-11)))
	)
	...
	(unwrap-panic (as-contract (contract-call? 'SP1MX3R99FENJJJVKW27DSA6X2M6SDSVJH4Y0HE23.pepepunks transfer u541 tx-sender agent-12)))
	(unwrap-panic (as-contract (contract-call? 'SP1MX3R99FENJJJVKW27DSA6X2M6SDSVJH4Y0HE23.pepepunks transfer u574 tx-sender agent-12)))
	(unwrap-panic (begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP2W58YQZEAC870M2MKE6QEKS1DPG0RMZZ2BGXSM4.tickets-90stx-mini-raffle-12 transfer u29 tx-sender agent-14)))
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4130000 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u550000 tx-sender agent-1)))
	)
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPFRNSJ3T6HSW1PJN2TAJZVKY3REYFCFDHETWJWG.stacks-punk-reloaded transfer u345 tx-sender agent-2)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.belles-witches transfer u331 tx-sender agent-3)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1MX3R99FENJJJVKW27DSA6X2M6SDSVJH4Y0HE23.pepepunks transfer u541 tx-sender agent-5)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u2495 tx-sender agent-8)))
		(unwrap-panic (as-contract (contract-call? 'SP2W58YQZEAC870M2MKE6QEKS1DPG0RMZZ2BGXSM4.tickets-90stx-mini-raffle-12 transfer u29 tx-sender agent-8)))
	(var-set agent-8-status false))
	true)
	(if (is-eq (var-get agent-9-status) true)
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP2N3BAG4GBF8NHRPH6AY4YYH1SP6NK5TGCY7RDFA.stacks-mfers transfer u2587 tx-sender agent-9)))
		(unwrap-panic (as-contract (contract-call? 'SP2N3BAG4GBF8NHRPH6AY4YYH1SP6NK5TGCY7RDFA.stacks-mfers transfer u1083 tx-sender agent-9)))
		...
		(unwrap-panic (as-contract (contract-call? 'SPXM7A1WWQPS3R504SNGXERRHEKHZEGQE40DJGJY.stockings transfer u229 tx-sender agent-9)))
		...
		(unwrap-panic (as-contract (contract-call? 'SPDKRP4ESV0037MT3SX0WE817WVR9EQ9A0JBVRP4.atlantic-dolphins transfer u18 tx-sender agent-9)))
	(var-set agent-9-status false))
	true)
	(if (is-eq (var-get agent-10-status) true)
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u7240000 tx-sender agent-10)))
	)
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPM1Q7YG18378H6W254YN8PABEVRPT38ZCY01SJD.collection-one-life-vol-2 transfer u13 tx-sender agent-11)))
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u37850000 tx-sender agent-12)))
	)
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1000000 tx-sender agent-14)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u37850000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
