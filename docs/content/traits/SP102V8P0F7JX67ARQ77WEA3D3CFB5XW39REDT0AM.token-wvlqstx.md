...
(define-data-var token-name (string-ascii 32) "vLiSTX Wrapper")
(define-data-var token-symbol (string-ascii 32) "wvlqstx")
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SM26NBC8SFHNW4P1Y4DFH27974P56WN86C92HPEHH.token-vlqstx get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
