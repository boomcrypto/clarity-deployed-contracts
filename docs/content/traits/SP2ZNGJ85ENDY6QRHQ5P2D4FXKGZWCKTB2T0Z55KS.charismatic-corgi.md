---
title: "Trait charismatic-corgi"
draft: true
---
```

;; Title: Charismatic Corgi
...
(define-data-var token-name (string-ascii 32) "Charismatic Corgi")
(define-data-var token-symbol (string-ascii 10) "iCC")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://charisma.rocks/indexes/charismatic-corgi.json"))
(define-data-var token-decimals uint u6)

(define-data-var token-a-ratio uint u100)
...
(define-public (add-liquidity (amount uint))
    (let
        ...
        (try! (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.liquid-staked-welsh-v2 transfer amount-a tx-sender contract none))
...
(define-public (remove-liquidity (amount uint))
    (let
        ...
        (try! (as-contract (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.liquid-staked-welsh-v2 transfer amount-a contract sender none)))
