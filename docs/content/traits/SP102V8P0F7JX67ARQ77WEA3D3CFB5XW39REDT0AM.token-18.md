...
(define-fungible-token token-18)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-18 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-18)))
