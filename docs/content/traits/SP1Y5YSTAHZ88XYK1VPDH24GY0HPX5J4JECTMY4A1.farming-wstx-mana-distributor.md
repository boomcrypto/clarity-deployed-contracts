---
title: "Trait farming-wstx-mana-distributor"
draft: true
---
```
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constants
(define-constant REWARD-TOKEN 'SP20KBF1FZAXDEH5D64FVYF9EYD8Y2Q8XPFNF381M.mana)
...
(define-public
  ...
  (let ((epoch (contract-call? .farming-wstx-mana-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .farming-wstx-mana-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .farming-wstx-mana-core current-epoch))
