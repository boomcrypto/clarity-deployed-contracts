...
(define-fungible-token token-20)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-20 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-20)))
