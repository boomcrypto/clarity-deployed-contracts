---
title: "Trait ballot-ballot-with-snap-A5b5z"
draft: true
---
```
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-block-info? id-header-hash u200299))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Ballot%20with%20Snapshot")
    (var-set description u"Ballot%20with%20Snapshot")
    (var-set voting-system "fptp")
    (var-set options (list "ffc20e7a-8b9d-411f-8045-4e61e4d7589e" "31be6b3d-7581-4be6-82d3-9ce10c78d5ef"))
    (var-set start u200299)
    (var-set end u300299)
    (map-set results {id: "ffc20e7a-8b9d-411f-8045-4e61e4d7589e"} {count: u0, name: u"Choice%201"}) (map-set results {id: "31be6b3d-7581-4be6-82d3-9ce10c78d5ef"} {count: u0, name: u"Choice%202"})
