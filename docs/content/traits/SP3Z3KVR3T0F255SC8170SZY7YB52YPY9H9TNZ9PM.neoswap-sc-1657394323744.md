---
title: "Trait neoswap-sc-1657394323744"
draft: true
---
```
...
(define-constant agent-8 'SPK9KP81Q281Q84SPGAMK8J12X2AQQJGT0XFPPCX)
...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u39750000 tx-sender agent-1)))
	)
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u1298 tx-sender agent-2)))
		(as-contract (stx-transfer? u3910000 tx-sender agent-2)))
	)
	...
	(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u2480 tx-sender agent-4)))
	(unwrap-panic (as-contract (contract-call? 'SPJPTE6B8CBQH8VWGYHE4871VXBEKFMC96WSJ9J4.dollicon-avatars-stacks transfer u9 tx-sender agent-5)))
	(unwrap-panic (begin
	...
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.virtual-tulips transfer u61 tx-sender agent-7)))
	(unwrap-panic (as-contract (contract-call? 'SP2N3BAG4GBF8NHRPH6AY4YYH1SP6NK5TGCY7RDFA.stacks-mfers transfer u2667 tx-sender agent-8)))
	...
	(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u3017 tx-sender agent-9)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP2N3BAG4GBF8NHRPH6AY4YYH1SP6NK5TGCY7RDFA.stacks-mfers transfer u2667 tx-sender agent-1)))
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.virtual-tulips transfer u61 tx-sender agent-1)))
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u1959 tx-sender agent-2)))
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1470000 tx-sender agent-5)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJPTE6B8CBQH8VWGYHE4871VXBEKFMC96WSJ9J4.dollicon-avatars-stacks transfer u9 tx-sender agent-6)))
	(var-set agent-6-status false))
	true)
	(if (is-eq (var-get agent-7-status) true)
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u1297 tx-sender agent-7)))
		(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u2034 tx-sender agent-7)))
		(as-contract (stx-transfer? u31400000 tx-sender agent-7)))
	)
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4000000 tx-sender agent-9)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.virtual-tulips transfer u61 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
		...
		(asserts! (is-ok (contract-call? 'SPJPTE6B8CBQH8VWGYHE4871VXBEKFMC96WSJ9J4.dollicon-avatars-stacks transfer u9 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
		...
		(asserts! (is-ok (stx-transfer? u31400000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
