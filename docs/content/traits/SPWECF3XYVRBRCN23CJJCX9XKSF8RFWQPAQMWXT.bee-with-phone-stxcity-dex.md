---
title: "Trait bee-with-phone-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPWECF3XYVRBRCN23CJJCX9XKSF8RFWQPAQMWXT.bee-with-phone-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u999257694284245)
    (var-set stx-balance u742857)
