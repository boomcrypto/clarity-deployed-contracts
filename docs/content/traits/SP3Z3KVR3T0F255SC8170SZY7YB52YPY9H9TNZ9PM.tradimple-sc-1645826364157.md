---
title: "Trait tradimple-sc-1645826364157"
draft: true
---
```
...
(begin
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-animal-stacks transfer u304 tx-sender agent-1)))
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u12100000 tx-sender agent-3)))
	)
