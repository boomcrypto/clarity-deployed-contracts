---
title: "Trait ballot-proposal-for-adj-zW8p8"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Proposal For Adjustment of ALEX Emissions")
    (var-set description u"We thank you for the feedback on Discourse for the proposal to adjust ALEX emissions. We have listened to community input regarding token dilution and have revised the proposed emissions to increase by less than half of the initially proposed amount.The revised proposals balances minimizing emissions while maintaining the necessary incentives for Liquidity Providers needed to grow the new sUSDT liquidity pools. The vote will begin on Friday, April 28th and will be open for one week. Governance will be deter")
    (var-set voting-system "fptp")
    (var-set options (list "cc420d37-0ca0-41a0-bec8-fdaaa0340fef" "3f2e3be7-cc1d-458f-9ce2-1431d9e5deab"))
    (var-set start u103677)
    (var-set end u104685)
    (map-set results {id: "cc420d37-0ca0-41a0-bec8-fdaaa0340fef"} {count: u0, name: u"For"}) (map-set results {id: "3f2e3be7-cc1d-458f-9ce2-1431d9e5deab"} {count: u0, name: u"Against"})
```
