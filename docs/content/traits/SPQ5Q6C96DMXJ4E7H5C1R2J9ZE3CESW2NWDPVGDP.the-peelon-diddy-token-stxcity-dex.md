---
title: "Trait the-peelon-diddy-token-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u333000818000000) ;; match with the token's supply (6 decimals)
(define-constant BONDING-DEX-ADDRESS (as-contract tx-sender)) ;; one contract per token

;; bonding curve config
(define-constant STX_TARGET_AMOUNT u100000000000)
(define-constant VIRTUAL_STX_VALUE u20000000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u2000000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SPQ5Q6C96DMXJ4E7H5C1R2J9ZE3CESW2NWDPVGDP.the-peelon-diddy-token-stxcity)
