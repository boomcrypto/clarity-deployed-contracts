---
title: "Trait neoswap-sc-1662144474704"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u970000 tx-sender agent-5)))
	)
	...
	(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u2613 tx-sender agent-8)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3150000 tx-sender agent-2)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u4029 tx-sender agent-7)))
