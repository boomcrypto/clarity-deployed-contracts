---
title: "Trait pussy-ju1ce-protocol-nft-badge"
draft: true
---
```
;; pussy-ju1ce-protocol-nft-badge
;; contractType: editions

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token pussy-ju1ce-protocol-nft-badge uint)
...
;; Internal variables
(define-data-var mint-limit uint u6900)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmSwu3kq8GgUw1VhKDkraCmYvPuf2H1Cq4D9UEh8sKRoUL/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (or (is-eq (var-get mint-limit) u0) (<= next-id (var-get mint-limit)))
    (begin
      (unwrap! (nft-mint? pussy-ju1ce-protocol-nft-badge next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? pussy-ju1ce-protocol-nft-badge token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? pussy-ju1ce-protocol-nft-badge token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? pussy-ju1ce-protocol-nft-badge token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? pussy-ju1ce-protocol-nft-badge id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? pussy-ju1ce-protocol-nft-badge id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? pussy-ju1ce-protocol-nft-badge id) (err ERR-NOT-FOUND)))
