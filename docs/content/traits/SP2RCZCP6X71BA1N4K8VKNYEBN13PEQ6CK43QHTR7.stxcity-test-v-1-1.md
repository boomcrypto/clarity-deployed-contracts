---
title: "Trait stxcity-test-v-1-1"
draft: true
---
```
;; Errors 
      ...
      (if (>= new-stx-balance  STX_TARGET_AMOUNT)
        (begin
          (let (
            ...
            (try! (as-contract (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-core-v-1-2 create-pool 'SP2RCZCP6X71BA1N4K8VKNYEBN13PEQ6CK43QHTR7.xyk-pool-stx-test-v-1-1 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.token-stx-v-1-2 token-trait remain-stx remain-tokens xyk-burn-amount u10 u40 u10 u40 'SP31C60QVZKZ9CMMZX73TQ3F3ZZNS89YX2DCCFT8P xyk-pool-uri true)))
            (try! (as-contract (contract-call? 'SP2RCZCP6X71BA1N4K8VKNYEBN13PEQ6CK43QHTR7.xyk-pool-stx-test-v-1-1 transfer u1 tx-sender 'SP2RCZCP6X71BA1N4K8VKNYEBN13PEQ6CK43QHTR7.xyk-pool-stx-test-v-1-1 none))) ;; @STXCITY: transfer remaining LP Tokens to XYK Core v-1-2 pool contract
            ;; send fee
