---
title: "Trait stableswap-staking-sbtc-pbtc-v-1-1"
draft: true
---
```
;; stableswap-staking-sbtc-pbtc-v-1-1
...
(define-private (transfer-lp-token (amount uint) (sender principal) (recipient principal))
  (let (
    (call-a (unwrap! (contract-call?
                     'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-pool-sbtc-pbtc-v-1-1 transfer
