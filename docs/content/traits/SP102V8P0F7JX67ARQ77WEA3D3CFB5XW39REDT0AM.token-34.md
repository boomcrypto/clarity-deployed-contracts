...
(define-fungible-token token-34)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-34 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-34)))
