---
title: "Trait bitcoin-bulls-remake-spoint-subscriber"
draft: true
---
```
;;Contract that enables the subscription of nfts in collection SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-bulls to gain spoints.
...
(define-constant collection-address 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-bulls)
;;maps
...
(define-public (subscribe (lookup-table <lookup-trait>) (item uint)) 
    (let (
        ...
        (asserts! (is-eq (unwrap-panic (unwrap-panic (contract-call? 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-bulls get-owner item))) tx-sender) (err ERR-NOT-AUTHORIZED))
