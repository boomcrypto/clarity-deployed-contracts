---
title: "Trait krdoll-dexterity"
draft: true
---
```
;; KRDOLL - LP Token, AMM DEX and Hold-to-Earn Engine
;; SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.krdoll-dexterity
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.krdoll-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    (sender tx-sender)
    (reserve-in (unwrap-panic (if forward (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.loupsi-dexterity get-balance CONTRACT) 
      (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.isabelle-dexterity get-balance CONTRACT))))
    (reserve-out (unwrap-panic (if forward (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.isabelle-dexterity get-balance CONTRACT) 
      (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.loupsi-dexterity get-balance CONTRACT))))
    ...
    (try! (if forward (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.loupsi-dexterity transfer amt-in sender CONTRACT none) 
      (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.isabelle-dexterity transfer amt-in sender CONTRACT none)))
    (try! (as-contract (if forward (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.isabelle-dexterity transfer amt-out CONTRACT sender none)
      (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.loupsi-dexterity transfer amt-out CONTRACT sender none))))
    (ok {amt-in: amt-in, amt-out: amt-out})))

(define-public (mint (who principal) (amount uint))
  (let (
    (reserve0 (unwrap-panic (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.loupsi-dexterity get-balance CONTRACT)))
    (reserve1 (unwrap-panic (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.isabelle-dexterity get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.loupsi-dexterity transfer token0-amount who CONTRACT none))
    (try! (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.isabelle-dexterity transfer token1-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.loupsi-dexterity transfer token0-amount CONTRACT who none)))
    (try! (as-contract (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.isabelle-dexterity transfer token1-amount CONTRACT who none)))
    (ok {token0-amount: token0-amount, token1-amount: token1-amount, lp-amount: amount})))
...
(define-read-only (get-tokens)
  (ok {token0: 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.loupsi-dexterity, token1: 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.isabelle-dexterity}))
...
(define-read-only (get-reserves)
  (ok {
    token0: (unwrap-panic (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.loupsi-dexterity get-balance CONTRACT)),
    token1: (unwrap-panic (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.isabelle-dexterity get-balance CONTRACT))
  }))
