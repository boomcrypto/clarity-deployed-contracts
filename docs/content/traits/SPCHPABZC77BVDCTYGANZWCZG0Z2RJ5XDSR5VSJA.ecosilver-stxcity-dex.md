---
title: "Trait ecosilver-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u21000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPCHPABZC77BVDCTYGANZWCZG0Z2RJ5XDSR5VSJA.ecosilver-stxcity)
...
(var-set token-balance u20895522388)
(var-set stx-balance u2000000)
