...
(define-non-fungible-token zombieverse uint)
...
(define-data-var artist-address principal 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmSdrJfqEwvARs1ri2AECMU7pPgHJ1euxLNcnNM6n9Q7nX/json/")
(define-data-var mint-paused bool false)
(define-data-var premint-enabled bool false)
(define-data-var sale-enabled bool false)
(define-data-var metadata-frozen bool false)
(define-data-var airdrop-called bool false)
(define-data-var mint-cap uint u99)
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? zombieverse next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? zombieverse token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? zombieverse token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? zombieverse token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? zombieverse id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? zombieverse id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? zombieverse id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u22539)
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u25905000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u19689000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u143000000)
...
;; Alt Minting Default
(define-data-var total-price-slime uint u1443000000)
...
;; Alt Minting Default
(define-data-var total-price-alex uint u10700000000)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? zombieverse (+ last-nft-id u0) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u1) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u2) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u3) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u4) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u5) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u6) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u7) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u8) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u9) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u10) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u11) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
      (try! (nft-mint? zombieverse (+ last-nft-id u12) 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S))
      (map-set token-count 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S (+ (get-balance 'SP1TDYR7MK78E53YYX3BCE7YT64Q4Z3C2FKFEC15S) u1))
