---
title: "Trait pontis-bridge-LOBO"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "LOBO.THE.WOLF.PUP")
(define-data-var token-symbol (string-ascii 10) "LOBO")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmUua5afckwSouWfbPRgAdKDAnmAvFJkwMUUdUoowP5Utp"))
;; 840000:35
