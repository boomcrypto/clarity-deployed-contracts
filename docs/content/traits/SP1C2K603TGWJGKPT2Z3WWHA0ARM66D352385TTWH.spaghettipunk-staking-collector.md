---
title: "Trait spaghettipunk-staking-collector"
draft: true
---
```
;; spaghettipunk-staking-collector
...
(define-public (collect-multi (fungible <token-trait>))
  ...
  (if (> to-collect-spaghettipunk-staking u0)
    ...
    (try! (contract-call? 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-staking-helper collect))
