---
title: "Trait bns-test-0002"
draft: true
---
```
;; --- 101BNS Team ----
;; Transfer BNS name back and forth between Standard Principal and Contract Principal

;; Keep it simple, switch between DEPLOYER_STANDARD and DEPLOYER_CONTRACT as sender and receiver.
