...
(define-constant VIRTUAL_STX_VALUE u100000) ;; 0.1 stx
(define-constant STX_TARGET_AMOUNT u1000000) ;; 1 stx
(define-constant COMPLETE_FEE u2000) ;; 2%
...
(define-constant AMM_WALLET 'SP3XK7NAXKSXFENTSWHGK75ETRFZP999PE92W7ANY)
(define-constant BURN_ADDRESS 'SP000000000000000000002Q6VF78) ;; burn mainnet

(define-constant deployer tx-sender)
(define-constant allow-token 'SPWECF3XYVRBRCN23CJJCX9XKSF8RFWQPAQMWXT.cat-test-token)
...
(begin
  ...
  (var-set deployer-percent u10) ;; based on burn-amount ~0.1 to 0.5% supply
  (ok true)
)
```
