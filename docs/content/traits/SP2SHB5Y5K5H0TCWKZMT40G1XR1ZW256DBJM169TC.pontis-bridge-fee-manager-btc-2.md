---
title: "Trait pontis-bridge-fee-manager-btc-2"
draft: true
---
```
...
;; maximum possible for min bridge is 100000 Rune tokens considering 18 decimals
(define-constant MAX-RUNE-BRIDGE-MINIMUM u100000000000000000000000)
...
(define-private (check-and-compare-proposed-owner)
	(begin 
		(asserts! (is-eq tx-sender (var-get proposed-owner)) ERR-NOT-AUTHORIZED)
