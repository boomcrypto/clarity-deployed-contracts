---
title: "Trait token-wpepe"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token wpepe)
(define-data-var token-name (string-ascii 32) "PEPE Wrapper")
(define-data-var token-symbol (string-ascii 32) "wpepe")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wpepe.json"))
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.tokensoft-token-v4k68639zxz get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
