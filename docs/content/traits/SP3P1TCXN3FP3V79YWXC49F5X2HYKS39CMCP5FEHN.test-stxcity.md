...
;; DEFINE METADATA
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://pdakhjpwkuwtadzmpnjm.supabase.co/storage/v1/object/public/uri/FDauyKAB-test-0-decimals.json"))
...
(begin
    ...
    (try! (ft-mint? TEST u1000000000000000 'SP3P1TCXN3FP3V79YWXC49F5X2HYKS39CMCP5FEHN.test-stxcity-dex))
)
