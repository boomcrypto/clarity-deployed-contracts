---
title: "Trait neoswap-sc-1690913607799"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/qoJlqdWhDNq87I1PFaOb
;; SwapId: w4iR8bFjFQlpUZePqKwM
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u1545000 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u1545000 tx-sender TRADER-1)))
	    )
            true
        )
