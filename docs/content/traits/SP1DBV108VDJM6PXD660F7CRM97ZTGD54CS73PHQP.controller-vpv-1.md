---
title: "Trait controller-vpv-1"
draft: true
---
```
;; title: controller-vpv-1
...
(map-set privileged-protocol-principals .registry-vpv-1 true)
(map-set privileged-protocol-principals .vault-vpv-1 true)
(map-set privileged-protocol-principals .redeem-vpv-1 true)
(map-set privileged-protocol-principals .stability-vpv-1 true)
...
(map-set contracts
    ...
    {
      address: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM,
      qualified-name: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.oracle-vpv-1
    }
)
...
(map-set contracts
    ...
    {
      address: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM,
      qualified-name: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.registry-vpv-1
    }
)
...
(map-set contracts
    ...
    {
      address: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM,
      qualified-name: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.vault-vpv-1
    }
)
...
(map-set contracts
    ...
    {
      address: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM,
      qualified-name: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.stability-vpv-1
    }
)
...
(map-set contracts
    ...
    {
      address: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM,
      qualified-name: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sorted-vaults-vpv-1
    }
)
