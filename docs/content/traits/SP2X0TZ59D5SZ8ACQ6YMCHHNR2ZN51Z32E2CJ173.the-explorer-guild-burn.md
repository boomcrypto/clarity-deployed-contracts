---
title: "Trait the-explorer-guild-burn"
draft: true
---
```
...
;; Claim an NFT as contract and transfer it to the owner wallet
...
;; Claim an NFT as contract
(define-private (claim-burn (index uint))
  (contract-call? .the-explorer-guild-mint claim))
```
