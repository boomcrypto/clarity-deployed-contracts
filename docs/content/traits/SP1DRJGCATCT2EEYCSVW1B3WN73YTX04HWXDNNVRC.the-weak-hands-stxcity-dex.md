---
title: "Trait the-weak-hands-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u11000000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP1DRJGCATCT2EEYCSVW1B3WN73YTX04HWXDNNVRC.the-weak-hands-stxcity)
