...
(define-fungible-token wbone)

(define-data-var token-name (string-ascii 32) "Bone Wrapper")
(define-data-var token-symbol (string-ascii 32) "wbone")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wbone.json"))
...
(define-read-only (get-base-token)
  'SP9PK32N4QVEE3N1JNQVJWBM4R36TKHNNKZMN62E.bone-stacks)

(define-read-only (get-base-decimals)
  (contract-call? 'SP9PK32N4QVEE3N1JNQVJWBM4R36TKHNNKZMN62E.bone-stacks get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP9PK32N4QVEE3N1JNQVJWBM4R36TKHNNKZMN62E.bone-stacks get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP9PK32N4QVEE3N1JNQVJWBM4R36TKHNNKZMN62E.bone-stacks transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
