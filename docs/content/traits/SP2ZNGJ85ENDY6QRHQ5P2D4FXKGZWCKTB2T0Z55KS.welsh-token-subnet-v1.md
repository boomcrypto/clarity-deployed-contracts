---
title: "Trait welsh-token-subnet-v1"
draft: true
---
```
;; title: welsh-token-subnet
;; author: rozar.btc
;; summary: Intent-based subnet token wrapper for welsh using blaze-v1 verifier.
...
(define-public (withdraw (amount uint) (recipient (optional principal)))
  (let ((owner tx-sender)
    ...
    (try! (as-contract (contract-call? 'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token transfer amount tx-sender recv none)))
