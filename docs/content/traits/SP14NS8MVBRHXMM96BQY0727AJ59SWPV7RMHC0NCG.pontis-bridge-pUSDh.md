---
title: "Trait pontis-bridge-pUSDh"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "Pontis USDh")
(define-data-var token-symbol (string-ascii 10) "pUSDh")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/Qmbra3jueTYBk1o3azqp9UqP93GiQxmkSjvqbe5stm4M8Y"))
;; 851869:625
