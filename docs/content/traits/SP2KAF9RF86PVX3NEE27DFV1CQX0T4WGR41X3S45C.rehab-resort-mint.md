...
;; Define Variables
(define-data-var last-id uint u215)
...
(define-private (mint (new-owner principal))
    (let (
      ...
      (match (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.rehab-resort transfer next-id (as-contract tx-sender) new-owner))
        success
        (let
