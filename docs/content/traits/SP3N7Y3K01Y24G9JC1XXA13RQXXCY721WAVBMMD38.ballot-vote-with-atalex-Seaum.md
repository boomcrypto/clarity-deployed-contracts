---
title: "Trait ballot-vote-with-atalex-Seaum"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with atALEX) Approve ALEX Governance Proposal for $XLNK and Tokenomics")
    (var-set description u"This proposal is to approve the ALEX Governance Proposal for $XLNK and Tokenomics. The proposal and tokenomics are available on: https://medium.com/alexgobtc/alex-governance-proposal-xlnk-approval-and-tokenomics-d65024df0626X/Twitter AMA: https://twitter.com/i/spaces/1jMJgmnrZkPKL?s=20Vote to either approve or disapprove the ALEX Governance Proposal for $XLNK and Tokenomics. => Vote with ALEX and atALEX <=As Ballot.gg does not support a voting strategy that involves two tokens (ALEX and atALEX) with differe")
    (var-set voting-system "fptp")
    (var-set options (list "bf7c0a5f-f51d-41dd-8143-6f5278275ec9" "9cf775b1-0d25-434e-a733-b4bdbe1e41ed"))
    (var-set start u138816)
    (var-set end u139824)
    (map-set results {id: "bf7c0a5f-f51d-41dd-8143-6f5278275ec9"} {count: u0, name: u"Approve ALEX Governance Proposal for $XLNK and Tokenomics"}) (map-set results {id: "9cf775b1-0d25-434e-a733-b4bdbe1e41ed"} {count: u0, name: u"Disapprove ALEX Governance Proposal for $XLNK and Tokenomics"})
```
