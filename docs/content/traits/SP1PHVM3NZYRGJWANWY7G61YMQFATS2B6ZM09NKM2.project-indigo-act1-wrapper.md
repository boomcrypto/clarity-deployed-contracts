---
title: "Trait project-indigo-act1-wrapper"
draft: true
---
```
(use-trait commission-trait 'SP176ZMV706NZGDDX8VSQRGMB7QN33BBDVZ6BMNHD.commission-trait.commission)
...
(define-public (buy-item (collection <marketplace>) (item-id uint) (comm <commission-trait>) (referer uint))
    (let (
        (item (contract-call? 'SP176ZMV706NZGDDX8VSQRGMB7QN33BBDVZ6BMNHD.project-indigo-act1 get-listing-in-ustx item-id))
