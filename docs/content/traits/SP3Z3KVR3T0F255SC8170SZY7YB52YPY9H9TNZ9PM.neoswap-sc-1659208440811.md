---
title: "Trait neoswap-sc-1659208440811"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP1W61GBSSTV6QFR16N7VEW549M07XP6BD0RXBW6B.btccustoms-components- transfer u18 tx-sender agent-5)))
	(unwrap-panic (as-contract (contract-call? 'SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.miamicoin-artweek transfer u80 tx-sender agent-5)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ.stacks-x-ghost-nft-nyc-2022 transfer u123 tx-sender agent-1)))
		(unwrap-panic (as-contract (contract-call? 'SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.miamicoin-artweek transfer u80 tx-sender agent-1)))
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPXM7A1WWQPS3R504SNGXERRHEKHZEGQE40DJGJY.stockings transfer u225 tx-sender agent-5)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.miamicoin-artweek transfer u80 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
