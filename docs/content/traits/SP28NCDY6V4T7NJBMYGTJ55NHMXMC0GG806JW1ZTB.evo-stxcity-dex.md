...
(define-constant allow-token 'SP28NCDY6V4T7NJBMYGTJ55NHMXMC0GG806JW1ZTB.evo-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u994991874233027)
    (var-set stx-balance u3020000)
