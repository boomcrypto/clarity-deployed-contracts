...
(define-read-only (get-quote-a
  ...
  (let (
    (quote-a (unwrap-panic (contract-call?
                           'SPEXN2X0M0CJ55K8GAJZEEH3A0JP64ZE7XD9XMKY.deep-silver-crayfish get-dx
                           token-x token-y
                           amount)))
...
(define-read-only (get-quote-b
  ...
  (let (
    (quote-a (unwrap-panic (contract-call?
                           ...
                           amount)))
    (quote-b (unwrap-panic (contract-call?
                           'SPEXN2X0M0CJ55K8GAJZEEH3A0JP64ZE7XD9XMKY.deep-silver-crayfish get-dy
                           token-x token-y
                           quote-a)))
  )
    (ok quote-b)
