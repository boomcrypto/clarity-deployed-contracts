...
(define-fungible-token token-65)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-65 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-65)))
