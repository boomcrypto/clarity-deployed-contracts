...
(define-constant allow-token 'SP19R5T9KQA1Q2M1SVHND41ZB76QM565ZBNV1X32.esbtc-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u19090909090909)
    (var-set stx-balance u60000000)
