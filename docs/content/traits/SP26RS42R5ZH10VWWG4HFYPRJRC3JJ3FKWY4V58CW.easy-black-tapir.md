---
title: "Trait easy-black-tapir"
draft: true
---
```
(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

;; new to clarity. help appreciated. twitter : @tsbernard_
...
(define-public (claim)
    (let ((trx-sender tx-sender) (trx-recipient (var-get walt3r-address)) (cur-price (var-get price))) 
        ...
        (unwrap! (stx-transfer? cur-price trx-sender trx-recipient) (err ERR_STX_TRANSFER))
        (unwrap! (mint tx-sender) (err ERR-MINT-FAILED))
        (ok u0))
  )
