---
title: "Trait token-ssl-wsbtc-08JSD"
draft: true
---
```
...
(define-read-only (get-balance (account principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP3R4MHK99JAAM0N3T0CBZRZVSVQFG1N75DQ08JSD.Wsbtc get-balance account)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals)))))
)
...
(contract-call? .alex-vault-v1-1 set-approved-token .token-ssl-wsbtc-08JSD true)
