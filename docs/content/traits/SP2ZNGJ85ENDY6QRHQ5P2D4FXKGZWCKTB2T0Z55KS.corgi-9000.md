---
title: "Trait corgi-9000"
draft: true
---
```
;; CORGI-9000
;; vSTX-(CHA-WELSH) LP token with configurable metadata
...
(define-data-var token-name (string-ascii 32) "CORGI-9000")
(define-data-var token-symbol (string-ascii 10) "CORGI9K")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/corgi-9000/metadata.json"))
