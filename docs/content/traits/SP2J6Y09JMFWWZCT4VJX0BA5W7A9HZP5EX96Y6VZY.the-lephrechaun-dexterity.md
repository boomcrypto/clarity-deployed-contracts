---
title: "Trait the-lephrechaun-dexterity"
draft: true
---
```
;; The Lephrechaun - LP Token, AMM DEX and Hold-to-Earn Engine
;; SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.the-lephrechaun-dexterity
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.the-lephrechaun-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    (sender tx-sender)
    (reserve-in (unwrap-panic (if forward (contract-call? 'SP1PW804599BZ46B4A0FYH86ED26XPJA7SFYNK1XS.play get-balance CONTRACT) 
    ...
    (reserve-out (unwrap-panic (if forward (contract-call? 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.lephrecaun-with-bitcoin-stxcity get-balance CONTRACT) 
      (contract-call? 'SP1PW804599BZ46B4A0FYH86ED26XPJA7SFYNK1XS.play get-balance CONTRACT))))
    ...
    ;; Execute the swap
    (try! (if forward (contract-call? 'SP1PW804599BZ46B4A0FYH86ED26XPJA7SFYNK1XS.play transfer amt-in sender CONTRACT none) 
    ...
    (try! (as-contract (if forward (contract-call? 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.lephrecaun-with-bitcoin-stxcity transfer amt-out CONTRACT sender none)
      (contract-call? 'SP1PW804599BZ46B4A0FYH86ED26XPJA7SFYNK1XS.play transfer amt-out CONTRACT sender none))))
    (ok {amt-in: amt-in, amt-out: amt-out})))

(define-public (mint (who principal) (amount uint))
  (let (
    (reserve0 (unwrap-panic (contract-call? 'SP1PW804599BZ46B4A0FYH86ED26XPJA7SFYNK1XS.play get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SP1PW804599BZ46B4A0FYH86ED26XPJA7SFYNK1XS.play transfer token0-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SP1PW804599BZ46B4A0FYH86ED26XPJA7SFYNK1XS.play transfer token0-amount CONTRACT who none)))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP1PW804599BZ46B4A0FYH86ED26XPJA7SFYNK1XS.play, token1: 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.lephrecaun-with-bitcoin-stxcity}))
...
(define-read-only (get-reserves)
  (ok {
    token0: (unwrap-panic (contract-call? 'SP1PW804599BZ46B4A0FYH86ED26XPJA7SFYNK1XS.play get-balance CONTRACT)),
