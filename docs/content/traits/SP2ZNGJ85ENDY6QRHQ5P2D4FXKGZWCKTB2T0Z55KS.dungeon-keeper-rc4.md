---
title: "Trait dungeon-keeper-rc4"
draft: true
---
```
...
(map-set verified-interactions .meme-engine-iou-welsh-rc2 true)
...
(map-set verified-interactions .keepers-petition-rc3 true)
