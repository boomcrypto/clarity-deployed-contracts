---
title: "Trait bitflow-token-2-dex"
draft: true
---
```
...
(define-constant STX_TARGET_AMOUNT u1000000) ;; 1 stx
(define-constant VIRTUAL_STX_VALUE u200000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u4) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP2QGQ3R0RH96SEGEV6YBK8QDPF7CQ0ATC2E7FH67.bitflow-token-2)
;; data vars
      ...
      (if (>= new-stx-balance  STX_TARGET_AMOUNT)
        (begin
          (let (
            ...
            (try! (as-contract (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-core-v-1-2 create-pool 'SP2QGQ3R0RH96SEGEV6YBK8QDPF7CQ0ATC2E7FH67.xyk-pool-token-2 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.token-stx-v-1-2 token-trait remain-stx remain-tokens xyk-burn-amount u10 u40 u10 u40 'SP31C60QVZKZ9CMMZX73TQ3F3ZZNS89YX2DCCFT8P xyk-pool-uri true)))
            (try! (as-contract (contract-call? 'SP2QGQ3R0RH96SEGEV6YBK8QDPF7CQ0ATC2E7FH67.xyk-pool-token-2 transfer u1 tx-sender 'SP2QGQ3R0RH96SEGEV6YBK8QDPF7CQ0ATC2E7FH67.xyk-pool-token-2 none))) ;; @STXCITY: transfer remaining LP Tokens to XYK Core v-1-2 pool contract
            ;; send fee
...
(begin
  ...
  (try! (stx-transfer? u1000 tx-sender 'SP1WG62TA0D3K980WGSTZ0QA071TZD4ZXNKP0FQZ7))
  (ok true)
)
```
