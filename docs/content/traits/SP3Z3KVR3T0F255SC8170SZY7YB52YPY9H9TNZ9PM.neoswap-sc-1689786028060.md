---
title: "Trait neoswap-sc-1689786028060"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/pLYHKmeEjovzT3ILlCKF
;; SwapId: 1mQgahbY30RJcXULKPYo

;; traders
(define-constant TRADER-1 'SP136AXDAQ41R31GJWJX8KX14E2T4K8PA08NCE6Q5)
(define-constant TRADER-2 'SPM1Q7YG18378H6W254YN8PABEVRPT38ZCY01SJD)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u4260000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u4260000 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u4260000 tx-sender TRADER-1)))
