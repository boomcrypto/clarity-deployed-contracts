---
title: "Trait ststx-leo"
draft: true
---
```
;; Leo Community Pool
;; stSTX-LEO LP token with configurable metadata
...
(define-data-var token-name (string-ascii 32) "Leo Community Pool")
(define-data-var token-symbol (string-ascii 10) "stSTX-LEO")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/ststx-leo/metadata.json"))
