---
title: "Trait basic-ivory-hedgehog"
draft: true
---
```
...
(define-public (load-contract)
  (ok
    (unwrap! (as-contract (contract-call? 'SP27F9EJH20K3GT6GHZG0RD08REZKY2TDMD6D9M2Z.btc-badgers-v2 transfer u80 tx-sender (as-contract tx-sender))) (err u104))
  )
)
```
