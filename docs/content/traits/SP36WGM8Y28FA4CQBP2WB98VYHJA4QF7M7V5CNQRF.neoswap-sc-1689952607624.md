---
title: "Trait neoswap-sc-1689952607624"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/P9FSpnUwv24jp3h1fX9p
;; SwapId: RL7VgIDomBvaSBN0u6ZI

;; traders
(define-constant TRADER-1 'SP2DZRMEHYF67812RDH1BG6V3SB0VF84YCDQQ9QK4)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u1035000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
	    )
            true
        )
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u935000 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u1035000 tx-sender TRADER-1)))
	    )
            true
        )
