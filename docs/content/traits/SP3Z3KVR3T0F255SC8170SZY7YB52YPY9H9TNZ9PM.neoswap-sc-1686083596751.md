---
title: "Trait neoswap-sc-1686083596751"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/Ub8KdYssZj31SVSVXiU0
;; SwapId: Zv0Y59ufAMhhJ9M9suE3

;; traders
(define-constant TRADER-1 'SPZTTWJ2DFJTQWV2THMY55W2ZVD7T7G9CCBNDCQ7)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u34450000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u34450000 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u34450000 tx-sender TRADER-2)))
		(unwrap-panic (as-contract (contract-call? 'SP27F9EJH20K3GT6GHZG0RD08REZKY2TDMD6D9M2Z.btc-badgers-v2 transfer u1168 tx-sender TRADER-2)))
	    )
            true
        )
