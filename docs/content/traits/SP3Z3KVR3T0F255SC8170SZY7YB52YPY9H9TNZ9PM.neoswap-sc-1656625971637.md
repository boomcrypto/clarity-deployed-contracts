---
title: "Trait neoswap-sc-1656625971637"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u3630000 tx-sender agent-4)))
	)
	(unwrap-panic (begin
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP248HH800501WYSG7Z2SS1ZWHQW1GGH85ME34NT2.layer-v2-1 transfer u16794 tx-sender agent-4)))
