...
(define-data-var token-name (string-ascii 32) "ETHEREUM Wrapper")
(define-data-var token-symbol (string-ascii 32) "wfrodo")
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SPPK49DG7WR1J5D50GZ4W7DYYWM5MAXSX0ZA9VEJ.FrodoSaylorKeanuPepe10Inu-token-v69 get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
