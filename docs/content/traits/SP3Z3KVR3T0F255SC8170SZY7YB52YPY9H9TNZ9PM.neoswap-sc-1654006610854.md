---
title: "Trait neoswap-sc-1654006610854"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.stackspy-nft transfer u20 tx-sender agent-4)))
	...
	(unwrap-panic (as-contract (contract-call? 'SP1CSHTKVHMMQJ7PRQRFYW6SB4QAW6SR3XY2F81PA.stxplates transfer u365 tx-sender agent-8)))
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.stacculents transfer u611 tx-sender agent-9)))
		(as-contract (stx-transfer? u770000 tx-sender agent-9)))
	)
	(unwrap-panic (begin
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.stackspy-nft transfer u20 tx-sender agent-1)))
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.stacculents transfer u611 tx-sender agent-4)))
		(as-contract (stx-transfer? u50040000 tx-sender agent-4)))
	)
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1180000 tx-sender agent-5)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.stackspy-nft transfer u20 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
		...
		(asserts! (is-ok (stx-transfer? u50040000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
