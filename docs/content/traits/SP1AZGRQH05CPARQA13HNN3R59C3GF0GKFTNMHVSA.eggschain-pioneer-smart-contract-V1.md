---
title: "Trait eggschain-pioneer-smart-contract-V1"
draft: true
---
```
 ...
 (define-data-var blockChain_Location (string-utf8 60) u"test String")
 (define-constant ERR_INVALID_STRING u0)

(define-public (set-message (messageDate (string-utf8 25))  (messageTime (string-utf8 25))  (messageLocation (string-utf8 60)) (message (string-utf8 150)))
        (if (var-set blockChain_message message) 
        (begin 
          (var-set blockChain_Date messageDate)
           (var-set blockChain_Time messageTime)
           (var-set blockChain_Location messageLocation)
