---
title: "Trait vlistx-not"
draft: true
---
```
;; Nothing Community Pool
;; vLiSTX-NOT LP token with configurable metadata
...
(define-data-var token-name (string-ascii 32) "Nothing Community Pool")
(define-data-var token-symbol (string-ascii 10) "vlSTX-NOT")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/vlistx-not/metadata.json"))
