...
;; DEFINE METADATA
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://pdakhjpwkuwtadzmpnjm.supabase.co/storage/v1/object/public/uri/hwOzwhpL-easy-easy-5-decimals.json"))
...
(begin
    ...
    (try! (ft-mint? EASY MAXSUPPLY (var-get contract-owner)))
)
