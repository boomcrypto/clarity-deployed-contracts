---
title: "Trait neoswap-sc-1690383447946"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/6d23vYSeOmzrX57W51LU
;; SwapId: VD7NC3cTVc5sTgQEvT47
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u950000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u950000 tx-sender TRADER-1)))
