---
title: "Trait stacks-art-market-v1"
draft: true
---
```
...
(define-public (reset (item-id uint))
    (let (
        ...
        (try! (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-stacks-dragons transfer item-id tx-sender sender)))
...
(define-public (unlist-item (item-id uint))
    (begin
        (try! (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-market-v5 buy-item 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-stacks-dragons NAME item-id))
        (ok true)
    )
)
