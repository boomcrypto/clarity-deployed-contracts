---
title: "Trait curve-pool-v1_0_0-0000"
draft: true
---
```
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(define-public
  ...
  (let ((pool_        (do-get-pool))
        ...
        (liquidity    (try! (contract-call? .curve-math_v1_0_0 mint r0 amt0 r1 amt1 total-supply (get A pool_))))
        )
...
(define-public
  ...
  (let ((pool_        (do-get-pool))
        ...
        (res          (contract-call? .curve-math_v1_0_0 burn r0 r1 total-supply liquidity))
        (amt0         (get dx res))
        (amt1         (get dy res))
        )
...
(define-public
  ...
  (let ((pool_     (var-get pool))
        ...
        (amt-out
         (if is-token0
             (unwrap-panic (contract-call? .curve-math_v1_0_0 find-dx r1 r0 amt-in-adjusted u0 (get A pool_)))
             (unwrap-panic (contract-call? .curve-math_v1_0_0 find-dx r0 r1 amt-in-adjusted u0 (get A pool_)))))
