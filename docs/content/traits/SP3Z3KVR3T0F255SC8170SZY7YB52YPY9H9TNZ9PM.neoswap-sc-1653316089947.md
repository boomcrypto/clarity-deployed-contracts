---
title: "Trait neoswap-sc-1653316089947"
draft: true
---
```
...
(begin
	(unwrap-panic (as-contract (contract-call? 'SP176ZMV706NZGDDX8VSQRGMB7QN33BBDVZ6BMNHD.project-indigo-act1 transfer u1852 tx-sender agent-1)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u22060000 tx-sender agent-2)))
	)
	(unwrap-panic (begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u2240000 tx-sender agent-4)))
	)
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP176ZMV706NZGDDX8VSQRGMB7QN33BBDVZ6BMNHD.project-indigo-act1 transfer u1852 tx-sender agent-2)))
