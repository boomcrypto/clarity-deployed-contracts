---
title: "Trait farming-wstx-long-distributor"
draft: true
---
```
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constants
(define-constant REWARD-TOKEN 'SP265WBWD4NH7TVPYQTVD23X3607NNK4484DTXQZ3.longcoin)
...
(define-public
  ...
  (let ((epoch (contract-call? .farming-wstx-long-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .farming-wstx-long-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .farming-wstx-long-core current-epoch))
