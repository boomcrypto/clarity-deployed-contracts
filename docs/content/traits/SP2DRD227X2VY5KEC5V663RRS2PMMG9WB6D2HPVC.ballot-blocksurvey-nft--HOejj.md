---
title: "Trait ballot-blocksurvey-nft--HOejj"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"BlockSurvey NFT Holders Poll - 10 Mar 2024")
    (var-set description u"BlockSurvey")
    (var-set voting-system "fptp")
    (var-set options (list "2b407361-ebba-4087-a5a0-dccda545d912" "dd2716c5-ee49-4f09-be7b-608dc84b42ff"))
    (var-set start u142259)
    (var-set end u174077)
    (map-set results {id: "2b407361-ebba-4087-a5a0-dccda545d912"} {count: u0, name: u"Choice 1"}) (map-set results {id: "dd2716c5-ee49-4f09-be7b-608dc84b42ff"} {count: u0, name: u"Choice 2"})
```
