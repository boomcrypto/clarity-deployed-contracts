---
title: "Trait tradimple-sc-1644937561062"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.afro-king transfer u221 tx-sender agent-1)))
	(unwrap-panic (begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.african-amazons transfer u6 tx-sender agent-4)))
	...
	(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.african-amazons transfer u7 tx-sender agent-5)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.african-amazons transfer u6 tx-sender agent-1)))
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u15300000 tx-sender agent-5)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.african-amazons transfer u6 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
		...
		(asserts! (is-ok (stx-transfer? u15300000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
