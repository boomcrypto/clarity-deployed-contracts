---
title: "Trait ptd-core-proposals"
draft: true
---
```
...
(define-public (create-proposal (proposal <proposal-trait>) (token <ft-trait>))
  (let
    ...
    (asserts! (is-none (contract-call? 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.ptd-base-dao executed-at proposal)) ERR_PROPOSAL_ALREADY_EXECUTED)
...
(define-public (conclude-proposal (proposal <proposal-trait>) (treasury <treasury-trait>) (token <ft-trait>))
  (let
    ...
    (and votePassed (try! (contract-call? 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.ptd-base-dao execute proposal tx-sender)))
    ;; return the result
    (ok votePassed)
  )
)
...
(define-private (is-dao-or-extension)
  (ok (asserts! (or (is-eq tx-sender 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.ptd-base-dao)
    (contract-call? 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.ptd-base-dao is-extension contract-caller)) ERR_NOT_DAO_OR_EXTENSION
  ))
)
