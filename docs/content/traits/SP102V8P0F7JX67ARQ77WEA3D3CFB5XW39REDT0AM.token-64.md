...
(define-fungible-token token-64)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-64 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-64)))
