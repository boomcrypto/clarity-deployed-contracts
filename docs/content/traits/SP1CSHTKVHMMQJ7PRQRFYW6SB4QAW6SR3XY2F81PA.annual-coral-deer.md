...
(define-public (claim-with (token <ft-trait>)) 
  (mint (list true)))

(define-public (claim-three-with (token <ft-trait>)) (mint-with token (list true true true)))

(define-public (claim-five-with (token <ft-trait>)) (mint-with token (list true true true true true)))

(define-public (claim-ten-with (token <ft-trait>)) (mint-with token (list true true true true true true true true true true)))

(define-public (claim-twentyfive-with (token <ft-trait>)) (mint-with token (list true true true true true true true true true true true true true true true true true true true true true true true true true)))

(define-private (mint-with (token <ft-trait>) (orders (list 25 bool)))
  (let 
    (
...
(define-private (mint-many-with (token <ft-trait>) (orders (list 25 bool)))  
  (let 
    (
      ...
      (price (* token-price (- id-reached last-nft-id)))
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? kitchen-sink next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
