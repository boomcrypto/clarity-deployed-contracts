...
(define-fungible-token token-23)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-23 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-23)))
