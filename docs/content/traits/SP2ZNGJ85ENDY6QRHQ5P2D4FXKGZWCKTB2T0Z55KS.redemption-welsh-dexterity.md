---
title: "Trait redemption-welsh-dexterity"
draft: true
---
```
;; Redemption Welsh - LP Token, AMM DEX and Hold-to-Earn Engine
;; SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.redemption-welsh-dexterity
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.redemption-welsh-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    ...
    (try! (as-contract (if forward (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.synthetic-welsh burn (/ (- raw-out amt-out) u2))
      (contract-call? 'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token transfer (/ (- raw-out amt-out) u2) CONTRACT sender none))))
