---
title: "Trait test-token-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP1FQ3DQDR5N9HJX3XC5DNKFCG4DHH48EFJQV6QH0.test-token-stxcity)
...
(var-set token-balance u68998850019166352)
