...
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://memefun.s3.ap-northeast-1.amazonaws.com/metadata/rwjh2q71hkze7zehmvxjn9otm7g5v79p.json?"))
(define-data-var is-minted bool false)


(define-fungible-token Fartcoin token-max-supply)
...
(define-read-only (get-balance (who principal))
    (ok (ft-get-balance Fartcoin who)))
...
(define-public (mint (amount uint) (recipient principal)) 
    (begin 
        ...
        (try! (ft-mint? Fartcoin amount recipient))
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34)))) 
    (begin
        ...
        (try! (ft-transfer? Fartcoin amount sender recipient))
...
(define-public (burn (amount uint))
    (ft-burn? Fartcoin amount tx-sender))
