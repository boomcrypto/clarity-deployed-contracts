---
title: "Trait test-token-3-stxcity-dex"
draft: true
---
```
...
(define-constant STX_TARGET_AMOUNT u38000000000)
(define-constant VIRTUAL_STX_VALUE u7600000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u760000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP1FQ3DQDR5N9HJX3XC5DNKFCG4DHH48EFJQV6QH0.test-token-3-stxcity)
