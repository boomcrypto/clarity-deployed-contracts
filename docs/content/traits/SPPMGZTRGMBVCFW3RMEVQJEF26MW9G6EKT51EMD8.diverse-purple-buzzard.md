---
title: "Trait diverse-purple-buzzard"
draft: true
---
```
...
(define-public (is-dao-or-extension)
  (ok (asserts!
    (or
      (is-eq tx-sender 'SPPMGZTRGMBVCFW3RMEVQJEF26MW9G6EKT51EMD8.underground-red-nightingale)
      (contract-call? 'SPPMGZTRGMBVCFW3RMEVQJEF26MW9G6EKT51EMD8.underground-red-nightingale is-extension contract-caller))
    ERR_UNAUTHORIZED
  ))
)
...
(define-public (direct-execute (proposal <proposal-trait>))
  (let
    ...
    (and (>= signals (var-get signalsRequired))
      (try! (contract-call? 'SPPMGZTRGMBVCFW3RMEVQJEF26MW9G6EKT51EMD8.underground-red-nightingale execute proposal tx-sender))
    )
