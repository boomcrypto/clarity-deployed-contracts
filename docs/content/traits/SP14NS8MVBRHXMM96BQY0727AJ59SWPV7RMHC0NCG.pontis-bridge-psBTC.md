---
title: "Trait pontis-bridge-psBTC"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "psBTC")
(define-data-var token-symbol (string-ascii 10) "psBTC")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmQd5xkJAwU6414jxTZ5NX2eH4cC94xh6NiAXm9LBxwTrq"))
