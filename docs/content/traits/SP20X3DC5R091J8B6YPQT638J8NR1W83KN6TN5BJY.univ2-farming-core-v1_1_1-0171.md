---
title: "Trait univ2-farming-core-v1_1_1-0171"
draft: true
---
```
...
(define-constant STAKING-TOKEN .univ2-lp-token-v1_0_0-0171)
...
(define-public (stake (amt uint))
  (let ((user      tx-sender)
    ...
    ;; Update global state
    (try! (contract-call? .univ2-lp-token-v1_0_0-0171 transfer amt user protocol none))
    ...
    ;; Postconditions
    (asserts!
      (>= (unwrap-panic (contract-call? .univ2-lp-token-v1_0_0-0171 get-balance protocol))
...
(define-public (unstake (amt uint))
  (let ((user      tx-sender)
    ...
    ;; Update global state
    (try! (as-contract (contract-call? .univ2-lp-token-v1_0_0-0171 transfer amt protocol user none)))
