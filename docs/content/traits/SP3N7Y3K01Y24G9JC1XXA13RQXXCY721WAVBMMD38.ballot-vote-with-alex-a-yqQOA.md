---
title: "Trait ballot-vote-with-alex-a-yqQOA"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with ALEX) Approve Launch of Orange on the ALEX Launchpad")
    ...
    (var-set options (list "d0a75db5-ede2-458f-b66a-22d5b23e4556" "db3423b0-411b-4ed9-9afe-ef14f9247df4"))
    (var-set start u135029)
    (var-set end u135461)
    (map-set results {id: "d0a75db5-ede2-458f-b66a-22d5b23e4556"} {count: u0, name: u"Approve Launch of Orange on the ALEX Launchpad"}) (map-set results {id: "db3423b0-411b-4ed9-9afe-ef14f9247df4"} {count: u0, name: u"Disapprove Launch of Orange on the ALEX Launchpad"})
```
