---
title: "Trait tradimple-sc-1645716529962"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.stx-jokers transfer u423 tx-sender agent-2)))
		(as-contract (stx-transfer? u2000000 tx-sender agent-2)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.afro-king transfer u3 tx-sender agent-3)))
