---
title: "Trait test-safety-1-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPSWQN1SJMZAEG815S7BMFSFRYA4X2S5AE91R88A.test-safety-1-stxcity)
