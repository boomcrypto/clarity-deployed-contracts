---
title: "Trait orbitdash-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPMV7AARVYK85FY4GB9Q4G0DKM2MX12MVFTTHHXX.orbitdash-stxcity)
...
(var-set token-balance u9992472337505746)
(var-set stx-balance u753333)
