---
title: "Trait monkey-d-luffy-rc9"
draft: true
---
```
...
(define-public (x-add-liquidity (amount uint) 
    ...
    (signature-b (buff 65)) (uuid-b (string-ascii 36)) (recipient-a principal) (recipient-b principal))
    (let (
        (delta (get-liquidity-quote amount))
...
(define-public (x-remove-liquidity (amount uint) 
    (signature (buff 65)) (uuid (string-ascii 36)) (recipient-a principal) (recipient-b principal))
    (let (
        ...
        (try! (as-contract (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token-subnet-rc6 transfer amount-a CONTRACT recipient-a none)))
        (try! (as-contract (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.welsh-token-subnet-rc2 transfer amount-b CONTRACT recipient-b none)))
