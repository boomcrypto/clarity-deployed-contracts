...
(define-read-only (get-quote-a
  ...
  (let (
    ...
    (r1 (if (is-eq reversed true)
            (get reserve0 velar-pool)
            (get reserve1 velar-pool)))
    (quote-a (try! (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.univ2-library get-amount-out amount r0 r1 swap-fee)))
...
(define-read-only (get-quote-b
  ...
  (let (
    ...
    (quote-a (unwrap-panic (contract-call?
                           ...
                           'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.stx-ststx-lp-token-v-1-2
                           amount)))
    (quote-b (try! (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.univ2-library get-amount-out quote-a r0 r1 swap-fee)))
  )
    (ok quote-b)
  )
)
