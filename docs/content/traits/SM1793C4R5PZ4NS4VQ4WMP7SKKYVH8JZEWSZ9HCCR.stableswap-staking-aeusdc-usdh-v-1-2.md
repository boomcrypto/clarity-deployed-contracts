---
title: "Trait stableswap-staking-aeusdc-usdh-v-1-2"
draft: true
---
```

;; stableswap-staking-aeusdc-usdh-v-1-2
...
(define-constant DEPLOYMENT_HEIGHT u863398)
...
(define-private (transfer-lp-token (amount uint) (sender principal) (recipient principal))
  (let (
    (call-a (unwrap! (contract-call?
                     .stableswap-pool-aeusdc-usdh-v-1-2 transfer
