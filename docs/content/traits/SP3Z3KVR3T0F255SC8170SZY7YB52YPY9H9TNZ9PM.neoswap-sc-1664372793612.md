---
title: "Trait neoswap-sc-1664372793612"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u3112 tx-sender agent-1)))
		...
		(as-contract (stx-transfer? u3905000 tx-sender agent-1)))
	)
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u804375 tx-sender agent-3)))
	)
	(unwrap-panic (begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u220625 tx-sender agent-6)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u220625 tx-sender agent-0)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1183875 tx-sender agent-2)))
	)
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u3112 tx-sender agent-5)))
		(as-contract (stx-transfer? u4966750 tx-sender agent-5)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u1183875 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (stx-transfer? u4966750 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
