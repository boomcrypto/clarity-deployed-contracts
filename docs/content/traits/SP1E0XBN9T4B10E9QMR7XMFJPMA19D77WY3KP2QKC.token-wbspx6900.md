...
(define-fungible-token wbspx6900)

(define-data-var token-name (string-ascii 32) "BSPX 6900 Wrapper")
(define-data-var token-symbol (string-ascii 32) "wbspx6900")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wbspx6900.json"))
...
(define-read-only (get-base-token)
  'SP3EBDZJH8Z3N62A20MKCYG37EXZ5R8FR77JFW5BR.bspx6900-stxcity)

(define-read-only (get-base-decimals)
  (contract-call? 'SP3EBDZJH8Z3N62A20MKCYG37EXZ5R8FR77JFW5BR.bspx6900-stxcity get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP3EBDZJH8Z3N62A20MKCYG37EXZ5R8FR77JFW5BR.bspx6900-stxcity get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP3EBDZJH8Z3N62A20MKCYG37EXZ5R8FR77JFW5BR.bspx6900-stxcity transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
