...
(define-public (deposit (amount uint))
    ...
    (
        ...
        (unwrap! (stx-transfer? amountMinusFee tx-sender (contract-address)) ERR-NOT-ENOUGH-BALANCE) 
        (unwrap! (stx-transfer? fee tx-sender (var-get feePrincipal)) ERR-NOT-ENOUGH-BALANCE) 
