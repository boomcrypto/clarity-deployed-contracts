---
title: "Trait router-stableswap-xyk-multihop-v-1-2"
draft: true
---
```
...
(define-public (get-quote-a
  ...
  (let (
    ...
    (quote-a (if (is-eq swaps-reversed false)
                 (unwrap! (contract-call? .stableswap-swap-helper-v-1-4 get-quote-a amount-after-aggregator-fees stableswap-tokens stableswap-pools) ERR_QUOTE_A)
...
(define-public (get-quote-d
  ...
  (let (
    ...
    (amount-check (asserts! (> amount-after-aggregator-fees u0) ERR_INVALID_AMOUNT))
    (quote-a (if (is-eq swaps-reversed false)
                 (unwrap! (contract-call? .stableswap-swap-helper-v-1-4 get-quote-b amount-after-aggregator-fees stableswap-tokens stableswap-pools) ERR_QUOTE_A)
                 (unwrap! (contract-call? .xyk-swap-helper-v-1-2 get-quote-a amount-after-aggregator-fees xyk-tokens xyk-pools) ERR_QUOTE_A)))
    (quote-b (if (is-eq swaps-reversed false)
                 (unwrap! (contract-call? .xyk-swap-helper-v-1-2 get-quote-a quote-a xyk-tokens xyk-pools) ERR_QUOTE_B)
...
(define-public (get-quote-g
  ...
  (let (
    ...
    (amount-check (asserts! (> amount-after-aggregator-fees u0) ERR_INVALID_AMOUNT))
    (quote-a (if (is-eq swaps-reversed false)
                 (unwrap! (contract-call? .stableswap-swap-helper-v-1-4 get-quote-c amount-after-aggregator-fees stableswap-tokens stableswap-pools) ERR_QUOTE_A)
                 (unwrap! (contract-call? .xyk-swap-helper-v-1-2 get-quote-a amount-after-aggregator-fees xyk-tokens xyk-pools) ERR_QUOTE_A)))
    (quote-b (if (is-eq swaps-reversed false)
                 (unwrap! (contract-call? .xyk-swap-helper-v-1-2 get-quote-a quote-a xyk-tokens xyk-pools) ERR_QUOTE_B)
...
(define-public (swap-helper-a
  ...
  (let (
    ...
    (swap-a (if (is-eq swaps-reversed false)
                (unwrap! (contract-call? .stableswap-swap-helper-v-1-4 swap-helper-a amount-after-aggregator-fees u0 stableswap-tokens stableswap-pools) ERR_SWAP_A)
...
(define-public (swap-helper-d
  ...
  (let (
    ...
    (amount-check (asserts! (> amount-after-aggregator-fees u0) ERR_INVALID_AMOUNT))
    (swap-a (if (is-eq swaps-reversed false)
                (unwrap! (contract-call? .stableswap-swap-helper-v-1-4 swap-helper-b amount-after-aggregator-fees u0 stableswap-tokens stableswap-pools) ERR_SWAP_A)
                (unwrap! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-a amount-after-aggregator-fees u0 xyk-tokens xyk-pools) ERR_SWAP_A)))
    (swap-b (if (is-eq swaps-reversed false)
                (unwrap! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-a swap-a u0 xyk-tokens xyk-pools) ERR_SWAP_B)
...
(define-public (swap-helper-g
  ...
  (let (
    ...
    (amount-check (asserts! (> amount-after-aggregator-fees u0) ERR_INVALID_AMOUNT))
    (swap-a (if (is-eq swaps-reversed false)
                (unwrap! (contract-call? .stableswap-swap-helper-v-1-4 swap-helper-c amount-after-aggregator-fees u0 stableswap-tokens stableswap-pools) ERR_SWAP_A)
                (unwrap! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-a amount-after-aggregator-fees u0 xyk-tokens xyk-pools) ERR_SWAP_A)))
    (swap-b (if (is-eq swaps-reversed false)
                (unwrap! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-a swap-a u0 xyk-tokens xyk-pools) ERR_SWAP_B)
