---
title: "Trait neoswap-sc-1680298958182"
draft: true
---
```
;; multiway-swap
...
(define-private (release-escrow) 
    (begin
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-fruitmen transfer u9 tx-sender TRADER-2)))

	(unwrap-panic (as-contract (stx-transfer? u22000000 tx-sender TRADER-1)))
