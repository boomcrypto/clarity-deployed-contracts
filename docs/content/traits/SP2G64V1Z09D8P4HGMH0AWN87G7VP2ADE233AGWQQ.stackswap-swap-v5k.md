---
title: "Trait stackswap-swap-v5k"
draft: true
---
```
...
(define-public (swap-x-for-y (amountIn uint))
  (let (
    (b1 (unwrap-panic (contract-call? .test-hello-world-v4 swap-wstx-usda amountIn)))
    (b2 (unwrap-panic (contract-call? .test-hello-world-v6 swap-usda-wstx b1)))
  )
    (begin
...
(define-public (swap-y-for-x (amountIn uint))
  (let (
    (b1 (unwrap-panic (contract-call? .test-hello-world-v4 swap-wstx-diko amountIn)))
    (b2 (unwrap-panic (contract-call? .test-hello-world-v6 swap-diko-wstx b1)))
  )
    (begin
      (asserts! (> b2 amountIn) (err ERR-COOLDOWN))
      (asserts! (is-eq CONTRACT-OWNER tx-sender) (err ERR-ALL-MINTED))
...
(define-public (swap-x-far-y (amountIn uint))
  (let (
    (b1 (unwrap-panic (contract-call? .test-hello-world-v6 swap-wstx-usda amountIn)))
    (b2 (unwrap-panic (contract-call? .test-hello-world-v4 swap-usda-wstx b1)))
  )
    (begin
      (asserts! (> b2 amountIn) (err ERR-COOLDOWN))
      (asserts! (is-eq CONTRACT-OWNER tx-sender) (err ERR-ALL-MINTED))
...
(define-public (swap-y-far-x (amountIn uint))
  (let (
    (b1 (unwrap-panic (contract-call? .test-hello-world-v6 swap-wstx-diko amountIn)))
    (b2 (unwrap-panic (contract-call? .test-hello-world-v4 swap-diko-wstx b1)))
  )
    (begin
      (asserts! (> b2 amountIn) (err ERR-COOLDOWN))
      (asserts! (is-eq CONTRACT-OWNER tx-sender) (err ERR-ALL-MINTED))
