...
;; BSD Protocol 
(impl-trait .bsd-trait-vpv-1.bsd-trait)
...
(map-set authorized-protocol-callers .registry-vpv-1 true)
(map-set authorized-protocol-callers .vault-vpv-1 true)
(map-set authorized-protocol-callers .redeem-vpv-1 true)
(map-set authorized-protocol-callers .stability-vpv-1 true)
```
