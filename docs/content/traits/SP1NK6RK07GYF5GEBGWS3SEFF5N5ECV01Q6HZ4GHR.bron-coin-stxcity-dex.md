---
title: "Trait bron-coin-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u10000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP1NK6RK07GYF5GEBGWS3SEFF5N5ECV01Q6HZ4GHR.bron-coin-stxcity)
...
(var-set token-balance u9917355371900)
