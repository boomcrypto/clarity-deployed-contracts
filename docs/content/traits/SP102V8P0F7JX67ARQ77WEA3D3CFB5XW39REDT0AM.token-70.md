...
(define-fungible-token token-70)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-70 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-70)))
