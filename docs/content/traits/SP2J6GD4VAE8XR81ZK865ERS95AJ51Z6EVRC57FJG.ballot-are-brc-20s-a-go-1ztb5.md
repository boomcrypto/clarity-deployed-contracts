---
title: "Trait ballot-are-brc-20s-a-go-1ztb5"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Are Brc-20's a good thing for btc?")
    (var-set description u"Are Brc-20's a good thing for btc?")
    (var-set voting-system "fptp")
    (var-set options (list "7d58e32d-9f6b-4226-93a6-0819202123ab" "b75918e0-9b95-49cb-8b56-c4aaa4c02c73"))
    (var-set start u106356)
    (var-set end u114276)
    (map-set results {id: "7d58e32d-9f6b-4226-93a6-0819202123ab"} {count: u0, name: u"yes"}) (map-set results {id: "b75918e0-9b95-49cb-8b56-c4aaa4c02c73"} {count: u0, name: u"no"})
```
