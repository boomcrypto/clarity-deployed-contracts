---
title: "Trait ctaxdao-token-owner"
draft: true
---
```
...
(define-public (set-token-uri (value (string-utf8 256)))
  (begin
    ...
    ;; update token uri
    (try! (as-contract (contract-call? 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.ctaxdao-faktory set-token-uri value)))
    (ok true)
  )
)
...
(define-public (transfer-ownership (new-owner principal))
  (begin
    ...
    (try! (is-dao-or-extension))
    ;; transfer ownership
    (try! (as-contract (contract-call? 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.ctaxdao-faktory set-contract-owner new-owner)))
    (ok true)
  )
)
