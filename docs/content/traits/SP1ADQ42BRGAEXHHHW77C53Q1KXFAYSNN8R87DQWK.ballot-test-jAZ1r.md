...
```
    ...
    (var-set description u"hotdog%20vs%20pizza")
    (var-set voting-system "fptp")
    (var-set options (list "0a28f57c-eece-4c65-b48e-8685f2ac08fb" "0597941b-ddb9-44f9-b4b3-b502f79d9a9a"))
    (var-set start u182914)
    (var-set end u182918)
    (map-set results {id: "0a28f57c-eece-4c65-b48e-8685f2ac08fb"} {count: u0, name: u"Choice%201"}) (map-set results {id: "0597941b-ddb9-44f9-b4b3-b502f79d9a9a"} {count: u0, name: u"Choice%202"})
```
