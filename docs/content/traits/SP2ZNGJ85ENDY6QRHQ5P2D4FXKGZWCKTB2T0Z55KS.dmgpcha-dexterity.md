---
title: "Trait dmgpcha-dexterity"
draft: true
---
```
;; DMG-pCHA - LP Token, AMM DEX and Hold-to-Earn Engine
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.dmgpcha-dexterity"))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dme000-governance-token, token1: 'SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.charisma-phoenix-stxcity}))
