---
title: "Trait neoswap-sc-1656530413739"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-matryoshka-dolls transfer u50 tx-sender agent-2)))
	(unwrap-panic (as-contract (contract-call? 'SPVMRAH27D4TKMG42NQX2F1PNK5AT922ZNE6SDST.fluid-marble transfer u7 tx-sender agent-3)))
...
(begin        
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPVMRAH27D4TKMG42NQX2F1PNK5AT922ZNE6SDST.fluid-marble transfer u7 tx-sender agent-2)))
