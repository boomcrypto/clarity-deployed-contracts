---
title: "Trait ballot-wear-a-house-DtcDI"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Wear%20a%20house")
    (var-set description u"For%20a%20simple%20decision")
    (var-set voting-system "fptp")
    (var-set options (list "694f1fb1-29c5-47ef-9587-d11cbd2b835f" "1563fdb5-5b8a-4470-a617-9c8ddc3f2216"))
    (var-set start u150466)
    (var-set end u150610)
    (map-set results {id: "694f1fb1-29c5-47ef-9587-d11cbd2b835f"} {count: u0, name: u"white"}) (map-set results {id: "1563fdb5-5b8a-4470-a617-9c8ddc3f2216"} {count: u0, name: u"black"})
```
