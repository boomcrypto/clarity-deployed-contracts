...
(define-data-var token-name (string-ascii 32) "Play Wrapper")
(define-data-var token-symbol (string-ascii 32) "wplay")
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP1PW804599BZ46B4A0FYH86ED26XPJA7SFYNK1XS.play get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
