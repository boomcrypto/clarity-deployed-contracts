---
title: "Trait ballot-vote-with-atalex-Aor2D"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with atALEX) Approve Launch of HuMaNz and Chamcha on the ALEX Launchpad")
    (var-set description u"This proposal is to select the next project(s) that will launch next on the ALEX Decentralized Launchpad. The two current applicants are:Humanz: https://cdn.alexlab.co/pdf/launch-candidates/HuMaNz.pdfChamcha: https://cdn.alexlab.co/pdf/launch-candidates/Chamcha.pdfThis is a multiple-choice vote and you can vote for either of the projects, or both.The ALEX Lab Foundation does NOT sponsor the projects approved for the ALEX Launchpad. Community members must do their own research on how to vote.The ALEX Lab Fou")
    (var-set voting-system "block")
    (var-set options (list "9c4ee60d-a299-400b-b412-6ae70779e8ae" "786e67a6-c5de-4140-b307-0d13c2c4c74e"))
    (var-set start u116577)
    (var-set end u117585)
    (map-set results {id: "9c4ee60d-a299-400b-b412-6ae70779e8ae"} {count: u0, name: u"HuMaNz"}) (map-set results {id: "786e67a6-c5de-4140-b307-0d13c2c4c74e"} {count: u0, name: u"Chamcha"})
```
