---
title: "Trait stagafiliza-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPQAJJ80B5NC0V8FP7XHDTXZ0ZCVNPWX0TMG1NW5.stagafiliza-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u964831878045250)
    (var-set stx-balance u14580000)
