---
title: "Trait test-fee-with-alex-stxcity-dex"
draft: true
---
```
...
;; FEE AND DEX WALLETS
(define-constant STX_CITY_SWAP_FEE_WALLET 'SP26HFF8ZZ6H8BA11J331CJS6RDGB9RC8JCV6GTJG)
(define-constant STX_CITY_COMPLETE_FEE_WALLET 'SP2V8G14YA1TDQR68XEXK0XN63AQ8YB1D24MKQCDV)
(define-constant BURN_ADDRESS 'SP000000000000000000002Q6VF78) ;; burn mainnet

(define-constant deployer tx-sender)
(define-constant allow-token 'SPWECF3XYVRBRCN23CJJCX9XKSF8RFWQPAQMWXT.test-fee-with-alex-stxcity)
...
(define-read-only (get-buyable-tokens (stx-amount uint)) 
  (let 
      ...
      (recommend-stx-amount-after-fee (/ (* recommend-stx-amount u103) u100)) ;; 3% (including 1% fee)
  )
...
(var-set token-balance u68908764795410870)
(var-set stx-balance u1324000)
  ...
  (try! (stx-transfer? u1000000 tx-sender 'SP2V8G14YA1TDQR68XEXK0XN63AQ8YB1D24MKQCDV))
  (ok true)
)
