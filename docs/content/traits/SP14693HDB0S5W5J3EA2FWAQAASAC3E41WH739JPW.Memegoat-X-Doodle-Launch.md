---
title: "Trait Memegoat-X-Doodle-Launch"
draft: true
---
```

;; ---------------------------------------------------------
;; MEMEGOAT X DOODLE LAUNCH
;; ---------------------------------------------------------
...
(define-constant LAUNCHPAD-TOKEN 'SP14693HDB0S5W5J3EA2FWAQAASAC3E41WH739JPW.Doodle)
...
(define-constant MIN-BUY u30000000)
(define-constant MAX-BUY u400000000)
(define-constant HARD-CAP u40000000000) 
(define-constant SOFT-CAP u25000000000)
(define-constant START-BLOCK u170084)
(define-constant END-BLOCK u172244)
...
(define-private (initialize)
  ...
  (begin
    ...
    (try! (contract-call? 'SP14693HDB0S5W5J3EA2FWAQAASAC3E41WH739JPW.Doodle transfer LISTING-ALLOCATION tx-sender LISTING-SIG-WALLET none))
    (try! (contract-call? 'SP14693HDB0S5W5J3EA2FWAQAASAC3E41WH739JPW.Doodle transfer SALE-ALLOCATION tx-sender LAUNCHPAD-ADDRESS none))
