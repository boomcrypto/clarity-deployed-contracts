...
(define-data-var token-name (string-ascii 32) "Wrapped Slime")
(define-data-var token-symbol (string-ascii 10) "WSLM")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wslm.json"))
...
(define-read-only (get-balance (account principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP125J1ADVYWGWB9NQRCVGKYAG73R17ZNMV17XEJ7.slime-token get-balance account)) (pow-decimals)) (pow u10 u6)))
)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    ...
    (contract-call? 'SP125J1ADVYWGWB9NQRCVGKYAG73R17ZNMV17XEJ7.slime-token transfer (/ (* amount (pow u10 u6)) (pow-decimals)) sender recipient memo)
  )
)
