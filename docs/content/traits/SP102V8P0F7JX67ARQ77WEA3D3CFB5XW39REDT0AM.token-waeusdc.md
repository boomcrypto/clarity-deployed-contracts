...
(define-data-var token-name (string-ascii 32) "aeUSDC Wrapper")
(define-data-var token-symbol (string-ascii 32) "waeusdc")
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP3Y2ZSH8P7D50B0VBTSX11S7XSG24M1VB9YFQA4K.token-aeusdc get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
