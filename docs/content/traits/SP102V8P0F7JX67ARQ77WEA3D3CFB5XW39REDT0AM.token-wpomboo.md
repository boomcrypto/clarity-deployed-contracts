---
title: "Trait token-wpomboo"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token wpomboo)
(define-data-var token-name (string-ascii 32) "Pomboo Wrapper")
(define-data-var token-symbol (string-ascii 32) "wpomboo")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wpomboo.json"))
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP1N4EXSR8DP5GRN2XCWZEW9PR32JHNRYW7MVPNTA.PomerenianBoo-Pomboo get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
