...
(define-fungible-token bridged-trenches)

(define-data-var token-name (string-ascii 32) "TRENCHES TOKEN")
(define-data-var token-symbol (string-ascii 32) "TRENCHES TOKEN")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.xlink.network/metadata/bridged-trenches.json"))
...
(define-read-only (get-base-token)
  'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.btcr-faktory)

(define-read-only (get-base-decimals)
  (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.btcr-faktory get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.btcr-faktory get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.btcr-faktory transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
