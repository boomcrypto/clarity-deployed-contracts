---
title: "Trait neoswap-sc-1660938187111"
draft: true
---
```
...
(begin
	(unwrap-panic (as-contract (contract-call? 'SP1XPG9QFX5M95G36SGN9R8YJ4KJ0JB7ZXNH892N6.consensus-2022 transfer u98 tx-sender agent-1)))
	(unwrap-panic (begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP3QBDVP816NV03PZRT3FWV99NA9G1PRTQ8E6FM9Z.randomwallpaper transfer u9 tx-sender agent-6)))
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.funky-donuts transfer u1066 tx-sender agent-7)))
	(unwrap-panic (as-contract (contract-call? 'SP1XPG9QFX5M95G36SGN9R8YJ4KJ0JB7ZXNH892N6.consensus-2022 transfer u99 tx-sender agent-8)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP3QBDVP816NV03PZRT3FWV99NA9G1PRTQ8E6FM9Z.randomwallpaper transfer u9 tx-sender agent-4)))
		...
		(unwrap-panic (as-contract (contract-call? 'SP1XPG9QFX5M95G36SGN9R8YJ4KJ0JB7ZXNH892N6.consensus-2022 transfer u98 tx-sender agent-4)))
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u440000 tx-sender agent-5)))
	)
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u2320000 tx-sender agent-7)))
	)
