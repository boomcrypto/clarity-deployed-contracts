---
title: "Trait univ2-farming-distributor-3-v1_0_0-0003"
draft: true
---
```
...
(define-public
  ...
  (let ((epoch (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.univ2-farming-core-v1_0_0-0003 current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.univ2-farming-core-v1_0_0-0003 get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.univ2-farming-core-v1_0_0-0003 current-epoch))
