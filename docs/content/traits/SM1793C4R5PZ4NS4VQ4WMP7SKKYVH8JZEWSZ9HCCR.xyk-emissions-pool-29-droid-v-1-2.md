---
title: "Trait xyk-emissions-pool-29-droid-v-1-2"
draft: true
---
```

;; xyk-emissions-pool-29-droid-v-1-2
...
(define-constant DEPLOYMENT_HEIGHT u886319)
...
(define-private (transfer-rewards-token (amount uint) (sender principal) (recipient principal))
  (let (
    (call-a (unwrap! (contract-call?
                     'SP2EEV5QBZA454MSMW9W3WJNRXVJF36VPV17FFKYH.DROID transfer
...
(define-private (get-contract-token-balance)
  (let (
    (call-a (unwrap! (contract-call?
                     'SP2EEV5QBZA454MSMW9W3WJNRXVJF36VPV17FFKYH.DROID get-balance
...
(define-private (get-external-user-data (user principal) (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     .xyk-staking-sbtc-droid-v-1-2 get-user-at-cycle
...
(define-private (get-external-cycle-data (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     .xyk-staking-sbtc-droid-v-1-2 get-lp-staked-at-cycle
