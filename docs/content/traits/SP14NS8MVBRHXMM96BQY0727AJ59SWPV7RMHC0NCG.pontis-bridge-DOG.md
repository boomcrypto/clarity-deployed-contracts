...
(define-data-var token-name (string-ascii 32) "DOG.GO.TO.THE.MOON")
(define-data-var token-symbol (string-ascii 10) "DOG")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmaNeuPd44FGFKxmxtYboSvUh4eZus18iQTkEA6poyYkij"))
;; 840000:3
