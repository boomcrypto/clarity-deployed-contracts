---
title: "Trait ballot-loan-bitcoin-fam-RQVmu"
draft: true
---
```
    ...
    (var-set options (list "33b53144-a258-4e15-b369-1a93508f9f16" "226ac747-ea87-4fe3-9aeb-efa7531ac857"))
    (var-set start u180030)
    (var-set end u182046)
    (map-set results {id: "33b53144-a258-4e15-b369-1a93508f9f16"} {count: u0, name: u"Yes"}) (map-set results {id: "226ac747-ea87-4fe3-9aeb-efa7531ac857"} {count: u0, name: u"No"})
