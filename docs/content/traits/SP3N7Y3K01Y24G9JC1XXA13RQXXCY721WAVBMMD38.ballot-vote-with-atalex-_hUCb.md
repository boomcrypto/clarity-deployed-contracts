---
title: "Trait ballot-vote-with-atalex-_hUCb"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with atALEX) Approve ALEX Governance Proposal: Nakatomo Release Emissions Adjustment")
    (var-set description u"This proposal is to approve the ALEX Governance Proposal: Nakatomo Release Emissions Adjustment. Proposal on Medium: https://medium.com/alexgobtc/alex-governance-proposal-nakamoto-release-emissions-adjustment-8ab727e352bcAMA: https://twitter.com/i/spaces/1yoJMwrRbXkKQ?s=20Vote to either approve or disapprove the ALEX Governance Proposal: Nakatomo Release Emissions Adjustment. => Vote with ALEX and atALEX <=As Ballot.gg does not support a voting strategy that involves two tokens (ALEX and atALEX) with differ")
    (var-set voting-system "fptp")
    (var-set options (list "4a39590e-5de4-4395-a904-a03c822268cf" "09319e1a-7626-4a06-b954-5e9556ad2833"))
    (var-set start u140858)
    (var-set end u141866)
    (map-set results {id: "4a39590e-5de4-4395-a904-a03c822268cf"} {count: u0, name: u"Approve ALEX Governance Proposal: Nakatomo Release Emissions Adjustment"}) (map-set results {id: "09319e1a-7626-4a06-b954-5e9556ad2833"} {count: u0, name: u"Disapprove ALEX Governance Proposal: Nakatomo Release Emissions Adjustment"})
```
