---
title: "Trait derupt-core-20230916"
draft: true
---
```
...
(define-private (log-like-message 
  ...
  (contract-call? .derupt-sentiment log-like-message tx-sender author-principal like-total liked-txid contractId pay-dev pay-gaia dev-total gaia-total dev-principal gaia-principal)
)
...
(define-private (log-dislike-message 
  ...
  (contract-call? .derupt-sentiment log-dislike-message tx-sender author-principal dislike-total disliked-txid cityName contractId pay-dev pay-gaia dev-total gaia-total dev-principal gaia-principal)
)
