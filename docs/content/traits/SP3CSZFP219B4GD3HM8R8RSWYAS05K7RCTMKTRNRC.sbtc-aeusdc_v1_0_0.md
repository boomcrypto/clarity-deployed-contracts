---
title: "Trait sbtc-aeusdc_v1_0_0"
draft: true
---
```
(impl-trait 'SP2AKWJYC7BNY18W1XXKPGP0YVEK63QJG4793Z2D4.sip-010-trait-ft-standard.sip-010-trait)
(impl-trait 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.ft-plus-trait.ft-plus-trait)
...
(define-private (check-owner)
  (ok (asserts! (is-eq contract-caller .gl-core) err-check-owner)))
...
(define-read-only (get-name)                   (ok "sbtc-aeusdc"))
(define-read-only (get-symbol)                 (ok "sbtc-aeusdc"))
