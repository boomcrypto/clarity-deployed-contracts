...
(define-fungible-token token-63)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-63 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-63)))
