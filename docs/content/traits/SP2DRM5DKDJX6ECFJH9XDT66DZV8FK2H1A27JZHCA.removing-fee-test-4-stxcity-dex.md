---
title: "Trait removing-fee-test-4-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP2DRM5DKDJX6ECFJH9XDT66DZV8FK2H1A27JZHCA.removing-fee-test-4-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u999901970395059)
    (var-set stx-balance u98039)
