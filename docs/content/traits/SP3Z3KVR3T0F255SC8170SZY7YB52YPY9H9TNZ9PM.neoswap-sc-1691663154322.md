---
title: "Trait neoswap-sc-1691663154322"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/QFT9ogLYwQpPeIE8eI2v
;; SwapId: Vy9sqBnXsEcpWG8NnmUK
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u25000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u25000 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u25000 tx-sender TRADER-1)))
