---
title: "Trait neoswap-sc-1653390869528"
draft: true
---
```
...
(define-constant agent-4 'SP3KTNQFHQ4N5DH40F1164TGYMX3QG2N8NA5VKN4X)
...
(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.stacks-punks-v3 transfer u2248 tx-sender agent-1)))
		(as-contract (stx-transfer? u3100000 tx-sender agent-1)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP187Y7NRSG3T9Z9WTSWNEN3XRV1YSJWS81C7JKV7.easter-bunnies transfer u10 tx-sender agent-2)))
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u13000000 tx-sender agent-3)))
	)
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4650000 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.belles-witches transfer u4282 tx-sender agent-1)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPZW30K9VG6YCPYV4BX4V1FT0VJ66R1Q01W9DQ1W.htl transfer u131 tx-sender agent-3)))
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP187Y7NRSG3T9Z9WTSWNEN3XRV1YSJWS81C7JKV7.easter-bunnies transfer u10 tx-sender agent-4)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SP187Y7NRSG3T9Z9WTSWNEN3XRV1YSJWS81C7JKV7.easter-bunnies transfer u10 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
