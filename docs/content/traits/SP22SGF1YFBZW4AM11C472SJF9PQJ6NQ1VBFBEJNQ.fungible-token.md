...
(define-fungible-token apple-coin)
...
(define-constant TOKEN_NAME "Apple Coin")
...
(define-public (mint (amount uint) (recipient principal))
  (begin
    ...
    (ft-mint? apple-coin u100000000 tx-sender)
  )
)
...
(define-public (transfer
  ...
  (begin
    ...
    (try! (ft-transfer? apple-coin amount sender recipient))
