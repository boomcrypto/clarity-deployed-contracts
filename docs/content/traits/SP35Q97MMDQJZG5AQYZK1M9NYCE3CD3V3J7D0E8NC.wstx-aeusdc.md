---
title: "Trait wstx-aeusdc"
draft: true
---
```
;;; wstx-aeusdc LP token.

(impl-trait 'SP35Q97MMDQJZG5AQYZK1M9NYCE3CD3V3J7D0E8NC.sip-010-trait-ft-standard.sip-010-trait)
...
(define-read-only (get-name)                   (ok "wstx-aeusdc"))
(define-read-only (get-symbol)                 (ok "wstx-aeusdc"))
