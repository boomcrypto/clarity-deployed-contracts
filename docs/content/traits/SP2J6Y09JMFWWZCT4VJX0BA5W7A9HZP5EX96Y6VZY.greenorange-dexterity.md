---
title: "Trait greenorange-dexterity"
draft: true
---
```
;; Green&Orange - LP Token, AMM DEX and Hold-to-Earn Engine
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.greenorange-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    (sender tx-sender)
    (reserve-in (unwrap-panic (if forward (contract-call? 'SP3M31QFF6S96215K4Y2Z9K5SGHJN384NV6YM6VM8.satoshai get-balance CONTRACT) 
      (contract-call? 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.ststx-token get-balance CONTRACT))))
    (reserve-out (unwrap-panic (if forward (contract-call? 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.ststx-token get-balance CONTRACT) 
      (contract-call? 'SP3M31QFF6S96215K4Y2Z9K5SGHJN384NV6YM6VM8.satoshai get-balance CONTRACT))))
    ...
    ;; Execute the swap
    (try! (if forward (contract-call? 'SP3M31QFF6S96215K4Y2Z9K5SGHJN384NV6YM6VM8.satoshai transfer amt-in sender CONTRACT none) 
      (contract-call? 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.ststx-token transfer amt-in sender CONTRACT none)))
    (try! (as-contract (if forward (contract-call? 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.ststx-token transfer amt-out CONTRACT sender none)
      (contract-call? 'SP3M31QFF6S96215K4Y2Z9K5SGHJN384NV6YM6VM8.satoshai transfer amt-out CONTRACT sender none))))
    (ok {amt-in: amt-in, amt-out: amt-out})))

(define-public (mint (who principal) (amount uint))
  (let (
    (reserve0 (unwrap-panic (contract-call? 'SP3M31QFF6S96215K4Y2Z9K5SGHJN384NV6YM6VM8.satoshai get-balance CONTRACT)))
    (reserve1 (unwrap-panic (contract-call? 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.ststx-token get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SP3M31QFF6S96215K4Y2Z9K5SGHJN384NV6YM6VM8.satoshai transfer token0-amount who CONTRACT none))
    (try! (contract-call? 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.ststx-token transfer token1-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SP3M31QFF6S96215K4Y2Z9K5SGHJN384NV6YM6VM8.satoshai transfer token0-amount CONTRACT who none)))
    (try! (as-contract (contract-call? 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.ststx-token transfer token1-amount CONTRACT who none)))
    (ok {token0-amount: token0-amount, token1-amount: token1-amount, lp-amount: amount})))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP3M31QFF6S96215K4Y2Z9K5SGHJN384NV6YM6VM8.satoshai, token1: 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.ststx-token}))
...
(define-read-only (get-reserves)
  (ok {
    token0: (unwrap-panic (contract-call? 'SP3M31QFF6S96215K4Y2Z9K5SGHJN384NV6YM6VM8.satoshai get-balance CONTRACT)),
    token1: (unwrap-panic (contract-call? 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.ststx-token get-balance CONTRACT))
  }))
