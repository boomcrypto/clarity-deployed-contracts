---
title: "Trait pontis-bridge-ZBIT"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "ZBIT.BLUE.BITCOIN")
(define-data-var token-symbol (string-ascii 10) "ZBIT")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmYDk8rcUfJzEQA831JYunZtrqZhNYorUqb2Xw4kfBasvH"))
;; 840022:28
