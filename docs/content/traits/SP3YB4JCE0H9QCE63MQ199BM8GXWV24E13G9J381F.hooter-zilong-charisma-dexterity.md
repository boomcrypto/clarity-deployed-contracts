---
title: "Trait hooter-zilong-charisma-dexterity"
draft: true
---
```
;; Hooter  Zilong Charisma - LP Token, AMM DEX and Hold-to-Earn Engine
;; SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.hooter-zilong-charisma-dexterity
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.hooter-zilong-charisma-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    ...
    (reserve-out (unwrap-panic (if forward (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity get-balance CONTRACT) 
    ...
    (try! (if forward (contract-call? 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dme000-governance-token transfer amt-in sender CONTRACT none) 
      (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity transfer amt-in sender CONTRACT none)))
    (try! (as-contract (if forward (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity transfer amt-out CONTRACT sender none)
...
(define-public (mint (who principal) (amount uint))
  (let (
    ...
    (reserve1 (unwrap-panic (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity transfer token1-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity transfer token1-amount CONTRACT who none)))
    (ok {token0-amount: token0-amount, token1-amount: token1-amount, lp-amount: amount})))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dme000-governance-token, token1: 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity}))
...
(define-read-only (get-reserves)
  (ok {
    ...
    token1: (unwrap-panic (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity get-balance CONTRACT))
  }))
