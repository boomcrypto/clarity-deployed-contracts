---
title: "Trait swt-faktory-dex"
draft: true
---
```

  ;; da1cbb71f930fe484e9c08bbb1b4178aa6d4b2d39151579067deedab7a697914
  ...
  (define-constant DEX-TOKEN 'SP2KSQNEN2TYH3NSH1CRQRNZ0XAQNTZCXCG2JKHDG.swt-faktory)
              ...
              (try! (as-contract 
                     (contract-call? 
                       'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-core-v-1-2 
                           create-pool 
                           'SP2KSQNEN2TYH3NSH1CRQRNZ0XAQNTZCXCG2JKHDG.xyk-pool-stx-swt-v-1-1
    ...
    (begin
      ...
      (try! (stx-transfer? u500000 tx-sender 'SMH8FRN30ERW1SX26NJTJCKTDR3H27NRJ6W75WQE))
        (print { 
            ...
            poolName: 'SP2KSQNEN2TYH3NSH1CRQRNZ0XAQNTZCXCG2JKHDG.xyk-pool-stx-swt-v-1-1
       })
      (ok true))
```
