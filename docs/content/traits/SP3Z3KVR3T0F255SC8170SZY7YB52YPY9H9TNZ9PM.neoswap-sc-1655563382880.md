---
title: "Trait neoswap-sc-1655563382880"
draft: true
---
```
...
(define-constant agent-2 'SP3Z8BFPY69R5SR3CHGA0QMRKP504KWSPJ9J0XGGX)
...
(begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3925000 tx-sender agent-2)))
	)
	(unwrap-panic (begin
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4075000 tx-sender agent-1)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u4075000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
