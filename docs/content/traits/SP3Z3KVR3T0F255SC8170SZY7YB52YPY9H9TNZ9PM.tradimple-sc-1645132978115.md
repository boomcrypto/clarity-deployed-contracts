---
title: "Trait tradimple-sc-1645132978115"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.afro-king transfer u3 tx-sender agent-4)))
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u7200000 tx-sender agent-3)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u1425 tx-sender agent-6)))
