---
title: "Trait neoswap-sc-1663693760763"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u125 tx-sender agent-6)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u125 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u5125 tx-sender agent-3)))
	)
