---
title: "Trait spaghettipunk-nft-staking"
draft: true
---
```
...
(define-read-only (check-collect (staker principal))
  (let (
      ...
      (to-collect (fold + (map check-collect-one staker-collections staker-addresses ) u0))
...
(print (bonus-add (list 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-bulls 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-bears 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.bitcoin-whales) u288 block-height u4032))
```
