---
title: "Trait the-funworld-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP9C39XV8GD9XBQ41JDYG37ZP7PFPHYHQ89HHRAA.the-funworld-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u99940368913215120)
    (var-set stx-balance u1193333)
