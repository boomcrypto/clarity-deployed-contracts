---
title: "Trait neoswap-sc-1662151379821"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u6020000 tx-sender agent-1)))
	)
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u2882 tx-sender agent-5)))
