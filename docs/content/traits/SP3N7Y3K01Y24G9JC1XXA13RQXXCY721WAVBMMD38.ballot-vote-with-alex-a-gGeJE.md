---
title: "Trait ballot-vote-with-alex-a-gGeJE"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with ALEX) Approve ALEX Governance Proposal for $XLNK and Tokenomics")
    ...
    (var-set options (list "7e46cdd6-62ca-4e56-b8d7-392d735226f4" "fe43b9be-85b5-4e88-bcbf-ddca7f0ec542"))
    (var-set start u138816)
    (var-set end u139824)
    (map-set results {id: "7e46cdd6-62ca-4e56-b8d7-392d735226f4"} {count: u0, name: u"Approve ALEX Governance Proposal for $XLNK and Tokenomics"}) (map-set results {id: "fe43b9be-85b5-4e88-bcbf-ddca7f0ec542"} {count: u0, name: u"Disapprove ALEX Governance Proposal for $XLNK and Tokenomics"})
```
