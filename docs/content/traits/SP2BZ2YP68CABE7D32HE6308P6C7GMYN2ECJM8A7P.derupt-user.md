...
(define-public (registration-activation (member principal))
  (let 
    (
      ...
      (asserts! (is-eq caller "derupt-member") unauthorized-user)
...
(define-public (activate-member (contract-address <derupt-user-trait>)) 
  (contract-call? 'SP3T3JC6V4S94PPB7WFEK17863HPG3EYP6CJ65E7M.derupt-member activate-member contract-address)
)
