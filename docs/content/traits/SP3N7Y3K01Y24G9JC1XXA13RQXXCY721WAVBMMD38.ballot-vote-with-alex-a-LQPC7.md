---
title: "Trait ballot-vote-with-alex-a-LQPC7"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with ALEX) Approve Launch of Ordiswap on the ALEX Launchpad")
    ...
    (var-set options (list "b288ba8b-9d29-41ca-aab9-a51352403972" "061fe1f1-d9e8-4058-bb13-6386b53d7e43"))
    (var-set start u133894)
    (var-set end u134326)
    (map-set results {id: "b288ba8b-9d29-41ca-aab9-a51352403972"} {count: u0, name: u"Approve Launch of Ordiswap on the ALEX Launchpad"}) (map-set results {id: "061fe1f1-d9e8-4058-bb13-6386b53d7e43"} {count: u0, name: u"Disapprove Launch of Ordiswap on the ALEX Launchpad"})
```
