...
(define-non-fungible-token monkey-poker-pass uint)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmYhm9Ja9n9TKFo497DVAGYKu7oFHS9SuVMjgGKVHjFXkh/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? monkey-poker-pass next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? monkey-poker-pass token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? monkey-poker-pass token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? monkey-poker-pass token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? monkey-poker-pass id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? monkey-poker-pass id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? monkey-poker-pass id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-banana uint u915000000)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? monkey-poker-pass (+ last-nft-id u0) 'SP3TZ3BCB16A0W0PPFYMGTTWTT3DVWTQEP8DFRAG1))
      (map-set token-count 'SP3TZ3BCB16A0W0PPFYMGTTWTT3DVWTQEP8DFRAG1 (+ (get-balance 'SP3TZ3BCB16A0W0PPFYMGTTWTT3DVWTQEP8DFRAG1) u1))
      (try! (nft-mint? monkey-poker-pass (+ last-nft-id u1) 'SP1DPNP3RRD6JG1557SP6JMX68W5BV6R2Z74BQEXV))
      (map-set token-count 'SP1DPNP3RRD6JG1557SP6JMX68W5BV6R2Z74BQEXV (+ (get-balance 'SP1DPNP3RRD6JG1557SP6JMX68W5BV6R2Z74BQEXV) u1))
      (try! (nft-mint? monkey-poker-pass (+ last-nft-id u2) 'SP2RKVC8PYANWJ40VSRCK2K935HSN4H0AHTVHD73D))
      (map-set token-count 'SP2RKVC8PYANWJ40VSRCK2K935HSN4H0AHTVHD73D (+ (get-balance 'SP2RKVC8PYANWJ40VSRCK2K935HSN4H0AHTVHD73D) u1))
      (try! (nft-mint? monkey-poker-pass (+ last-nft-id u3) 'SP1DMPD0JNAVDRCTY17S2MNHX8F6502NB0Z25RVR))
      (map-set token-count 'SP1DMPD0JNAVDRCTY17S2MNHX8F6502NB0Z25RVR (+ (get-balance 'SP1DMPD0JNAVDRCTY17S2MNHX8F6502NB0Z25RVR) u1))
      (try! (nft-mint? monkey-poker-pass (+ last-nft-id u4) 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX))
      (map-set token-count 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX (+ (get-balance 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX) u1))
      (try! (nft-mint? monkey-poker-pass (+ last-nft-id u5) 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX))
      (map-set token-count 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX (+ (get-balance 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX) u1))
      (try! (nft-mint? monkey-poker-pass (+ last-nft-id u6) 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX))
      (map-set token-count 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX (+ (get-balance 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX) u1))
      (try! (nft-mint? monkey-poker-pass (+ last-nft-id u7) 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX))
      (map-set token-count 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX (+ (get-balance 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX) u1))
      (try! (nft-mint? monkey-poker-pass (+ last-nft-id u8) 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX))
      (map-set token-count 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX (+ (get-balance 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX) u1))
      (try! (nft-mint? monkey-poker-pass (+ last-nft-id u9) 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX))
      (map-set token-count 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX (+ (get-balance 'SP1335DXY4JFH44F47CHNM9E5D7430762C5FA0SCX) u1))
