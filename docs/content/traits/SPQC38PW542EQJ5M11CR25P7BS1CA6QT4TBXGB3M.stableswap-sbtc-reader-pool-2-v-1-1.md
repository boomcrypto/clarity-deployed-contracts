---
title: "Trait stableswap-sbtc-reader-pool-2-v-1-1"
draft: true
---
```
;; stableswap-sbtc-reader-pool-2-v-1-1
...
(define-read-only (get-user-sbtc-balance (user principal))
  (let (
    ...
    (user-staking-data (unwrap! (contract-call? 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.stableswap-staking-sbtc-pbtc-v-1-1 get-user
                                user) ERR_NO_USER_DATA))
