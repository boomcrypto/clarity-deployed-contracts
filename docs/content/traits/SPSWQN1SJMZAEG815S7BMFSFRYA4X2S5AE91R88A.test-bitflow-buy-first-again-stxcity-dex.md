---
title: "Trait test-bitflow-buy-first-again-stxcity-dex"
draft: true
---
```
...
(define-constant STX_TARGET_AMOUNT u9000000000)
(define-constant VIRTUAL_STX_VALUE u1800000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u180000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SPSWQN1SJMZAEG815S7BMFSFRYA4X2S5AE91R88A.test-bitflow-buy-first-again-stxcity)
...
(var-set token-balance u68997444539091144)
