---
title: "Trait skinny-melons-summer-2024"
draft: true
---
```
;; skinny-melons-summer-2024
;; contractType: public

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token skinny-melons-summer-2024 uint)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmcY8PA6cojTHtDxZ7sa9XUKJNHb7GzSy9ApLmVXYp1jYx/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? skinny-melons-summer-2024 next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? skinny-melons-summer-2024 token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? skinny-melons-summer-2024 token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? skinny-melons-summer-2024 token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? skinny-melons-summer-2024 id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? skinny-melons-summer-2024 id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? skinny-melons-summer-2024 id) (err ERR-NOT-FOUND)))
