---
title: "Trait anime-contest-2021"
draft: true
---
```
;; Stacks Anime Contest 2021

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

;; Non Fungible Token, using sip-009
(define-non-fungible-token anime-contest-2021 uint)
...
(define-data-var artist-address principal 'SP33SE5XKAY043VN4ZNYCZB7G7AQ2QT1K9K3J70Z2)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmeRmZmaeZp5iREujshhUU4CzsYPwHCWWaCrto2Thn74ui/")
...
(define-private (mint-helper (new-owner principal) (next-id uint))
    (match (nft-mint? anime-contest-2021 next-id new-owner)
            success
              (begin
...
(define-public (transfer (token-id uint) (sender principal) (recipient principal))
  (if (and
      ...
      (match (nft-transfer? anime-contest-2021 token-id sender recipient)
        success (ok success)
        error (err error))
      (err err-invalid-user)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? anime-contest-2021 token-id)))
