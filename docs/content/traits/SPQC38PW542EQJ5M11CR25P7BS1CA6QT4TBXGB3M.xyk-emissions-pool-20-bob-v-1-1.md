---
title: "Trait xyk-emissions-pool-20-bob-v-1-1"
draft: true
---
```
;; xyk-emissions-pool-20-bob-v-1-1
...
(define-private (get-external-user-data (user principal) (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.xyk-staking-stx-bob-v-1-1 get-user-at-cycle
...
(define-private (get-external-cycle-data (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.xyk-staking-stx-bob-v-1-1 get-lp-staked-at-cycle
