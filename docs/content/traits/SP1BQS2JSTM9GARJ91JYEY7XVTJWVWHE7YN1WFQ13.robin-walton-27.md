...
(define-public (swap-alex-stackswap
    ...
    (let
        ...
        (let
            (
                (balance-before (stx-get-balance (as-contract tx-sender)))
                (y-amount (unwrap-panic (swap-alex (unwrap-panic (contract-call? stackswap-token-x-trait get-decimals)) alex-token-x-trait alex-token-y-trait (alex-number dx (unwrap-panic (contract-call? stackswap-token-x-trait get-decimals)) (unwrap-panic (contract-call? alex-token-x-trait get-decimals))))))
