---
title: "Trait ape-with-keys-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP1B87D0S1Z9G97K3QTXQW689Z54EEE46DSZ1F8H9.ape-with-keys-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u998967733342213)
    (var-set stx-balance u1033333)
