---
title: "Trait btc-peg-in-v2-07a-swap"
draft: true
---
```
...
(define-public (finalize-peg-in-cross-swap
	...
	(let (
		...
		(try! (contract-call? 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.btc-peg-out-endpoint-v2-01 set-peg-out-fee (var-get btc-peg-outfee)))
