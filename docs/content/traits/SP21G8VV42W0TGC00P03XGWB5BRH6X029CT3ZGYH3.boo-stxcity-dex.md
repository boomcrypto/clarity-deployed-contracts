...
(define-constant allow-token 'SP21G8VV42W0TGC00P03XGWB5BRH6X029CT3ZGYH3.boo-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u99963346772849)
    (var-set stx-balance u220000)
