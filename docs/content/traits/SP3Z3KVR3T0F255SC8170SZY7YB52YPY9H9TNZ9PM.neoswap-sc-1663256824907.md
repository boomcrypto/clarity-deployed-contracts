---
title: "Trait neoswap-sc-1663256824907"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u266750 tx-sender agent-0)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u2898375 tx-sender agent-2)))
	)
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1368375 tx-sender agent-3)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u2898375 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (stx-transfer? u1368375 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
