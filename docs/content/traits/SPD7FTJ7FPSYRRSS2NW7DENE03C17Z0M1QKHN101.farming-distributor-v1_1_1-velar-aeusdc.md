---
title: "Trait farming-distributor-v1_1_1-velar-aeusdc"
draft: true
---
```
...
(define-public
  ...
  (let ((epoch (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.farming-velar-aeusdc-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.farming-velar-aeusdc-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.farming-velar-aeusdc-core current-epoch))
