---
title: "Trait neoswap-sc-1690142416868"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/sARnX7PoLX0ZcF7kHxZU
;; SwapId: Xv6wwBzQGk5Vptvvxz6M
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u3082692 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (contract-call? 'SP3D6PV2ACBPEKYJTCMH7HEN02KP87QSP8KTEH335.megapont-robot-component-nft transfer u27533 tx-sender TRADER-2)))

	(unwrap-panic (as-contract (stx-transfer? u3082692 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u3082692 tx-sender TRADER-1)))
