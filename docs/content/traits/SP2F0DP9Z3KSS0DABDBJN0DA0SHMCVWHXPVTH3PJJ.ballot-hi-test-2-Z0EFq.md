---
title: "Trait ballot-hi-test-2-Z0EFq"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Hi test 2")
    (var-set description u"test test test")
    (var-set voting-system "block")
    (var-set options (list "ea721313-5e70-41ad-8fc6-97d7cc00c643" "c8bed449-52e0-461c-b8d9-abdd27ad2790" "7c3c4322-bbb5-4660-bdb5-369b9890ab09" "e74a6d39-1c9f-4502-94dd-6357a695c23b"))
    (var-set start u117291)
    (var-set end u117718)
    (map-set results {id: "ea721313-5e70-41ad-8fc6-97d7cc00c643"} {count: u0, name: u"Proposal 1 - Nigeria Chapter"}) (map-set results {id: "c8bed449-52e0-461c-b8d9-abdd27ad2790"} {count: u0, name: u"Proposal 2 - Nepal Chapter"}) (map-set results {id: "7c3c4322-bbb5-4660-bdb5-369b9890ab09"} {count: u0, name: u"Proposal 3 - Art Curator"}) (map-set results {id: "e74a6d39-1c9f-4502-94dd-6357a695c23b"} {count: u0, name: u"Proposal 4 - 3D Ordinals Gallery"})
```
