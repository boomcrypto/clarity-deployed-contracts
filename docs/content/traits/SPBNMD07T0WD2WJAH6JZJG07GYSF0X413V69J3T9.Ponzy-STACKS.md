...
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmNY58GUng9euaEmZJtBo9hK7rYzgXzp7muAFwiearYvRF"))
...
(begin
  (try! (ft-mint? PonzyStacks u2000000000000000 contract-creator))
)
```
