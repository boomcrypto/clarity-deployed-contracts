---
title: "Trait sweet-yamz-faktory-dex"
draft: true
---
```

;; b776d49366c5d57468c48933d4043fe6480d8483a293aa95ce56e0749fd0976a
...
(define-constant DEX-TOKEN 'SP2Z2CBMGWB9MQZAF5Z8X56KS69XRV3SJF4WKJ7J9.sweet-yamz-faktory)
(define-constant AUTHORIZED-CONTRACT 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.buy-with-velar-faktory)

;; token constants
(define-constant TARGET_STX u3000000000)
(define-constant FAK_STX u750000000)
(define-constant GRAD-FEE u60000000)
...
;; boot dex
  (begin
    ...
    (var-set ft-balance u67794759766119)
    (var-set stx-balance u13333334)
    (var-set open true)
