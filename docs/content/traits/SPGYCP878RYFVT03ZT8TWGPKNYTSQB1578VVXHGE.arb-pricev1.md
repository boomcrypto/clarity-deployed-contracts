...
(define-read-only (reserves)
    (let (
        ...
        (s-p (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.univ2-core get-pool u11)) ;; velar stx-pepe
        ...
        (c-p (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.univ2-core get-pool u12)) ;; chadex cha-pepe
        (s-ss-c-w (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.univ2-core get-pool u13)) ;; chadex s-ss-c-w
        (c-w-iw (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.univ2-core get-pool u11)) ;; chadex c-w-iw
    )
    {
...
(define-public (call-me)
    ...
    (ok {
        ...
        supplies: {
            cha-welsh: (get cha-welsh supplies),
            welsh-iou: (get welsh-iou supplies),
            wstx-synstx: (get wstx-synstx supplies)
        }
    }))
)
```
