---
title: "Trait tradimple-sc-1645460239190"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u651 tx-sender agent-2)))
	(unwrap-panic (begin
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u4600000 tx-sender agent-4)))
	)
	(unwrap-panic (begin
...
(begin        
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u651 tx-sender agent-4)))
