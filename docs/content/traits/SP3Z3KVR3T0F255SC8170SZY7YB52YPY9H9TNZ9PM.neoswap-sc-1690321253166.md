---
title: "Trait neoswap-sc-1690321253166"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/1m8ouNppq48OR8cuw7fl
;; SwapId: kT1AKfBflAvyV60Ls63R

;; traders
(define-constant TRADER-1 'SP3ZDQ9E9FJGYHADCBEKEJ64F8SETMQS1R20YM0XN)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u585000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u585000 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u585000 tx-sender TRADER-2)))
