---
title: "Trait simulation-coin-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.simulation-coin-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u900360144057623)
