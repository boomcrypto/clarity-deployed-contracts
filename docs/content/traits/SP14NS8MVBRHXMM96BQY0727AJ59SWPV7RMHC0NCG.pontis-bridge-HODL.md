---
title: "Trait pontis-bridge-HODL"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "HODL.DIAMOND.DICK")
(define-data-var token-symbol (string-ascii 10) "HODL")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmNi43jNUt91FkCDCzVbSmQ86woyxTvFCJCQPCRa4qwDrE"))
;; 840000:52
