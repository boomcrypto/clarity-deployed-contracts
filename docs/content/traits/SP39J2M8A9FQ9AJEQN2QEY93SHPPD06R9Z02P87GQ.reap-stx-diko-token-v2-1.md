---
title: "Trait reap-stx-diko-token-v2-1"
draft: true
---
```
...
(define-private (check-is-approved)
  (ok (asserts! (is-eq contract-caller .arkadiko-stx-diko-pool-v2-1) ERR-NOT-AUTHORIZED))
)
...
(define-public (mint (amount uint) (recipient principal))
	(begin
		(asserts! (is-eq contract-caller .arkadiko-stx-diko-pool) ERR-NOT-AUTHORIZED)
