...
```
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-ft-holdings)
            (at-block (unwrap-panic (get-block-info? id-header-hash u178437))
                (let
                    (
    ...
    (var-set options (list "edebd737-c26a-401b-a99b-a8b4ae6d2d30" "a797939b-1e78-4b7c-821d-48bee1d56a03"))
    (var-set start u178438)
    (var-set end u178440)
    (map-set results {id: "edebd737-c26a-401b-a99b-a8b4ae6d2d30"} {count: u0, name: u"Choice%201"}) (map-set results {id: "a797939b-1e78-4b7c-821d-48bee1d56a03"} {count: u0, name: u"Choice%202"})
