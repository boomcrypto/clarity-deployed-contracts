---
title: "Trait fiftysats2-pre-faktory"
draft: true
---
```

      ;; ab21856724da0f0f4ac700b31106535d1dd4ba7b6cd34a599b3f6c069900f513
      ...
      (define-constant PRICE-PER-SEAT u6900) ;; 69K sats per seat - revert this for launch u69000
      (define-constant TOKENS-PER-SEAT u1000000000000000) ;; 10M tokens per seat if supply 1B
      (define-constant DEX-AMOUNT u100000)
      (define-constant MULTI-SIG-AMOUNT u3000)
      (define-constant FEE-AMOUNT u35000)
      ...
      (define-constant VESTING-SCHEDULE
          (list 
              ...
              {height: u1, percent: u10, id: u0}    ;; 10% at initial unlock
              
              ;; Second phase - 20% total across 6 drips
              {height: u2, percent: u3, id: u1}     ;; 3%
              {height: u3, percent: u3, id: u2}     ;; 3%
              {height: u4, percent: u3, id: u3}     ;; 3%
              {height: u5, percent: u3, id: u4}     ;; 3%
              {height: u6, percent: u4, id: u5}     ;; 4%
              {height: u7, percent: u4, id: u6}    ;; 4% - hitting 30% total at original second milestone
              
              ;; Third phase - 30% total across 7 drips
              {height: u8, percent: u4, id: u7}    ;; 4%
              {height: u9, percent: u4, id: u8}    ;; 4%
              {height: u10, percent: u4, id: u9}    ;; 4%
              {height: u11, percent: u4, id: u10}   ;; 4%
              {height: u12, percent: u4, id: u11}   ;; 4%
              {height: u13, percent: u5, id: u12}   ;; 5%
              {height: u14, percent: u5, id: u13}   ;; 5% - hitting 60% total at original third milestone
              
              ;; Final phase - 40% total across 7 drips
              {height: u15, percent: u5, id: u14}   ;; 5%
              {height: u16, percent: u5, id: u15}   ;; 5%
              {height: u17, percent: u6, id: u16}   ;; 6%
              {height: u18, percent: u6, id: u17}   ;; 6%
              {height: u19, percent: u6, id: u18}   ;; 6%
              {height: u21, percent: u6, id: u19}   ;; 6%
              {height: u21, percent: u6, id: u20})) ;; 6% - hitting 100% total at original final milestone
      ...
      ;; Token, Dex and sBTC
      (define-constant TOKEN-DAO 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fiftysats2-faktory) ;; param
      (define-constant DEX-DAO 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fiftysats2-faktory-dex) ;; param
  ...
  ;; Constants
  (define-constant COOLDOWN-PERIOD u2) ;; Longer cooldown between airdrops
