...
(define-fungible-token token-14)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-14 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-14)))
