---
title: "Trait bitcoin-monkeys-eggs-collection-wrapper"
draft: true
---
```
...
(define-public (buy-item (collection <marketplace>) (item-id uint) (comm <commission-trait>) (referer uint))
    (let (
        (item (contract-call? 'SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.bitcoin-monkeys-eggs-collection get-listing-in-ustx item-id))
