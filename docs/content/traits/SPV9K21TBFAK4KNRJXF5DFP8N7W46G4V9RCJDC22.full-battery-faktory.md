---
title: "Trait full-battery-faktory"
draft: true
---
```

;; 7bd2c5be703ed7c0131e8e6621c39f1f513d34fc5c65f54cde539b759d0b66ba
;; full Powered By Faktory.fun v1.0 
...
(define-fungible-token FULL MAX)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       (asserts! (is-eq tx-sender sender) (err ERR-NOT-AUTHORIZED))
        (ft-transfer? FULL amount sender recipient)
    )
)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance FULL account))
)
...
(begin 
    ...
    (try! (ft-mint? FULL u69000000000000 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.full-battery-faktory-dex)) ;; supply-left
