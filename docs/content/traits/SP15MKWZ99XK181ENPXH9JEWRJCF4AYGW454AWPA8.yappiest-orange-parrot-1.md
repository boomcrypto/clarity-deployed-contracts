---
title: "Trait yappiest-orange-parrot-1"
draft: true
---
```
...
(define-read-only (get-sbtc-rewards (who principal))
    (let (
        ...
        (reward-balance
            (unwrap-panic
                (convert-to sbtc wstx
                    ;; (unwrap-panic
                    ;;     (contract-call? 'SP2VCQJGH7PHP2DJK7Z0V48AGBHQAW3R3ZW1QF4N.zsbtc-v2-0 get-balance who)
                    ;; )
                    ;; (get-user-sbtc-balance who)
                    u10
                )
            )
        )
...
(define-read-only (get-user-sbtc-balance (who principal))
  (let (
        (principal
            ...
            (contract-call? 'SP2VCQJGH7PHP2DJK7Z0V48AGBHQAW3R3ZW1QF4N.zsbtc-token get-balance who)
        )
    )
