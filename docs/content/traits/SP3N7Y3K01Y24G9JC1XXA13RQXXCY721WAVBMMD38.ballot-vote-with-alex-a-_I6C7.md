---
title: "Trait ballot-vote-with-alex-a-_I6C7"
draft: true
---
```
    ...
    (var-set options (list "5013f53b-e37c-4859-90bf-20463a5ef18a" "bff6d168-eda9-46e8-8fa0-0f6a1dd09f2b"))
    (var-set start u132659)
    (var-set end u133091)
    (map-set results {id: "5013f53b-e37c-4859-90bf-20463a5ef18a"} {count: u0, name: u"Approve Launch of OrdzGames on the ALEX Launchpad"}) (map-set results {id: "bff6d168-eda9-46e8-8fa0-0f6a1dd09f2b"} {count: u0, name: u"Disapprove Launch of OrdzGames on the ALEX Launchpad"})
```
