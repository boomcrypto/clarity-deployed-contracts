---
title: "Trait curve-farming-distributor-1-v1_1_1_ststx"
draft: true
---
```
...
(define-public
  ...
  (let ((epoch (contract-call? .curve-farming-core-v1_1_1_ststx-0001 current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .curve-farming-core-v1_1_1_ststx-0001 get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .curve-farming-core-v1_1_1_ststx-0001 current-epoch))
