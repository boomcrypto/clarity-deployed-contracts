...
(define-constant token-supply u166688000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP1VPRWYNE48R5CX4HDE4K1ZHN8NR8MBE678WMR0K.scum-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u165842204755)
    (var-set stx-balance u2040000)
