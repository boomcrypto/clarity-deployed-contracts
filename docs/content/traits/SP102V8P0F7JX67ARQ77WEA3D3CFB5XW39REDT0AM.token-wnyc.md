---
title: "Trait token-wnyc"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token wnyc)
(define-data-var token-name (string-ascii 32) "NYC Wrapper")
(define-data-var token-symbol (string-ascii 32) "wnyc")
...
(define-read-only (get-base-decimals)
  (contract-call? 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-token-v2 get-decimals))
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-token-v2 get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-token-v2 transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
