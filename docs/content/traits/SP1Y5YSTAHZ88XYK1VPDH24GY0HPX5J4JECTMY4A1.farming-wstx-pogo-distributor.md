---
title: "Trait farming-wstx-pogo-distributor"
draft: true
---
```
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constants
(define-constant REWARD-TOKEN 'SP3J9X6APANYNVE9B9ZWB7WJADYHFJH97R6KE2MYG.Pogocoinbtc)
...
(define-public
  ...
  (let ((epoch (contract-call? .farming-wstx-pogo-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .farming-wstx-pogo-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .farming-wstx-pogo-core current-epoch))
