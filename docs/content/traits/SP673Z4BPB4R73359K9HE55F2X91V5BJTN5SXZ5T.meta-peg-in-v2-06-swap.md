---
title: "Trait meta-peg-in-v2-06-swap"
draft: true
---
```
...
(define-data-var btc-peg-out-fee uint u0)
...
(define-public (set-btc-peg-out-fee (fee uint))
	(begin
		(try! (is-dao-or-extension))
		(ok (var-set btc-peg-out-fee fee))))
  ...
  (let (
    ...
    (and (> amt-net u0) (if (get no-burn token-details) 
      ...
      (as-contract (try! (contract-call? token-trait mint-fixed amt-net tx-sender)))))
        ...
        (try! (contract-call? 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.btc-peg-out-endpoint-v2-01 set-peg-out-fee (var-get btc-peg-out-fee)))
        (try! (contract-call? 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.btc-peg-out-endpoint-v2-01 set-peg-out-min-fee (var-get btc-peg-out-min-fee)))
