...
(define-fungible-token token-27)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-27 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-27)))
