...
(define-non-fungible-token peekaboo uint)
...
(define-data-var artist-address principal 'SPYKWQVC6F9XTQAGEC0JPKSN55VHPCTC4ZF9EXNK)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmNozsbDJgoGU9C5xMTW1ipe6UGfPMJxvLvzto6KHyiTzY/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? peekaboo next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? peekaboo token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? peekaboo token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? peekaboo token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? peekaboo id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? peekaboo id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? peekaboo id) (err ERR-NOT-FOUND)))
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? peekaboo (+ last-nft-id u0) 'SP82G2Q9V9KE9XXRCJXJCEB1ZVQCA171D4HJHDRD))
      (map-set token-count 'SP82G2Q9V9KE9XXRCJXJCEB1ZVQCA171D4HJHDRD (+ (get-balance 'SP82G2Q9V9KE9XXRCJXJCEB1ZVQCA171D4HJHDRD) u1))
      (try! (nft-mint? peekaboo (+ last-nft-id u1) 'SPCGJT66SJ314GME2JRCZKTQ5KABKCJCH9HPS92H))
      (map-set token-count 'SPCGJT66SJ314GME2JRCZKTQ5KABKCJCH9HPS92H (+ (get-balance 'SPCGJT66SJ314GME2JRCZKTQ5KABKCJCH9HPS92H) u1))
      (try! (nft-mint? peekaboo (+ last-nft-id u2) 'SP21EVMSB2278F58564JNE3TC2TNSSDDPK2PQQYNG))
      (map-set token-count 'SP21EVMSB2278F58564JNE3TC2TNSSDDPK2PQQYNG (+ (get-balance 'SP21EVMSB2278F58564JNE3TC2TNSSDDPK2PQQYNG) u1))
      (try! (nft-mint? peekaboo (+ last-nft-id u3) 'SPY6HFEWRG719Q3Y147N0CBM1XHK0PKQG112JETV))
      (map-set token-count 'SPY6HFEWRG719Q3Y147N0CBM1XHK0PKQG112JETV (+ (get-balance 'SPY6HFEWRG719Q3Y147N0CBM1XHK0PKQG112JETV) u1))
      (try! (nft-mint? peekaboo (+ last-nft-id u4) 'SP3KSSFS1W8XZ2W989B9QPF7QK4MV2T5JD5EBBZ3N))
      (map-set token-count 'SP3KSSFS1W8XZ2W989B9QPF7QK4MV2T5JD5EBBZ3N (+ (get-balance 'SP3KSSFS1W8XZ2W989B9QPF7QK4MV2T5JD5EBBZ3N) u1))
      (try! (nft-mint? peekaboo (+ last-nft-id u5) 'SP2GDPJK7QQZGBA5CJ00GWJF50Z33TKK0W3EF6WJ5))
