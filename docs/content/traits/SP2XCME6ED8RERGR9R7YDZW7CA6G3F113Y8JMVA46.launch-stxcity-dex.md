---
title: "Trait launch-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u100000000000000) ;; match with the token's supply (use decimals)
...
(define-constant allow-token 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.launch-stxcity)
