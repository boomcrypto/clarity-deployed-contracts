---
title: "Trait liquidium-early-access-nft"
draft: true
---
```

;; liquidium-early-access-nft
...
(define-data-var base-uri (string-ascii 100) "ipfs://QmTjSpsevh4b8B7NMiWkfCEakCA8ktcLiB8bLfstDesa3o/{id}")
