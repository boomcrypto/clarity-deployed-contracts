...
(define-fungible-token apple-token)
...
(define-constant TOKEN_URI u"https://apple.io") ;; utf-8 string with token metadata host
(define-constant TOKEN_NAME "The Apple Token on Stacks")
(define-constant TOKEN_SYMBOL "APPLE")
...
(define-public (mint)
  (begin
    ...
    (ft-mint? apple-token u100000000 tx-sender)
  )
)
...
(define-public (transfer
  ...
  (begin
    ...
    (try! (ft-transfer? apple-token amount sender recipient))
