---
title: "Trait charisma-and-this-squad-dexterity"
draft: true
---
```
;; Charisma and this Squad - LP Token, AMM DEX and Hold-to-Earn Engine
;; SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.charisma-and-this-squad-dexterity
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.charisma-and-this-squad-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    (sender tx-sender)
    (reserve-in (unwrap-panic (if forward (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.hoot-dex get-balance CONTRACT) 
      (contract-call? 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.crow-with-bitcoin-dexterity get-balance CONTRACT))))
    (reserve-out (unwrap-panic (if forward (contract-call? 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.crow-with-bitcoin-dexterity get-balance CONTRACT) 
      (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.hoot-dex get-balance CONTRACT))))
    ...
    ;; Execute the swap
    (try! (if forward (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.hoot-dex transfer amt-in sender CONTRACT none) 
      (contract-call? 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.crow-with-bitcoin-dexterity transfer amt-in sender CONTRACT none)))
    (try! (as-contract (if forward (contract-call? 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.crow-with-bitcoin-dexterity transfer amt-out CONTRACT sender none)
      (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.hoot-dex transfer amt-out CONTRACT sender none))))
    (ok {amt-in: amt-in, amt-out: amt-out})))

(define-public (mint (who principal) (amount uint))
  (let (
    (reserve0 (unwrap-panic (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.hoot-dex get-balance CONTRACT)))
    (reserve1 (unwrap-panic (contract-call? 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.crow-with-bitcoin-dexterity get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.hoot-dex transfer token0-amount who CONTRACT none))
    (try! (contract-call? 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.crow-with-bitcoin-dexterity transfer token1-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.hoot-dex transfer token0-amount CONTRACT who none)))
    (try! (as-contract (contract-call? 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.crow-with-bitcoin-dexterity transfer token1-amount CONTRACT who none)))
    (ok {token0-amount: token0-amount, token1-amount: token1-amount, lp-amount: amount})))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.hoot-dex, token1: 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.crow-with-bitcoin-dexterity}))
...
(define-read-only (get-reserves)
  (ok {
    token0: (unwrap-panic (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.hoot-dex get-balance CONTRACT)),
    token1: (unwrap-panic (contract-call? 'SP2J6Y09JMFWWZCT4VJX0BA5W7A9HZP5EX96Y6VZY.crow-with-bitcoin-dexterity get-balance CONTRACT))
  }))
