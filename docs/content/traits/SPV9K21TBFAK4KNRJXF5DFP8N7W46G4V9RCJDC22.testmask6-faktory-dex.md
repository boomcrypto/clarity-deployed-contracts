---
title: "Trait testmask6-faktory-dex"
draft: true
---
```
;; 9b940a03b8f7d0de6ea883b98bd6a5d7a29f5a87b17d3a1f2aaeb60df2e401f8
  ...
  (define-constant DEX-TOKEN 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask6-faktory)
  ...
  (define-public (buy (ft <faktory-token>) (ubtc uint))
    (begin
      ...
      (let (
        ...
        (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
                    transfer pre-fee tx-sender 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask6-pre-faktory none))
        (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask6-pre-faktory create-fees-receipt pre-fee))) 
        (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
        ...
        (if (>= new-stx TARGET_STX)
            (let ((premium-amount (/ (* new-ft (var-get premium)) u100))
              ...
              (try! (as-contract 
                     (contract-call? 
                       'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-core-v-1-2 
                           create-pool 
                           'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.xyk-pool-sbtc-testmask6-v-1-1
              ...
              (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask6-pre-faktory toggle-bonded))) 
  ...
  (define-public (open-market) 
    (let ((is-prelaunch-allowing (unwrap-panic (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask6-pre-faktory is-market-open))))
    ...
    (begin
      ...
      (var-set ft-balance u16000000000000000)
        (print { 
            ...
            poolName: 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.xyk-pool-sbtc-testmask6-v-1-1
       })
      (ok true))
```
