---
title: "Trait moonib-bukelee-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP2TFBWDFE6YFESBJXG9FM2M00ZPRS2EF01X1YKCT.moonib-bukelee-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u9942004971002486)
    (var-set stx-balance u4666667)
