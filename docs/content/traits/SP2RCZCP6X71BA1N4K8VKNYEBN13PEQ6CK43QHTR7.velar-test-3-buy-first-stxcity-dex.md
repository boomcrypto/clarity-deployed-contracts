---
title: "Trait velar-test-3-buy-first-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u12939123819000000) ;; match with the token's supply (6 decimals)
(define-constant BONDING-DEX-ADDRESS (as-contract tx-sender)) ;; one contract per token

;; bonding curve config
(define-constant STX_TARGET_AMOUNT u11000000000)
(define-constant VIRTUAL_STX_VALUE u2200000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u220000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP2RCZCP6X71BA1N4K8VKNYEBN13PEQ6CK43QHTR7.velar-test-3-buy-first-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u12938339677201382)
    (var-set stx-balance u133333)
