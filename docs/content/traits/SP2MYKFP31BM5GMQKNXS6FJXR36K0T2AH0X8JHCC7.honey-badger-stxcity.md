---
title: "Trait honey-badger-stxcity"
draft: true
---
```
;;  ---------------------------------------------------------
...
(define-private (send-token (recipient { to: principal, amount: uint, memo: (optional (buff 34)) }))
  (send-token-with-memo (get amount recipient) (get to recipient) (get memo recipient))) (contract-call? 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dme002-proposal-submission propose 'SP2MYKFP31BM5GMQKNXS6FJXR36K0T2AH0X8JHCC7.list-odin (+ block-height u10)
)
