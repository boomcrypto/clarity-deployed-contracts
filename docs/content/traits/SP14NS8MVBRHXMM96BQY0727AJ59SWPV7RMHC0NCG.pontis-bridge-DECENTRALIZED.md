---
title: "Trait pontis-bridge-DECENTRALIZED"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "DECENTRALIZED")
(define-data-var token-symbol (string-ascii 13) "DECENTRALIZED")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmUpEa5JASseWydCJqLUoV46V3NWmkEGYPxVpiGPQ2xeSV"))
;; 840000:2
