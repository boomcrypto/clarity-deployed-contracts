...
(define-constant allow-token 'SP11CCZM51A5XR0JYWQ2GSHPQ5RMZRHDAZ230MVC9.alisa-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u950369588173178)
    (var-set stx-balance u31333333)
