---
title: "Trait other-azure-basilisk"
draft: true
---
```
(define-public (get-asset-price)
  (let (
    ...
    (ok {
      ststx-price: (/ (* stx-ststx (to-uint (get price pyth-entry))) u1000000),
      stx-price: (to-uint (get price pyth-entry)),
    })
  )
)
```
