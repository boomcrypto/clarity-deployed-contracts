---
title: "Trait stacks-mouse-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u111000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP2XNCG1PE6X2QAHWM11QKBQZJKN7EMS2HZKP9QHE.stacks-mouse-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u110219280099296)
    (var-set stx-balance u11333333)
