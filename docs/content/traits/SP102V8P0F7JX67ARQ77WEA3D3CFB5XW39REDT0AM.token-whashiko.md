---
title: "Trait token-whashiko"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token whashiko)
(define-data-var token-name (string-ascii 32) "Hashiko Wrapper")
(define-data-var token-symbol (string-ascii 32) "whashiko")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-whashiko.json"))
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP28NB976TJHHGF4218KT194NPWP9N1X3WY516Z1P.Hashiko get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
