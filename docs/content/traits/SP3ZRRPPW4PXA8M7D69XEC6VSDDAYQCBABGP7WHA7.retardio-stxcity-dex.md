---
title: "Trait retardio-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP3ZRRPPW4PXA8M7D69XEC6VSDDAYQCBABGP7WHA7.retardio-stxcity)
...
(var-set token-balance u67957977675640)
(var-set stx-balance u15333333)
