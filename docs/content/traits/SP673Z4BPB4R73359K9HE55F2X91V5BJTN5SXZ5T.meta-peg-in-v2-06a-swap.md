---
title: "Trait meta-peg-in-v2-06a-swap"
draft: true
---
```
...
(define-public (finalize-peg-in-cross-swap 
  ...
  (let (
    ...
    (and (is-some (get chain-id order-details)) (try! (update-peg-out-fee pair-tuple (var-get peg-out-fee) (var-get peg-out-gas-fee)))) 
