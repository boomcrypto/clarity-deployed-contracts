...
(define-fungible-token token-71)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-71 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-71)))
