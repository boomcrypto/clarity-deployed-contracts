...
(define-constant allow-token 'SPAJMEDR4VY80W67XW61EK02170N99M9XHFWSDJZ.moo-deng-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u949968334388853)
    (var-set stx-balance u52666667)
