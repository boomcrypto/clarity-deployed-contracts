---
title: "Trait charismatic-zil-mobile-legends-dexterity"
draft: true
---
```
;; Charismatic ZIL Mobile Legends - LP Token, AMM DEX and Hold-to-Earn Engine
;; SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    (sender tx-sender)
    (reserve-in (unwrap-panic (if forward (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend get-balance CONTRACT) 
    ...
    (reserve-out (unwrap-panic (if forward (contract-call? 'SP1KMAA7TPZ5AZZ4W67X74MJNFKMN576604CWNBQS.shark-coin-stxcity get-balance CONTRACT) 
      (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend get-balance CONTRACT))))
    ...
    ;; Execute the swap
    (try! (if forward (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend transfer amt-in sender CONTRACT none) 
    ...
    (try! (as-contract (if forward (contract-call? 'SP1KMAA7TPZ5AZZ4W67X74MJNFKMN576604CWNBQS.shark-coin-stxcity transfer amt-out CONTRACT sender none)
      (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend transfer amt-out CONTRACT sender none))))
    (ok {amt-in: amt-in, amt-out: amt-out})))

(define-public (mint (who principal) (amount uint))
  (let (
    (reserve0 (unwrap-panic (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend transfer token0-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend transfer token0-amount CONTRACT who none)))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend, token1: 'SP1KMAA7TPZ5AZZ4W67X74MJNFKMN576604CWNBQS.shark-coin-stxcity}))
...
(define-read-only (get-reserves)
  (ok {
    token0: (unwrap-panic (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend get-balance CONTRACT)),
...
(define-read-only (get-name)
  (ok "Charismatic ZIL Mobile Legends"))
