---
title: "Trait neoswap-sc-1659723125134"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u5020000 tx-sender agent-4)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4420000 tx-sender agent-1)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP3R8APMXYQRQC6JZAE376ZDVKJAQG5KYMTPV3F9E.bitcoin-flowers transfer u120 tx-sender agent-4)))
		(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u2035 tx-sender agent-4)))
