...
(define-constant token-supply u5400000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPM6E63ZMA3SWZ196CR827C7ECZZ2MYJ28ERSCRM.xxx-stxcity)
