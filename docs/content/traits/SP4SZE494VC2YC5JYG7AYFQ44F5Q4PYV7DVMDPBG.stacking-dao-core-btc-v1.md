---
title: "Trait stacking-dao-core-btc-v1"
draft: true
---
```
;; @contract Core BTC
...
(define-public (deposit 
  ...
  (let (
    ...
    (try! (contract-call? .ststxbtc-token mint-for-protocol stx-user-amount tx-sender))
...
(define-public (withdraw-idle 
  ...
  (let (
    ...
    (try! (contract-call? .ststxbtc-token burn-for-protocol stx-amount receiver))
...
(define-public (init-withdraw 
  ...
  (let (
    ...
    (try! (contract-call? .ststxbtc-token transfer ststxbtc-amount tx-sender (as-contract tx-sender) none))
...
(define-public (withdraw 
  ...
  (let (
    ...
    ;; STX to user, burn stSTXbtc
    (try! (as-contract (contract-call? reserve request-stx-for-withdrawal stx-user-amount receiver)))
    (try! (contract-call? .ststxbtc-token burn-for-protocol (get stx-amount withdrawal-entry) (as-contract tx-sender)))
