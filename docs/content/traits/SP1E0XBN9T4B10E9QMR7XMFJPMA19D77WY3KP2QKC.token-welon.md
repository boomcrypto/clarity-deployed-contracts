...
(define-fungible-token welon)

(define-data-var token-name (string-ascii 32) "ELONSTX Wrapper")
(define-data-var token-symbol (string-ascii 32) "welon")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-welon.json"))
...
(define-read-only (get-base-token)
  'SPX9AGSPZMPX7J7Z90N7PER50PRJY5M59RZ1P8CC.elonstx)

(define-read-only (get-base-decimals)
  (contract-call? 'SPX9AGSPZMPX7J7Z90N7PER50PRJY5M59RZ1P8CC.elonstx get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SPX9AGSPZMPX7J7Z90N7PER50PRJY5M59RZ1P8CC.elonstx get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SPX9AGSPZMPX7J7Z90N7PER50PRJY5M59RZ1P8CC.elonstx transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
