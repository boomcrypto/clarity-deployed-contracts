---
title: "Trait token-wleo"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token wleo)
(define-data-var token-name (string-ascii 32) "LEO Wrapper")
(define-data-var token-symbol (string-ascii 32) "wleo")
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP1AY6K3PQV5MRT6R4S671NWW2FRVPKM0BR162CT6.leo-token get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
