...
(define-data-var token-name (string-ascii 32) "Long Wrapper")
(define-data-var token-symbol (string-ascii 32) "wlong")
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP265WBWD4NH7TVPYQTVD23X3607NNK4484DTXQZ3.longcoin get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
