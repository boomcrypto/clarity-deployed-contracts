...
(define-constant authorized-minter-and-burner .vault-manager-USDB)
...
(define-data-var auth-mint-burn (list 10 principal) (list .vault-manager-USDB .stability-pool-USDB))
