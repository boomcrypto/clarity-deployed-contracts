---
title: "Trait arkadiko-stake-pool-wstx-usda-v1-2"
draft: true
---
```
...
;; Constants
(define-constant POOL-TOKEN .arkadiko-swap-token-wstx-usda)
...
(define-public (stake (registry-trait <stake-registry-trait>) (token <ft-trait>) (staker principal) (amount uint))
  (begin
    ...
    (let (
      ...
      (try! (contract-call? .arkadiko-swap-token-wstx-usda transfer amount staker (as-contract tx-sender) none))
