---
title: "Trait welsh-credits-rc3"
draft: true
---
```
;; title: welsh-credits-rc3
;; authors: rozar.btc
...
(define-public (redeem-note
  ...
  (let
    (
      ...
      (signer-principal (try! (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.blaze-rc5 submit signature amount-str uuid)))
    )
