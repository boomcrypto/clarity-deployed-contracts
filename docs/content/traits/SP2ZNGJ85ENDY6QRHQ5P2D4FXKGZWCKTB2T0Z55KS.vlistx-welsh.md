---
title: "Trait vlistx-welsh"
draft: true
---
```
;; Welsh Community Pool
;; vLiSTX-WELSH LP token with configurable metadata
...
(define-data-var token-name (string-ascii 32) "Welsh Community Pool")
(define-data-var token-symbol (string-ascii 10) "vlSTXWELSH")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/vlistx-welsh/metadata.json"))
