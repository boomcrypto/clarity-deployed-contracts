---
title: "Trait testmask-faktory"
draft: true
---
```

;; b0f1fc33f56b02fd0a811f0f07be43ab2bdf6fd1b7dd3a16c615c34a7576e024
;; testmask Powered By Faktory.fun v1.0 
...
(define-fungible-token testMASK MAX)
(define-constant MAX u100000000000000000)
(define-data-var contract-owner principal 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask-token-owner)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? testMASK amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance testMASK account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? testMASK (/ (* MAX u80) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask-treasury)) ;; 80% treasury
    (try! (ft-mint? testMASK (/ (* MAX u20) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask-faktory-dex))
