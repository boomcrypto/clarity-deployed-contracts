...
(define-constant token-supply u18000000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPWECF3XYVRBRCN23CJJCX9XKSF8RFWQPAQMWXT.neiro-bonding-curve)
