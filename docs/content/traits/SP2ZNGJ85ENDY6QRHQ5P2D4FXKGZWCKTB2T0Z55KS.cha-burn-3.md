---
title: "Trait cha-burn-3"
draft: true
---
```
(define-private (burn-tokens (address principal))
  (let (
    (total-amount (unwrap-panic (contract-call? 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dme000-governance-token get-balance address)))
    (amount-locked (unwrap-panic (contract-call? 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dme000-governance-token dmg-get-locked address)))
