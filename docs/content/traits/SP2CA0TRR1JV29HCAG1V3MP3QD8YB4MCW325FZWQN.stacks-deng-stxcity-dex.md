---
title: "Trait stacks-deng-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP2CA0TRR1JV29HCAG1V3MP3QD8YB4MCW325FZWQN.stacks-deng-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u966494845360824)
    (var-set stx-balance u69333333)
