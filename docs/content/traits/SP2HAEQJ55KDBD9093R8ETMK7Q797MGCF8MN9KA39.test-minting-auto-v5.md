---
title: "Trait test-minting-auto-v5"
draft: true
---
```
...
(define-public (mint
  ...
  (let (
    ...
    (try! (contract-call? minting-asset transfer amount-asset-required contract-caller (get custody-address supported-asset-data) memo))
