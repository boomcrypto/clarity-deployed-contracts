...
(define-fungible-token token-28)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-28 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-28)))
