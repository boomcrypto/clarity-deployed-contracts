---
title: "Trait stackswap-stacker3-v1d"
draft: true
---
```
...
(define-data-var stacker-name (string-ascii 256) "stacker-l-3")
      ...
      success (begin
        ...
        (match (as-contract (contract-call? 'SP000000000000000000002Q6VF78.pox stack-stx tokens-to-stack pox-addr start-burn-ht lock-period))
          result (begin
            ...
            (try! (contract-call? .stackswap-mortgager-v1d set-stacking-unlock-burn-height (var-get stacker-name) (get unlock-burn-height result)))
            (try! (contract-call? .stackswap-stx-reserve-v1c set-next-stacker-name "stacker-l-4"))
