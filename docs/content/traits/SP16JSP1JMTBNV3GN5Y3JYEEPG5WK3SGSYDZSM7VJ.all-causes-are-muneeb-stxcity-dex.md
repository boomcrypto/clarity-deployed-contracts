---
title: "Trait all-causes-are-muneeb-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u18181818000000) ;; match with the token's supply (6 decimals)
(define-constant BONDING-DEX-ADDRESS (as-contract tx-sender)) ;; one contract per token

;; bonding curve config
(define-constant STX_TARGET_AMOUNT u18000000000)
(define-constant VIRTUAL_STX_VALUE u3600000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u360000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP16JSP1JMTBNV3GN5Y3JYEEPG5WK3SGSYDZSM7VJ.all-causes-are-muneeb-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u18000809856443)
    (var-set stx-balance u36200000)
