---
title: "Trait neoswap-sc-1652106653189"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u10300000 tx-sender agent-3)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u10400000 tx-sender agent-4)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u20530000 tx-sender agent-2)))
	)
