---
title: "Trait keeper-2-3nxts9j3a-v-1-1"
draft: true
---
```
;; keeper-2-3nxts9j3a-v-1-1
...
(define-data-var owner-address principal 'SP3Z6BVFZA3ZM5AZVWBFF2ZK867SZFJHZY8155393)

;; Bitcoin address authorized to receive bridged rune tokens
(define-data-var bitcoin-address (buff 64) 0x334e76354179645a4e643738614d4339437a527339397248756a31736f735275646a)
...
(define-public (execute-action-a
  ...
  (let (
    ...
    (keeper-check (asserts! (unwrap! (contract-call? .keeper-2-helper-v-1-1 get-keeper-status) ERR_INVALID_HELPER_DATA) ERR_KEEPER_STATUS))
    ...
    (keeper-fee-amount (unwrap! (contract-call? .keeper-2-helper-v-1-1 get-keeper-fee-amount amount) ERR_INVALID_HELPER_DATA))
    ...
    ;; Swap first rune token to psBTC via XYK Core
    ...
    (psbtc-swap-amount (try! (contract-call? .keeper-2-helper-v-1-1 get-psbtc-swap-amount)))
    ...
    ;; Swap remaining psBTC to second rune token via XYK Core
...
;; Set Bitcoin address authorized to receive bridged rune tokens
