---
title: "Trait bitcoin-bulls-spoints-subscriber"
draft: true
---
```
;;Contract that enables the subscription of nfts in collection SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-bulls to gain spoints.
...
(define-constant collection-address 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-bulls)
;;maps
...
(define-data-var multipliers principal 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.bull-multipliers)
...
(define-data-var blocks-per-spoint uint u116)
...
(define-public (subscribe (lookup-table <lookup-trait>) (item uint)) 
    (let (
        ...
        (asserts! (is-eq (unwrap-panic (unwrap-panic (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-bulls get-owner item))) tx-sender) (err ERR-NOT-AUTHORIZED))
