...
(define-fungible-token token-69)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-69 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-69)))
