---
title: "Trait tattooed-temptations"
draft: true
---
```
;; tattooed-temptations
;; contractType: public

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token tattooed-temptations uint)
...
;; Internal variables
(define-data-var mint-limit uint u1555)
(define-data-var last-id uint u1)
(define-data-var total-price uint u2500000)
(define-data-var artist-address principal 'SP1NXT9A2S1MQ866SYC5DM1Q7P3EZ1Y2566QCKPPZ)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmfMCfA72fAmw8eKT3Qix2dWe7p14VrUfS2tRhFTH6BBAY/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? tattooed-temptations next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? tattooed-temptations token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? tattooed-temptations token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? tattooed-temptations token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? tattooed-temptations id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? tattooed-temptations id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? tattooed-temptations id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u4222)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u0) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u1) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u2) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u3) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u4) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u5) 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436))
      (map-set token-count 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436 (+ (get-balance 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u6) 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436))
      (map-set token-count 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436 (+ (get-balance 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u7) 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436))
      (map-set token-count 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436 (+ (get-balance 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u8) 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV))
      (map-set token-count 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV (+ (get-balance 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u9) 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV))
      (map-set token-count 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV (+ (get-balance 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u10) 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV))
      (map-set token-count 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV (+ (get-balance 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u11) 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV))
      (map-set token-count 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV (+ (get-balance 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u12) 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV))
      (map-set token-count 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV (+ (get-balance 'SPJBJCZV6VCAY52QKR0VHQECAGD1H9N742EQT7MV) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u13) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? tattooed-temptations (+ last-nft-id u14) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
