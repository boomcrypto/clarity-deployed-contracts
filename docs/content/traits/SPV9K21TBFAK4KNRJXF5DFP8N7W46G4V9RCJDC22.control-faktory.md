---
title: "Trait control-faktory"
draft: true
---
```

;; 
;; frame Powered By Faktory.fun v1.0 
...
(define-fungible-token FRAME MAX)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       (asserts! (is-eq tx-sender sender) (err ERR-NOT-AUTHORIZED))
        (ft-transfer? FRAME amount sender recipient)
    )
)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance FRAME account))
)
...
(begin 
    ...
    (try! (ft-mint? FRAME u69000000000000 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.control-faktory-dex)) ;; supply-left
