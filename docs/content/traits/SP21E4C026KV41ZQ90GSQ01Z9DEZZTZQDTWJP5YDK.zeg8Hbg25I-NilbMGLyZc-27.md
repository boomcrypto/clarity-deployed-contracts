---
title: "Trait zeg8Hbg25I-NilbMGLyZc-27"
draft: true
---
```
    ...
    (let
        ...
        (let
            (
                ...
                (nmoFJdZDqlSrMz (unwrap-panic (VCQGoSAdvbxUQE B2ScWCyaYXQhb8x TPksrk9EaNzhmtf KnKttLSP2Bg7cb6 lgOKJUDXNTYsaE)))
            )
            (if (is-eq jnJe1z8sXPa46T true)
...
(define-public (swap-helper-3
    ...
    (let
        ...
        (let
            (
                (x-amount (unwrap-panic (VCQGoSAdvbxUQE REZaDNbWLaV7mk3 KnKttLSP2Bg7cb6 TPksrk9EaNzhmtf dx)))
                (lgOKJUDXNTYsaE (unwrap-panic (VCQGoSAdvbxUQE B2ScWCyaYXQhb8x TPksrk9EaNzhmtf token-z x-amount)))
                (nmoFJdZDqlSrMz (unwrap-panic (VCQGoSAdvbxUQE amm-3 token-z KnKttLSP2Bg7cb6 lgOKJUDXNTYsaE)))
            )
            (if (is-eq jnJe1z8sXPa46T true)
                (begin (try! (as-contract (stx-transfer? nmoFJdZDqlSrMz tx-sender z89U2vcrbMgcMz3))))
                (begin (try! (as-contract (contract-call? gmf9MFsEr5uXqn6 transfer nmoFJdZDqlSrMz tx-sender z89U2vcrbMgcMz3 none))))
