---
title: "Trait fluttering-amaranth-peacock"
draft: true
---
```
...
(impl-trait 'SPAF4RG9V62H4QEEANTGV0N5BEPE3Y1NQP4AHD3D.keeper-action-trait-v-1-1.keeper-action-trait)

;; Use all required traits
(use-trait ft-trait 'SP2AKWJYC7BNY18W1XXKPGP0YVEK63QJG4793Z2D4.sip-010-trait-ft-standard.sip-010-trait)
(use-trait keeper-action-trait 'SPAF4RG9V62H4QEEANTGV0N5BEPE3Y1NQP4AHD3D.keeper-action-trait-v-1-1.keeper-action-trait)
...
(define-public (get-output
  ...
  (let (
    ...
    (keeper-fee-amount (unwrap! (contract-call? 'SPAF4RG9V62H4QEEANTGV0N5BEPE3Y1NQP4AHD3D.keeper-4-helper-v-1-1 get-keeper-fee-amount amount) ERR_INVALID_HELPER_DATA))
