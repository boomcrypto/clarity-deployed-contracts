---
title: "Trait jump-protocol-v3"
draft: true
---
```
;; jump-protocol-v3 (mainnet release)

(use-trait commission-trait 'SP3D6PV2ACBPEKYJTCMH7HEN02KP87QSP8KTEH335.commission-trait.commission)

(define-non-fungible-token jump-protocol-v3 uint)
...
(define-public (unlock-nft (uri (string-ascii 1024)) (address principal))
  (begin
    ...
    (let
      ...
      (match (nft-mint? jump-protocol-v3 id address)
        success
          (begin
...
(define-public (lock-nft (id uint) (chain (string-ascii 1024)) (address (string-ascii 1024)))
  (begin
    ...
    (match (nft-burn? jump-protocol-v3 id tx-sender)
      success 
        (begin
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? jump-protocol-v3 id sender recipient)
    success
      (let
...
(define-public (buy-in-ustx (id uint) (comm <commission-trait>))
  (let 
    ((owner (unwrap! (nft-get-owner? jump-protocol-v3 id) err-not-found))
...
(define-private (is-owner (id uint) (address principal))
  (is-eq address (unwrap! (nft-get-owner? jump-protocol-v3 id) false)))
...
(define-read-only (get-owner (id uint))
  (ok (nft-get-owner? jump-protocol-v3 id)))
