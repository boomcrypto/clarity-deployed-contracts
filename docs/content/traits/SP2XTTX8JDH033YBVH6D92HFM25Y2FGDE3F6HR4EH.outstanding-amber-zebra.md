---
title: "Trait outstanding-amber-zebra"
draft: true
---
```
...
(define-public (stake (registry-trait <stake-registry-trait>) (pool-trait <stake-pool-trait>) (token-trait <ft-trait>) (amount uint))
    (let (
        ...
        ;; Stake LP tokens
        (try! (as-contract (contract-call? pool-trait stake registry-trait token-trait tx-sender amount)))
...
(define-public (unstake (registry-trait <stake-registry-trait>) (pool-trait <stake-pool-trait>) (token-trait <ft-trait>) (amount uint))
    (let (
        ...
        ;; Unstake LP tokens
        (try! (as-contract (contract-call? pool-trait unstake registry-trait token-trait tx-sender amount)))
