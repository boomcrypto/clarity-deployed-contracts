---
title: "Trait solo-dev-kahnoa-nyugen-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP8TBMNAAT7BSH55PMRD1KXCEW7VRMGM5C17RKFE.solo-dev-kahnoa-nyugen-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u900180036007201)
    (var-set stx-balance u332666667)
