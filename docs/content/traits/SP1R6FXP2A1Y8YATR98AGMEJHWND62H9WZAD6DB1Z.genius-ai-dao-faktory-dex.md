---
title: "Trait genius-ai-dao-faktory-dex"
draft: true
---
```

;; 0d901ffac2eed1288f56150043091a6df80c3d4a751af0450d5c61123cdc0995
...
(define-constant DEX-TOKEN 'SP1R6FXP2A1Y8YATR98AGMEJHWND62H9WZAD6DB1Z.genius-ai-dao-faktory)
(define-constant AUTHORIZED-CONTRACT 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.buy-with-velar-faktory)

;; token constants
(define-constant TARGET_STX u10000000000)
(define-constant FAK_STX u2500000000)
(define-constant GRAD-FEE u200000000)
...
;; boot dex
  (begin
    ...
    (var-set ft-balance u20723684205073)
