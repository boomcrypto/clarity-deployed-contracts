---
title: "Trait arb-calc-p2"
draft: true
---
```
;; Token Price Calculator Contract V3
...
(define-public (get-prices)
    (let (
        ...
        ;; Calculate prices
        (welsh-price (calculate-token-price welsh-stx-r0 welsh-stx-r1))
        (pepe-price (calculate-token-price pepe-stx-r0 pepe-stx-r1))
        (welsh-iou-ratio (calculate-token-price welsh-iou-r0 welsh-iou-r1))
        (iouwelsh-price (/ (* welsh-iou-ratio welsh-price) u1000000))
        (cha-price (calculate-token-price stx-cha-r1 stx-cha-r0))
        (synstx-price (calculate-token-price stx-syn-r0 stx-syn-r1))
    )
    (ok {
        welsh: welsh-price,
        pepe: pepe-price,
