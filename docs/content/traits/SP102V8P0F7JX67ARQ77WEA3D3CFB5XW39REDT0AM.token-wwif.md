...
(define-data-var token-name (string-ascii 32) "WIF Wrapper")
(define-data-var token-symbol (string-ascii 32) "wwif")
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP3WPNAEBYMX06RQNNYTH5PTJ1FRGX5A13ZZMZ01D.dogwifhat-token get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
