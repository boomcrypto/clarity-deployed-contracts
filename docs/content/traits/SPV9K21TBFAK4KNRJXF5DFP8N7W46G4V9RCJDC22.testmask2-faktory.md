---
title: "Trait testmask2-faktory"
draft: true
---
```

;; 660bfb3dabf6accd191efc0c0ae12ee5bf65d2cefe26d24da0d941bafd451b4a
;; testmask2 Powered By Faktory.fun v1.0 
...
(define-fungible-token testMASK2 MAX)
(define-constant MAX u100000000000000000)
(define-data-var contract-owner principal 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask2-token-owner)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? testMASK2 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance testMASK2 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? testMASK2 (/ (* MAX u80) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask2-treasury)) ;; 80% treasury
    (try! (ft-mint? testMASK2 (/ (* MAX u20) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask2-faktory-dex))
