---
title: "Trait stacks-scroll-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u500000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP6G1NGH5FWK84PD4ZZ1D06CVQKBAA9T264AW4VW.stacks-scroll-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u499267204050363)
    (var-set stx-balance u733333)
