---
title: "Trait tokensoft-v2-token-v1ddgjs1aj7"
draft: true
---
```
...
(define-constant ERR_UNAUTHORIZED u4204)
...
(define-public (transfer (amount uint) (from principal) (to principal) (memo (optional (buff 34))))
  (begin
    ...
    (ft-transfer? tokensoft-token amount from to)
  )
)
...
(contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-one-step-mint-v4a add-soft-token (as-contract tx-sender))
```
