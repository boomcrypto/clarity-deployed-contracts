---
title: "Trait lp-batch-checker"
draft: true
---
```
(define-read-only (check-many-1a)
  (check-many-a (var-get address-list-1))
)
(define-read-only (check-many-1b)
  (check-many-b (var-get address-list-1))
)
(define-read-only (check-many-1c)
  (check-many-c (var-get address-list-1))
)
(define-read-only (check-many-1d)
  (check-many-d (var-get address-list-1))
)

(define-read-only (check-many-2a)
  (check-many-a (var-get address-list-2))
)
(define-read-only (check-many-2b)
  (check-many-b (var-get address-list-2))
)
(define-read-only (check-many-2c)
  (check-many-c (var-get address-list-2))
)
(define-read-only (check-many-2d)
  (check-many-d (var-get address-list-2))
)

(define-read-only (check-many-3a)
  (check-many-a (var-get address-list-3))
)
(define-read-only (check-many-3b)
  (check-many-b (var-get address-list-3))
)
(define-read-only (check-many-3c)
  (check-many-c (var-get address-list-3))
)
(define-read-only (check-many-3d)
  (check-many-d (var-get address-list-3))
)

(define-read-only (check-many-4a)
  (check-many-a (var-get address-list-4))
)
(define-read-only (check-many-4b)
  (check-many-b (var-get address-list-4))
)
(define-read-only (check-many-4c)
  (check-many-c (var-get address-list-4))
)
(define-read-only (check-many-4d)
  (check-many-d (var-get address-list-4))
)
...
(define-private (check-scs-user-lp (address principal))
  (contract-call? .lp-recovery-calculator scs-user-lp-checker address u166688)
)

(define-private (check-wcs-user-lp (address principal))
  (contract-call? .lp-recovery-calculator wcs-user-lp-checker address u166688)
)

(define-private (check-scs-lands-lp (address principal))
  (contract-call? .lp-recovery-calculator scs-lands-lp-checker address u166688)
)

(define-private (check-wcs-lands-lp (address principal))
  (contract-call? .lp-recovery-calculator wcs-lands-lp-checker address u166688)
)
