---
title: "Trait neoswap-sc-1653664882582"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP2N3BAG4GBF8NHRPH6AY4YYH1SP6NK5TGCY7RDFA.stacks-mfers transfer u2247 tx-sender agent-1)))
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.frontier transfer u444 tx-sender agent-1)))
		(as-contract (stx-transfer? u28902085 tx-sender agent-1)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u33932000 tx-sender agent-2)))
	)
	...
	(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.nandi-sisters transfer u7 tx-sender agent-6)))
	(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.afro-sisters transfer u8 tx-sender agent-6)))
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u7370000 tx-sender agent-7)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u6000000 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP27F9EJH20K3GT6GHZG0RD08REZKY2TDMD6D9M2Z.btc-badgers-v2 transfer u179 tx-sender agent-1)))
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u2250000 tx-sender agent-3)))
	)
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u55304085 tx-sender agent-4)))
	)
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u15650000 tx-sender agent-6)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.nandi-sisters transfer u7 tx-sender agent-7)))
		(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.afro-sisters transfer u8 tx-sender agent-7)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u55304085 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.nandi-sisters transfer u7 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
		(asserts! (is-ok (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.afro-sisters transfer u8 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
