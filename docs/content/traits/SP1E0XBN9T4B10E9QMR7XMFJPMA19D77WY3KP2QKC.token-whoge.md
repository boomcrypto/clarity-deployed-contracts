...
(define-fungible-token whoge)

(define-data-var token-name (string-ascii 32) "HOGE Wrapper")
(define-data-var token-symbol (string-ascii 32) "whoge")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-whoge.json"))
...
(define-read-only (get-base-token)
  'SP3KWRG8T56H8GY291EHATAX095XXMTWQA01SR2MP.happydoge)

(define-read-only (get-base-decimals)
  (contract-call? 'SP3KWRG8T56H8GY291EHATAX095XXMTWQA01SR2MP.happydoge get-decimals))

(define-read-only (get-balance (who principal))
	(let (
			(base-balance (unwrap-panic (contract-call? 'SP3KWRG8T56H8GY291EHATAX095XXMTWQA01SR2MP.happydoge get-balance who))))
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (let (
		...
		(contract-call? 'SP3KWRG8T56H8GY291EHATAX095XXMTWQA01SR2MP.happydoge transfer base-amount sender recipient memo)))
;; ------
