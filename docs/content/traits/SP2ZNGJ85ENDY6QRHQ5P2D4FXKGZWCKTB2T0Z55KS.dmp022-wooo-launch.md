---
title: "Trait dmp022-wooo-launch"
draft: true
---
```
;; Title: DMP022 Wooo! Launch
;; Author: rozar.btc
;; Synopsis:
...
(define-public (execute (sender principal))
	(begin
		...
		(try! (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.dme021-wooo-token set-craft-reward-factor u100))
		(try! (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.dme021-wooo-token set-salvage-reward-factor u1))
		(try! (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.dme021-wooo-token set-transfer-reward-factor u1))
		;; enable new contract extention
		...
		(try! (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.dme022-wooo-title-belt-nft set-reward-payout-multiplier u100))
