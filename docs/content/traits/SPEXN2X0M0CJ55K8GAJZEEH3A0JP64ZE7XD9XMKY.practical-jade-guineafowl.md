---
title: "Trait practical-jade-guineafowl"
draft: true
---
```
;; practical-jade-guineafowl
...
(define-public (execute-action-a
  ...
  (let (
    ...
    (keeper-check (asserts! (unwrap! (contract-call? 'SPAF4RG9V62H4QEEANTGV0N5BEPE3Y1NQP4AHD3D.keeper-1-helper-v-1-3 get-keeper-status) ERR_INVALID_HELPER_DATA) ERR_KEEPER_STATUS))
    ...
    (keeper-fee-amount (unwrap! (contract-call? 'SPAF4RG9V62H4QEEANTGV0N5BEPE3Y1NQP4AHD3D.keeper-1-helper-v-1-3 get-keeper-fee-amount amount) ERR_INVALID_HELPER_DATA))
    ...
    (swap-pbtc-to-sbtc (try! (contract-call?
    ...
    (swap-sbtc-to-stx (try! (contract-call?
