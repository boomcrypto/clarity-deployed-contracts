---
title: "Trait age004-claim-and-stake"
draft: true
---
```
...
(define-public (claim-and-stake (claim-and-stake-trait <extension-trait>) (memo (buff 34)))
	(begin
		(asserts! (is-eq (as-contract tx-sender) (contract-of claim-and-stake-trait)) err-unauthorised)
		(contract-call? .executor-dao request-extension-callback claim-and-stake-trait memo)
	)
)
