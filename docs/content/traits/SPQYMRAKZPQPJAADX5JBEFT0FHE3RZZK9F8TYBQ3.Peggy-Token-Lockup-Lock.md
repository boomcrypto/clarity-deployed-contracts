---
title: "Trait Peggy-Token-Lockup-Lock"
draft: true
---
```

;; ---------------------------------------------------------
;; MEMEGOAT X PEGGY LOCK
;; ---------------------------------------------------------
...
;; STORAGE
(define-constant LOCK-TOKEN 'SPQYMRAKZPQPJAADX5JBEFT0FHE3RZZK9F8TYBQ3.dawgpool-stxcity)
...
(define-public (initialize) 
  (begin
    (let
      (
        (token-amount u1500000000000)
        (fee-in-stx true)
        (vested true)
        (unlock-blocks-data (list {height: u223275, percentage: u50} {height: u249339, percentage: u25} {height: u275691, percentage: u25}))
        (addresses-info (list {address: 'SP389APB4DHZ836P4AE9RJW7EKEZAPV5NPDNG7N46, amount: u750000000000, withdrawal-address: 'SP389APB4DHZ836P4AE9RJW7EKEZAPV5NPDNG7N46} {address: 'SP2KDDXN8976TK8K8YSGXE640V259HSFDAPKE0ZMP, amount: u750000000000, withdrawal-address: 'SP2KDDXN8976TK8K8YSGXE640V259HSFDAPKE0ZMP}))
      ) 
      ...
      (try! (contract-call? 'SPQYMRAKZPQPJAADX5JBEFT0FHE3RZZK9F8TYBQ3.dawgpool-stxcity transfer token-amount tx-sender LOCK-ADDRESS none))
