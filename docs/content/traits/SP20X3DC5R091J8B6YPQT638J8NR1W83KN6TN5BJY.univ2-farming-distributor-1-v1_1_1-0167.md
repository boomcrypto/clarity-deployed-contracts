---
title: "Trait univ2-farming-distributor-1-v1_1_1-0167"
draft: true
---
```
...
(define-public
  ...
  (let ((epoch (contract-call? .univ2-farming-core-v1_1_1-0167 current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .univ2-farming-core-v1_1_1-0167 get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .univ2-farming-core-v1_1_1-0167 current-epoch))
