---
title: "Trait ballot-loan-bitcoin-fam-Z5zlF"
draft: true
---
```
    ...
    (var-set options (list "e408cae7-c30c-4bff-acda-4bea2af10eb2" "92363075-3c9c-431e-bd77-bda7b5f7454d"))
    (var-set start u416000)
    (var-set end u479000)
    (map-set results {id: "e408cae7-c30c-4bff-acda-4bea2af10eb2"} {count: u0, name: u"Yes"}) (map-set results {id: "92363075-3c9c-431e-bd77-bda7b5f7454d"} {count: u0, name: u"No"})
