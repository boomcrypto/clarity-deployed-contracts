---
title: "Trait ballot-vote-with-alex-p-EKeC6"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with ALEX) Proposal For Adjustment of ALEX Emissions")
    ...
    (var-set options (list "b9c6720f-2fa5-4626-86ca-0fc18a4588d5" "a80a17ad-63a9-4a30-a017-bc9b510d9d59"))
    (var-set start u103774)
    (var-set end u104782)
    (map-set results {id: "b9c6720f-2fa5-4626-86ca-0fc18a4588d5"} {count: u0, name: u"For"}) (map-set results {id: "a80a17ad-63a9-4a30-a017-bc9b510d9d59"} {count: u0, name: u"Against"})
```
