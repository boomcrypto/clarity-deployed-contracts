---
title: "Trait annoyed-indigo-landfowl"
draft: true
---
```
...
(define-constant usdt-price-feed-id 0x2b89b9dc8fdf9f34709a5b106b472f0f39bb6ca9ce04b0fd7f2e971688e2e53b)
...
(map-set assets ststxbtc-contract { price-feed-id: stx-price-feed-id, sigma-mu: u500000 })
;; 0.1%
(map-set assets usdc-contract { price-feed-id: usdc-price-feed-id, sigma-mu: u100000 })
(map-set assets usdt-contract { price-feed-id: usdt-price-feed-id, sigma-mu: u100000 })
