---
title: "Trait tradimple-sc-1648153435750"
draft: true
---
```
...
(define-constant agent-4 'SPZD3EE1M7YMH3RCKNQE1CGPA4VDTGMDCT2QWGQN)
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.stacks-mandala transfer u441 tx-sender agent-2)))
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u19100000 tx-sender agent-3)))
	)
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.frontier transfer u704 tx-sender agent-4)))
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-stacks-pixels transfer u742 tx-sender agent-4)))
	(unwrap-panic (as-contract (contract-call? 'SP497E7RX3233ATBS2AB9G4WTHB63X5PBSP5VGAQ.boom-nfts transfer u5502 tx-sender agent-5)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u10600000 tx-sender agent-0)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.stacks-mandala transfer u441 tx-sender agent-1)))
	...
	(unwrap-panic (begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-stacks-pixels transfer u742 tx-sender agent-2)))
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.frontier transfer u704 tx-sender agent-2)))
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP497E7RX3233ATBS2AB9G4WTHB63X5PBSP5VGAQ.boom-nfts transfer u5502 tx-sender agent-4)))
		(unwrap-panic (as-contract (contract-call? 'SPZW30K9VG6YCPYV4BX4V1FT0VJ66R1Q01W9DQ1W.borges-mia-btc-fam transfer u78 tx-sender agent-4)))
		(as-contract (stx-transfer? u1700000 tx-sender agent-4)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-stacks-pixels transfer u742 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
		(asserts! (is-ok (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.frontier transfer u704 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
