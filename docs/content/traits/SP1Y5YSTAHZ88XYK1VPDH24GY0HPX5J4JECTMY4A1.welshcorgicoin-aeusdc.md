---
title: "Trait welshcorgicoin-aeusdc"
draft: true
---
```
;;; welshcorgicoin-aeusdc LP token.
...
(define-read-only (get-name)                   (ok "welshcorgicoin-aeusdc"))
(define-read-only (get-symbol)                 (ok "welshcorgicoin-aeusdc"))
