...
```
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"hey !")
    (var-set description u"super yeah ")
    (var-set voting-system "fptp")
    (var-set options (list "5e5680a7-a338-485d-b677-8e34332f5fad" "5196b4b5-d178-4d84-9efd-e2be1ba80405"))
    (var-set start u134305)
    (var-set end u134593)
    (map-set results {id: "5e5680a7-a338-485d-b677-8e34332f5fad"} {count: u0, name: u"Choice 1"}) (map-set results {id: "5196b4b5-d178-4d84-9efd-e2be1ba80405"} {count: u0, name: u"Choice 2"})
```
