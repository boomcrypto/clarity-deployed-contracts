...
(define-constant token-supply u404000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP5PF97GTRHG6N68E5EB53NFVCW7D34MGSBHMMZ1.pop-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u395884370)
    (var-set stx-balance u8200000)
