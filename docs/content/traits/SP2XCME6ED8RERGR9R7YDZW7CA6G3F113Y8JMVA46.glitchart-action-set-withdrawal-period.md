---
title: "Trait glitchart-action-set-withdrawal-period"
draft: true
---
```
...
(define-public (run (parameters (buff 2048)))
  (let
    ...
    (contract-call? 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.glitchart-bank-account set-withdrawal-period period)
  )
)
