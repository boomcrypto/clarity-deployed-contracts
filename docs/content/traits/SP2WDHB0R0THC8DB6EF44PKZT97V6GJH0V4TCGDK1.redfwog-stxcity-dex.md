---
title: "Trait redfwog-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u6666666666000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP2WDHB0R0THC8DB6EF44PKZT97V6GJH0V4TCGDK1.redfwog-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u6199628021698698)
    (var-set stx-balance u75333333)
