---
title: "Trait ballot-bitcoin-ath-2023-suZHx"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Bitcoin ATH 2023")
    (var-set description u"Will bitcoin reach its ATH in 2023?")
    (var-set voting-system "fptp")
    (var-set options (list "0039ae4b-698d-499d-93b7-9cf01e2c9a31" "f27494b1-f36a-4e9a-8ec4-9ac539ca4baf"))
    (var-set start u128827)
    (var-set end u135163)
    (map-set results {id: "0039ae4b-698d-499d-93b7-9cf01e2c9a31"} {count: u0, name: u"Yes"}) (map-set results {id: "f27494b1-f36a-4e9a-8ec4-9ac539ca4baf"} {count: u0, name: u"No"})
```
