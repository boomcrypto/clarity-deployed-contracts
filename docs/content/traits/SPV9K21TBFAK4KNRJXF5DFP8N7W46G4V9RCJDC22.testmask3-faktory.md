---
title: "Trait testmask3-faktory"
draft: true
---
```

;; 8c059bcedcf9fcf9b4eb126c40571d69ec75316da56ed584fff5f8f006704988
;; testmask3 Powered By Faktory.fun v1.0 
...
(define-fungible-token testMASK3 MAX)
(define-constant MAX u100000000000000000)
(define-data-var contract-owner principal 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask3-token-owner)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? testMASK3 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance testMASK3 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? testMASK3 (/ (* MAX u80) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask3-treasury)) ;; 80% treasury
    (try! (ft-mint? testMASK3 (/ (* MAX u20) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask3-faktory-dex))
