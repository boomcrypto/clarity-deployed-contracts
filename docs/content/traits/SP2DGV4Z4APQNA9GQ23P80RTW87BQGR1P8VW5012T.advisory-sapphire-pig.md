---
title: "Trait advisory-sapphire-pig"
draft: true
---
```
(define-public (execute (price-feed-bytes (optional (buff 8192))))
    (let (
        ...
        (try! (contract-call? 'SP2VCQJGH7PHP2DJK7Z0V48AGBHQAW3R3ZW1QF4N.asset-deployment-154 run-update))
        ...
        (as-contract 
            (try!
                (contract-call? 'SP2VCQJGH7PHP2DJK7Z0V48AGBHQAW3R3ZW1QF4N.borrow-helper-v2-1-1
                    ...
                    tx-sender
                    none
                    'SP2VCQJGH7PHP2DJK7Z0V48AGBHQAW3R3ZW1QF4N.incentives-v2-1
                )
            )
        )
