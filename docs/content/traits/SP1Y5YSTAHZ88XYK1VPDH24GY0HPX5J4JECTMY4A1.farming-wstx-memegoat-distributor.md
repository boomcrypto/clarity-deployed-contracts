---
title: "Trait farming-wstx-memegoat-distributor"
draft: true
---
```
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constants
(define-constant REWARD-TOKEN 'SP2F4QC563WN0A0949WPH5W1YXVC4M1R46QKE0G14.memegoatstx)
...
(define-public
  ...
  (let ((epoch (contract-call? .farming-wstx-memegoat-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .farming-wstx-memegoat-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .farming-wstx-memegoat-core current-epoch))
