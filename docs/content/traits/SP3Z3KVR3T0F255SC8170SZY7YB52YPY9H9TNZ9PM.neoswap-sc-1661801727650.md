---
title: "Trait neoswap-sc-1661801727650"
draft: true
---
```
...
(begin        
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP187Y7NRSG3T9Z9WTSWNEN3XRV1YSJWS81C7JKV7.stacks-ninjas- transfer u137 tx-sender agent-3)))
