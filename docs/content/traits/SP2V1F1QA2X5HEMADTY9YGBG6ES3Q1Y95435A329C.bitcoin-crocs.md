...
(define-data-var artist-address principal 'SP1SQ2GBMHJ986ZRR934XERA6RP9TABFBFXHQQ1GC)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmXsBu8ZNGhQwkKiPceXgYCSjhSwFR3rnHEhmTmJYBwuFC/")
...
(define-public (transfer (token-id uint) (sender principal) (recipient principal))
  (begin
    ...
    (nft-transfer? bitcoin-crocs token-id sender recipient)
  )
)
