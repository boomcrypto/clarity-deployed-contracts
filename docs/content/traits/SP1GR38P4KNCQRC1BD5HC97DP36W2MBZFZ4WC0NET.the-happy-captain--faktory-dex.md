---
title: "Trait the-happy-captain--faktory-dex"
draft: true
---
```

;; b3e44ec23f9d586976411810f388d3543e605514783a796305e6e91d79e8cd9b
...
(define-constant DEX-TOKEN 'SP1GR38P4KNCQRC1BD5HC97DP36W2MBZFZ4WC0NET.the-happy-captain--faktory)
(define-constant AUTHORIZED-CONTRACT 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.buy-with-velar-faktory)

;; token constants
(define-constant TARGET_STX u5000000000)
(define-constant FAK_STX u1250000000)
(define-constant GRAD-FEE u100000000)
...
;; boot dex
  (begin
    ...
    (var-set ft-balance u994694959948357)
