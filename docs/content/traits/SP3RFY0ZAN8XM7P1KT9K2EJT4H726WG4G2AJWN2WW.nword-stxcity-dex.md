...
(define-constant allow-token 'SP3RFY0ZAN8XM7P1KT9K2EJT4H726WG4G2AJWN2WW.nword-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u99948693004257)
    (var-set stx-balance u513333)
