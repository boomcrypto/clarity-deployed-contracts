  ...
  (let
    (
      ...
      (next-snapshot-stx-block-height
        (unwrap!
          (contract-call?
              'SPQVH3QWEJYRFN9H4XRK1M55EWM5YMNYMVJ65EHJ.yield-rewards-sbtc-incentive-test
            get-stacks-block-height-for-cycle-snapshot
...
(define-read-only (get-is-yield-active) 
  (contract-call?   'SPQVH3QWEJYRFN9H4XRK1M55EWM5YMNYMVJ65EHJ.yield-rewards-sbtc-incentive-test get-is-contract-active)
)
...
(define-read-only (yield-contract-current-cycle-stacks-block-height)
  (get current-cycle-stacks-block-height (contract-call?   'SPQVH3QWEJYRFN9H4XRK1M55EWM5YMNYMVJ65EHJ.yield-rewards-sbtc-incentive-test cycle-data))
)

(define-read-only (yield-contract-cycle-id)
  (get cycle-id (contract-call?   'SPQVH3QWEJYRFN9H4XRK1M55EWM5YMNYMVJ65EHJ.yield-rewards-sbtc-incentive-test cycle-data))
)

(define-read-only (yield-contract-snapshot-index)
  (get current-snapshot-index (contract-call?   'SPQVH3QWEJYRFN9H4XRK1M55EWM5YMNYMVJ65EHJ.yield-rewards-sbtc-incentive-test cycle-data))
)

(define-read-only (yield-contract-nr-snapshots-cycle)
  (get nr-snapshots-cycle (contract-call?   'SPQVH3QWEJYRFN9H4XRK1M55EWM5YMNYMVJ65EHJ.yield-rewards-sbtc-incentive-test cycle-data))
)

(define-read-only (yield-contract-nr-blocks-snapshot)
  (get nr-blocks-snapshot (contract-call?   'SPQVH3QWEJYRFN9H4XRK1M55EWM5YMNYMVJ65EHJ.yield-rewards-sbtc-incentive-test cycle-data))
)
...
(define-read-only (can-head-to-next-cycle-or-snapshot)
  (let 
    (
      (yield-data (contract-call?   'SPQVH3QWEJYRFN9H4XRK1M55EWM5YMNYMVJ65EHJ.yield-rewards-sbtc-incentive-test current-overview-data))
