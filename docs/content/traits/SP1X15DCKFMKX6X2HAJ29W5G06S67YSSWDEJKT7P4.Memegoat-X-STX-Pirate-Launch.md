---
title: "Trait Memegoat-X-STX-Pirate-Launch"
draft: true
---
```

;; ---------------------------------------------------------
;; MEMEGOAT X STX PIRATE LAUNCH
;; ---------------------------------------------------------
...
(define-constant LAUNCHPAD-TOKEN 'SP1X15DCKFMKX6X2HAJ29W5G06S67YSSWDEJKT7P4.PIRATE)
...
(define-constant MIN-BUY u100000)
(define-constant MAX-BUY u1000000)
(define-constant HARD-CAP u10000000) 
(define-constant SOFT-CAP u1000000)
(define-constant START-BLOCK u167358)
(define-constant END-BLOCK u167646)
...
(define-public (deposit-stx (amount uint))
  (let
    ...
    (try! (stx-transfer? amount tx-sender LISTING-SIG-WALLET))
...
(define-private (initialize)
  ...
  (begin
    ...
    (try! (contract-call? 'SP1X15DCKFMKX6X2HAJ29W5G06S67YSSWDEJKT7P4.PIRATE transfer LISTING-ALLOCATION tx-sender LISTING-SIG-WALLET none))
    (try! (contract-call? 'SP1X15DCKFMKX6X2HAJ29W5G06S67YSSWDEJKT7P4.PIRATE transfer SALE-ALLOCATION tx-sender LAUNCHPAD-ADDRESS none))
