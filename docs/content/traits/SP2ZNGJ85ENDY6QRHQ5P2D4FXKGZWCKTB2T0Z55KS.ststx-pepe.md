---
title: "Trait ststx-pepe"
draft: true
---
```
;; Pepe Community Pool
;; stSTX-PEPE LP token with configurable metadata
...
(define-data-var token-symbol (string-ascii 10) "stSTX-PEPE")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/ststx-pepe/metadata.json"))
