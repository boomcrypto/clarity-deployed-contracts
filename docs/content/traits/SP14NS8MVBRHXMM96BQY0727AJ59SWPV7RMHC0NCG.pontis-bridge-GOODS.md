---
title: "Trait pontis-bridge-GOODS"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "UNCOMMON.GOODS")
(define-data-var token-symbol (string-ascii 10) "GOODS")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmaZzPtffzePz3r2wy3wxbE3TKebLNFV9rPwgSq6AMkj4W"))
;; 1:0
