---
title: "Trait reap-stx-diko-token-v2-0"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "Reap STX-DIKO Token V2-0")
(define-data-var token-symbol (string-ascii 10) "reapSDV2-0")
...
(define-private (check-is-approved)
  (ok (asserts! (is-eq contract-caller .arkadiko-stx-diko-pool) ERR-NOT-AUTHORIZED))
)
...
(define-public (mint (amount uint) (recipient principal))
	(begin
		(asserts! (is-eq contract-caller .arkadiko-stx-diko-pool-v2-0) ERR-NOT-AUTHORIZED)
