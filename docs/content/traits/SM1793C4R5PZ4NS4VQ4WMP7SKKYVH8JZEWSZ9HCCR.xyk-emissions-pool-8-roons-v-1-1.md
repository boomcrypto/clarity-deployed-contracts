---
title: "Trait xyk-emissions-pool-8-roons-v-1-1"
draft: true
---
```

;; xyk-emissions-pool-8-roons-v-1-1
...
(define-constant DEPLOYMENT_HEIGHT u869944)
...
(define-private (transfer-rewards-token (amount uint) (sender principal) (recipient principal))
  (let (
    (call-a (unwrap! (contract-call?
                     'SP14NS8MVBRHXMM96BQY0727AJ59SWPV7RMHC0NCG.pontis-bridge-ROONS transfer
...
(define-private (get-contract-token-balance)
  (let (
    (call-a (unwrap! (contract-call?
                     'SP14NS8MVBRHXMM96BQY0727AJ59SWPV7RMHC0NCG.pontis-bridge-ROONS get-balance
...
(define-private (get-external-user-data (user principal) (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.xyk-staking-pusdh-roons-v-1-1 get-user-at-cycle
...
(define-private (get-external-cycle-data (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.xyk-staking-pusdh-roons-v-1-1 get-lp-staked-at-cycle
