---
title: "Trait googlier-liquidation-rewards-v1-2"
draft: true
---
```
(impl-trait .googlier-liquidation-rewards-trait-v2.liquidation-rewards-trait)
...
(define-map reward-data
  ...
  {
    share-block: uint, ;; STX block on which USD shares are calculated
...
(define-read-only (get-reward-data (reward-id uint))
  (default-to
    { share-block: u0, unlock-block: u0, token-is-stx: false, token: .usd-token, total-amount: u0 }
