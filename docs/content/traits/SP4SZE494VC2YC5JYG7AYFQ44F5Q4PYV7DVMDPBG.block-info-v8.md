...
(define-read-only (get-user-velar-helper (account principal))
  (let (
    ...
    (user-staked (get end (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.farming-ststx-aeusdc-core get-user-staked account)))
