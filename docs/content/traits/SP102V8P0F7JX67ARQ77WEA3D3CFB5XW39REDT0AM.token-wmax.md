...
(define-data-var token-name (string-ascii 32) "MAX Wrapper")
(define-data-var token-symbol (string-ascii 32) "wmax")
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP7V1SE7EA3ZG3QTWSBA2AAG8SRHEYJ06EBBD1J2.max-token get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
