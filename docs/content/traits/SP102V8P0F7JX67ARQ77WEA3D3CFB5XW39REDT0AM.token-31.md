...
(define-fungible-token token-31)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-31 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-31)))
