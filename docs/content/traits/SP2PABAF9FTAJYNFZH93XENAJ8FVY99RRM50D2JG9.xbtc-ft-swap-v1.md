...
(define-map swaps uint {xbtc: uint, buyer: principal, amount-sell: uint, seller: (optional principal), when: uint, open: bool, ft-sell: principal, fees: principal})
...
;; create a swap between xbtc and fungible token
(define-public (create-swap (xbtc uint) (amount-sell uint) (seller (optional principal)) (ft-sell <fungible-token>) (fees <fees-trait>))
  (let ((id (var-get next-id)))
    (asserts! (map-insert swaps id
      {xbtc: xbtc, buyer: tx-sender, amount-sell: amount-sell, seller: seller,
