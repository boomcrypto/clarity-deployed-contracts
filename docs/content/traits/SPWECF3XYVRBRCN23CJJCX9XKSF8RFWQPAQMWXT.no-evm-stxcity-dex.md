---
title: "Trait no-evm-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPWECF3XYVRBRCN23CJJCX9XKSF8RFWQPAQMWXT.no-evm-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u9994288977727014)
    (var-set stx-balance u571429)
