---
title: "Trait viking-stacking-v2-2"
draft: true
---
```
...
(define-public (create-pool 
  ...
  (let
    ...
    (try! (contract-call? reward-token transfer reward-amount sender 'SPAAZWD8D1RXQG85HDH9NQ90DV8TGXBXS4XY02J3.viking-stacking-vault-v2 none)) 
...
(define-private (do-withdraw-stake (stake-id uint) (user-addr principal) (amount uint) (stake-token <ft-trait>))
  (begin 
    (let
      ...
      (as-contract (try! (contract-call? 'SPAAZWD8D1RXQG85HDH9NQ90DV8TGXBXS4XY02J3.viking-stacking-vault-v2 transfer-ft stake-token amount user-addr)))   
...
(define-private (do-claim-reward (stake-id uint) (user-addr principal) (reward-token <ft-trait>))
  (begin 
    (let
      ...
      ;; transfer token from vault
      (as-contract (try! (contract-call? 'SPAAZWD8D1RXQG85HDH9NQ90DV8TGXBXS4XY02J3.viking-stacking-vault-v2 transfer-ft reward-token reward user-addr)))   
