---
title: "Trait reduced-amethyst-rat"
draft: true
---
```
...
(define-constant album-price u780000)

(define-constant track-price u100000) 
(define-constant musician-fee u40000)
(define-constant artist-fee u25000)   
(define-constant special-artist-fee u25000)
(define-constant provider-fee u5000) 
(define-constant gated-fee u5000) 
...
(define-constant track-6-contributor-1 'SP342MMZRDFSC556F193N76D87SCTYX7SSHD8H3XD)
(define-constant track-6-contributor-2 'SP1WZJ9NV8AG971XX3MDPQE3D2H8SQ4S5D57P1YZY)

(define-constant track-7-contributor-1 'SPJSCH3DDEJ8GQPGYZBHSB4F3HX5Q222CG89PSAB)
(define-constant track-7-contributor-2 'SP3NZE3E8PNM4N9RC7NCXG6FPQQS1HTGXZQG4REQG)
...
;; read only functions
;; Add these read-only functions to your contract
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (begin
    ;; Ensure the token ID is within the limit
    (asserts! (< id (var-get album-token-id)) ERR-NOT-AUTHORIZED)
    ;; Attempt to transfer the NFT
    (try! (nft-transfer? radio-silence id sender recipient))
