---
title: "Trait neoswap-sc-1688730523738"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/1o4sqFbFMC9802WySWLB
;; SwapId: uIcpr4oH4dH2Bmu5EXGz
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u5250000 tx-sender TRADER-1)))
	    )
            true
        )
