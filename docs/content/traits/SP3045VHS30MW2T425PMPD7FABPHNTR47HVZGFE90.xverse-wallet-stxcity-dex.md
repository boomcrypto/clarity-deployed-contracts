---
title: "Trait xverse-wallet-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP3045VHS30MW2T425PMPD7FABPHNTR47HVZGFE90.xverse-wallet-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u20487804878048)
