...
(define-fungible-token wdokwon)

(define-data-var token-name (string-ascii 32) "KWON Wrapper")
(define-data-var token-symbol (string-ascii 32) "wdokwon")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wdokwon.json"))
...
(define-read-only (get-base-decimals)
  (contract-call? 'SP253CHXESX9W66MCSN4JM2XZJBFG9NPHJE6J5JFX.dokwondesk-stxcity get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP253CHXESX9W66MCSN4JM2XZJBFG9NPHJE6J5JFX.dokwondesk-stxcity get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP253CHXESX9W66MCSN4JM2XZJBFG9NPHJE6J5JFX.dokwondesk-stxcity transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
