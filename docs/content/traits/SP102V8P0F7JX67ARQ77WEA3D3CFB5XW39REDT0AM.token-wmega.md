---
title: "Trait token-wmega"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token wmega)
(define-data-var token-name (string-ascii 32) "MEGA Wrapper")
(define-data-var token-symbol (string-ascii 32) "wmega")
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP3D6PV2ACBPEKYJTCMH7HEN02KP87QSP8KTEH335.mega get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
