...
(define-fungible-token wparker)

(define-data-var token-name (string-ascii 32) "Muneeb Cat Parker Wrapper")
(define-data-var token-symbol (string-ascii 32) "wparker")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wparker.json"))
...
(define-read-only (get-base-token)
  'SPA7YK5GQWE9SYCT0GSSK4CNZQN6TRPYK0KW04W4.muneeb-cat-parker)

(define-read-only (get-base-decimals)
  (contract-call? 'SPA7YK5GQWE9SYCT0GSSK4CNZQN6TRPYK0KW04W4.muneeb-cat-parker get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SPA7YK5GQWE9SYCT0GSSK4CNZQN6TRPYK0KW04W4.muneeb-cat-parker get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SPA7YK5GQWE9SYCT0GSSK4CNZQN6TRPYK0KW04W4.muneeb-cat-parker transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
