---
title: "Trait liquid-staked-roo-v2"
draft: true
---
```
...
(define-public (unstake (amount uint))
	(begin
		(let
			...
			(try! (as-contract (contract-call? 'SP2C1WREHGM75C7TGFAEJPFKTFTEGZKF6DFT6E2GE.kangaroo transfer amount-token contract sender none)))
		)
		(ok true)
	)
)
