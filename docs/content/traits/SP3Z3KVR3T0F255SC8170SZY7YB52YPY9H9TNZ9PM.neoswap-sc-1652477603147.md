---
title: "Trait neoswap-sc-1652477603147"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u10800076 tx-sender agent-1)))
	)
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1362438 tx-sender agent-2)))
	)
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u2460000 tx-sender agent-0)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u14622514 tx-sender agent-3)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u14622514 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
