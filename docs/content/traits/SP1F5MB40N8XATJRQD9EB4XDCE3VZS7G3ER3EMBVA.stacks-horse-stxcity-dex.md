---
title: "Trait stacks-horse-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP1F5MB40N8XATJRQD9EB4XDCE3VZS7G3ER3EMBVA.stacks-horse-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u994530084535057)
    (var-set stx-balance u2200000)
