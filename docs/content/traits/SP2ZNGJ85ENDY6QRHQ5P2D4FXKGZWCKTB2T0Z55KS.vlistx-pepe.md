---
title: "Trait vlistx-pepe"
draft: true
---
```
;; Pepe Community Pool
;; vLiSTX-PEPE LP token with configurable metadata
...
(define-data-var token-name (string-ascii 32) "Pepe Community Pool")
(define-data-var token-symbol (string-ascii 10) "vlSTX-PEPE")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/vlistx-pepe/metadata.json"))
