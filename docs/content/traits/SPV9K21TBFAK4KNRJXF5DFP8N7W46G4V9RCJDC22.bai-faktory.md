---
title: "Trait bai-faktory"
draft: true
---
```

;; e18e83ee6495801cc8382833ed78c45dc5657616410021ebe8e3ec153ae057ef
;; bai Powered By Faktory.fun v1.0 
...
(define-fungible-token bai MAX)
(define-constant MAX u1000000000000000)
(define-data-var contract-owner principal 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.bai-token-owner)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? bai amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? bai (/ (* MAX u80) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.bai-treasury)) ;; 80% treasury
    (try! (ft-mint? bai (/ (* MAX u20) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.bai-faktory-dex)) ;; 20% dex
