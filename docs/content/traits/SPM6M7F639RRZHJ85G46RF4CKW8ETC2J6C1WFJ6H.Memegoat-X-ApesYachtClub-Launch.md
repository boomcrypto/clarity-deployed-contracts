---
title: "Trait Memegoat-X-ApesYachtClub-Launch"
draft: true
---
```

;; ---------------------------------------------------------
;; MEMEGOAT X APESYACHTCLUB LAUNCH
;; ---------------------------------------------------------
...
;; LAUNCHPAD DATA
(define-constant LISTING-ALLOCATION u6300000000000000)
(define-constant SALE-ALLOCATION u12600000000000000)
(define-constant LAUNCHPAD-TOKEN 'SPM6M7F639RRZHJ85G46RF4CKW8ETC2J6C1WFJ6H.apesyachtclub)
...
(define-constant MAX-BUY u200000000)
(define-constant HARD-CAP u50000000000) 
(define-constant SOFT-CAP u10000000000)
(define-constant START-BLOCK u170191)
(define-constant END-BLOCK u172207)
...
(define-private (initialize)
  ...
  (begin
    ...
    (try! (contract-call? 'SPM6M7F639RRZHJ85G46RF4CKW8ETC2J6C1WFJ6H.apesyachtclub transfer LISTING-ALLOCATION tx-sender LISTING-SIG-WALLET none))
    (try! (contract-call? 'SPM6M7F639RRZHJ85G46RF4CKW8ETC2J6C1WFJ6H.apesyachtclub transfer SALE-ALLOCATION tx-sender LAUNCHPAD-ADDRESS none))
