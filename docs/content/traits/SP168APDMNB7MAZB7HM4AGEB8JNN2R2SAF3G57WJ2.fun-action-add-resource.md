---
title: "Trait fun-action-add-resource"
draft: true
---
```
...
(define-public (run (parameters (buff 2048)))
  (let
    ...
    (try! (contract-call? 'SP168APDMNB7MAZB7HM4AGEB8JNN2R2SAF3G57WJ2.fun-payments-invoices add-resource (get name paramsTuple) (get description paramsTuple) (get price paramsTuple) (get url paramsTuple)))
    (ok true)
  )
)
