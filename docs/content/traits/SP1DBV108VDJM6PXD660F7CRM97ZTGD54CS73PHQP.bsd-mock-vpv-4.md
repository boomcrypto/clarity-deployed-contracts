...
;; BSD Protocol 
(impl-trait .bsd-trait-vpv-4.bsd-trait)
...
(map-set authorized-protocol-callers .registry-vpv-4 true)
(map-set authorized-protocol-callers .vault-vpv-4 true)
(map-set authorized-protocol-callers .redeem-vpv-4 true)
(map-set authorized-protocol-callers .stability-vpv-4 true)
```
