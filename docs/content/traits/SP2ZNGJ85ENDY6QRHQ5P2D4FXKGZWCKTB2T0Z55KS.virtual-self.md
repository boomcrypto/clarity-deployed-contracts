---
title: "Trait virtual-self"
draft: true
---
```
;; Virtual Self
;; synSTX-iouWELSH LP token with configurable metadata
...
(define-data-var token-name (string-ascii 32) "Virtual Self")
(define-data-var token-symbol (string-ascii 10) "vSELF")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/virtual-self/metadata.json"))
