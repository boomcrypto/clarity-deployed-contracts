---
title: "Trait test-buy-first-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u12000000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPWECF3XYVRBRCN23CJJCX9XKSF8RFWQPAQMWXT.test-buy-first-stxcity)
...
(begin
  ...
  (var-set token-balance u11984263088873210) 
(var-set stx-balance u2888889)
