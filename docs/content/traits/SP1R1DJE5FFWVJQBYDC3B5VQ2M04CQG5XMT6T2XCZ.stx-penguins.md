...
(define-non-fungible-token stx-penguins uint)
...
(define-data-var artist-address principal 'SP1R1DJE5FFWVJQBYDC3B5VQ2M04CQG5XMT6T2XCZ)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmQ2oAMEJXLMoq32MMMzPf1GDCXC8KAkV6QTUAc767smTc/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? stx-penguins next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? stx-penguins token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? stx-penguins token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? stx-penguins token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? stx-penguins id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? stx-penguins id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? stx-penguins id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u4756)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? stx-penguins (+ last-nft-id u0) 'SP1R1DJE5FFWVJQBYDC3B5VQ2M04CQG5XMT6T2XCZ))
      (map-set token-count 'SP1R1DJE5FFWVJQBYDC3B5VQ2M04CQG5XMT6T2XCZ (+ (get-balance 'SP1R1DJE5FFWVJQBYDC3B5VQ2M04CQG5XMT6T2XCZ) u1))
      (try! (nft-mint? stx-penguins (+ last-nft-id u1) 'SP1R1DJE5FFWVJQBYDC3B5VQ2M04CQG5XMT6T2XCZ))
      (map-set token-count 'SP1R1DJE5FFWVJQBYDC3B5VQ2M04CQG5XMT6T2XCZ (+ (get-balance 'SP1R1DJE5FFWVJQBYDC3B5VQ2M04CQG5XMT6T2XCZ) u1))
      (try! (nft-mint? stx-penguins (+ last-nft-id u2) 'SP1R1DJE5FFWVJQBYDC3B5VQ2M04CQG5XMT6T2XCZ))
      (map-set token-count 'SP1R1DJE5FFWVJQBYDC3B5VQ2M04CQG5XMT6T2XCZ (+ (get-balance 'SP1R1DJE5FFWVJQBYDC3B5VQ2M04CQG5XMT6T2XCZ) u1))
      (try! (nft-mint? stx-penguins (+ last-nft-id u3) 'SP2CVN228ZXKMCZJES9MV10MCH1WTY5EZ2QH4GYQX))
