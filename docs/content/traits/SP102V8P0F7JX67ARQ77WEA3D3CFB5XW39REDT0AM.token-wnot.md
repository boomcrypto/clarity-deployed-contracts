---
title: "Trait token-wnot"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token wnot)
(define-data-var token-name (string-ascii 32) "NOT Wrapper")
(define-data-var token-symbol (string-ascii 32) "wnot")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wnot.json"))
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.nope get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
