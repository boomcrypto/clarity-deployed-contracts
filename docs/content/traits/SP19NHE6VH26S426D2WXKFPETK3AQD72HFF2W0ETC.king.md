...
;; DEFINE METADATA
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://gaia.hiro.so/hub/1Jdya5ZXR7VxNQfpX1Fue6DZVwULdMcmKN/thekingscollection-3.json"))
(define-data-var token-name (string-ascii 32) "KING")
(define-data-var token-symbol (string-ascii 32) "KING")
...
(begin
    ...
    (try! (ft-mint? KING MAXSUPPLY (var-get contract-owner)))
)
