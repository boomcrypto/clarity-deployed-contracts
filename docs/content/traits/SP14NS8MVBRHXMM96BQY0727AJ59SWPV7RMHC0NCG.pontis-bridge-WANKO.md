---
title: "Trait pontis-bridge-WANKO"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "WANKO.MANKO.RUNES")
(define-data-var token-symbol (string-ascii 10) "WANKO")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmQVfXLNQgU18nb9pyK7PHUy5FL7QJnYb5CgvmcKDwgif7"))
;; 840010:4
