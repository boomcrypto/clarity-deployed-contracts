...
(define-public (swap-x-for-y (amountIn uint))
  (let (
    (b1 (unwrap-panic (contract-call? .test-hello-world-v9 swap-wstx-usda amountIn)))
    (b2 (unwrap-panic (contract-call? .test-hello-world-v9 swap-usda-diko b1)))
    (b3 (unwrap-panic (contract-call? .test-hello-world-v9 swap-diko-wstx b2)))
  )
    (begin
...
(define-public (swap-y-for-x (amountIn uint))
  (let (
    (b1 (unwrap-panic (contract-call? .test-hello-world-v9 swap-wstx-diko amountIn)))
    (b2 (unwrap-panic (contract-call? .test-hello-world-v9 swap-diko-usda b1)))
    (b3 (unwrap-panic (contract-call? .test-hello-world-v9 swap-usda-wstx b2)))
  )
    (begin
      (asserts! (> b3 amountIn) (err ERR-COOLDOWN))
      (asserts! (is-eq CONTRACT-OWNER tx-sender) (err ERR-ALL-MINTED))
...
(define-public (add-to-position (amountIn uint))
  (let (
    (b1 (unwrap-panic (contract-call? .test-hello-world-v9 swap-wstx-xbtc amountIn)))
    (b2 (unwrap-panic (contract-call? .test-hello-world-v9 swap-xbtc-usda b1)))
    (b3 (unwrap-panic (contract-call? .test-hello-world-v9 swap-usda-wstx b2)))
  )
    (begin
      (asserts! (> b3 amountIn) (err ERR-COOLDOWN))
...
(define-public (reduce-position (amountIn uint))
  (let (
    (b1 (unwrap-panic (contract-call? .test-hello-world-v9 swap-wstx-usda amountIn)))
    (b2 (unwrap-panic (contract-call? .test-hello-world-v9 swap-usda-xbtc b1)))
    (b3 (unwrap-panic (contract-call? .test-hello-world-v9 swap-xbtc-wstx b2)))
  )
    (begin
      (asserts! (> b3 amountIn) (err ERR-COOLDOWN))
      (asserts! (is-eq CONTRACT-OWNER tx-sender) (err ERR-ALL-MINTED))
