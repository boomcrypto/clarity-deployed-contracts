---
title: "Trait ballot-snapshot-test"
draft: true
---
```
;; ballot
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-block-info? id-header-hash u199721))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Poll%20with%20Snapshot")
    (var-set description u"Poll%20with%20Snapshot")
    (var-set voting-system "fptp")
    (var-set options (list "b445f1bb-cb5e-40fd-b3b5-d69ac58bec1b" "af096afd-ecf1-4d3c-a34e-99cf472ffd3f"))
    (var-set start u199721)
    (var-set end u299721)
    (map-set results {id: "b445f1bb-cb5e-40fd-b3b5-d69ac58bec1b"} {count: u0, name: u"Choice%201"}) (map-set results {id: "af096afd-ecf1-4d3c-a34e-99cf472ffd3f"} {count: u0, name: u"Choice%202"})
