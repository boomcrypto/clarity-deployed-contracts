---
title: "Trait neoswap-sc-1658089270621"
draft: true
---
```
...
(define-constant agent-7 'SP1ZCCT29WWFYZDCA9RC5YH46BQ7QF35R0K4MDP3N)
...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u19000000 tx-sender agent-1)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1000000 tx-sender agent-2)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP1W61GBSSTV6QFR16N7VEW549M07XP6BD0RXBW6B.btccustoms-components- transfer u16 tx-sender agent-3)))
	(unwrap-panic (begin
	...
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.byte-fighters transfer u606 tx-sender agent-7)))
	(unwrap-panic (as-contract (contract-call? 'SP22GHCK5W3EK5VC1PEB3VVCBVFRQNTQXV9306QA0.bear-market-buddies transfer u236 tx-sender agent-8)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP22GHCK5W3EK5VC1PEB3VVCBVFRQNTQXV9306QA0.bear-market-buddies transfer u236 tx-sender agent-1)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1W61GBSSTV6QFR16N7VEW549M07XP6BD0RXBW6B.btccustoms-components- transfer u16 tx-sender agent-4)))
	(var-set agent-4-status false))
	true)
	(if (is-eq (var-get agent-5-status) true)
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u1290 tx-sender agent-5)))
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.byte-fighters transfer u606 tx-sender agent-5)))
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u19950000 tx-sender agent-8)))
	)
