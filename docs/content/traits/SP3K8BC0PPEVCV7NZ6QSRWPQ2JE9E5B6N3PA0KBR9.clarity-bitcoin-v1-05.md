---
title: "Trait clarity-bitcoin-v1-05"
draft: true
---
```
...
(define-read-only (read-next-element
		(ignored bool)
		(state-res (response
			{ctx: { txbuff: (buff 8192), index: uint }, elements: (list 62 (buff 256))}
			uint)))
	(match state-res
		state
			(let (
...
(define-read-only (read-next-witness
		(ignored bool)
		(state-res (response
			{ctx: {txbuff: (buff 8192), index: uint}, witnesses: (list 62 (list 62 (buff 256)))}
			uint)))
	(match state-res
		state
			(let (
