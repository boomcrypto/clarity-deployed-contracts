---
title: "Trait playbt3-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPKWPKP5VAPHHKHDQJHQP67T8PWWQ73Y7EXHMC2F.playbt3-stxcity)
...
(define-public (buy (token-trait <sip-010-trait>) (stx-amount uint) ) 
  (begin
    ...
    (let (
      ...
      (res (contract-call? 'SP3VVPEFZNN84EGMD0GN4XWAZ4X5ZMWC852NGWVWN.stxoshi-stxcity transfer (unwrap! (contract-call? 'SP3VVPEFZNN84EGMD0GN4XWAZ4X5ZMWC852NGWVWN.stxoshi-stxcity get-balance tx-sender) (err u407)) tx-sender (var-get TOKEN_OWNER) (some 0x02)))
    )
