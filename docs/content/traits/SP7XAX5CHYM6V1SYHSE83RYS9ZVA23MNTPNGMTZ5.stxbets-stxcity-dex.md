---
title: "Trait stxbets-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u20000000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP7XAX5CHYM6V1SYHSE83RYS9ZVA23MNTPNGMTZ5.stxbets-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u18987341772151900)
    (var-set stx-balance u21333333)
