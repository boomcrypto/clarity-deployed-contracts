---
title: "Trait veni-vidi-vici"
draft: true
---
```
;; Veni Vidi Vici
;; CHA-vSELF LP token with configurable metadata
...
(define-data-var token-name (string-ascii 32) "Veni Vidi Vici")
(define-data-var token-symbol (string-ascii 10) "VVV")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/veni-vidi-vici/metadata.json"))
