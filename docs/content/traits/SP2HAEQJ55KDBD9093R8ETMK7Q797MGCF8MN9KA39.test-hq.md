...
(define-constant activation-delay u4)
...
(map-set minting-contracts { address: .test-minting } { active: true, burn-block-height: (some burn-block-height) })
(map-set minting-contracts { address: .test-minting-otc } { active: true, burn-block-height: (some burn-block-height) })
(map-set minting-contracts { address: .test-controller } { active: true, burn-block-height: (some burn-block-height) })
(map-set minting-contracts { address: .test-emergency-recover } { active: true, burn-block-height: (some burn-block-height) })
(map-set minting-contracts { address: .test-staking } { active: true, burn-block-height: (some burn-block-height) })
```
