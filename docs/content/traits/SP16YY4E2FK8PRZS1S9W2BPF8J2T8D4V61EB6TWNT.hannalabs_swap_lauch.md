---
title: "Trait hannalabs_swap_lauch"
draft: true
---
```

;; title: hannalabs_swap_lauch
;; version:
;; summary:
;; description:
...
(define-constant token-supply u1000000000000) ;; match with the token's supply (1M 6 decimals)
(define-constant BONDING-DEX-ADDRESS (as-contract tx-sender)) ;; one contract per token

;; ;; bonding curve config
(define-constant VIRTUAL_STX_VALUE u200000000) ;; 200u stx
(define-constant STX_TARGET_AMOUNT u1000000000) ;; 1000u stx
(define-constant COMPLETE_FEE u50000000)

;; FEE AND DEX WALLETS
(define-constant STX_CITY_SWAP_FEE_WALLET 'SP16YY4E2FK8PRZS1S9W2BPF8J2T8D4V61EB6TWNT)
(define-constant STX_CITY_COMPLETE_FEE_WALLET 'SP16YY4E2FK8PRZS1S9W2BPF8J2T8D4V61EB6TWNT)
(define-constant VELAR_ADDRESS 'SP16YY4E2FK8PRZS1S9W2BPF8J2T8D4V61EB6TWNT)
(define-constant BURN_ADDRESS 'SP000000000000000000002Q6VF78)


(define-constant allow-token 'SP16YY4E2FK8PRZS1S9W2BPF8J2T8D4V61EB6TWNT.hanna-labs)
