---
title: "Trait dev-action-toggle-resource"
draft: true
---
```
...
(define-public (run (parameters (buff 2048)))
  (let
    ...
    (contract-call? 'SP168APDMNB7MAZB7HM4AGEB8JNN2R2SAF3G57WJ2.dev-payments-invoices toggle-resource-by-name resourceName)
  )
)
