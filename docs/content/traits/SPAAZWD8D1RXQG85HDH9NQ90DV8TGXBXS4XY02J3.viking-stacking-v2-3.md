---
title: "Trait viking-stacking-v2-3"
draft: true
---
```
...
(define-data-var  transfer-fee-percent uint u1000)
...
(define-public (stake (stake-id uint) (amount uint) (stake-token <ft-trait>))
  ...
  (begin
    ...
    (try! (contract-call? stake-token transfer amount-after-fee tx-sender 'SPAAZWD8D1RXQG85HDH9NQ90DV8TGXBXS4XY02J3.viking-stacking-vault-v2 none))
    (ok true)
  )
  )
)
