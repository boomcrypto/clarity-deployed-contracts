---
title: "Trait exuberant-sapphire-squid"
draft: true
---
```
...
(define-public (unlist-item (item-id uint))
    (begin
        (try! (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-market-v5 buy-item 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-tulips NAME item-id))
        (ok true)
    )
)
```
