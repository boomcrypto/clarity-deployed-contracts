---
title: "Trait ballot-vote-with-alex-a-uTHxy"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with ALEX) Approve ALEX Governance Proposal: Nakatomo Release Emissions Adjustment")
    ...
    (var-set options (list "1c521c1d-de00-4cd9-a026-a6031f1134ed" "9e1e1af0-8378-4912-8725-670269751e1c"))
    (var-set start u140858)
    (var-set end u141866)
    (map-set results {id: "1c521c1d-de00-4cd9-a026-a6031f1134ed"} {count: u0, name: u"Approve ALEX Governance Proposal: Nakatomo Release Emissions Adjustment"}) (map-set results {id: "9e1e1af0-8378-4912-8725-670269751e1c"} {count: u0, name: u"Disapprove ALEX Governance Proposal: Nakatomo Release Emissions Adjustment"})
```
