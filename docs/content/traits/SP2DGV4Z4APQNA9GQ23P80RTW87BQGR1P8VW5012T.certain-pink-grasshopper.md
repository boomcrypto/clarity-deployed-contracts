---
title: "Trait certain-pink-grasshopper"
draft: true
---
```
...
(define-public (execute (price-feed-bytes (optional (buff 8192))))
    (let (
        ...
        (try! (contract-call? 'SP2VCQJGH7PHP2DJK7Z0V48AGBHQAW3R3ZW1QF4N.asset-deployment-163 run-update))
        ...
        (as-contract 
            (try!
                (contract-call? 'SP2VCQJGH7PHP2DJK7Z0V48AGBHQAW3R3ZW1QF4N.borrow-helper-v2-1-1
                    supply
