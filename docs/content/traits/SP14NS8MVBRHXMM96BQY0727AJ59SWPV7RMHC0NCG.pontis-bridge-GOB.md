...
(define-data-var token-name (string-ascii 32) "GOB.IS.GOB.IS.GOB")
(define-data-var token-symbol (string-ascii 10) "GOB")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmesPEYrrC1QVAZiSz8emF61Huv8JyTKgnzqfAoxuHYzGk"))
;; 840001:1
