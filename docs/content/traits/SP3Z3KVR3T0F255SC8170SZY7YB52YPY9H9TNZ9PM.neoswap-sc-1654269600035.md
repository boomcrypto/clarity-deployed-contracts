---
title: "Trait neoswap-sc-1654269600035"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u1781 tx-sender agent-5)))
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u19490000 tx-sender agent-6)))
	)
	(unwrap-panic (begin
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u8630000 tx-sender agent-5)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u8630000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
