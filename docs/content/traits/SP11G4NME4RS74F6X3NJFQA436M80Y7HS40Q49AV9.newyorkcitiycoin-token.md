---
title: "Trait newyorkcitiycoin-token"
draft: true
---
```
...
(define-constant TOKEN_URI u"https://cdn.citycoins.co/metadata/newyorkcitycoin.json") ;; utf-8 string with token metadata host
(define-constant TOKEN_NAME "newyorkcitycoin")
(define-constant TOKEN_SYMBOL "NYC")
...
(define-data-var TOKEN_AMOUNT uint u480000000000)
...
(begin
    ...
    ;; Transfer the tokens
    (let ((result (ft-transfer? newyorkcitycoin amount sender recipient)))
      (if (is-ok result)
        (begin
...
;; (define-public (nyc-genesis (recipients (list 1000 principal) ))
...
(begin
  (try! (ft-mint? newyorkcitycoin u5000000000000000 CONTRACT_OWNER)) 
  ;; (try! (ft-mint? newyorkcitycoin u20000000000 'SP31GQBM80BBKWABPHGZPRY6W97QTNJX6Z39NZQHV)) 
  ;; (try! (ft-mint? newyorkcitycoin u100000000000 'ST18VZNQWK7R44BFN75X3RANYRAT4B9ZA8S47KZ24)) 
) 
