---
title: "Trait meme-engine-iouwelsh-rc1"
draft: true
---
```
;; Synthetic Welsh Meme Engine
;;
...
(define-data-var contract-uri (optional (string-utf8 256)) (some u"https://charisma.rocks/explore/engines/iouwelsh"))
...
(define-private (tap)
  (let
    ...
    (print tapped-out)
    (contract-call? .dungeon-keeper-rc2 energize potential-energy tx-sender)
  )
)
