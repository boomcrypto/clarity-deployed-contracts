---
title: "Trait pepe-magic-faktory"
draft: true
---
```

;; b0a5f75701bbf4d2ad406fc66240a3aad5929dc679a969b06ccd591ca7ae0b90
;; miaou Powered By Faktory.fun v1.0 
...
(define-fungible-token miaou MAX)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       (asserts! (is-eq tx-sender sender) (err ERR-NOT-AUTHORIZED))
        (ft-transfer? miaou amount sender recipient)
    )
)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance miaou account))
)
...
(begin 
    ...
    (try! (ft-mint? miaou u69000000000000 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.pepe-magic-faktory-dex)) ;; supply-left
