---
title: "Trait btc-peg-in-v2-07b-swap"
draft: true
---
```
...
(define-public (finalize-peg-in-cross-swap
	...
	(let (
			...
			(pair-tuple { token: (get token-out order-details), chain-id: (unwrap-panic (get chain-id order-details)) })
			...
			(default-fee-tuple (if token-is-meta
				(let (
					...
					{ peg-out-fee: (get peg-out-fee pair-details), peg-out-gas-fee: (get peg-out-gas-fee pair-details) })
				(let (
					...
					{ peg-out-fee: (get fee pair-details), peg-out-gas-fee: (get min-fee pair-details) }))))
		...
		(if token-is-meta
			(begin
				(try! (contract-call? 'SP673Z4BPB4R73359K9HE55F2X91V5BJTN5SXZ5T.meta-bridge-registry-v2-04 set-peg-out-fee pair-tuple (var-get peg-out-fee)))
				(try! (contract-call? 'SP673Z4BPB4R73359K9HE55F2X91V5BJTN5SXZ5T.meta-bridge-registry-v2-04 set-peg-out-gas-fee pair-tuple (var-get peg-out-gas-fee))))
			(let (
				(pair-details (try! (contract-call? 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.cross-bridge-registry-v2-01 get-approved-pair-or-fail pair-tuple))))
				(try! (contract-call? 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.cross-bridge-registry-v2-01 set-approved-pair pair-tuple { fee: (var-get peg-out-fee), min-fee: u0, approved: (get approved pair-details), burnable: (get burnable pair-details), max-amount: (get max-amount pair-details), min-amount: (get min-amount pair-details) }))))
		(match (validate-tx-cross-swap-extra validation-data routing-traits token-out-trait)
			...
			(begin
				...
				(if token-is-meta
					(begin
						(try! (contract-call? 'SP673Z4BPB4R73359K9HE55F2X91V5BJTN5SXZ5T.meta-bridge-registry-v2-04 set-peg-out-fee pair-tuple (get peg-out-fee default-fee-tuple)))
						(try! (contract-call? 'SP673Z4BPB4R73359K9HE55F2X91V5BJTN5SXZ5T.meta-bridge-registry-v2-04 set-peg-out-gas-fee pair-tuple (get peg-out-gas-fee default-fee-tuple))))
					(let (
						(pair-details (try! (contract-call? 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.cross-bridge-registry-v2-01 get-approved-pair-or-fail pair-tuple))))
						(try! (contract-call? 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.cross-bridge-registry-v2-01 set-approved-pair pair-tuple { fee: (get peg-out-fee default-fee-tuple), min-fee: (get peg-out-gas-fee default-fee-tuple), approved: (get approved pair-details), burnable: (get burnable pair-details), max-amount: (get max-amount pair-details), min-amount: (get min-amount pair-details) }))))	
