---
title: "Trait farming-wstx-hshko-distributor"
draft: true
---
```
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constants
(define-constant REWARD-TOKEN 'SP28NB976TJHHGF4218KT194NPWP9N1X3WY516Z1P.new-hashiko)
...
(define-public
  ...
  (let ((epoch (contract-call? .farming-wstx-hshko-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .farming-wstx-hshko-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .farming-wstx-hshko-core current-epoch))
