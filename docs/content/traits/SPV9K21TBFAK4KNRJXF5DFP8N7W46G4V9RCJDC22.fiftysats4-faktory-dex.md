---
title: "Trait fiftysats4-faktory-dex"
draft: true
---
```
;; 41e25016e475c9fc92ee565f0ef2f3c8c4e9e85891335192205c2190f8a6b744
    ;; fak.fun DEX @version 2.0
    ...
    (define-constant ORIGINATOR 'SP16PP6EYRCB7NCTGWAC73DH5X0KXWAPEQ8RKWAKS)
    (define-constant DEX-TOKEN 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fiftysats4-faktory)
  
    ;; token constants
    (define-constant TARGET_STX u21000000)
    (define-constant FAK_STX u4000000) ;; this will be 4M satoshis
    (define-constant GRAD-FEE u400000)
    ...
    (define-data-var premium uint u20)
    ...
    (define-public (buy (ft <faktory-token>) (ubtc uint))
      (begin
        ...
        (let (
          ...
          (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
                      transfer pre-fee tx-sender 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fiftysats4-pre-faktory none))
          (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fiftysats4-pre-faktory create-fees-receipt pre-fee))) 
          (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
          ...
          (if (>= new-stx TARGET_STX)
              (let ((premium-amount (/ (* new-ft (var-get premium)) u100))
                ...
                (try! (as-contract (contract-call? ft transfer premium-amount tx-sender 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fiftysats4-bonus-faktory none)))
                (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fiftysats4-bonus-faktory deposit-bonus agent-amount originator-amount)))
                (try! (as-contract (contract-call? ft transfer amm-amount tx-sender 'SP3DX9KDA8AMX5BHW5QJ68W39V7YHZE696PHXFR20 none)))
                (try! (as-contract (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
                                  transfer amm-ustx tx-sender 'SP3DX9KDA8AMX5BHW5QJ68W39V7YHZE696PHXFR20 none)))
                (try! (as-contract (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
                ...
                (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fiftysats4-pre-faktory toggle-bonded))) 
    ...
    (define-public (open-market) 
      (let ((is-prelaunch-allowing (unwrap-panic (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fiftysats4-pre-faktory is-market-open))))
    ...
    ;; boot dex
      (begin
        ...
        (var-set ft-balance u80000000000000000)
          (print { 
