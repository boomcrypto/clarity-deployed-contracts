---
title: "Trait neoswap-sc-1689532485475"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/76xkTF6EsiedXklthBk5
;; SwapId: dg1w6B8c2aVUOWTUpYPz
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u4813167 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.citadels transfer u1734 tx-sender TRADER-2)))

	(unwrap-panic (as-contract (stx-transfer? u4813167 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u4813167 tx-sender TRADER-1)))
