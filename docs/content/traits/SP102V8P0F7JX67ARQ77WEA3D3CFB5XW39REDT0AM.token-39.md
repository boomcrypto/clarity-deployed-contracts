...
(define-fungible-token token-39)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-39 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-39)))
