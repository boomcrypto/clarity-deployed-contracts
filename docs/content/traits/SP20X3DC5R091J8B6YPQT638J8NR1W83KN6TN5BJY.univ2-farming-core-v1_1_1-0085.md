---
title: "Trait univ2-farming-core-v1_1_1-0085"
draft: true
---
```
...
(define-constant STAKING-TOKEN .univ2-lp-token-v1_0_0-0085)
...
(define-public (stake (amt uint))
  (let ((user      tx-sender)
    ...
    ;; Update global state
    (try! (contract-call? .univ2-lp-token-v1_0_0-0085 transfer amt user protocol none))
    ...
    ;; Postconditions
    (asserts!
      (>= (unwrap-panic (contract-call? .univ2-lp-token-v1_0_0-0085 get-balance protocol))
...
(define-public (unstake (amt uint))
  (let ((user      tx-sender)
    ...
    ;; Update global state
    (try! (as-contract (contract-call? .univ2-lp-token-v1_0_0-0085 transfer amt protocol user none)))
