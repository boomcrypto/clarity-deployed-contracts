---
title: "Trait brc20-bridge-endpoint-dev-preview-4"
draft: true
---
```
...
(define-public (finalize-peg-in (tx (buff 4096)) (output-index uint) (offset uint) (order-index uint) (token-trait <sip010-trait>))
	(let (
			...
			(tx-indexed (try! (contract-call? .indexer-dev-preview-6 get-bitcoin-tx-indexed-or-fail tx output-index offset)))
