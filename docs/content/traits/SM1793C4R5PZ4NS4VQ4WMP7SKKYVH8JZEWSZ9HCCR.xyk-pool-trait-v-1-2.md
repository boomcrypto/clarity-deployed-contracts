---
title: "Trait xyk-pool-trait-v-1-2"
draft: true
---
```
...
(define-trait xyk-pool-trait
    ...
    (create-pool (principal principal principal principal uint (string-ascii 32) (string-ascii 32) (string-utf8 256) bool) (response bool uint))
    )
)
```
