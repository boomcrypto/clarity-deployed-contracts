---
title: "Trait test-incomplete-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPWECF3XYVRBRCN23CJJCX9XKSF8RFWQPAQMWXT.test-incomplete-stxcity)
...
(begin
  ...
  (var-set token-balance u9992672040503632) 
