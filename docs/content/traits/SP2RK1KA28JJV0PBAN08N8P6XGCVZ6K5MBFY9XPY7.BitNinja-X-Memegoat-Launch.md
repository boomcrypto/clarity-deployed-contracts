---
title: "Trait BitNinja-X-Memegoat-Launch"
draft: true
---
```

;; ---------------------------------------------------------
;; MEMEGOAT X BITNINJA LAUNCH
;; ---------------------------------------------------------
...
;; LAUNCHPAD DATA
(define-constant LISTING-ALLOCATION u3000000000)
(define-constant SALE-ALLOCATION u6000000000)
(define-constant LAUNCHPAD-TOKEN 'SP2F4QC563WN0A0949WPH5W1YXVC4M1R46QKE0G14.Bnin)
...
(define-constant MIN-BUY u10000000)
(define-constant MAX-BUY u100000000)
(define-constant HARD-CAP u10000000000) 
(define-constant SOFT-CAP u5000000000)
(define-constant START-BLOCK u170609)
(define-constant END-BLOCK u172169)
...
(define-private (initialize)
  ...
  (begin
    ...
    (try! (contract-call? 'SP2F4QC563WN0A0949WPH5W1YXVC4M1R46QKE0G14.Bnin transfer LISTING-ALLOCATION tx-sender LISTING-SIG-WALLET none))
    (try! (contract-call? 'SP2F4QC563WN0A0949WPH5W1YXVC4M1R46QKE0G14.Bnin transfer SALE-ALLOCATION tx-sender LAUNCHPAD-ADDRESS none))
