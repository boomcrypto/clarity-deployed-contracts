...
(define-fungible-token token-60)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-60 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-60)))
