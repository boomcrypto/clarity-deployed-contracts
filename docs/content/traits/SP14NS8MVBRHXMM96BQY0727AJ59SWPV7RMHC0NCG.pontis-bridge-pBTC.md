---
title: "Trait pontis-bridge-pBTC"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "Pontis Bitcoin")
(define-data-var token-symbol (string-ascii 10) "pBTC")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmdepLy9bnfGtqL2XA6A2UgM2rigg4Racx4URS7x9deHx7"))
