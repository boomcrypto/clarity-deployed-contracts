---
title: "Trait stacky-ai-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP15FAANQY1CPYMWSQSNB299AMT0XGCEVCJW23F30.stacky-ai-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u90090090090090)
    (var-set stx-balance u66000000)
