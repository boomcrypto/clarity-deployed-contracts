---
title: "Trait testmask8-faktory-dex"
draft: true
---
```

  ;; 557f63ec0bf8342cf47e2b72f2f77529e5f07ab5de107453a08be63224ed2940
  ...
  (define-constant DEX-TOKEN 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask8-faktory)
  ...
  (define-public (buy (ft <faktory-token>) (ubtc uint))
    (begin
      ...
      (let (
        ...
        (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
                    transfer pre-fee tx-sender 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask8-pre-faktory none))
        (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask8-pre-faktory create-fees-receipt pre-fee))) 
        (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
        ...
        (if (>= new-stx TARGET_STX)
            (let ((premium-amount (/ (* new-ft (var-get premium)) u100))
              ...
              (try! (as-contract 
                     (contract-call? 
                       'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-core-v-1-2 
                           create-pool 
                           'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.xyk-pool-sbtc-testmask8-v-1-1
              ...
              (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask8-pre-faktory toggle-bonded))) 
  ...
  (define-public (open-market) 
    (let ((is-prelaunch-allowing (unwrap-panic (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask8-pre-faktory is-market-open))))
    ...
    (begin
      ...
      (var-set ft-balance u16000000000000000)
        (print { 
            ...
            poolName: 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.xyk-pool-sbtc-testmask8-v-1-1
       })
      (ok true))
```
