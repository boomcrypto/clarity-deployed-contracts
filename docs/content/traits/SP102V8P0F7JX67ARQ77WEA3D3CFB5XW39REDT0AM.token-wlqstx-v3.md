---
title: "Trait token-wlqstx-v3"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token wlqstx)
(define-data-var token-name (string-ascii 32) "LiSTX Wrapper")
(define-data-var token-symbol (string-ascii 32) "wlqstx")
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SM26NBC8SFHNW4P1Y4DFH27974P56WN86C92HPEHH.token-lqstx get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
