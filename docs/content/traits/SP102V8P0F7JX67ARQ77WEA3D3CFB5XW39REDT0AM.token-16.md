...
(define-fungible-token token-16)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-16 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-16)))
