---
title: "Trait tradimple-sc-1648579988349"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u923 tx-sender agent-1)))
		(as-contract (stx-transfer? u4733334 tx-sender agent-1)))
	)
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u7233333 tx-sender agent-3)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u6800000 tx-sender agent-0)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u18766667 tx-sender agent-2)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u923 tx-sender agent-3)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u18766667 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u923 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
