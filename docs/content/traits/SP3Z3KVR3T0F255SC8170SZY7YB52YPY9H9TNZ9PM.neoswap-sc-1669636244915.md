---
title: "Trait neoswap-sc-1669636244915"
draft: true
---
```
...
(define-constant agent-2 'SPHK8A7P61C6ASWKYDX1PCDX9YA54DKVJN49EXGJ)
...
(begin
	(unwrap-panic (as-contract (contract-call? 'SP2BE8TZATXEVPGZ8HAFZYE5GKZ02X0YDKAN7ZTGW.btc-sports-flags-nft transfer u1276 tx-sender agent-1)))
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u2052375 tx-sender agent-3)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u302625 tx-sender agent-4)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u302625 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u12657625 tx-sender agent-1)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP2BE8TZATXEVPGZ8HAFZYE5GKZ02X0YDKAN7ZTGW.btc-sports-flags-nft transfer u1276 tx-sender agent-2)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u12657625 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (contract-call? 'SP2BE8TZATXEVPGZ8HAFZYE5GKZ02X0YDKAN7ZTGW.btc-sports-flags-nft transfer u1276 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
