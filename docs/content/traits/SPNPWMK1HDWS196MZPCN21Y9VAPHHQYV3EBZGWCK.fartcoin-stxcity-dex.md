---
title: "Trait fartcoin-stxcity-dex"
draft: true
---
```
...
(define-constant STX_TARGET_AMOUNT u35000000000)
(define-constant VIRTUAL_STX_VALUE u7000000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u700000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SPNPWMK1HDWS196MZPCN21Y9VAPHHQYV3EBZGWCK.fartcoin-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u995260663507109)
