...
(define-public (get-output
  ...
  (let (
    ...
    (xyk-result (unwrap-panic (xyk-qa amount-after-fee token-trait-a token-trait-b xyk-pool-trait-a)))
...
(define-public (execute-legacy-quote (amount uint) (swaps-reversed bool))
    (if swaps-reversed
        (quote-legacy-y-to-x amount)
        (quote-legacy-x-to-y amount))
)
...
(define-public (execute-action
  ...
  (let (
    ...
    ;; Execute both swaps
    (xyk-result (unwrap-panic (xyk-sa amount-after-fee token-trait-a token-trait-b xyk-pool-trait-a)))
