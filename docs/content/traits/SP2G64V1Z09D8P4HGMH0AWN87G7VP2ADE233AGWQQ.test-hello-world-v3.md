---
title: "Trait test-hello-world-v3"
draft: true
---
```
...
(define-public (test-1 (amountIn uint))
  (let (
    (b1 (unwrap-panic (contract-call? .test-hello-world-v2 swap-wstx-usda amountIn)))
    (b2 (unwrap-panic (contract-call? .test-hello-world-v2 swap-usda-diko b1)))
    (b3 (unwrap-panic (contract-call? .test-hello-world-v2 swap-diko-wstx b2)))
  )
    (begin
...
(define-public (test-2 (amountIn uint))
  (let (
    (b1 (unwrap-panic (contract-call? .test-hello-world-v2 swap-wstx-diko amountIn)))
    (b2 (unwrap-panic (contract-call? .test-hello-world-v2 swap-diko-usda b1)))
    (b3 (unwrap-panic (contract-call? .test-hello-world-v2 swap-usda-wstx b2)))
  )
    (begin
      (asserts! (> b3 amountIn) (err ERR-COOLDOWN))
      (asserts! (is-eq CONTRACT-OWNER tx-sender) (err ERR-ALL-MINTED))
