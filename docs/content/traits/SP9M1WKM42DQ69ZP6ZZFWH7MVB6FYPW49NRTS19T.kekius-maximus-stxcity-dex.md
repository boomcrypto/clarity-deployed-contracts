---
title: "Trait kekius-maximus-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u420000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP9M1WKM42DQ69ZP6ZZFWH7MVB6FYPW49NRTS19T.kekius-maximus-stxcity)
...
(var-set token-balance u417218543046357)
