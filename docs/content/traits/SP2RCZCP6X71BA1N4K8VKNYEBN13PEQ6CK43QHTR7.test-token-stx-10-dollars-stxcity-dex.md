---
title: "Trait test-token-stx-10-dollars-stxcity-dex"
draft: true
---
```
...
(define-constant STX_TARGET_AMOUNT u40000000000)
(define-constant VIRTUAL_STX_VALUE u8000000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u800000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP2RCZCP6X71BA1N4K8VKNYEBN13PEQ6CK43QHTR7.test-token-stx-10-dollars-stxcity)
...
(var-set token-balance u68994250479126736)
