---
title: "Trait tradimple-sc-1644503559427"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u10100000 tx-sender agent-1)))
	)
	...
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.stacks-giantpandas transfer u2399 tx-sender agent-3)))
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3200000 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u5600000 tx-sender agent-4)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u5600000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
