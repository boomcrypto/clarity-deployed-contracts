...
(define-data-var token-name (string-ascii 32) "MAGIC.INTERNET.MONEY")
(define-data-var token-symbol (string-ascii 10) "MIM")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmPFCP26gnG7udjMfQzw9p5vfNCSAQKxXCyUq7kzvzyTds"))
;; 840000:45
