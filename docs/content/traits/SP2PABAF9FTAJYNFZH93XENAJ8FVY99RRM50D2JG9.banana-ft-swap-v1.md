...
(define-map swaps uint {ubanana: uint, buyer: principal, amount-sell: uint, seller: (optional principal), when: uint, open: bool, ft-sell: principal, fees: principal})
...
(define-public (create-swap (ubanana uint) (amount-sell uint) (seller (optional principal)) (ft-sell <fungible-token>) (fees <fees-trait>))
  (let ((id (var-get next-id)))
    (asserts! (map-insert swaps id
      {ubanana: ubanana, buyer: tx-sender, amount-sell: amount-sell, seller: seller,
