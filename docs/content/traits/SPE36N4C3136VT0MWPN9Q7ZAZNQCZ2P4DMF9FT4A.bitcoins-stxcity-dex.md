---
title: "Trait bitcoins-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPE36N4C3136VT0MWPN9Q7ZAZNQCZ2P4DMF9FT4A.bitcoins-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u14092105263157894)
    (var-set stx-balance u196078431)
