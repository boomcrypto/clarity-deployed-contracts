---
title: "Trait pontis-bridge-POOKA"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "POOKA.CANNOT.BE.STOPPED")
(define-data-var token-symbol (string-ascii 10) "POOKA")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmZwSXVCi797322i64EkSsQhhud7NM4auPPDNsCmBGVson"))
;; 865956:1711
