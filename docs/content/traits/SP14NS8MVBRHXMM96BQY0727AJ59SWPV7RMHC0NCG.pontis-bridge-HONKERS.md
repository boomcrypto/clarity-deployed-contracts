---
title: "Trait pontis-bridge-HONKERS"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "PEPE.WIT.HONKERS")
(define-data-var token-symbol (string-ascii 10) "HONKERS")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmWdKsH93Nom73V3TPmo8uAawCerax3ec296fH9as8JAMp"))
;; 840000:55
