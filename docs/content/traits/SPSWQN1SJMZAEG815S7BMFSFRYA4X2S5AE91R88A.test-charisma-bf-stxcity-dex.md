---
title: "Trait test-charisma-bf-stxcity-dex"
draft: true
---
```
...
(define-constant STX_TARGET_AMOUNT u14000000000)
(define-constant VIRTUAL_STX_VALUE u2800000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u280000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SPSWQN1SJMZAEG815S7BMFSFRYA4X2S5AE91R88A.test-charisma-bf-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u9999761910430706)
