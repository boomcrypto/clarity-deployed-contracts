---
title: "Trait token-wgort"
draft: true
---
```
(impl-trait 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.trait-sip-010.sip-010-trait)

(define-fungible-token wgort)

(define-data-var token-name (string-ascii 32) "Gort Wrapper")
(define-data-var token-symbol (string-ascii 32) "wgort")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wgort.json"))
...
(define-read-only (get-base-token)
  'SP11T07PFR1YGRHTW9D8H1RWB8XZJV1HJZV2W85Q8.gort)

(define-read-only (get-base-decimals)
  (contract-call? 'SP11T07PFR1YGRHTW9D8H1RWB8XZJV1HJZV2W85Q8.gort get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP11T07PFR1YGRHTW9D8H1RWB8XZJV1HJZV2W85Q8.gort get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP11T07PFR1YGRHTW9D8H1RWB8XZJV1HJZV2W85Q8.gort transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
