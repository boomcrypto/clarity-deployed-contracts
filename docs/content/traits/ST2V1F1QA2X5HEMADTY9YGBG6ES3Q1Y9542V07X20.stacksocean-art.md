...
(define-constant COMM u300)

(define-constant DEPLOYER tx-sender)
(define-constant COMM_ADDR 'ST2V1F1QA2X5HEMADTY9YGBG6ES3Q1Y9542V07X20)
...
(define-private (mint-many (orders (list 10 bool)))
  (let (
      ...
      (total-artist (- price (+ total-commission total-commission1)))
    )
