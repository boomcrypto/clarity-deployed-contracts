---
title: "Trait stackswap-stacker4-v1b"
draft: true
---
```
...
(define-data-var stacker-name (string-ascii 256) "l-stacker-4")
      ...
      success (begin
        ...
        (match (as-contract (contract-call? 'SP000000000000000000002Q6VF78.pox stack-stx tokens-to-stack pox-addr start-burn-ht lock-period))
          result (begin
            ...
            (try! (contract-call? .stackswap-stx-reserve-v1b set-next-stacker-name "l-stacker"))
