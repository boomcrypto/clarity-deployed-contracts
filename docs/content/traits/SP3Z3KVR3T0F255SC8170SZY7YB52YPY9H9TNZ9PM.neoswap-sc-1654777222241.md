---
title: "Trait neoswap-sc-1654777222241"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1010000 tx-sender agent-4)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u10000 tx-sender agent-2)))
	)
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u2530000 tx-sender agent-5)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.magic-ape-school transfer u1340 tx-sender agent-6)))
