...
```
  ...
  (define-public (transfer
    ...
    (begin
      ...
      (try! (ft-transfer? rstSTX amount sender recipient))
  ...
  (define-read-only (get-balance (owner principal))
    (ok (ft-get-balance rstSTX owner))
  )
  ...
  (begin
    (try! (ft-mint? rstSTX u10000000000000000 contract-owner)) 
  )
