---
title: "Trait neoswap-sc-1682767090717"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/6iDcJJGr7MEyD2XXBEQH
;; SwapId: D0ddVaZ0RQmsy3GVVFws
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u24400000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (contract-call? 'SP2X0TZ59D5SZ8ACQ6YMCHHNR2ZN51Z32E2CJ173.the-explorer-guild transfer u424 tx-sender TRADER-2)))

	(unwrap-panic (as-contract (stx-transfer? u24400000 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u24400000 tx-sender TRADER-2)))
