...
(define-fungible-token token-76)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-76 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-76)))
