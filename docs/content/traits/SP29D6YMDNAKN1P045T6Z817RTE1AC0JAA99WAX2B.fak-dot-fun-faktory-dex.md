---
title: "Trait fak-dot-fun-faktory-dex"
draft: true
---
```
...
(define-constant FEE-RECEIVER 'SPZYMEK0JYQMPGRTHM0TAMF0J2P70ZX4BHQZNHA8)
(define-constant G-RECEIVER 'SP3MZAPFZEA9MZHBCGHG3TYKNFGDMNF5FW9RZ3AXS)
...
(define-constant DEX-TOKEN 'SP29D6YMDNAKN1P045T6Z817RTE1AC0JAA99WAX2B.fak-dot-fun-faktory)
...
(begin
  ...
  (try! (stx-transfer? u1000000 tx-sender 'SP2Z2N5HGEK6KD2MBBKN0WH7MS1W70AYXBPBG0N2F))
  (ok true))
```
