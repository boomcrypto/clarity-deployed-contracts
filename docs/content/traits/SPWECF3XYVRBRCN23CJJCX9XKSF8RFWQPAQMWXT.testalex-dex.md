...
(define-constant token-supply u0) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPWECF3XYVRBRCN23CJJCX9XKSF8RFWQPAQMWXT.testalex)
