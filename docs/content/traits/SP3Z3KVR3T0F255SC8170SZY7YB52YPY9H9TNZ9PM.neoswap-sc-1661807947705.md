---
title: "Trait neoswap-sc-1661807947705"
draft: true
---
```
...
(begin
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.stacks-mandala transfer u535 tx-sender agent-1)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1D3Y8A2VVD2W98VFXCG5AXRYX5PJBBEMV1YPKF1.nonnish-grafters transfer u670 tx-sender agent-2)))
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u3350000 tx-sender agent-3)))
	)
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u19950000 tx-sender agent-5)))
	)
