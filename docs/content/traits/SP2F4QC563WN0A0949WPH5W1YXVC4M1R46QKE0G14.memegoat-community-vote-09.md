---
title: "Trait memegoat-community-vote-09"
draft: true
---
```
;;
...
(define-public (execute (sender principal) (opt uint))
  (begin
    ...
    (try! (contract-call? .memegoat-community-dao set-extensions 
      (list 
        {extension: .memegoat-community-pools-v2, enabled: true}
        {extension: .memegoat-community-pools-v1, enabled: false}
      )
    ))

    (try! (contract-call? .memegoat-community-pools-v2 move-pools 
      (list u0 u1 u2 u3 u4 u5 u6 u7 u8 u9 u10 u11 u12 u13 u14 u15 u16 u17 u18 u19 u20 u21 u22 u23 u24 u25 u26 u27 u28 u29 u30)
    ))
    ...
    (try! (contract-call? .memegoat-community-pools-v2 move-user-records
      ...
      (list 
        ...
        {user: 'SP326H2T31PKEBR5VDPDG0FCHCGCBKFCN61Y5V8Z0, old-id: u6}
        {user: 'SP3DYP99Z4RPX11G384JR7GAN9RQD6WWKGKW9TC4E, old-id: u6}
        {user: 'SPRXTW9SPD3C95VZ6J88MC68QQE4YSQCZQ63JEAM, old-id: u6}
        {user: 'SP2SNQHT55ZM0TBF7DD0TA39XM652QZ97E3CXN2SJ, old-id: u6}
      )
    ))
    ...
    (try! (contract-call? .memegoat-community-pools-v2 move-user-records
      ...
      (list 
        ...
        {user: 'SP3PSRA8PV42GEB8K70CESKHPZFG9MRB4FZANS2KA, old-id: u8}
      )
    ))
    ...
    (try! (contract-call? .memegoat-community-pools-v2 move-user-records
      ...
      (list 
        ...
        {user: 'SP1RXD8QZSANSYETD782M88PK8EXRXHX6E82HBPG6, old-id: u11}
        {user: 'SP1NGMS9Z48PRXFAG2MKBSP0PWERF07C0KV9SPJ66, old-id: u11}
        {user: 'SP1NGMS9Z48PRXFAG2MKBSP0PWERF07C0KV9SPJ66, old-id: u11}
        {user: 'SP35MER4PHM6XGB99YDRQAK0M0JQ8F9CVF04VZ1VX, old-id: u11}
        {user: 'SP37S6ASV5A45JJ9MQWD1GG53W0CYMKXQZ6D9BR2P, old-id: u11}
        {user: 'SP2XHGP0P45WDJ1XZPZZT2Q0MV3WBAP7SN7ZWCGN5, old-id: u11}
      )
    ))
    ...
    (try! (contract-call? .memegoat-community-pools-v2 move-user-records
      ...
      (list 
        ...
        {user: 'SP31DFRJ0QZ07AK7JHH5P47KNRETMV0W564Y8VB2C, old-id: u12}
        {user: 'SP30TN9ZWDW49BSDEQM3SCXSGGF309V61ERZ764J0, old-id: u12}
        {user: 'SP326H2T31PKEBR5VDPDG0FCHCGCBKFCN61Y5V8Z0, old-id: u12}
        {user: 'SP2SNQHT55ZM0TBF7DD0TA39XM652QZ97E3CXN2SJ, old-id: u12}
        {user: 'SPYK0YH7AK4GM2YCHZRS33B5G0HMT5SR7JYF1FNX, old-id: u12}
        {user: 'SP28JZJY7BQHGT0NBN62RP9FDPH9MSY1KFGMPFT93, old-id: u12}
        {user: 'SPJASS1NWD1RT051QJZMWKTBBN4SPW6SYHFTDRJ1, old-id: u12}
        {user: 'SP2P0QX0C70S8SJ8VYP530JFMNPHNVJBQY3KEZ9ZC, old-id: u12}
        {user: 'SP2ZE5HQYBABTX4SRRA7VSRD1DK70FDVEWV37A1Q3, old-id: u12}
        {user: 'SP26STSDW5X5YY5N5DRPR4VDJY86FPMB4NZ0RNBW, old-id: u12}
        {user: 'SP38WCGSSQJBFAKH77R93AMTHBBEF83DQ6EJ358F2, old-id: u12}
        {user: 'SP3GDZ84WVJ0XSXWAC0W0XMSZCHJSQTBTC7JCB10A, old-id: u12}
        {user: 'SP1EHG5M8H61ACV1JYRD9Z9TC8BKSW519YZ4WE5Z4, old-id: u12}
        {user: 'SP8SHCQXZJZN6TS58MTX6M4PBN5PQ110F0PAEG9T, old-id: u12}
        {user: 'SP3NEWV1EPV1Y9KKSGDSC63CFE5ASA9QHAHWGTPS6, old-id: u12}
      )
    ))
    ...
    (try! (contract-call? .memegoat-community-pools-v2 move-user-records
      ...
      (list 
        ...
        {user: 'SPTWA5VVS3TEBNVYC419AY454MEHM0HZH0DQD16, old-id: u13}
        {user: 'SP2XHGP0P45WDJ1XZPZZT2Q0MV3WBAP7SN7ZWCGN5, old-id: u13}
        {user: 'SP2J1EX6Y8ZANKZ68ZK3FCPNDDRHT447C1RY7FZTW, old-id: u13}
      )
    ))
    ...
    (try! (contract-call? .memegoat-community-pools-v2 move-user-records
      ...
      (list 
        ...
        {user: 'SP36KK1WYNES6725ERKNCFHYFXBF81E8S73AAPKGP, old-id: u14}
        {user: 'SP35MER4PHM6XGB99YDRQAK0M0JQ8F9CVF04VZ1VX, old-id: u14}
        {user: 'SP15RX1J41YMDQ3Z4FH704GNATGHG2T7M17TW2C8Y, old-id: u14}
        {user: 'SPX5CBAMGM7R0DWEX1077HN13QVMRQHRAWW4X401, old-id: u14}
        {user: 'SP3VMAHTFVN9ED5FB073MK1B8MGNCZW5VCEHFFD7C, old-id: u14}
      )
    ))
    ...
    (try! (contract-call? .memegoat-community-pools-v2 move-user-records
      ...
      (list 
        ...
        {user: 'SP1CFWC7XAJ5PG1QN2N2FKJC7AS5GN1MDSX8VAW58, old-id: u15}
        {user: 'SP8SHCQXZJZN6TS58MTX6M4PBN5PQ110F0PAEG9T, old-id: u15}
        {user: 'SP31DFRJ0QZ07AK7JHH5P47KNRETMV0W564Y8VB2C, old-id: u15}
        {user: 'SP3NEWV1EPV1Y9KKSGDSC63CFE5ASA9QHAHWGTPS6, old-id: u15}
        {user: 'SPX5CBAMGM7R0DWEX1077HN13QVMRQHRAWW4X401, old-id: u15}
        {user: 'SP1DZ6CVX4TYYNRV39WBPSH18EMA5C6S6TZHBZT75, old-id: u15}
        {user: 'SPTWA5VVS3TEBNVYC419AY454MEHM0HZH0DQD16, old-id: u15}
        {user: 'SP3VMAHTFVN9ED5FB073MK1B8MGNCZW5VCEHFFD7C, old-id: u15}
        {user: 'SP2J1EX6Y8ZANKZ68ZK3FCPNDDRHT447C1RY7FZTW, old-id: u15}
        {user: 'SP1EHG5M8H61ACV1JYRD9Z9TC8BKSW519YZ4WE5Z4, old-id: u15}
        {user: 'SP2XHGP0P45WDJ1XZPZZT2Q0MV3WBAP7SN7ZWCGN5, old-id: u15}
        {user: 'SP3MJ27QVV5ZZ9YWZFF2TW27FC2KVNNFKK6TCSWAA, old-id: u15}
        {user: 'SP2SNQHT55ZM0TBF7DD0TA39XM652QZ97E3CXN2SJ, old-id: u15}
        {user: 'SPH1ZAHN998PFH9A2CBNQ5EM3HKXG08FA0CKF4MB, old-id: u15}
        {user: 'SP2CYW85YW03WX0XMSFGMJ3HZQ30X8NKFA6TXVNRX, old-id: u15}
        {user: 'SP36KK1WYNES6725ERKNCFHYFXBF81E8S73AAPKGP, old-id: u15}
        {user: 'SPPTQ6GQ4ARKZN6H0WB8K8Z7555NMH2DKT93Z6K0, old-id: u15}
      )
    ))
    ...
    (try! (contract-call? .memegoat-community-pools-v2 move-user-records
      ...
      (list 
        ...
        {user: 'SP1CFWC7XAJ5PG1QN2N2FKJC7AS5GN1MDSX8VAW58, old-id: u16}
        {user: 'SPX5CBAMGM7R0DWEX1077HN13QVMRQHRAWW4X401, old-id: u16}
        {user: 'SP36KK1WYNES6725ERKNCFHYFXBF81E8S73AAPKGP, old-id: u16}
        {user: 'SPSQ4W56BY5XKZR8YJMXYP1CKJ64TT4CQ04GFQT8, old-id: u16}
        {user: 'SP1HGP6E8ZHZBRA91NME5MPCC1ZQA6VTREQD723GP, old-id: u16}
      )
    ))
    (ok true)
  )
