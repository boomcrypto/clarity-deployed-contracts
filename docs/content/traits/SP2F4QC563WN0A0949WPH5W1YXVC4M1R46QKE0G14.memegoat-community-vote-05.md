---
title: "Trait memegoat-community-vote-05"
draft: true
---
```
;;
...
(define-public (execute (sender principal) (opt uint))
  (begin
    (try! (is-dao-or-extension))
    ;; leo pool
    (try! (contract-call? .memegoat-community-pools-v1 set-approval-status 'SP1AY6K3PQV5MRT6R4S671NWW2FRVPKM0BR162CT6.leo-token u28 true))
    (ok true)
  )
)
