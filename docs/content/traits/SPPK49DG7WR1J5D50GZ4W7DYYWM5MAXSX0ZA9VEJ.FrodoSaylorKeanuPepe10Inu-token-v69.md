---
title: "Trait FrodoSaylorKeanuPepe10Inu-token-v69"
draft: true
---
```
;; ---------------------------------------------------------
...
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://bafkreianrp5f2qlzzjow6zefoj75rznyopqkvxx5dbttc22apbhpm5xa5q.ipfs.nftstorage.link"))
...
(begin
  (try! (ft-mint? FrodoSaylorKeanuPepe10Inu u120138879310000 'SP274TRYH62WAYP9M6NPZD2219S12K4BWTZEAQA16))
)
```
