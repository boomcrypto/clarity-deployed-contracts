---
title: "Trait gangnam-rose-apt-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u18690420093000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPD1R8A962EKB8JEHFQTFNXGZTRR93J0NG5KCM81.gangnam-rose-apt-stxcity)
...
(var-set token-balance u16823060389738972)
