---
title: "Trait rug-pull-advisory-token-ldp-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP32BCNMVZ237CC7CHV53GVXHFY8TKVCF1Q2PC59J.rug-pull-advisory-token-ldp-stxcity)
