---
title: "Trait stackswap-collateral-types-v1b"
draft: true
---
```

(impl-trait .stackswap-collateral-types-trait-v1b.collateral-types-trait)
...
(begin
  (map-set collateral-types
    { name: "STX-A" }
    {
      ...
      collateral-to-debt-ratio: u150, 
      maximum-debt: u10000000000000,
      stability-fee: u9512937595,
      stability-fee-decimals: u16,
      stability-fee-apy: u500
    }
  )
  (map-set collateral-types
    { name: "STX-B" }
