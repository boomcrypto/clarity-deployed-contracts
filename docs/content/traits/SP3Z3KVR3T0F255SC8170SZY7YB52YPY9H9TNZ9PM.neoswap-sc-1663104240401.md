---
title: "Trait neoswap-sc-1663104240401"
draft: true
---
```
(use-trait nft 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-constant agent-1 'SP2JGQT966TBN0HTKS1BHNZY44GZ7NZV9JM6YEK9V)
...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u5731569 tx-sender agent-1)))
	)
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u1077 tx-sender agent-1)))
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4991569 tx-sender agent-2)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u4991569 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
