---
title: "Trait satothewise-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP37DYXVWBXEH82Y84K1FQTWSADE9EF0H4SQETWXT.satothewise-stxcity)
...
(var-set token-balance u9998666844420744)
