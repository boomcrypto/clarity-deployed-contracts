---
title: "Trait zerebro-ai-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP3TCNAP82H54EKQX1W5D01QPHMKRM018KH4TF3VH.zerebro-ai-stxcity)
...
(var-set token-balance u982961992136304)
(var-set stx-balance u34666667)
