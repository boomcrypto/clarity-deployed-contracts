---
title: "Trait neoswap-sc-1689880639361"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/xRY79WudqPpGYyWHz7PT
;; SwapId: czopB3WxgKGYaFLkIBql
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u5200000 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u5200000 tx-sender TRADER-1)))
