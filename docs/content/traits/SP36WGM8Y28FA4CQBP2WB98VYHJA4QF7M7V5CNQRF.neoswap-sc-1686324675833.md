---
title: "Trait neoswap-sc-1686324675833"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/zO55evtRmn12FcLxIbwq
;; SwapId: A6f12z7eW9Yd3UDmVSTp
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u310000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (contract-call? 'SP3QWNA75CY7QAK7S9XG7T258KSVQE1DW4HGTVRA3.king-katz transfer u190 tx-sender TRADER-2)))

	(unwrap-panic (as-contract (stx-transfer? u310000 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u310000 tx-sender TRADER-1)))
