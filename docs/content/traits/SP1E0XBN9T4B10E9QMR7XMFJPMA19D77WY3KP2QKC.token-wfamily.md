...
(define-fungible-token wfamily)

(define-data-var token-name (string-ascii 32) "Family Wrapper")
(define-data-var token-symbol (string-ascii 32) "wfamily")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wfamily.json"))
...
(define-read-only (get-base-token)
  'SP3ATSS8V1SVQJRX1BF44Z12JENZ1K6FQ6J5F7XHX.family)

(define-read-only (get-base-decimals)
  (contract-call? 'SP3ATSS8V1SVQJRX1BF44Z12JENZ1K6FQ6J5F7XHX.family get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP3ATSS8V1SVQJRX1BF44Z12JENZ1K6FQ6J5F7XHX.family get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP3ATSS8V1SVQJRX1BF44Z12JENZ1K6FQ6J5F7XHX.family transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
