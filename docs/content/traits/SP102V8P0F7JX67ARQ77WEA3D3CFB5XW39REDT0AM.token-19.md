...
(define-fungible-token token-19)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-19 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-19)))
