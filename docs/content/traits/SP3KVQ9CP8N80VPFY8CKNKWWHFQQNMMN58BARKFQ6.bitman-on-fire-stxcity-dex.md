---
title: "Trait bitman-on-fire-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP3KVQ9CP8N80VPFY8CKNKWWHFQQNMMN58BARKFQ6.bitman-on-fire-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u20315371964786)
    (var-set stx-balance u13480000)
