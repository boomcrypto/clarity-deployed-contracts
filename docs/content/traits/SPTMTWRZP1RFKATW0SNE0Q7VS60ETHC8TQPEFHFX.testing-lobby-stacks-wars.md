---
title: "Trait testing-lobby-stacks-wars"
draft: true
---
```
...
(define-data-var pool-name (string-ascii 50) "testing lobby")
(define-data-var max-players uint u4)
(define-data-var prize-pool uint u100)
(define-data-var amount-per-player uint u25)
