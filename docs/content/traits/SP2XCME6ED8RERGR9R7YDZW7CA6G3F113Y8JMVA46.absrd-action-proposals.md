---
title: "Trait absrd-action-proposals"
draft: true
---
```
...
(define-public (propose-action (action <action-trait>) (parameters (buff 2048)))
  (let
    (
      ...
      (voterBalance (unwrap! (contract-call? 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.absrd-stxcity get-balance tx-sender) ERR_FETCHING_TOKEN_DATA))
