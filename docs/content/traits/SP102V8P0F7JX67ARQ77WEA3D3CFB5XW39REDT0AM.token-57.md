...
(define-fungible-token token-57)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-57 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-57)))
