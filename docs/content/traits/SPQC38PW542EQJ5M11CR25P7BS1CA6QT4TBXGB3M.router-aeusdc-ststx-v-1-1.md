---
title: "Trait router-aeusdc-ststx-v-1-1"
draft: true
---
```
;; router-aeusdc-ststx-v-1-1
...
;; route-a: aeusdc-susdt, then susdt-stx, then stx-ststx
...
;; route-b: ststx-stx, then stx-susdt, then susdt-aeusdc
