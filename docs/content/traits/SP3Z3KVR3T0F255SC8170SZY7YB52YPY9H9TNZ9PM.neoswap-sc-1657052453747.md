---
title: "Trait neoswap-sc-1657052453747"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3009000 tx-sender agent-4)))
	)
	(unwrap-panic (begin
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u9000 tx-sender agent-3)))
	)
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u1287 tx-sender agent-5)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u9000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
