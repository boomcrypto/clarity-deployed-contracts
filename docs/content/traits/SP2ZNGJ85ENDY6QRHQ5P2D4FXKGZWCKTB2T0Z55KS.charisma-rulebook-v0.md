---
title: "Trait charisma-rulebook-v0"
draft: true
---
```
...
(define-data-var max-mint uint u0)  ;; 0 DMG
...
(define-public (mint (amount uint) (target principal))
  (let ((modified (modify-mint {amount: amount, target: target, caller: contract-caller})))
    ...
    (contract-call? 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dme000-governance-token dmg-mint (get amount modified) (get target modified))))
