...
(define-fungible-token token-25)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-25 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-25)))
