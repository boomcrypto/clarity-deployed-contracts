...
(define-fungible-token wbleo)

(define-data-var token-name (string-ascii 32) "Baby Leo Wrapper")
(define-data-var token-symbol (string-ascii 32) "wbleo")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wbleo.json"))
...
(define-read-only (get-base-token)
  'SP306GW4ZQVNEZ2TMECB18XR78KRANYY2F63XM87T.baby-leo)

(define-read-only (get-base-decimals)
  (contract-call? 'SP306GW4ZQVNEZ2TMECB18XR78KRANYY2F63XM87T.baby-leo get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP306GW4ZQVNEZ2TMECB18XR78KRANYY2F63XM87T.baby-leo get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP306GW4ZQVNEZ2TMECB18XR78KRANYY2F63XM87T.baby-leo transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
