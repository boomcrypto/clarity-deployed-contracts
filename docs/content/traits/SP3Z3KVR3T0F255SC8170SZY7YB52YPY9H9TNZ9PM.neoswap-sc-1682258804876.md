---
title: "Trait neoswap-sc-1682258804876"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/xMMFtvOxnxtvoG2FoidM
;; SwapId: p8xsdMHaj9uQk1eGPDPL
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u33364486 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
    (begin
	(unwrap-panic (as-contract (contract-call? 'SP8HMQP4Q63V3E6SXXPXZ4WJXA263HBD95QY2AM3.narcotix transfer u1973 tx-sender TRADER-1)))
	...
	(unwrap-panic (as-contract (stx-transfer? u33364486 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u33364486 tx-sender TRADER-2)))
