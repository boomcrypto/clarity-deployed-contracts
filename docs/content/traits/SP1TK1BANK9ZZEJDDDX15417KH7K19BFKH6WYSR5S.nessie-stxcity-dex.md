---
title: "Trait nessie-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP1TK1BANK9ZZEJDDDX15417KH7K19BFKH6WYSR5S.nessie-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u989282769991756)
    (var-set stx-balance u4333333)
