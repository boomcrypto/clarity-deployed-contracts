---
title: "Trait pontis-bridge-KOALA"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "KOALA.ON.IMPALA")
(define-data-var token-symbol (string-ascii 10) "KOALA")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmSo1tVtfAw8Gtt945FW8XEcqpWQhJqFjEKPG8eZaenpQF"))
;; 840000:56
