...
;; BSD Protocol 
(impl-trait .bsd-trait-vpv-5.bsd-trait)
...
(map-set authorized-protocol-callers .registry-vpv-5 true)
(map-set authorized-protocol-callers .vault-vpv-5 true)
(map-set authorized-protocol-callers .redeem-vpv-5 true)
(map-set authorized-protocol-callers .stability-vpv-5 true)
```
