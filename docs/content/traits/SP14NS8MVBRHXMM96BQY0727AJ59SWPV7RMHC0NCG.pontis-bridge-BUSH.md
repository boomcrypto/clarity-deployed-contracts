---
title: "Trait pontis-bridge-BUSH"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "BUSH.DID.NINE.ELEVEN")
(define-data-var token-symbol (string-ascii 10) "BUSH")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmNxfAEWLM3QFRQUoSNASEMPo8mzX7vmdEv3P5DiH6hErh"))
;; 840000:57
