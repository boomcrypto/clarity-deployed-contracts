---
title: "Trait pickle-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u666666666000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP1A1GRPBTT1Q9D6APCCGEHXSNXNMHGST8RZ33ARC.pickle-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u616522810727496)
    (var-set stx-balance u81333333)
