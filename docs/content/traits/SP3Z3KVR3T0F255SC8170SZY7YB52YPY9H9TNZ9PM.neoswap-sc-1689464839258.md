---
title: "Trait neoswap-sc-1689464839258"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/jCX2oqcvivfFIVLS5cX3
;; SwapId: W01YW0Tigm6jFxznBhlg

;; traders
(define-constant TRADER-1 'SP136AXDAQ41R31GJWJX8KX14E2T4K8PA08NCE6Q5)
(define-constant TRADER-2 'SP3ZQ3PRK7K9YG2E1AA2F4KAV6TZ876XDEQQBBGDB)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u5535101 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u5535101 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u5535101 tx-sender TRADER-1)))
