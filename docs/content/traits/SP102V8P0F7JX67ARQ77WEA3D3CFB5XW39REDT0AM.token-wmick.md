---
title: "Trait token-wmick"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token wmick)
(define-data-var token-name (string-ascii 32) "Mick Wrapper")
(define-data-var token-symbol (string-ascii 32) "wmick")
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP2Y8T3TR3FKH3Y2FPZVNQAEKNJXKWVS4RVQF48JE.stakemouse get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
