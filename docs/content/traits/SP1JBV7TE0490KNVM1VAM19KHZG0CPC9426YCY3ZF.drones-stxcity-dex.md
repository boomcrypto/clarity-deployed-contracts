---
title: "Trait drones-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP1JBV7TE0490KNVM1VAM19KHZG0CPC9426YCY3ZF.drones-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u94470336314397)
    (var-set stx-balance u35120000)
