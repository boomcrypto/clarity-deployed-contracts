---
title: "Trait onlybot2-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPVR6CK5SEWGB9C40MAKHATG52690YKRVHPGEXDC.onlybot2-stxcity)
...
(define-public (buy (token-trait <sip-010-trait>) (stx-amount uint) ) 
  (begin
    ...
    (try! (stx-transfer? u40000000 tx-sender deployer))
