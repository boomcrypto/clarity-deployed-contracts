---
title: "Trait xyk-emissions-pool-8-roons-v-1-2"
draft: true
---
```

;; xyk-emissions-pool-8-roons-v-1-2
...
(define-private (get-external-user-data (user principal) (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     .xyk-staking-pusdh-roons-v-1-2 get-user-at-cycle
...
(define-private (get-external-cycle-data (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     .xyk-staking-pusdh-roons-v-1-2 get-lp-staked-at-cycle
