---
title: "Trait ballot-vote-with-alex-a-532Se"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with ALEX) Approve transition of ALEX Bridge into a separate entity XLink")
    ...
    (var-set options (list "3dea1157-9b46-4879-be11-1e1ad62b35d3" "d68b1fe5-84b7-4a0f-960a-3d28ce795204"))
    (var-set start u128755)
    (var-set end u129763)
    (map-set results {id: "3dea1157-9b46-4879-be11-1e1ad62b35d3"} {count: u0, name: u"Approve transition of ALEX Bridge into a separate entity XLink"}) (map-set results {id: "d68b1fe5-84b7-4a0f-960a-3d28ce795204"} {count: u0, name: u"Disapprove transition of ALEX Bridge into a separate entity XLink"})
```
