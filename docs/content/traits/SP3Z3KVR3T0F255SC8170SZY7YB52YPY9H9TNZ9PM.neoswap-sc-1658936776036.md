---
title: "Trait neoswap-sc-1658936776036"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u1758 tx-sender agent-3)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1920000 tx-sender agent-4)))
	)
	(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u2828 tx-sender agent-5)))
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1160000 tx-sender agent-6)))
	)
