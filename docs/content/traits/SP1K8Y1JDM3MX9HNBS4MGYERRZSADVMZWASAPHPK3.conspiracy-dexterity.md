---
title: "Trait conspiracy-dexterity"
draft: true
---
```
;; Conspiracy - LP Token, AMM DEX and Hold-to-Earn Engine
;; SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.conspiracy-dexterity
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.conspiracy-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    (sender tx-sender)
    (reserve-in (unwrap-panic (if forward (contract-call? 'SP3W69VDG9VTZNG7NTW1QNCC1W45SNY98W1JSZBJH.flat-earth-stxcity get-balance CONTRACT) 
      (contract-call? 'SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.simulation-coin-stxcity get-balance CONTRACT))))
    (reserve-out (unwrap-panic (if forward (contract-call? 'SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.simulation-coin-stxcity get-balance CONTRACT) 
      (contract-call? 'SP3W69VDG9VTZNG7NTW1QNCC1W45SNY98W1JSZBJH.flat-earth-stxcity get-balance CONTRACT))))
    ...
    (try! (if forward (contract-call? 'SP3W69VDG9VTZNG7NTW1QNCC1W45SNY98W1JSZBJH.flat-earth-stxcity transfer amt-in sender CONTRACT none) 
      (contract-call? 'SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.simulation-coin-stxcity transfer amt-in sender CONTRACT none)))
    (try! (as-contract (if forward (contract-call? 'SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.simulation-coin-stxcity transfer amt-out CONTRACT sender none)
      (contract-call? 'SP3W69VDG9VTZNG7NTW1QNCC1W45SNY98W1JSZBJH.flat-earth-stxcity transfer amt-out CONTRACT sender none))))
    (ok {amt-in: amt-in, amt-out: amt-out})))

(define-public (mint (who principal) (amount uint))
  (let (
    (reserve0 (unwrap-panic (contract-call? 'SP3W69VDG9VTZNG7NTW1QNCC1W45SNY98W1JSZBJH.flat-earth-stxcity get-balance CONTRACT)))
    (reserve1 (unwrap-panic (contract-call? 'SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.simulation-coin-stxcity get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SP3W69VDG9VTZNG7NTW1QNCC1W45SNY98W1JSZBJH.flat-earth-stxcity transfer token0-amount who CONTRACT none))
    (try! (contract-call? 'SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.simulation-coin-stxcity transfer token1-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SP3W69VDG9VTZNG7NTW1QNCC1W45SNY98W1JSZBJH.flat-earth-stxcity transfer token0-amount CONTRACT who none)))
    (try! (as-contract (contract-call? 'SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.simulation-coin-stxcity transfer token1-amount CONTRACT who none)))
    (ok {token0-amount: token0-amount, token1-amount: token1-amount, lp-amount: amount})))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP3W69VDG9VTZNG7NTW1QNCC1W45SNY98W1JSZBJH.flat-earth-stxcity, token1: 'SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.simulation-coin-stxcity}))
...
(define-read-only (get-reserves)
  (ok {
    token0: (unwrap-panic (contract-call? 'SP3W69VDG9VTZNG7NTW1QNCC1W45SNY98W1JSZBJH.flat-earth-stxcity get-balance CONTRACT)),
    token1: (unwrap-panic (contract-call? 'SP1K8Y1JDM3MX9HNBS4MGYERRZSADVMZWASAPHPK3.simulation-coin-stxcity get-balance CONTRACT))
  }))
