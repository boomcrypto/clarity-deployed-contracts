---
title: "Trait neoswap-sc-1685641500616"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/ebrCy5HFMGmnEgmBXS7z
;; SwapId: 236mblnVOQcJ6wPTpf4V
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u2850000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u2850000 tx-sender TRADER-2)))
