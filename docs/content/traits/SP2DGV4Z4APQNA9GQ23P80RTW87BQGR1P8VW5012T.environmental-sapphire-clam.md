---
title: "Trait environmental-sapphire-clam"
draft: true
---
```
(define-public (execute (price-feed-bytes (optional (buff 8192))))
    (let (
        ...
        (try! (contract-call? 'SP2VCQJGH7PHP2DJK7Z0V48AGBHQAW3R3ZW1QF4N.asset-deployment-143 run-update))

        (try! (stx-transfer? u1100000 tx-sender (as-contract tx-sender)))

        (as-contract 
            (try!
                (contract-call? 'SP2VCQJGH7PHP2DJK7Z0V48AGBHQAW3R3ZW1QF4N.borrow-helper-v2-1-0
                    supply
                    ...
                    tx-sender
                    none
                    'SP2VCQJGH7PHP2DJK7Z0V48AGBHQAW3R3ZW1QF4N.incentives-v2-0
                )
            )
        )
