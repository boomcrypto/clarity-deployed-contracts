...
(define-fungible-token token-37)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-37 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-37)))
