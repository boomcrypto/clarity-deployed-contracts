---
title: "Trait stableswap-stx-ststx-v-1-1"
draft: true
---
```
;; Bitflow Stableswap Core Contract
;; This contract handles the core logic of the Stableswap protocol.
;; The trading pair is STX<>stSTX where stSTX is the liquid stacking token by StackingDAO.
...
(define-data-var staking-and-rewards-contract principal contract-caller)
