---
title: "Trait stableswap-pool-aeusdc-usdh-v-1-2"
draft: true
---
```

;; stableswap-pool-aeusdc-usdh-v-1-2

;; Implement Stableswap pool trait and use SIP 010 trait
(impl-trait .stableswap-pool-trait-v-1-2.stableswap-pool-trait)
...
(define-constant CORE_ADDRESS .stableswap-core-v-1-2)
