...
(define-constant token-supply u88666000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant COMPLETE_FEE u200000000) ;; 2%
...
(define-constant allow-token 'SP2DRM5DKDJX6ECFJH9XDT66DZV8FK2H1A27JZHCA.cow-with-soap-bonding-curve)
