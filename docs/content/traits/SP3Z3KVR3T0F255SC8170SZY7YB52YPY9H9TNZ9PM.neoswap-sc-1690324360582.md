---
title: "Trait neoswap-sc-1690324360582"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/EHwy3B7BULFxiv6JLEib
;; SwapId: YztfuuIuZPKYNW0EfKc1

;; traders
(define-constant TRADER-1 'SP344RE1J7654NGD0D5WZNS3RT03VYR01SD1M8T3D)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u4480000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u4480000 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u4480000 tx-sender TRADER-2)))
