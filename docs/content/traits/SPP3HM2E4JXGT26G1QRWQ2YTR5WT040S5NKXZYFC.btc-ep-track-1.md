---
title: "Trait btc-ep-track-1"
draft: true
---
```
;; btc-ep-track-1
;; contractType: editions
;; Reviewed by Rapha.btc

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)
;; (impl-trait .nft-trait-gamma.nft-trait)
(define-non-fungible-token btc-ep-track-1 uint)
;; Constants
(define-constant DEPLOYER 'SP1T78J8434G726CJ8CRZN2SMPCVV63MW1RZ118Z7) ;; hardcoded deployer address
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmbfUSnnpER6UipMErZs2ZXXaAb7BS7LvmckUS4Qtf4P33/")
...
(begin
(unwrap! (nft-mint? btc-ep-track-1 next-id tx-sender) next-id)
(+ next-id u1)
...
(nft-burn? btc-ep-track-1 token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
(is-eq user (unwrap! (nft-get-owner? btc-ep-track-1 token-id) false)))
...
(ok (nft-get-owner? btc-ep-track-1 token-id)))
...
(match (nft-transfer? btc-ep-track-1 id sender recipient)
success
(let
...
(let ((owner (unwrap! (nft-get-owner? btc-ep-track-1 id) false)))
...
(let ((owner (unwrap! (nft-get-owner? btc-ep-track-1 id) (err ERR-NOT-FOUND)))
