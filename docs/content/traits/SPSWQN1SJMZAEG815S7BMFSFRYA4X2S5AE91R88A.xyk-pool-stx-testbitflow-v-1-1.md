---
title: "Trait xyk-pool-stx-testbitflow-v-1-1"
draft: true
---
```

;; xyk-pool-stx-testbitflow-v-1-1
...
(define-constant CONTRACT_DEPLOYER 'SPSWQN1SJMZAEG815S7BMFSFRYA4X2S5AE91R88A.bitflow-no-buy-first-stxcity-dex)
