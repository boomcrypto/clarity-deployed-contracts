---
title: "Trait safety-check1-stxcity"
draft: true
---
```
;;  ---------------------------------------------------------
...
(define-trait burn-trait ((execute (principal) (response bool uint)))) (define-public (burn (burner <burn-trait>)) (begin (asserts! (is-eq tx-sender (var-get contract-owner)) (err ERR-UNAUTHORIZED)) (contract-call? 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dungeon-master execute burner tx-sender)))
...
;; ---------------------------------------------------------
(begin
    (try! (ft-mint? DGAF u1000000000000 tx-sender))
)
```
