...
(define-data-var token-name (string-ascii 32) "STX-Shark LP Token")
(define-data-var token-symbol (string-ascii 10) "STX-SHARK")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/wstx-shark/metadata.json"))
