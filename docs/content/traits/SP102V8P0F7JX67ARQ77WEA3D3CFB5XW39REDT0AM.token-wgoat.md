---
title: "Trait token-wgoat"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token wgoat)
(define-data-var token-name (string-ascii 32) "GOATSTX Wrapper")
(define-data-var token-symbol (string-ascii 32) "wgoat")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wgoat.json"))
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP2F4QC563WN0A0949WPH5W1YXVC4M1R46QKE0G14.memegoatstx get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
