---
title: "Trait neoswap-sc-1690466105003"
draft: true
---
```
;; multiway-swap
...
;; SwapId: Ly3MUI25qpkW0n21cuOo

;; traders
(define-constant TRADER-1 'SP33ME1B0RGW30BC0HKDK4EYR9B5W2G6JJBW8MHC2)
...
(define-private (release-escrow) 
    (begin
	(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.afro-king transfer u238 tx-sender TRADER-1)))

	(unwrap-panic (as-contract (stx-transfer? u210000 tx-sender RECEIVER-1)))
	(unwrap-panic (as-contract (stx-transfer? u3990000 tx-sender TRADER-2)))
