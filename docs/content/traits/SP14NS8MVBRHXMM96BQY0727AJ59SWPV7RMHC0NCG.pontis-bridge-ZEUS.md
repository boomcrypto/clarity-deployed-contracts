---
title: "Trait pontis-bridge-ZEUS"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "ZEUS.RUNES.BITCOIN")
(define-data-var token-symbol (string-ascii 10) "ZEUS")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmU398xkWbMV6hVBV6a2TbxLvSoteuot76QCiw6RoRZXDC"))
;; 856915:1096
