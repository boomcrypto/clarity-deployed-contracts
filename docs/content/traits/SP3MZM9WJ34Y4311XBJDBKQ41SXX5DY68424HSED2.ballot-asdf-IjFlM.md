...
```
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-ft-holdings)
            (at-block (unwrap-panic (get-block-info? id-header-hash u363301))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"asdf")
    (var-set description u"asdfadsf")
    (var-set voting-system "fptp")
    (var-set options (list "5672a7d1-a908-4784-b0ed-324a57f0d2f6" "7f80ba59-f15f-4644-82da-da64fc38c6b7"))
    (var-set start u178538)
    (var-set end u179538)
    (map-set results {id: "5672a7d1-a908-4784-b0ed-324a57f0d2f6"} {count: u0, name: u"Choice%201"}) (map-set results {id: "7f80ba59-f15f-4644-82da-da64fc38c6b7"} {count: u0, name: u"Choice%202"})
