...
(define-fungible-token wxusd)

(define-data-var token-name (string-ascii 32) "Wrapped USDC")
(define-data-var token-symbol (string-ascii 10) "xUSD")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wxusd.json"))
