...
(define-fungible-token token-26)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-26 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-26)))
