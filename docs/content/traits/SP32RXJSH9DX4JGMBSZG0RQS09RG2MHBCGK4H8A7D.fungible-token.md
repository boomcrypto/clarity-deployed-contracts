...
(define-fungible-token ClokTen-coin)
...
(define-constant TOKEN_NAME "Clok Ten")
(define-constant TOKEN_SYMBOL "CLOK10")
...
(define-public (mint (amount uint) (recipient principal))
  (begin
    ...
    (ft-mint? ClokTen-coin amount recipient)
  )
)
...
(define-public (transfer
  ...
  (begin
    ...
    (try! (ft-transfer? ClokTen-coin amount sender recipient))
