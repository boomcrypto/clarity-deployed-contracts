---
title: "Trait undead-frost-mages"
draft: true
---
```
;; undead-frost-mages
...
(define-non-fungible-token undead-frost-mages uint)
...
;; Internal variables
(define-data-var mint-limit uint u47)
(define-data-var last-id uint u1)
(define-data-var total-price uint u44000000)
(define-data-var artist-address principal 'SP1XQW4W5FXJM63BJJ3QPN4DR5AXZS91476WNV76E)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmZBLJfKk1PUmmQX3vj5k59fs7Eyx6o5168B9aQAdNsyjz/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? undead-frost-mages next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? undead-frost-mages token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? undead-frost-mages token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? undead-frost-mages token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? undead-frost-mages id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? undead-frost-mages id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? undead-frost-mages id) (err ERR-NOT-FOUND)))
...
(map-set mint-passes 'SP2ABNX65BSKVM00ZQZ7K174DFV18CXVGGEMP7Y6X u4)
(map-set mint-passes 'SPV00QHST52GD7D0SEWV3R5N04RD4Q1PMA3TE2MP u4)
(map-set mint-passes 'SP2YXG51R7P18RJ0SNMEWGGNN1BJ792CYQHB57S6Q u3)
...
(map-set mint-passes 'SP356400A5XM1ZKNXCQ7BJRE8PXXG1EJHV3954Z27 u3)
(map-set mint-passes 'SP363ECSA62Y3HTHD6NB70RY5WTVA113WJPGN7G6N u3)
...
(map-set mint-passes 'SP1BS33ES5PWDG7J5HD70GEXD163Z6C55S22YXG62 u2)
(map-set mint-passes 'SP1QZT85MFT8HBAG3XEK7K6QY4GGP3MSG5C3H9PQ1 u2)
(map-set mint-passes 'SP1XQW4W5FXJM63BJJ3QPN4DR5AXZS91476WNV76E u2)
