---
title: "Trait neoswap-sc-1690393002873"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/xRZ4vYs3k0wZMGvpj9Ow
;; SwapId: ShtepBOFbnjs0jEWftu9
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
		...
		(unwrap! (contract-call? 'SP3M7N9Q9HDRM7RVP1Q26P0EE69358PZZAX4MD19Q.nft-nyc-exclusive transfer u220 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
	    )
            true
        )
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (contract-call? 'SP3M7N9Q9HDRM7RVP1Q26P0EE69358PZZAX4MD19Q.nft-nyc-exclusive transfer u220 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u5790000 tx-sender TRADER-1)))
		(unwrap-panic (as-contract (contract-call? 'SP3M7N9Q9HDRM7RVP1Q26P0EE69358PZZAX4MD19Q.nft-nyc-exclusive transfer u220 tx-sender TRADER-1)))
	    )
            true
        )
