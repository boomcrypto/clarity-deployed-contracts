...
(define-fungible-token token-29)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-29 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-29)))
