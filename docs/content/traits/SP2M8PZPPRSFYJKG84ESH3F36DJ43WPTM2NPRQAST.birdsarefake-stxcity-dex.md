...
(define-constant allow-token 'SP2M8PZPPRSFYJKG84ESH3F36DJ43WPTM2NPRQAST.birdsarefake-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u959692898272552)
    (var-set stx-balance u42000000)
