---
title: "Trait rising-of-the-great-worm"
draft: true
---
```
;; rising-of-the-great-worm
;; contractType: public

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token rising-of-the-great-worm uint)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmQH7LYKwRHXCrhtM2EymSmQZgVTWfiaoCR34JpykDRhfc/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? rising-of-the-great-worm next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? rising-of-the-great-worm token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? rising-of-the-great-worm token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? rising-of-the-great-worm token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? rising-of-the-great-worm id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? rising-of-the-great-worm id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? rising-of-the-great-worm id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u3161)
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u1094000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u431000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u37000000)
...
;; Alt Minting Default
(define-data-var total-price-slime uint u357000000)
