...
;; BSD Protocol 
(impl-trait .bsd-trait-vpv-3.bsd-trait)
...
(map-set authorized-protocol-callers .registry-vpv-3 true)
(map-set authorized-protocol-callers .vault-vpv-3 true)
(map-set authorized-protocol-callers .redeem-vpv-3 true)
(map-set authorized-protocol-callers .stability-vpv-3 true)
```
