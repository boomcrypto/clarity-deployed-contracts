---
title: "Trait ballot-will-the-nih-202-dbHJ6"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Will%20the%20NIH%202025%20funding%20cuts%20negatively%20affect%20the%20overall%20global%20competitiveness%20of%20the%20United%20States%20in%20scientific%20research%20and%20innovation%20before%20the%20end%20of%202035%3F")
    ...
    (var-set options (list "12702592-b804-4bab-8f62-abdfca0d8bee" "ea582966-05d2-450a-b613-8d4ab83cdc16" "ae254f45-2506-460d-958b-1676cb3f6090" "5449688c-5c12-4355-a5a1-b4930259bb5b"))
    (var-set start u188980)
    (var-set end u230889)
    (map-set results {id: "12702592-b804-4bab-8f62-abdfca0d8bee"} {count: u0, name: u"Yes"}) (map-set results {id: "ea582966-05d2-450a-b613-8d4ab83cdc16"} {count: u0, name: u"Probably%20yes"}) (map-set results {id: "ae254f45-2506-460d-958b-1676cb3f6090"} {count: u0, name: u"Probably%20not"}) (map-set results {id: "5449688c-5c12-4355-a5a1-b4930259bb5b"} {count: u0, name: u"No"})
```
