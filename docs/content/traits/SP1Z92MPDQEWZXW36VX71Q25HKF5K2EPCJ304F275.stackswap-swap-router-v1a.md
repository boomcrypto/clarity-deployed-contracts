---
title: "Trait stackswap-swap-router-v1a"
draft: true
---
```
...
(define-public (router-swap
  ...
  (let
    ...
    (let
        ...
        ;; (ok (list from-amt delta_bridge_amt))
        (asserts! (> delta_bridge_amt from-2-bridge-min-amt) ERR_INEFFICIENT_AMOUNT_BRIDGE)
        (if (and to-type true)
            (begin
        ...
        (let
            ...
            (asserts! (> delta_bridge_amt bridge-2-to-min-amt) ERR_INEFFICIENT_AMOUNT_TO)
