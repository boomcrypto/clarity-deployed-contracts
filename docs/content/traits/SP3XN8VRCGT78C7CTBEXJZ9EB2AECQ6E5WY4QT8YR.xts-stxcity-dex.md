...
(define-constant token-supply u1818000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP3XN8VRCGT78C7CTBEXJZ9EB2AECQ6E5WY4QT8YR.xts-stxcity)
