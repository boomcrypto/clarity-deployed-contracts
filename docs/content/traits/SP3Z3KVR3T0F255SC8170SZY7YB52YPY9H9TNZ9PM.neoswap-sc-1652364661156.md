---
title: "Trait neoswap-sc-1652364661156"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u1948 tx-sender agent-1)))
	...
	(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u5321 tx-sender agent-1)))
	(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u6882 tx-sender agent-1)))
	(unwrap-panic (begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP497E7RX3233ATBS2AB9G4WTHB63X5PBSP5VGAQ.boom-nfts transfer u9923 tx-sender agent-2)))
		(as-contract (stx-transfer? u100000 tx-sender agent-2)))
	)
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1651000 tx-sender agent-5)))
	)
	...
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP1691VGPP73NJ4QXQWZQX1779SCGH257CZV9TY00.women-power transfer u50 tx-sender agent-7)))
		(as-contract (stx-transfer? u10260000 tx-sender agent-7)))
	)
	(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u49 tx-sender agent-8)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u14999000 tx-sender agent-9)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u10310000 tx-sender agent-0)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.stx-youth transfer u224 tx-sender agent-3)))
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.stx-jokers transfer u407 tx-sender agent-3)))
	...
	(unwrap-panic (begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP497E7RX3233ATBS2AB9G4WTHB63X5PBSP5VGAQ.boom-nfts transfer u9923 tx-sender agent-4)))
		(as-contract (stx-transfer? u1800000 tx-sender agent-4)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP2N3BAG4GBF8NHRPH6AY4YYH1SP6NK5TGCY7RDFA.stacks-mfers transfer u1345 tx-sender agent-5)))
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP229FR0MTFR0PX83YS9P5KEHAFPPKTXPG04RKP7T.afro-sisters transfer u18 tx-sender agent-6)))
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP2N3BAG4GBF8NHRPH6AY4YYH1SP6NK5TGCY7RDFA.stacks-mfers transfer u2295 tx-sender agent-7)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1691VGPP73NJ4QXQWZQX1779SCGH257CZV9TY00.women-power transfer u50 tx-sender agent-9)))
		(unwrap-panic (as-contract (contract-call? 'SP248HH800501WYSG7Z2SS1ZWHQW1GGH85ME34NT2.gm-silver-airdrop-continued transfer u60 tx-sender agent-9)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u21320000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (stx-transfer? u1800000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (contract-call? 'SP1691VGPP73NJ4QXQWZQX1779SCGH257CZV9TY00.women-power transfer u50 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
