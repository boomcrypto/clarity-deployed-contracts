---
title: "Trait token-wfatherwelsh"
draft: true
---
```
...
(define-fungible-token wfatherwelsh)

(define-data-var token-name (string-ascii 32) "Father of Welsh Wrapper")
(define-data-var token-symbol (string-ascii 32) "wfatherwelsh")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wfatherwelsh.json"))
...
(define-read-only (get-base-token)
  'SP1YT7HPD025ZMY9Q5NYHZ6V7MN6J8BMHVXKD3NJJ.father-of-welsh)

(define-read-only (get-base-decimals)
  (contract-call? 'SP1YT7HPD025ZMY9Q5NYHZ6V7MN6J8BMHVXKD3NJJ.father-of-welsh get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP1YT7HPD025ZMY9Q5NYHZ6V7MN6J8BMHVXKD3NJJ.father-of-welsh get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SP1YT7HPD025ZMY9Q5NYHZ6V7MN6J8BMHVXKD3NJJ.father-of-welsh transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
