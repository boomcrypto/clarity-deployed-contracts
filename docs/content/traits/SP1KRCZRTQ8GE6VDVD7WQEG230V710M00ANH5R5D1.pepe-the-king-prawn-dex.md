---
title: "Trait pepe-the-king-prawn-dex"
draft: true
---
```
...
(define-constant token-supply u69100000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP1KRCZRTQ8GE6VDVD7WQEG230V710M00ANH5R5D1.pepe-the-king-prawn-bonding-curve)
