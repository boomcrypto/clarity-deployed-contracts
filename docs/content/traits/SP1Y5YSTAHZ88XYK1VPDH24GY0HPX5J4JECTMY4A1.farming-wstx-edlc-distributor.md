---
title: "Trait farming-wstx-edlc-distributor"
draft: true
---
```
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constants
(define-constant REWARD-TOKEN 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.edelcoin)
...
(define-public
  ...
  (let ((epoch (contract-call? .farming-wstx-edlc-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .farming-wstx-edlc-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .farming-wstx-edlc-core current-epoch))
