---
title: "Trait tradimple-sc-1645042549834"
draft: true
---
```
(use-trait nft 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-constant agent-1 'SP1JX2RYKPR0G7H81SQHZQ187H50RR6QSM8GX839X)
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SPGAKH27HF1T170QET72C727873H911BKNMPF8YB.stacks-board-slot transfer u225 tx-sender agent-3)))
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPGAKH27HF1T170QET72C727873H911BKNMPF8YB.stacks-board-slot transfer u225 tx-sender agent-1)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u1425 tx-sender agent-5)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SPGAKH27HF1T170QET72C727873H911BKNMPF8YB.stacks-board-slot transfer u225 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
