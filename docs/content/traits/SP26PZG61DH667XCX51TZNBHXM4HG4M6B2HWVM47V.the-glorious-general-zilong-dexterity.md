---
title: "Trait the-glorious-general-zilong-dexterity"
draft: true
---
```
;; The glorious General Zilong - LP Token, AMM DEX and Hold-to-Earn Engine
;; SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.the-glorious-general-zilong-dexterity
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.the-glorious-general-zilong-dexterity"))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.zilong-meme-token-mobile-legend, token1: 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token}))
...
(define-read-only (get-name)
  (ok "The glorious General Zilong"))
