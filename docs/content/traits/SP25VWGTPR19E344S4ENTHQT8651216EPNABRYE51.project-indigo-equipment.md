---
title: "Trait project-indigo-equipment"
draft: true
---
```
;; Equipment(s) NFT
;; Equipment NFT for Project Indigo
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let
    ...
    (try! (nft-transfer? equipment id owner tx-sender))
    (map-delete market id)
...
(define-public (mint-equipment (lost-shipment-id uint))
  (let
    ...
    (asserts! (is-eq tx-sender (unwrap-panic (unwrap-panic (contract-call? .project-indigo-lost-shipments get-owner lost-shipment-id)))) ERR-GET-OWNER-FAILED)

    ;; burn lost-shipments NFTs
    (try! (contract-call? .project-indigo-lost-shipments burn-lost-shipment lost-shipment-id))
