---
title: "Trait neoswap-sc-1693101348012"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/HxUbLGRQDy73EpYI0N35
;; SwapId: nZA1s23rsgcvnZoT2IGt
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u9500000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
	    )
            true
        )
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u9500000 tx-sender TRADER-2)))
