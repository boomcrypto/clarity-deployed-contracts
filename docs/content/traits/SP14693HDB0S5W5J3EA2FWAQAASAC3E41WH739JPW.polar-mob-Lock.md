...
;; STORAGE
(define-constant LOCK-TOKEN 'SP14693HDB0S5W5J3EA2FWAQAASAC3E41WH739JPW.Mob)
...
(define-public (initialize) 
  (begin
    (let
      (
        (token-amount u250000000000)
        (fee-in-stx true)
        (vested false)
        (unlock-blocks-data (list {height: u168649, percentage: u100}))
        (addresses-info (list {address: 'SP14693HDB0S5W5J3EA2FWAQAASAC3E41WH739JPW, amount: u250000000000, withdrawal-address: 'SP14693HDB0S5W5J3EA2FWAQAASAC3E41WH739JPW}))
      ) 
      ...
      (try! (contract-call? 'SP14693HDB0S5W5J3EA2FWAQAASAC3E41WH739JPW.Mob transfer token-amount tx-sender LOCK-ADDRESS none))
