...
(define-fungible-token token-56)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-56 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-56)))
