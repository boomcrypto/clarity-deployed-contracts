...
(define-fungible-token wmia)

(define-data-var token-name (string-ascii 32) "Wrapped MIA")
(define-data-var token-symbol (string-ascii 10) "MIA")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wmia.json"))
...
(define-read-only (get-balance (account principal))
  ...
  (ok (/ (* (unwrap-panic (contract-call? 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-token-v2 get-balance account)) (pow-decimals)) (pow u10 u6)))
)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    ...
    ;;NOTE V2 is expected to have 6 decimals
    (contract-call? 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-token-v2 transfer (/ (* amount (pow u10 u6)) (pow-decimals)) sender recipient memo)
  )
)
