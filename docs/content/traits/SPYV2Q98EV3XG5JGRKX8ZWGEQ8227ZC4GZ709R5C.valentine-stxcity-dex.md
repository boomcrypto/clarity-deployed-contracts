---
title: "Trait valentine-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPYV2Q98EV3XG5JGRKX8ZWGEQ8227ZC4GZ709R5C.valentine-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u68945992306026)
    (var-set stx-balance u313333)
