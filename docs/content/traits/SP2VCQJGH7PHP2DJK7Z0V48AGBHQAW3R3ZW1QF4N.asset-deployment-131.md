---
title: "Trait asset-deployment-131"
draft: true
---
```
...
(define-public (run-update)
  (begin
    ...
    (try! (contract-call? .pool-borrow-v2-0 set-asset-e-mode-type ststx-address stx-emode-type))
    (try! (contract-call? .pool-borrow-v2-0 set-asset-e-mode-type wstx-address stx-emode-type))
    (try! (contract-call? .pool-borrow-v2-0 set-asset-e-mode-type ststxbtc-address stx-emode-type))
