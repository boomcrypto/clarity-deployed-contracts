---
title: "Trait bitcoin-goats-spoints-subscriber"
draft: true
---
```
;;Contract that enables the subscription of nfts in collection SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-goats to gain spoints.
...
(define-constant collection-address 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-goats)
;;maps
...
(define-data-var multipliers principal 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.goat-multipliers)
...
(define-public (subscribe (lookup-table <lookup-trait>) (item uint)) 
    (let (
        ...
        (asserts! (is-eq (unwrap-panic (unwrap-panic (contract-call? 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-goats get-owner item))) tx-sender) (err ERR-NOT-AUTHORIZED))
