---
title: "Trait keeper-4-owwc2img8-v-1-1"
draft: true
---
```
;; keeper-4-owwc2img8-v-1-1
...
(define-data-var owner-address principal 'SP261KJDEZ63DCPV97TZWMP9BJH380BHMCDBWJPKG)

;; Bitcoin address authorized to receive bridged rune tokens and bitcoin
(define-data-var bitcoin-address (buff 64) 0x33457452526f4d536d685045566944394561393442546277414c7236314479677a75)
