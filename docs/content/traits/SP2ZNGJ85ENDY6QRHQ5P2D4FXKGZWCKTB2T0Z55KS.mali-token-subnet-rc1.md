---
title: "Trait mali-token-subnet-rc1"
draft: true
---
```
;; title: mali-token-subnet
;; authors: generated by Charisma
;; summary: Intent-based subnet token wrapper for belgian-malinois using blaze-intent verifier.
...
(define-read-only (get-decimals)     (contract-call? 'SPKBV3CZB15CM3CVMCMRX56WRYKDY5P5CTQQXSN0.belgian-malinois get-decimals))
(define-read-only (get-token-uri)    (contract-call? 'SPKBV3CZB15CM3CVMCMRX56WRYKDY5P5CTQQXSN0.belgian-malinois get-token-uri))
(define-read-only (get-total-supply) (contract-call? 'SPKBV3CZB15CM3CVMCMRX56WRYKDY5P5CTQQXSN0.belgian-malinois get-total-supply))
...
(define-public (withdraw (amount uint) (recipient (optional principal)))
  (let ((owner tx-sender)
    ...
    (try! (as-contract (contract-call? 'SPKBV3CZB15CM3CVMCMRX56WRYKDY5P5CTQQXSN0.belgian-malinois transfer amount tx-sender recv none)))
