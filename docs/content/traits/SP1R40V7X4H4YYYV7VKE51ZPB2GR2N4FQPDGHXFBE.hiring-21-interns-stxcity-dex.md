---
title: "Trait hiring-21-interns-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP1R40V7X4H4YYYV7VKE51ZPB2GR2N4FQPDGHXFBE.hiring-21-interns-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u988467874794069)
    (var-set stx-balance u14000000)
