...
(define-fungible-token token-30)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-30 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-30)))
