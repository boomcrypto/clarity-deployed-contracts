---
title: "Trait full-battery-faktory-dex"
draft: true
---
```

;; 14f69cdec6c249b0a055cd3038dd13f59488e71c877c3e9897c7dec6a61d926e
...
(define-constant AMM-RECEIVER 'SP2BN9JN4WEG02QYVX5Y21VMB2JWV3W0KNHPH9R4P)
(define-constant CANT-BE-EVIL 'SP000000000000000000002Q6VF78)
(define-constant DEV tx-sender)
(define-constant DEX-TOKEN 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.full-battery-faktory)
(define-constant TESTER 'SP3S2565C4DP2MGR3CMANMGYDCDA314Q258CG2R7C) ;; testing on mainnet

;; token constants
(define-constant TARGET_STX u1000000)
(define-constant FAK_STX u250000)
(define-constant GRAD-FEE u20000)
...
(define-public (buy (ft <faktory-token>) (ustx uint))
  (begin
    (asserts! (is-eq tx-sender TESTER) ERR-TOKEN-NOT-AUTH) ;; testing on mainnet
...
;; boot dex
  (begin
    ...
    (var-set ft-balance u69000000000000)
    (var-set stx-balance u0)
    (var-set open true)
    (try! (stx-transfer? u1000000 tx-sender 'SMH8FRN30ERW1SX26NJTJCKTDR3H27NRJ6W75WQE))
      (print { 
          ...
          ammReceiver: 'SP2BN9JN4WEG02QYVX5Y21VMB2JWV3W0KNHPH9R4P,
     })
    (ok true))
```
