---
title: "Trait neoswap-sc-1662653786208"
draft: true
---
```
...
(define-constant agent-8 'SP1QJBY8XZF6HVFSHBH5C8DGKK9BK4BC4ZHT944CB)
...
(begin
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u570000 tx-sender agent-3)))
	)
	(unwrap-panic (begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.dream-daruma transfer u2323 tx-sender agent-8)))
	(unwrap-panic (as-contract (contract-call? 'SP2A665S3H6FVMZSY4VJ17ESXX21CGS0A32984B1H.Punks-Army-Upgrade-NFTs transfer u250 tx-sender agent-8)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3160000 tx-sender agent-1)))
	)
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u2840000 tx-sender agent-5)))
	)
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4210000 tx-sender agent-8)))
	)
