---
title: "Trait xyk-sbtc-reader-pool-23-v-1-2"
draft: true
---
```
;; xyk-sbtc-reader-pool-23-v-1-2
...
(define-read-only (get-user-sbtc-balance (user principal))
  (let (
    ...
    (user-staking-data-a (unwrap! (contract-call? 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.xyk-staking-sbtc-bdc-v-1-1 get-user
                                  user) ERR_NO_USER_DATA))
    (user-staking-data-b (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-staking-sbtc-bdc-v-1-2 get-user
                                  user) ERR_NO_USER_DATA))
