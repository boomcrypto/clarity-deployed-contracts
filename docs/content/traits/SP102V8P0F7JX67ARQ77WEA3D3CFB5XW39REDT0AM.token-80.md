...
(define-fungible-token token-80)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-80 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-80)))
