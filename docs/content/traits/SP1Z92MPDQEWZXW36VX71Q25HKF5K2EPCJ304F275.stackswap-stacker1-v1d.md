---
title: "Trait stackswap-stacker1-v1d"
draft: true
---
```
...
(define-data-var stacker-name (string-ascii 256) "stacker-l")
      ...
      success (begin
        ...
        (match (as-contract (contract-call? 'SP000000000000000000002Q6VF78.pox stack-stx tokens-to-stack pox-addr start-burn-ht lock-period))
          result (begin
            ...
            (try! (contract-call? .stackswap-stx-reserve-v1c set-next-stacker-name "stacker-l-2"))
