...
(define-public (transfer (amount uint) (from principal) (to principal) (memo (optional (buff 34))))
  (begin
    ...
    (ft-transfer? stsw amount from to)
  )
)
...
;;     (ft-mint? stsw mint-amount mint-to)))
...
;;     (ft-burn? stsw burn-amount burn-from)))
...
(define-public (revoke-tokens (revoke-amount uint) (revoke-from principal) (revoke-to principal) )
  (begin
    ...
    (ft-transfer? stsw revoke-amount revoke-from revoke-to)))
...
(define-public (mint-for-dao (amount uint) (recipient principal))
  (begin
    (asserts! (is-eq contract-caller 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-dao-v4a) (err PERMISSION_DENIED_ERROR))
    (ft-mint? stsw amount recipient)
  )
)
