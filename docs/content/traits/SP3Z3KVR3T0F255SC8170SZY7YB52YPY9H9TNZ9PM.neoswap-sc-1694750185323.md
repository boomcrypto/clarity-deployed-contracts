---
title: "Trait neoswap-sc-1694750185323"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/Ru8RCAY2lsrtwxALJLDE
;; SwapId: WBaSwwjuBQdQD07RVBBL

;; traders
(define-constant TRADER-1 'SP136AXDAQ41R31GJWJX8KX14E2T4K8PA08NCE6Q5)
(define-constant TRADER-2 'SP24X692XB6CZB0Z70ZGWRNCY22PZ5FED3P9KBGS8)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
		...
		(unwrap! (contract-call? 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ.tyler-foust-with-gamma transfer u12 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
	    )
            true
        )
...
(define-private (release-escrow) 
    (begin
	(unwrap-panic (as-contract (contract-call? 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ.tyler-foust-with-gamma transfer u12 tx-sender TRADER-1)))
	...
	(unwrap-panic (as-contract (stx-transfer? u6300000 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
		...
		(unwrap-panic (as-contract (contract-call? 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ.tyler-foust-with-gamma transfer u12 tx-sender TRADER-2)))
	    )
            true
        )
