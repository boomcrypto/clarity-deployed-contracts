---
title: "Trait neoswap-sc-1661703103714"
draft: true
---
```
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3045000 tx-sender agent-2)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u3045000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
