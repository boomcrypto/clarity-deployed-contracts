...
(define-data-var token-name (string-ascii 32) "NICOLAS.PI.RUNES")
(define-data-var token-symbol (string-ascii 10) "NPR")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmZMkR7HzTCWyouB3n7FcdX92pWDZgdVhX28LXcwykaDZP"))
;; 840312:230
