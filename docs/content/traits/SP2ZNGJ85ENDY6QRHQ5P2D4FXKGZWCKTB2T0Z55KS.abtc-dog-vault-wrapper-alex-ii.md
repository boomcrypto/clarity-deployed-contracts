---
title: "Trait abtc-dog-vault-wrapper-alex-ii"
draft: true
---
```
;; Title: aBTC-DOG ALEX Wrapper
...
(define-constant POOL-ID u99)                  ;; ALEX STX-CHA pool ID

(define-constant TOKEN-NAME "THIS IS SPARTA!")
(define-constant TOKEN-SYMBOL "SPARTA")
(define-constant TOKEN-URI (some u"https://charisma.rocks/api/v0/metadata/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.abtc-dog-vault-wrapper-alex"))
...
(define-read-only (get-swap-quote (amount uint) (opcode (optional (buff 16))))
    (let (
        ...
        (alex-out (unwrap-panic (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.amm-pool-v2-01 get-helper
            (if is-a-in 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.token-abtc 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.runes-dog)
            (if is-a-in 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.runes-dog 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.token-abtc)
            ALEX-FACTOR
            (* amount AMOUNT-FACTOR)))))
        {
            dx: amount,
