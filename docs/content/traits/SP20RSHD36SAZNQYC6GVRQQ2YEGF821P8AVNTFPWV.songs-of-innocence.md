---
title: "Trait songs-of-innocence"
draft: true
---
```
;;####@##@###@###@##########@########@############@#@#@######*:--...............-..-+#@@###*:-::=*#@#@####@###@########@###@###@####@####@####@######@###@#@####@
...
(define-constant COMM-ADDR-ONE 'SP20RSHD36SAZNQYC6GVRQQ2YEGF821P8AVNTFPWV)
(define-constant COMM-ADDR-TWO 'SP20RSHD36SAZNQYC6GVRQQ2YEGF821P8AVNTFPWV)
...
(define-data-var artist-address principal 'SP20RSHD36SAZNQYC6GVRQQ2YEGF821P8AVNTFPWV)
(define-data-var ipfs-root (string-ascii 80) "ipfs://QmZMuHsTtNyToQ49VkjR1GGK4fapdvLaJjC1ST8YAGGycC/")
...
(define-public (claim (user (list 1 principal))) 
  (mint user))
