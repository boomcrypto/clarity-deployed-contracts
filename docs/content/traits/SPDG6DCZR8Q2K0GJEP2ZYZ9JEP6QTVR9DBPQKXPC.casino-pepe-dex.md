...
(define-constant token-supply u77000000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPDG6DCZR8Q2K0GJEP2ZYZ9JEP6QTVR9DBPQKXPC.casino-pepe-bonding-curve)
