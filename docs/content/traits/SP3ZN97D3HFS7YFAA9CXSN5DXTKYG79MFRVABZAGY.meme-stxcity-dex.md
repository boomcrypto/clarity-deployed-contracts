...
(define-constant AMM_WALLET 'SP28QFJ288ZDCQFEVT1RBSWV1B429EJQP6NF0NBQG)
(define-constant BURN_ADDRESS 'SP000000000000000000002Q6VF78) ;; burn mainnet

(define-constant deployer tx-sender)
(define-constant allow-token 'SP3ZN97D3HFS7YFAA9CXSN5DXTKYG79MFRVABZAGY.meme-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u63013698630136984)
    (var-set stx-balance u380000000)
