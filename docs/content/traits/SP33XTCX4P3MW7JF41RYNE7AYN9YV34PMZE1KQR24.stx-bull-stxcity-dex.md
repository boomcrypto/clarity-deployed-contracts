---
title: "Trait stx-bull-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP33XTCX4P3MW7JF41RYNE7AYN9YV34PMZE1KQR24.stx-bull-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u999512460033383)
    (var-set stx-balance u2926667)
