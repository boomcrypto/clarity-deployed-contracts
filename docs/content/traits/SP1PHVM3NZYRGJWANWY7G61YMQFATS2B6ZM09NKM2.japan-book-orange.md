...
(define-non-fungible-token japan-book-orange uint)
...
(define-data-var base-uri (string-ascii 100) "ipfs://QmbYfxMicPjh7WS5CZbdW11RUDACUvnnCLYa2V5bFqAwzj/1-japan-book-orange/")
...
(define-data-var artist-address (list 1000 principal) (list 'SP1ZQBAJAB9S0QFJCJSK6J0NR80334T7GBVMW7ABS 'SP1VZ743H2Y4K983JNN4DE13BB6410A7R8N16WAXF 'SP312R8WPKAGF3E5WJ7YHMFP8EDF1E3NJEZ11NB8J 'SP7NNN9PRQ0E0JDACV74F6TBKXY3476QEWRXAP3B 'SP218P6TAB7GXHV6G43GZM42NSXFHR6YB9VKC43XV )) 
...
(define-data-var public-target-block-height uint u63877)
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? japan-book-orange id sender recipient)
        success
          (let
...
(define-read-only (get-owner (id uint))
  ;; Make sure to replace japan-book-orange
  (ok (nft-get-owner? japan-book-orange id)))
...
(define-private (mint (new-owner principal))
    (let (
      ...
      (match (nft-mint? japan-book-orange next-id new-owner)
        success
        (let
...
(define-public (burn (id uint) (owner principal))
    ...
    (match (nft-burn? japan-book-orange id owner)
        success
        (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? japan-book-orange id) false)))
...
(define-public (buy-in-ustx (id uint) (comm <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? japan-book-orange id) ERR-NOT-FOUND))
