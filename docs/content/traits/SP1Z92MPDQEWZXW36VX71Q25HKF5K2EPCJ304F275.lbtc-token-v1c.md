  ...
  (begin
    (asserts! 
      (or
        ...
        (or 
          (is-eq contract-caller (unwrap-panic (contract-call? .stackswap-dao-v5k get-qualified-name-by-name "stx-reserve-l")))
          (is-eq contract-caller (unwrap-panic (contract-call? .stackswap-dao-v5k get-qualified-name-by-name "sip10-reserve-l")))
        )
       )
     (err ERR-NOT-AUTHORIZED))
    (asserts! (var-get is-emergency-stop-not-called) (err ERR-EMERGENCY-STOPPED))
