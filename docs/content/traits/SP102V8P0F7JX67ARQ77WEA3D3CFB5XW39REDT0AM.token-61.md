...
(define-fungible-token token-61)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-61 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-61)))
