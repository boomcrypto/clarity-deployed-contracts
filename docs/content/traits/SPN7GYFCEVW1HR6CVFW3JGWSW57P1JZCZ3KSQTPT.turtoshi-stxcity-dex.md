---
title: "Trait turtoshi-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPN7GYFCEVW1HR6CVFW3JGWSW57P1JZCZ3KSQTPT.turtoshi-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u930521091811414)
    (var-set stx-balance u74666667)
