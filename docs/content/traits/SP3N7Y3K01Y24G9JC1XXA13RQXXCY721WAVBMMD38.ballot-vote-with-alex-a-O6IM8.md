---
title: "Trait ballot-vote-with-alex-a-O6IM8"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with ALEX) Approve Launch of iZIP.AI on the ALEX Launchpad")
    ...
    (var-set options (list "845fe1b0-592f-40aa-beb2-8f2d8585d6c7" "652bc2b3-989f-4e0d-8c9b-42bbe5c14e3a"))
    (var-set start u135819)
    (var-set end u136251)
    (map-set results {id: "845fe1b0-592f-40aa-beb2-8f2d8585d6c7"} {count: u0, name: u"Approve Launch of iZIP.AI on the ALEX Launchpad"}) (map-set results {id: "652bc2b3-989f-4e0d-8c9b-42bbe5c14e3a"} {count: u0, name: u"Disapprove Launch of iZIP.AI on the ALEX Launchpad"})
```
