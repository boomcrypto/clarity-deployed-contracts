...
(define-fungible-token token-15)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-15 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-15)))
