---
title: "Trait pontis-bridge-cypher"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "CYPHER.GENESIS")
(define-data-var token-symbol (string-ascii 10) "CYPHER")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/bafkreihxrvxaeiybsazt6dhlxeyq4a76bdfj2tnl52umqkifwmevqwewlu"))
;; 867138:1861
