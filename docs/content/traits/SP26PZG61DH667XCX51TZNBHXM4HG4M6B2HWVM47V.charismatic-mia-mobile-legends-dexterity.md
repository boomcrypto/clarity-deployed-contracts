---
title: "Trait charismatic-mia-mobile-legends-dexterity"
draft: true
---
```
;; Charismatic Mia Mobile Legends - LP Token, AMM DEX and Hold-to-Earn Engine
;; SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-mia-mobile-legends-dexterity
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-mia-mobile-legends-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    ...
    (reserve-in (unwrap-panic (if forward (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.mia-meme-token-mobile-legend  get-balance CONTRACT) 
      (contract-call? 'SPXZ32XFJZCT4TRDNE4R3HX3DRX9ZE6B5G2WZNRK.pixel-rozar-stxcity get-balance CONTRACT))))
    (reserve-out (unwrap-panic (if forward (contract-call? 'SPXZ32XFJZCT4TRDNE4R3HX3DRX9ZE6B5G2WZNRK.pixel-rozar-stxcity get-balance CONTRACT) 
    ...
    (try! (if forward (contract-call? 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.mia-meme-token-mobile-legend  transfer amt-in sender CONTRACT none) 
      (contract-call? 'SPXZ32XFJZCT4TRDNE4R3HX3DRX9ZE6B5G2WZNRK.pixel-rozar-stxcity transfer amt-in sender CONTRACT none)))
    (try! (as-contract (if forward (contract-call? 'SPXZ32XFJZCT4TRDNE4R3HX3DRX9ZE6B5G2WZNRK.pixel-rozar-stxcity transfer amt-out CONTRACT sender none)
...
(define-public (mint (who principal) (amount uint))
  (let (
    ...
    (reserve1 (unwrap-panic (contract-call? 'SPXZ32XFJZCT4TRDNE4R3HX3DRX9ZE6B5G2WZNRK.pixel-rozar-stxcity get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SPXZ32XFJZCT4TRDNE4R3HX3DRX9ZE6B5G2WZNRK.pixel-rozar-stxcity transfer token1-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SPXZ32XFJZCT4TRDNE4R3HX3DRX9ZE6B5G2WZNRK.pixel-rozar-stxcity transfer token1-amount CONTRACT who none)))
    (ok {token0-amount: token0-amount, token1-amount: token1-amount, lp-amount: amount})))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.mia-meme-token-mobile-legend , token1: 'SPXZ32XFJZCT4TRDNE4R3HX3DRX9ZE6B5G2WZNRK.pixel-rozar-stxcity}))
...
(define-read-only (get-reserves)
  (ok {
    ...
    token1: (unwrap-panic (contract-call? 'SPXZ32XFJZCT4TRDNE4R3HX3DRX9ZE6B5G2WZNRK.pixel-rozar-stxcity get-balance CONTRACT))
  }))
...
(define-read-only (get-name)
  (ok "Charismatic Mia Mobile Legends"))
