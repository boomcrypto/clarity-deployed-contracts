---
title: "Trait neoswap-sc-1659464218111"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u1648 tx-sender agent-3)))
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u580000 tx-sender agent-1)))
	)
