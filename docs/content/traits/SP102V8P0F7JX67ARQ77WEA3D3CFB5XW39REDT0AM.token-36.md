...
(define-fungible-token token-36)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-36 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-36)))
