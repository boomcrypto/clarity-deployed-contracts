---
title: "Trait stackswap-swap-v5d"
draft: true
---
```

(impl-trait 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-swap-trait-v1a.stackswap-swap)
  ...
  (let
    (
      ...
      (pair-data {
        ...
        fee-balance-x: u0,
        fee-balance-y: u0,
        fee-to-address: (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-dao-v5d get-payout-address),
...
(define-public (set-fee-to-address (token-x principal) (token-y principal) (token-liquidity-trait <liquidity-token>) (address principal))
  (let (
    ...
    (asserts! (is-eq tx-sender (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-dao-v5d get-dao-owner)) ERR_NOT_OWNER)
