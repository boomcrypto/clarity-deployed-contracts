---
title: "Trait neoswap-sc-1683313214561"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/nhR5xFNjI9pN4vYBdA0r
;; SwapId: aSu7mReqtxlyvB8YxAW3

;; traders
(define-constant TRADER-1 'SP38WCGSSQJBFAKH77R93AMTHBBEF83DQ6EJ358F2)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (contract-call? 'SPQS1J3X9FJ6N4E9K2MW81W5DNBSCC8ZPHR6K2YA.carole-levy-with-gamma transfer u237 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
	    )
            true
        )
...
(define-private (release-escrow) 
    (begin
	(unwrap-panic (as-contract (contract-call? 'SPQS1J3X9FJ6N4E9K2MW81W5DNBSCC8ZPHR6K2YA.carole-levy-with-gamma transfer u237 tx-sender TRADER-1)))

	(unwrap-panic (as-contract (stx-transfer? u200000 tx-sender RECEIVER-1)))
	(unwrap-panic (as-contract (stx-transfer? u1950000 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (contract-call? 'SPQS1J3X9FJ6N4E9K2MW81W5DNBSCC8ZPHR6K2YA.carole-levy-with-gamma transfer u237 tx-sender TRADER-2)))
	    )
            true
        )
