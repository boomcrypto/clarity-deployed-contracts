---
title: "Trait asset-deployment-146"
draft: true
---
```
...
(define-constant new-supply-cap u300000000000000)
(define-constant new-borrow-cap u200000000000000)
...
(define-public (run-update)
  (let (
    ...
    (try!
      (contract-call? .pool-borrow-v2-1 set-reserve usdh-address
