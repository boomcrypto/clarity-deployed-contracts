---
title: "Trait project-i-l-s-s-2-1"
draft: true
---
```
;; lost-shipment(s) NFT
...
;; Purchase Price - starting at 15 stx but will be able to be modified by admin
...
(define-public (mint-lost-shipment-purchase)
  (let
    ...
    ;; PI Fund (49%) 
    (try! (stx-transfer? (/ (* (var-get purchase-price) u49) u100) tx-sender 'SP2DADKD5KK22MHMVN3DCSKS10T17CM7PDTC6WQV8))
    ;; Jon (26%)
...
(define-public (burn-lost-shipment (lost-shipment-id uint))
  (begin 
    ...
    ;; (asserts! (is-eq contract-caller 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.project-indigo-equipment-series-2) ERR-NOT-AUTH)
    (asserts! (is-eq contract-caller .project-i-e-s-2-1) ERR-NOT-AUTH)
