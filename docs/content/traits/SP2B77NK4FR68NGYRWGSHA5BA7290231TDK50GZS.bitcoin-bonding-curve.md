---
title: "Trait bitcoin-bonding-curve"
draft: true
---
```
...
;; DEFINE METADATA
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://pdakhjpwkuwtadzmpnjm.supabase.co/storage/v1/object/public/uri/gVyqOnsZ-bitcoin-0-decimals.json"))
...
(begin
    ...
    (try! (ft-mint? BTC u21000000000000 'SP2B77NK4FR68NGYRWGSHA5BA7290231TDK50GZS.bitcoin-dex))
)
