  ...
  (begin
    (let
      (
        ...
        (fee-in-stx true)
        (vested true)
        (unlock-blocks-data (list {height: u168697, percentage: u10}))
        (addresses-info (list {address: 'SP23MKF862F9HX5Q50WFVNAT6TRJJVVSQA67PSK1A, amount: u25000000000, withdrawal-address: 'SP23MKF862F9HX5Q50WFVNAT6TRJJVVSQA67PSK1A}))
      ) 
