---
title: "Trait ballot-hi-test-1-ABVs4"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Hi test 1")
    (var-set description u"test test test")
    (var-set voting-system "weighted")
    (var-set options (list "a08893b2-987c-4293-a221-ef485220a05f" "c901b1b8-3c68-400b-b45b-0321b041c8b9" "bee788d6-c15d-4451-a28a-b83902a554a0" "ef32a1a1-4fdf-4bea-8e1a-395706994ea0"))
    (var-set start u117164)
    (var-set end u117732)
    (map-set results {id: "a08893b2-987c-4293-a221-ef485220a05f"} {count: u0, name: u"Proposal 1 - Gamma"}) (map-set results {id: "c901b1b8-3c68-400b-b45b-0321b041c8b9"} {count: u0, name: u"Proposal 2 - Liquidium"}) (map-set results {id: "bee788d6-c15d-4451-a28a-b83902a554a0"} {count: u0, name: u"Proposal 3 - Arkadiko"}) (map-set results {id: "ef32a1a1-4fdf-4bea-8e1a-395706994ea0"} {count: u0, name: u"Proposal 4 - ALEX"})
```
