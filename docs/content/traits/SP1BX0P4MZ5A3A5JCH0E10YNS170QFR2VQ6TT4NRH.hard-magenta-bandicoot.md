---
title: "Trait hard-magenta-bandicoot"
draft: true
---
```
(define-private (unlist-bid (collection-id (string-ascii 256)) (order uint))
    (contract-call? 'SP1BX0P4MZ5A3A5JCH0E10YNS170QFR2VQ6TT4NRH.byzantion-market-v7 admin-withdraw-multiple-bid collection-id order)
)
