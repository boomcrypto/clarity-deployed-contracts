---
title: "Trait pontis-bridge-MEME"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "MEME.ECONOMICS")
(define-data-var token-symbol (string-ascii 10) "MEME")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmT3iCPuVL2gpWLKvMKAts6Sh6NPpvrYpFd5mR6rKiVdjC"))
;; 840000:25
