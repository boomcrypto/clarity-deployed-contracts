---
title: "Trait testmask4-faktory"
draft: true
---
```

;; 7125e2d72710db1dcf4f030cde5bc0dec50018b31ac86d422bd78dd86e5743e7
;; testmask4 Powered By Faktory.fun v1.0 
...
(define-fungible-token testMASK4 MAX)
(define-constant MAX u100000000000000000)
(define-data-var contract-owner principal 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask4-token-owner)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? testMASK4 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance testMASK4 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? testMASK4 (/ (* MAX u80) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask4-treasury)) ;; 80% treasury
    (try! (ft-mint? testMASK4 (/ (* MAX u20) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.testmask4-faktory-dex))
