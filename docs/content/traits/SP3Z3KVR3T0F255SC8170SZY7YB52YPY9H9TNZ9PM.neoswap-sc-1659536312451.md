---
title: "Trait neoswap-sc-1659536312451"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u1653 tx-sender agent-1)))
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3011000 tx-sender agent-3)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u2000000 tx-sender agent-4)))
	)
	(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u1648 tx-sender agent-5)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3671000 tx-sender agent-1)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u3671000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
