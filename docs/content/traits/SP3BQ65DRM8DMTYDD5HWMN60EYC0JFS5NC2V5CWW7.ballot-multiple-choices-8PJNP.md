---
title: "Trait ballot-multiple-choices-8PJNP"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"multiple choices test")
    (var-set description u"this is test")
    (var-set voting-system "block")
    (var-set options (list "1b7d2208-236d-46eb-bd3a-e57d9070534f" "293451fd-33a2-4e65-a3ef-ce50c8e21d35" "20f8d259-52c0-4f65-83d7-c8538ed8dc83" "440dc377-3c2c-4002-bafe-5a50cdd63513"))
    (var-set start u116340)
    (var-set end u116346)
    (map-set results {id: "1b7d2208-236d-46eb-bd3a-e57d9070534f"} {count: u0, name: u"Choice 1"}) (map-set results {id: "293451fd-33a2-4e65-a3ef-ce50c8e21d35"} {count: u0, name: u"Choice 2"}) (map-set results {id: "20f8d259-52c0-4f65-83d7-c8538ed8dc83"} {count: u0, name: u"Choice 3"}) (map-set results {id: "440dc377-3c2c-4002-bafe-5a50cdd63513"} {count: u0, name: u"Choice 4"})
```
