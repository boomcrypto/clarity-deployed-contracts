...
;; Variables
(define-fungible-token WAPES MAXSUPPLY)
...
(define-public (transfer (amount uint) (from principal) (to principal) (memo (optional (buff 34))))
    (begin
        ...
        (ft-transfer? WAPES amount from to)
    )
)
...
(define-data-var token-name (string-ascii 32) "Wasteland Apes")
(define-data-var token-symbol (string-ascii 32) "WAPES")
...
(begin
    ...
    (try! (ft-mint? WAPES MAXSUPPLY (var-get contract-owner)))
)
