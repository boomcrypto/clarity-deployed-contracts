---
title: "Trait neoswap-sc-1690324090194"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/ate8crK7P2QCYIx5ir4Z
;; SwapId: IoisosyeiXMLgfSeN1c0

;; traders
(define-constant TRADER-1 'SPD4A8PA4ZB0N4P4AV1A5T1HDTG272KXPPQ39KX2)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u2985000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u2985000 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u2985000 tx-sender TRADER-2)))
