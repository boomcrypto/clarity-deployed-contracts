---
title: "Trait neoswap-sc-1681606221547"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/Up3ZObp2d9EhfqFM7RuW
;; SwapId: uINv3o0jmJJHEt2tTlV3

;; traders
(define-constant TRADER-1 'SP136AXDAQ41R31GJWJX8KX14E2T4K8PA08NCE6Q5)
(define-constant TRADER-2 'SP15GRAFS0X41ZXPVM3FPD8Y566D29HN4V1YJ6HE8)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u10780000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
	    )
            true
        )
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u10780000 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u10780000 tx-sender TRADER-2)))
	    )
            true
        )
