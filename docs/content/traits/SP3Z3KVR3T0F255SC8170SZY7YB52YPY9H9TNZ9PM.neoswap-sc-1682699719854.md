---
title: "Trait neoswap-sc-1682699719854"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/usNLvRC2CWlMsnjaBZwJ
;; SwapId: 28Er331wEdKKrsG09g6L

;; traders
(define-constant TRADER-1 'SP136AXDAQ41R31GJWJX8KX14E2T4K8PA08NCE6Q5)
(define-constant TRADER-2 'SP1RV4NCZPPFZP0GGWM5WF9AHY28ZPS90WRNQ7SSQ)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u16696429 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
	    )
            true
        )
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u16696429 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u16696429 tx-sender TRADER-2)))
	    )
            true
        )
