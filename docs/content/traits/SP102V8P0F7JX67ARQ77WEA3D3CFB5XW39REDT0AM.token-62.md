...
(define-fungible-token token-62)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-62 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-62)))
