---
title: "Trait spirit-of-ubuntu-mama-africa"
draft: true
---
```
;; spirit-of-ubuntu-mama-africa
;; contractType: public

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token spirit-of-ubuntu-mama-africa uint)
...
(define-data-var artist-address principal 'SP2FT0G3T2AGC8WANTM212AM4FKNJ7Z7YCH1B477)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmPpEvVqmpH2Gfv8QnhizXvkfmk2YrAG5GUYtbJcjPytgq/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? spirit-of-ubuntu-mama-africa next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? spirit-of-ubuntu-mama-africa token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? spirit-of-ubuntu-mama-africa token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? spirit-of-ubuntu-mama-africa token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? spirit-of-ubuntu-mama-africa id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? spirit-of-ubuntu-mama-africa id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? spirit-of-ubuntu-mama-africa id) (err ERR-NOT-FOUND)))
