---
title: "Trait keeper-4-nocsyy6s1-v-1-1"
draft: true
---
```
;; keeper-4-nocsyy6s1-v-1-1
...
(define-data-var owner-address principal 'SP3TACCTR25GDV8SHGP1FNDBGZCR0NQJWA7WZBSNK)

;; Bitcoin address authorized to receive bridged rune tokens and bitcoin
(define-data-var bitcoin-address (buff 64) 0x3347615931464765615a74417245724634595155354d59734357636268734d437565)
