---
title: "Trait solvitur-ambulando-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u999999999000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP16SB4KF90XXWMN2Z6KC452WPM7QPWEMN4FC3N9F.solvitur-ambulando-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u950035185538353)
    (var-set stx-balance u94666667)
