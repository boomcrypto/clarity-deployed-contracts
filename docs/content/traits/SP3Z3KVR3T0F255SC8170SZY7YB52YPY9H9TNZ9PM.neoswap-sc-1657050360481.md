---
title: "Trait neoswap-sc-1657050360481"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SPDKRP4ESV0037MT3SX0WE817WVR9EQ9A0JBVRP4.atlantic-dolphins transfer u24 tx-sender agent-1)))
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u27900000 tx-sender agent-2)))
	)
	(unwrap-panic (begin
