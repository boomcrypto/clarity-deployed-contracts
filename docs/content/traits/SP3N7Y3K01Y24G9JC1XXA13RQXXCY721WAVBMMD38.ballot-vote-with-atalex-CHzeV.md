---
title: "Trait ballot-vote-with-atalex-CHzeV"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with atALEX) Approve Launch of Orange on the ALEX Launchpad")
    (var-set description u"This proposal is to approve Orange for the ALEX Decentralized Launchpad. Information on the project is available on the application form Orange has submitted.Orange Launchpad Application Form: https://docs.google.com/spreadsheets/d/1B4ZAhVh1KlLMNjvoH5X6S3XUzX46N1M3e4l1S7UHfjA/edit#gid=2091054548X/Twitter: https://x.com/orangecryptoHQWebsite: https://orangecrypto.comTelegram: https://t.me/orangecryptoHQAn AMA with Orange will be held on January 10, 15:30 UTC: https://twitter.com/i/spaces/1PlJQDqpeAWGEVote to")
    (var-set voting-system "fptp")
    (var-set options (list "653cbd67-6675-46b9-9a1c-1b6949400af6" "0efc5342-0c0b-483a-a3be-6f40f6f171f9"))
    (var-set start u135029)
    (var-set end u135461)
    (map-set results {id: "653cbd67-6675-46b9-9a1c-1b6949400af6"} {count: u0, name: u"Approve Launch of Orange on the ALEX Launchpad"}) (map-set results {id: "0efc5342-0c0b-483a-a3be-6f40f6f171f9"} {count: u0, name: u"Disapprove Launch of Orange on the ALEX Launchpad"})
```
