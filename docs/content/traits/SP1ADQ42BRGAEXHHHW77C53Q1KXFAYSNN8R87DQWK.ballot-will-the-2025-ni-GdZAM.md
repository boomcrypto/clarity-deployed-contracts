---
title: "Trait ballot-will-the-2025-ni-GdZAM"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Will%20the%202025%20NIH%20funding%20cuts%20slow%20the%20rate%20of%20new%20medical%20research%20breakthroughs%20before%20the%20end%20of%202035%3F")
    ...
    (var-set options (list "4ef93378-4935-4b8f-8b05-8d8eda876d06" "fdfe3e23-3954-4ad7-8962-68a17cc4b57e" "00ae8258-b12b-4229-975f-d5daede731d4" "9ac07aa9-1035-4a8e-a26b-dea161e02815"))
    (var-set start u188979)
    (var-set end u230889)
    (map-set results {id: "4ef93378-4935-4b8f-8b05-8d8eda876d06"} {count: u0, name: u"Yes"}) (map-set results {id: "fdfe3e23-3954-4ad7-8962-68a17cc4b57e"} {count: u0, name: u"Probably%20yes"}) (map-set results {id: "00ae8258-b12b-4229-975f-d5daede731d4"} {count: u0, name: u"Probably%20not"}) (map-set results {id: "9ac07aa9-1035-4a8e-a26b-dea161e02815"} {count: u0, name: u"No"})
```
