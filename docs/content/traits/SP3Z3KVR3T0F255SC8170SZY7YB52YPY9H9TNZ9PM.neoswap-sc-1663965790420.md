---
title: "Trait neoswap-sc-1663965790420"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1635000 tx-sender agent-4)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1995000 tx-sender agent-1)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u1995000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
