...
(define-constant token-supply u4444000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP8FFZ0X5Q4QR377F6RWTNAYJSCPFDRM0C2F1KBW.itoshimototsu-bonding-curve)
