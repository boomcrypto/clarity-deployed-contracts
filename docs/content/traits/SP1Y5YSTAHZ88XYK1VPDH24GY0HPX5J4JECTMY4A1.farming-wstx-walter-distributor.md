---
title: "Trait farming-wstx-walter-distributor"
draft: true
---
```
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constants
(define-constant REWARD-TOKEN 'SP45RYP4W83SMSCG5C7MZCM1EFVRJY4K6D0E05Z6.walter)
...
(define-public
  ...
  (let ((epoch (contract-call? .farming-wstx-walter-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .farming-wstx-walter-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .farming-wstx-walter-core current-epoch))
