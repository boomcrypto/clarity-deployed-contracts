...
(define-public (fund-rooons (token <ft-trait>) (amt   uint))
    (begin       
        (try!
          (contract-call?
           token transfer amt tx-sender .roooons-cash-out none))
      (ok true)
    )
)
...
(define-public (claim-rooons-10 (token-id-01 uint) (token-id-02 uint) (token-id-03 uint) (token-id-04 uint) (token-id-05 uint) (token-id-06 uint) (token-id-07 uint) (token-id-08 uint) (token-id-09 uint) (token-id-10 uint)  (token-claim <ft-trait>))
    (begin       
    (try! (claim-rooons token-id-01 token-claim)) 
    (try! (claim-rooons token-id-02 token-claim))
    (try! (claim-rooons token-id-03 token-claim))
    (try! (claim-rooons token-id-04 token-claim))
    (try! (claim-rooons token-id-05 token-claim))
    (try! (claim-rooons token-id-06 token-claim))
    (try! (claim-rooons token-id-07 token-claim))
    (try! (claim-rooons token-id-08 token-claim))
    (try! (claim-rooons token-id-09 token-claim))
    (try! (claim-rooons token-id-10 token-claim))
    (ok true)
    )    
)
