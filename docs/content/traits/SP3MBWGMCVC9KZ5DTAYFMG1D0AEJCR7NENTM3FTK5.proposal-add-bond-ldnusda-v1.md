---
title: "Trait proposal-add-bond-ldnusda-v1"
draft: true
---
```
...
(define-public (execute)
  (begin
    ...
    (unwrap-panic (contract-call? .bond-depository-v1-1 add-bond
      'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-swap-token-ldn-usda     ;; token to accept as payment
      u4000000000                      ;; capacity (4000 LDN)
      true                             ;; capacity limit for payout
      u5                               ;; scaling variable for price
      false                            ;; fixed expiration
      u432                             ;; fixed-term - term in blocks
      u0                               ;; fixed-expiration - block number bond matures
      (+ block-height u576)            ;; block number bond no longer offered
      u830                             ;; minimum-price (vs principal value)
