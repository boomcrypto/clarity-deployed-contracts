---
title: "Trait memegoat-community-vote-08"
draft: true
---
```
;;
...
(define-public (execute (sender principal) (opt uint))
  (begin
    ...
    ;; stx wrapper token for community pools
    (try! (contract-call? .memegoat-vault set-approval-status 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx u0 true))
    (try! (contract-call? .memegoat-vault set-approval-status 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wstx u0 true))
