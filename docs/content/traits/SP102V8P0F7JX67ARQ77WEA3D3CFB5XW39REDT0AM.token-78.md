...
(define-fungible-token token-78)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-78 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-78)))
