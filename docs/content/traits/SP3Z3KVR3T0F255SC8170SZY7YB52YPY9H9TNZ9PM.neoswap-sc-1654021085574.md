---
title: "Trait neoswap-sc-1654021085574"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u19200000 tx-sender agent-1)))
	)
	...
	(unwrap-panic (as-contract (contract-call? 'SPZW30K9VG6YCPYV4BX4V1FT0VJ66R1Q01W9DQ1W.pokinometry transfer u78 tx-sender agent-2)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3800000 tx-sender agent-3)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP1JCPNPAMAQJ364AFHPTW3HY7X0HYZ3TJ0ZDGWZH.bitcoin-on-the-beach transfer u102 tx-sender agent-4)))
	...
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.belles-witches transfer u4344 tx-sender agent-4)))
	...
	(unwrap-panic (as-contract (contract-call? 'SP3BS8RXKKAAM7HA76SFDKG4Q2YSG0X8K5K44XNDV.jelly-nft transfer u575 tx-sender agent-5)))
	(unwrap-panic (begin
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u6630000 tx-sender agent-2)))
	)
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.stacks-mandala transfer u6 tx-sender agent-3)))
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u16480000 tx-sender agent-4)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u6630000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (stx-transfer? u16480000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
