---
title: "Trait this-is-welsh-2-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP2QGQ3R0RH96SEGEV6YBK8QDPF7CQ0ATC2E7FH67.this-is-welsh-2-stxcity)
      ...
      (if (>= new-stx-balance  STX_TARGET_AMOUNT)
        (begin
          (let (
            ...
            (try! (as-contract (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-core-v-1-2 create-pool 'SP2QGQ3R0RH96SEGEV6YBK8QDPF7CQ0ATC2E7FH67.xyk-pool-stx-welsh2-v-1-1 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.token-stx-v-1-2 token-trait remain-stx remain-tokens xyk-burn-amount u10 u40 u10 u40 'SP31C60QVZKZ9CMMZX73TQ3F3ZZNS89YX2DCCFT8P xyk-pool-uri true)))
            ;; (try! (as-contract (contract-call? SP2QGQ3R0RH96SEGEV6YBK8QDPF7CQ0ATC2E7FH67.xyk-pool-stx-welsh2-v-1-1 transfer u1 tx-sender SP2QGQ3R0RH96SEGEV6YBK8QDPF7CQ0ATC2E7FH67.xyk-pool-stx-welsh2-v-1-1 none))) ;; @STXCITY: transfer remaining LP Tokens to XYK Core v-1-2 pool contract
            ;; send fee
