---
title: "Trait neoswap-sc-1658690154930"
draft: true
---
```
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1D3Y8A2VVD2W98VFXCG5AXRYX5PJBBEMV1YPKF1.nonnish-grafters transfer u1811 tx-sender agent-2)))
