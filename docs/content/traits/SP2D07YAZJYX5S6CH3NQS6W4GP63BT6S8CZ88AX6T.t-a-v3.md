...
(define-public (mng-airdrop-id (id (buff 48)) (idspace (buff 20)) (send-to principal)) 
    (let 
        (
            ...
            (id-v1-resolve (unwrap! (contract-call? 'SP000000000000000000002Q6VF78.bns name-resolve idspace id) ERR-UNWRAP-V1-NAME))
        ...
        (asserts! (is-eq contract-caller .m-a-v3) ERR-NOT-AUTHORIZED)
