---
title: "Trait ballot-cuando-CAisO"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Cuando?")
    (var-set description u"Cuando votamos?")
    (var-set voting-system "fptp")
    (var-set options (list "e9e8b142-c5f5-490a-b04f-cd55ccd59a98" "0bc30f58-c0e5-43de-9969-d6eea577b43d"))
    (var-set start u140573)
    (var-set end u140837)
    (map-set results {id: "e9e8b142-c5f5-490a-b04f-cd55ccd59a98"} {count: u0, name: u"Manana"}) (map-set results {id: "0bc30f58-c0e5-43de-9969-d6eea577b43d"} {count: u0, name: u"Pasado"})
```
