---
title: "Trait asset-deployment-128"
draft: true
---
```
...
(define-constant stx-oracle .stx-btc-oracle-v1)
(define-constant ststx-oracle .stx-btc-oracle-v1)
(define-constant ststxbtc-oracle .stx-btc-oracle-v1)
(define-constant sbtc-oracle .stx-btc-oracle-v1)
...
(define-read-only (preview-update)
  (let (
    ...
    (print { old: reserve-data-4, new: (merge reserve-data-4 { oracle: sbtc-oracle }) })
    (ok true)
  )
)
