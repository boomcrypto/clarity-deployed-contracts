---
title: "Trait neoswap-sc-1687546009720"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/q9uXerAXdh7cA7qdzggz
;; SwapId: hHwzEgwzdPiSdN92TnWh
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u385072 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.byte-fighters transfer u557 tx-sender TRADER-2)))

	(unwrap-panic (as-contract (stx-transfer? u385072 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u385072 tx-sender TRADER-1)))
