---
title: "Trait neoswap-sc-1686083334438"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/jcV4TtMnVyYx6bC5cnDy
;; SwapId: l83rSyJVTflXSJZjGbXg

;; traders
(define-constant TRADER-1 'SP3KXV3J6MRHAH4H89MDS390X1KS0GQN4DWQ5RFVB)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u99065 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u99065 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u99065 tx-sender TRADER-2)))
