---
title: "Trait neoswap-sc-1695061362795"
draft: true
---
```
;; multiway-swap
...
;; traders
(define-constant TRADER-1 'SP3R4NKXMGW6YXA44X2ESZPKJNV25X4ZN7DPW0RXR)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u217173 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u217173 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u217173 tx-sender TRADER-2)))
