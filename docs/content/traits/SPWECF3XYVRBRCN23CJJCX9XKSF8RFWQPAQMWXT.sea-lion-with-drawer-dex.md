---
title: "Trait sea-lion-with-drawer-dex"
draft: true
---
```
...
(define-constant STX_TARGET_AMOUNT u2000000)
(define-constant VIRTUAL_STX_VALUE u400000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u40000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SPWECF3XYVRBRCN23CJJCX9XKSF8RFWQPAQMWXT.sea-lion-with-drawer-bonding-curve)
