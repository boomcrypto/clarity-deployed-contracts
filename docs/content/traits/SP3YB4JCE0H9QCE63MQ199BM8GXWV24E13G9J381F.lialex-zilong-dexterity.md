---
title: "Trait lialex-zilong-dexterity"
draft: true
---
```
;; LiALEX Zilong - LP Token, AMM DEX and Hold-to-Earn Engine
;; SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.lialex-zilong-dexterity
...
(define-data-var energy-burn-amount uint u1000000)
(define-data-var swap-fee uint u30082) ;; Default to 3.0%
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP3YB4JCE0H9QCE63MQ199BM8GXWV24E13G9J381F.lialex-zilong-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    (sender tx-sender)
    (reserve-in (unwrap-panic (if forward (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity get-balance CONTRACT) 
      (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.auto-alex-v3 get-balance CONTRACT))))
    (reserve-out (unwrap-panic (if forward (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.auto-alex-v3 get-balance CONTRACT) 
      (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity get-balance CONTRACT))))
    ...
    ;; Execute the swap
    (try! (if forward (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity transfer amt-in sender CONTRACT none) 
      (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.auto-alex-v3 transfer amt-in sender CONTRACT none)))
    (try! (as-contract (if forward (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.auto-alex-v3 transfer amt-out CONTRACT sender none)
      (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity transfer amt-out CONTRACT sender none))))
    (ok {amt-in: amt-in, amt-out: amt-out})))

(define-public (mint (who principal) (amount uint))
  (let (
    (reserve0 (unwrap-panic (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity get-balance CONTRACT)))
    (reserve1 (unwrap-panic (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.auto-alex-v3 get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity transfer token0-amount who CONTRACT none))
    (try! (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.auto-alex-v3 transfer token1-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity transfer token0-amount CONTRACT who none)))
    (try! (as-contract (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.auto-alex-v3 transfer token1-amount CONTRACT who none)))
    (ok {token0-amount: token0-amount, token1-amount: token1-amount, lp-amount: amount})))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity, token1: 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.auto-alex-v3}))
...
(define-read-only (get-reserves)
  (ok {
    token0: (unwrap-panic (contract-call? 'SP26PZG61DH667XCX51TZNBHXM4HG4M6B2HWVM47V.charismatic-zil-mobile-legends-dexterity get-balance CONTRACT)),
    token1: (unwrap-panic (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.auto-alex-v3 get-balance CONTRACT))
  }))
