---
title: "Trait dmgprzr-dexterity"
draft: true
---
```
;; DMG-pRZR - LP Token, AMM DEX and Hold-to-Earn Engine
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.dmgprzr-dexterity"))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP2D5BGGJ956A635JG7CJQ59FTRFRB0893514EZPJ.dme000-governance-token, token1: 'SPXZ32XFJZCT4TRDNE4R3HX3DRX9ZE6B5G2WZNRK.pixel-rozar-stxcity}))
