---
title: "Trait methylphenidate-dexterity"
draft: true
---
```
;; methylphenidate - LP Token, AMM DEX and Hold-to-Earn Engine
;; SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.methylphenidate-dexterity
...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.methylphenidate-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    ...
    (reserve-in (unwrap-panic (if forward (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token get-balance CONTRACT) 
      (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.krdoll-dexterity get-balance CONTRACT))))
    (reserve-out (unwrap-panic (if forward (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.krdoll-dexterity get-balance CONTRACT) 
    ...
    (try! (if forward (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token transfer amt-in sender CONTRACT none) 
      (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.krdoll-dexterity transfer amt-in sender CONTRACT none)))
    (try! (as-contract (if forward (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.krdoll-dexterity transfer amt-out CONTRACT sender none)
...
(define-public (mint (who principal) (amount uint))
  (let (
    ...
    (reserve1 (unwrap-panic (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.krdoll-dexterity get-balance CONTRACT)))
    ...
    (try! (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.krdoll-dexterity transfer token1-amount who CONTRACT none))
...
(define-public (burn (who principal) (amount uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.krdoll-dexterity transfer token1-amount CONTRACT who none)))
    (ok {token0-amount: token0-amount, token1-amount: token1-amount, lp-amount: amount})))
...
(define-read-only (get-tokens)
  (ok {token0: 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token, token1: 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.krdoll-dexterity}))
...
(define-read-only (get-reserves)
  (ok {
    ...
    token1: (unwrap-panic (contract-call? 'SPGYCP878RYFVT03ZT8TWGPKNYTSQB1578VVXHGE.krdoll-dexterity get-balance CONTRACT))
  }))
