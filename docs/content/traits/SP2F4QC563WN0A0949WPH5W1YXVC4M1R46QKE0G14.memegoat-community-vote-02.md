---
title: "Trait memegoat-community-vote-02"
draft: true
---
```
;;
...
(define-public (execute (sender principal) (opt uint))
  (begin
    ...
    ;; eth-thcam
    (try! (contract-call? .memegoat-community-pools-v1 set-approval-status 'SP1QBKVTKP2DG8BGHQQD3KG6EBWWCB6V4X5NXQRYR.eth-thcam-stxcity u19 true))
    (try! (contract-call? .memegoat-community-pools-v1 set-approval-status 'SP1QBKVTKP2DG8BGHQQD3KG6EBWWCB6V4X5NXQRYR.eth-thcam-stxcity u20 true))
    (try! (contract-call? .memegoat-community-pools-v1 set-approval-status 'SP1QBKVTKP2DG8BGHQQD3KG6EBWWCB6V4X5NXQRYR.eth-thcam-stxcity u21 true))

    ;; walter pool
    (try! (contract-call? .memegoat-community-pools-v1 set-approval-status 'SP45RYP4W83SMSCG5C7MZCM1EFVRJY4K6D0E05Z6.walter u17 true))
