---
title: "Trait ststx-welsh"
draft: true
---
```
;; Welsh Community Pool
;; stSTX-WELSH LP token with configurable metadata
...
(define-data-var token-symbol (string-ascii 10) "stSTXWELSH")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/ststx-welsh/metadata.json"))
