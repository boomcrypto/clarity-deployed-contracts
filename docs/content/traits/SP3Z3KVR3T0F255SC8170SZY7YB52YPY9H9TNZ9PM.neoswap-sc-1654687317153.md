---
title: "Trait neoswap-sc-1654687317153"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u46000000 tx-sender agent-3)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.minotauri-nft transfer u866 tx-sender agent-4)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1110000 tx-sender agent-1)))
	)
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u49590000 tx-sender agent-4)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u980 tx-sender agent-5)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u49590000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
