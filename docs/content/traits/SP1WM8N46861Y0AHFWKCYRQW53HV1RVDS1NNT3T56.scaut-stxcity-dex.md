...
(define-constant allow-token 'SP1WM8N46861Y0AHFWKCYRQW53HV1RVDS1NNT3T56.scaut-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u991571641051065)
    (var-set stx-balance u34000000)
