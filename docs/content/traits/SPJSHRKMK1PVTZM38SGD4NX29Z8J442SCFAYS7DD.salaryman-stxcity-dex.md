---
title: "Trait salaryman-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPJSHRKMK1PVTZM38SGD4NX29Z8J442SCFAYS7DD.salaryman-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u944186017234542)
    (var-set stx-balance u59113333)
