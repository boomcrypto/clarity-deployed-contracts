---
title: "Trait borrow-helper-v2-0"
draft: true
---
```
...
(use-trait redeemeable-token .redeemeable-trait-v1-0.redeemeable-trait)
...
(define-public (withdraw
  ...
  (amount uint)
  (owner principal)
  (assets (list 100 { asset: <ft>, lp-token: <a-token>, oracle: <oracle-trait> }))
  )
  (let (
    (asset-principal (contract-of asset))
