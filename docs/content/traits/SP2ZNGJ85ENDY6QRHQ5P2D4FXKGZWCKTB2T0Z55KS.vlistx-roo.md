---
title: "Trait vlistx-roo"
draft: true
---
```
;; Roo Community Pool
;; vLiSTX-ROO LP token with configurable metadata
...
(define-data-var token-symbol (string-ascii 10) "vlSTX-ROO")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/vlistx-roo/metadata.json"))
