---
title: "Trait token-wgus"
draft: true
---
```
(impl-trait .trait-sip-010.sip-010-trait)
(define-fungible-token wgus)
(define-data-var token-name (string-ascii 32) "GUS Wrapper")
(define-data-var token-symbol (string-ascii 32) "wgus")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wgus.json"))
...
(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SP1JFFSYTSH7VBM54K29ZFS9H4SVB67EA8VT2MYJ9.gus-token get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))
