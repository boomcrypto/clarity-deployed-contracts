...
(define-constant allow-token 'SP2K10HFR0BY3JZVQ70MXGW5MKMKKWM3QM86HZ8B3.bruh-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u90000000000000)
    (var-set stx-balance u333333333)
