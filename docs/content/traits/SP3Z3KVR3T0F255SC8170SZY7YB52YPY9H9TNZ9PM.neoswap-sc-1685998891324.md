---
title: "Trait neoswap-sc-1685998891324"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/dpWUvKbepvzGp8ORQuZo
;; SwapId: JedCwZ0P7Gawn6MefKH7

;; traders
(define-constant TRADER-1 'SP3C5JYPB8YE5H9WC2SM196RVJ0JXN2GHCWXJWSES)
(define-constant TRADER-2 'SP3PWY4EYA2SK3MNKS4KDB30T6D66MW41RNZFC3AJ)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u22000000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
	    )
            true
        )
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u1100000 tx-sender RECEIVER-1)))
	(unwrap-panic (as-contract (stx-transfer? u20900000 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u22000000 tx-sender TRADER-2)))
	    )
            true
        )
