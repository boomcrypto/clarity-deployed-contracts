...
;; version: cha-v1
;; summary: Subnet token for Charisma with fast off-chain transactions
...
(define-public (withdraw (amount uint))
  (let
    ...
    (try! (as-contract (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token transfer amount tx-sender sender none)))
...
(define-read-only (get-name)
  (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token get-name)
)

(define-read-only (get-symbol)
  (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token get-symbol)
)

(define-read-only (get-decimals)
  (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token get-decimals)
)

(define-read-only (get-token-uri)
  (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token get-token-uri)
)

(define-read-only (get-total-supply)
  (contract-call? 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token get-total-supply)
)
