---
title: "Trait keeper-action-1-v-1-1"
draft: true
---
```
...
(define-private (swap-sa
  ...
  (let (
    ...
    (swap-a (if is-swap
      (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-a amount u0 tokens-tuple xyk-pools-tuple))
      (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-a amount tokens-tuple xyk-pools-tuple))
    ))
  )
...
;; Swap or get quote using 2 XYK pools
(define-private (swap-sb
  ...
  (let (
    ...
    ;; Perform swap or get quote result
    (swap-a (if is-swap
      (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-b amount u0 tokens-tuple xyk-pools-tuple))
      (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-b amount tokens-tuple xyk-pools-tuple))
    ))
  )
...
;; Swap or get quote using 3 XYK pools
(define-private (swap-sc
  ...
  (let (
    ...
    ;; Perform swap or get quote result
    (swap-a (if is-swap
      (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-c amount u0 tokens-tuple xyk-pools-tuple))
      (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-c amount tokens-tuple xyk-pools-tuple))
    ))
  )
...
;; Swap or get quote using 4 XYK pools
(define-private (swap-sd
  ...
  (let (
    ...
    ;; Perform swap or get quote result
    (swap-a (if is-swap
      (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-d amount u0 tokens-tuple xyk-pools-tuple))
      (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-d amount tokens-tuple xyk-pools-tuple))
    ))
  )
...
;; Swap or get quote using 5 XYK pools
(define-private (swap-se
  ...
  (let (
    ...
    ;; Perform swap or get quote result
    (swap-a (if is-swap
      (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-e amount u0 tokens-tuple xyk-pools-tuple))
      (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-e amount tokens-tuple xyk-pools-tuple))
    ))
  )
