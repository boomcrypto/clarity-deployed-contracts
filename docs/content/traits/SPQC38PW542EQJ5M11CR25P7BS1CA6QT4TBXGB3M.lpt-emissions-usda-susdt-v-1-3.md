---
title: "Trait lpt-emissions-usda-susdt-v-1-3"
draft: true
---
```
;; lpt-emissions-usda-susdt-v-1-3
...
(define-constant DEPLOYMENT_HEIGHT u827258)
...
(define-read-only (get-user-rewards-at-cycle (user principal) (cycle uint))
  (let (
    ...
    (cycle-user-data-external (unwrap! (contract-call? 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.earn-usda-susdt-v-1-3 get-user-data-at-cycle 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-susdt 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.usda-susdt-lp-token-v-1-2 user cycle) ERR_NO_CYCLE_USER_DATA_EXTERNAL))
    (cycle-user-lp-staked (get lp-token-staked cycle-user-data-external))
    (cycle-total-lp-staked-external (unwrap! (contract-call? 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.earn-usda-susdt-v-1-3 get-data-at-cycle 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-susdt 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.usda-susdt-lp-token-v-1-2 cycle) ERR_NO_CYCLE_DATA_EXTERNAL))
...
(define-public (withdraw-cycle-rewards (amount uint) (recipient principal))
  (let (
    ...
    (begin
      ...
      (unwrap! (as-contract (contract-call? 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.usda-susdt-lp-token-v-1-2 transfer amount tx-sender recipient none)) ERR_TOKEN_TRANSFER_FAILED)
...
(define-public (claim-cycle-rewards (cycle uint))
  (let (
    ...
    (cycle-user-claimed (get claimed cycle-user-data))
    (cycle-user-data-external (unwrap! (contract-call? 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.earn-usda-susdt-v-1-3 get-user-data-at-cycle 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-susdt 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.usda-susdt-lp-token-v-1-2 tx-sender cycle) ERR_NO_CYCLE_USER_DATA_EXTERNAL))
    (cycle-user-lp-staked (get lp-token-staked cycle-user-data-external))
    (cycle-total-lp-staked-external (unwrap! (contract-call? 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.earn-usda-susdt-v-1-3 get-data-at-cycle 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-susdt 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.usda-susdt-lp-token-v-1-2 cycle) ERR_NO_CYCLE_DATA_EXTERNAL))
    (cycle-rewards (/ (* (get total-rewards cycle-data) cycle-user-lp-staked) cycle-total-lp-staked-external))
    ...
    (begin
      ...
      (asserts! (> cycle-rewards u0) ERR_CYCLE_NO_USER_REWARDS)
      (asserts! (<= cycle-rewards (get unclaimed-rewards cycle-data)) ERR_CYCLE_REWARDS_TOO_HIGH)
      (unwrap! (as-contract (contract-call? 'SPQC38PW542EQJ5M11CR25P7BS1CA6QT4TBXGB3M.usda-susdt-lp-token-v-1-2 transfer cycle-rewards tx-sender caller none)) ERR_TOKEN_TRANSFER_FAILED)
