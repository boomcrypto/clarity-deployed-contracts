...
(define-constant allow-token 'SP1S0GJQM2EB3FXQNPD4TASDT4A16GFC0TS8FN68V.brat-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u68412790217301)
    (var-set stx-balance u3433333)
