...
(define-fungible-token wsnack)

(define-data-var token-name (string-ascii 32) "Jindo Wrapper")
(define-data-var token-symbol (string-ascii 32) "wsnack")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/token-wsnack.json"))
...
(define-read-only (get-base-token)
  'SPQT2PNZVZVYT4JV8CDY014HT3PN0YJT0T6GVQJ0.trump-wif-snacks)

(define-read-only (get-base-decimals)
  (contract-call? 'SPQT2PNZVZVYT4JV8CDY014HT3PN0YJT0T6GVQJ0.trump-wif-snacks get-decimals))

(define-read-only (get-balance (who principal))
  (ok (/ (* (unwrap-panic (contract-call? 'SPQT2PNZVZVYT4JV8CDY014HT3PN0YJT0T6GVQJ0.trump-wif-snacks get-balance who)) (pow-decimals)) (pow u10 (unwrap-panic (get-base-decimals))))))

(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq sender tx-sender) ERR-NOT-AUTHORIZED)
    (contract-call? 'SPQT2PNZVZVYT4JV8CDY014HT3PN0YJT0T6GVQJ0.trump-wif-snacks transfer (/ (* amount (pow u10 (unwrap-panic (get-base-decimals)))) (pow-decimals)) sender recipient memo)))
;; ------
