---
title: "Trait farming-wstx-vence-distributor"
draft: true
---
```
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constants
(define-constant REWARD-TOKEN 'SPGDF0FAF9MKMPJ36G07QAR09DT4DANRFV98RZNT.dj-vence)
...
(define-public
  ...
  (let ((epoch (contract-call? .farming-wstx-vence-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .farming-wstx-vence-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .farming-wstx-vence-core current-epoch))
