---
title: "Trait ccip016-missed-payouts"
draft: true
---
```
;; TRAITS
...
(define-read-only (get-vote
  ...
  (let (
      ...
      (cycle82Data (at-block cycle82Hash
        (contract-call? 'SP8A9HZ3PKST0S42VM9523Z9NV42SZ026V4K39WH.ccd007-citycoin-stacking get-stacker cityId u2 userId)
      ))
      ...
      (cycle83Data (at-block cycle83Hash
        (contract-call? 'SP8A9HZ3PKST0S42VM9523Z9NV42SZ026V4K39WH.ccd007-citycoin-stacking get-stacker cityId u3 userId)
      ))
