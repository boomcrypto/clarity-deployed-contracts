---
title: "Trait BOS-NFT-TESTING-ADMIN"
draft: true
---
```
...
(define-public (mint-bos)
  (let
    ...
    (asserts! (is-eq contract-caller .BOS-TESTING-ADMIN) ERR-NOT-AUTH)
    ;; (asserts! (is-eq contract-caller .Test-BOS-Board) ERR-NOT-AUTH)
