---
title: "Trait memobots-helper-v1"
draft: true
---
```
...
(define-read-only (is-gigapepe-owner)
    (ok (asserts! (> u0 (contract-call? 'SP2RNHHQDTHGHPEVX83291K4AQZVGWEJ7WCQQDA9R.giga-pepe-v2 get-balance tx-sender)) ERR_UNAUTHORIZED))
)
