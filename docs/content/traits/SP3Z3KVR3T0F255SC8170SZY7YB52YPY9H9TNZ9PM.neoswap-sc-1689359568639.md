---
title: "Trait neoswap-sc-1689359568639"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/0pHMBBZ3ix5Ki1wmsdyr
;; SwapId: RCUPLNsKm4JVh12Hb93w
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u6009000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.citadels transfer u230 tx-sender TRADER-2)))

	(unwrap-panic (as-contract (stx-transfer? u6009000 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u6009000 tx-sender TRADER-1)))
