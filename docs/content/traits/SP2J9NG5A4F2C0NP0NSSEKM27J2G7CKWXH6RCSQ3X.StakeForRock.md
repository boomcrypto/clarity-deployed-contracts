...
(define-public (stake
  ...
  (let (
    ...
    (try! (as-contract (contract-call? 'SP2J9NG5A4F2C0NP0NSSEKM27J2G7CKWXH6RCSQ3X.Staking-NFT mint sender)))
...
(define-public (unstake (listing-id uint) (nft-asset-contract <nft-trait>))
  (let (
    ...
    (try! (as-contract (contract-call? 'SP2J9NG5A4F2C0NP0NSSEKM27J2G7CKWXH6RCSQ3X.Staking-NFT burn (+ listing-id u1) maker)))
