---
title: "Trait russian-roulette-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP2M6H8EHQ4KJ0BDPWZCKCF04FA6AXERFZ0CPCJK9.russian-roulette-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u900900900900900)
    (var-set stx-balance u110000000)
