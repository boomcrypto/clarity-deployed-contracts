---
title: "Trait neoswap-sc-1652908743374"
draft: true
---
```
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u16720000 tx-sender agent-3)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u16720000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
