---
title: "Trait neoswap-sc-1663705168439"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u62875 tx-sender agent-1)))
	)
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u62875 tx-sender agent-0)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1597875 tx-sender agent-2)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u1597875 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
