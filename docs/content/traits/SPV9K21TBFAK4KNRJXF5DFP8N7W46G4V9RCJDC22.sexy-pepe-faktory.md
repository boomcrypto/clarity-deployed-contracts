---
title: "Trait sexy-pepe-faktory"
draft: true
---
```

;; 
;; sexypepe Powered By Faktory.fun v1.0 
...
(define-fungible-token SEXYPEPE MAX)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       (asserts! (is-eq tx-sender sender) (err ERR-NOT-AUTHORIZED))
        (ft-transfer? SEXYPEPE amount sender recipient)
    )
)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance SEXYPEPE account))
)
...
(begin 
    ...
    (try! (ft-mint? SEXYPEPE u69000000000000 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.sexy-pepe-faktory-dex)) ;; supply-left
