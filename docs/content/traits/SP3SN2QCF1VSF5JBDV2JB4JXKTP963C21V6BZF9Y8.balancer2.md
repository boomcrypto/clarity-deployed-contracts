...
(define-constant BNF 'SP3SN2QCF1VSF5JBDV2JB4JXKTP963C21V6BZF9Y8)
...
(define-public (balancer (dd uint) (mr uint))
    (let
        ...
        (and (> ba dd) (try! (stx-transfer? (- ba dd) tx-sender BNF)))
        (ok l)
    )
)
...
(define-public (balancer3 (in uint) (mrc uint))
    (begin 
...
(define-public (balancer4 (in uint) (mrc uint))
    (begin 
