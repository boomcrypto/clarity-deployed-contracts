---
title: "Trait stacko-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u42069000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPJ8B5PK53HZMR39X2J8QHPBKKYJSZAZQ1J1D7MT.stacko-stxcity)
...
(var-set token-balance u41652475247524752)
