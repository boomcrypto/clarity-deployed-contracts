...
(define-read-only (has-free-claim (address principal))
  (is-some (index-of (var-get free-claim-list) address))
)
...
(define-data-var free-claim-list (list 650 principal) (list
