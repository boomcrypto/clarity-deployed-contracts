---
title: "Trait ballot-test-1-bxmwj"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Test%201")
    (var-set description u"Test%202")
    (var-set voting-system "fptp")
    (var-set options (list "1537346a-2bf9-4ab9-bd9a-331abf323475" "bae02ea9-901e-4373-b9b3-81f160eb8e89"))
    (var-set start u168315)
    (var-set end u409196)
    (map-set results {id: "1537346a-2bf9-4ab9-bd9a-331abf323475"} {count: u0, name: u"Choice%201"}) (map-set results {id: "bae02ea9-901e-4373-b9b3-81f160eb8e89"} {count: u0, name: u"Choice%202"})
```
