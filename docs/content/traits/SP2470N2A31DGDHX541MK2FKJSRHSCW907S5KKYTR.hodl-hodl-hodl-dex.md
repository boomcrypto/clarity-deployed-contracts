---
title: "Trait hodl-hodl-hodl-dex"
draft: true
---
```
...
(define-constant token-supply u11111111111000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP2470N2A31DGDHX541MK2FKJSRHSCW907S5KKYTR.hodl-hodl-hodl-bonding-curve)
