---
title: "Trait neoswap-sc-1674159628008"
draft: true
---
```
...
(define-constant RECEIVER-2 'SP192QE0B7TQB9H0F7PMHP6M8NJ7HNS0H3GXZTQ8P)
(define-constant RECEIVER-3 'SP1XJ6GNTDVF6HR1VHPQDMFZJY87D9W6TGMH3QCP)
(define-constant RECEIVER-4 'SP2TW1D8YF5CE0NDP5VCR5NMTPHQ4PQR1KBB4NQ5Q)
(define-constant RECEIVER-5 'SP32CF0E78JNPK0HYDTH3CCZ8FN76PFX5W0FYBN20)
(define-constant RECEIVER-6 'SPH9YG28V53YATFKTJHMDG19RRJT74YFNS2MYTGF)
(define-constant RECEIVER-7 'SPVDF4YJER5QZD2PEY7WEDY6ZX6EQ36V1WN5XME)
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u21000000 tx-sender TRADER-1)))
	    )
            true
        )
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
