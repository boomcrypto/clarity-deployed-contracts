---
title: "Trait ballot-test-quest-Mgfhn"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Test quest")
    (var-set description u"i test service ")
    (var-set voting-system "block")
    (var-set options (list "2c06ab57-0ac3-4e16-8e65-36bd31fefa2e" "ac88b40a-91ab-4c42-90ca-83ab93abf9b0"))
    (var-set start u107643)
    (var-set end u107787)
    (map-set results {id: "2c06ab57-0ac3-4e16-8e65-36bd31fefa2e"} {count: u0, name: u"Choiccoe 1"}) (map-set results {id: "ac88b40a-91ab-4c42-90ca-83ab93abf9b0"} {count: u0, name: u"Choice 2"})
```
