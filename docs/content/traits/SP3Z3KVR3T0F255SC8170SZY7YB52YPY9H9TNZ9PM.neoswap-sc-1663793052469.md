---
title: "Trait neoswap-sc-1663793052469"
draft: true
---
```
...
(begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3750 tx-sender agent-3)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3750 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u153750 tx-sender agent-2)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u153750 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
