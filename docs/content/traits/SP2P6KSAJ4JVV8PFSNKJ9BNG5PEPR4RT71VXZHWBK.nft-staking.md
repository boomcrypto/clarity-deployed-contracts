...
(define-constant ERR-NFT-LISTED u105)
(define-constant ERR-ITEM-PRICE-TOO-LOW u102)
(define-constant ERR-NOT-ENOUGH-STX u106)
(define-constant CONTRACT-OWNER tx-sender)

(define-data-var admin principal 'SP3BT9AEHQ82QEGQVY0WCW3QD8HGVYDG3Y1B3CP4S)
(define-data-var blocks-per-token uint u3)
(define-data-var staking-fees (list 1000 uint) (list u2000000 u3000000))
(define-data-var unstaking-fees (list 1000 uint) (list u2000000 u3000000))
...
(define-data-var payout-addresses (list 1000 principal) (list 'SP3BT9AEHQ82QEGQVY0WCW3QD8HGVYDG3Y1B3CP4S 'SP2P6KSAJ4JVV8PFSNKJ9BNG5PEPR4RT71VXZHWBK))
...
(define-data-var token-address principal .slime)
...
(define-public (stake (collection <nft-trait>) (lookup-table <lookup-trait>) (item uint))
    ...
    (asserts! (is-eq false (get-listed (contract-of collection) item)) (err ERR-NFT-LISTED))
