---
title: "Trait belgian-malinois-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPKBV3CZB15CM3CVMCMRX56WRYKDY5P5CTQQXSN0.belgian-malinois-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u98924253698942720)
    (var-set stx-balance u65246667)
