---
title: "Trait ballot-ballot-snapshot-Sp7SO"
draft: true
---
```
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-block-info? id-header-hash u200334))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Ballot-snapshot")
    (var-set description u"Ballot-snapshot")
    (var-set voting-system "fptp")
    (var-set options (list "6ed6c483-8be1-451c-ac42-293f5ff70c4e" "5b7d9c32-9a0b-4726-9d03-c5340c440486"))
    (var-set start u200334)
    (var-set end u300334)
    (map-set results {id: "6ed6c483-8be1-451c-ac42-293f5ff70c4e"} {count: u0, name: u"Choice%201"}) (map-set results {id: "5b7d9c32-9a0b-4726-9d03-c5340c440486"} {count: u0, name: u"Choice%202"})
