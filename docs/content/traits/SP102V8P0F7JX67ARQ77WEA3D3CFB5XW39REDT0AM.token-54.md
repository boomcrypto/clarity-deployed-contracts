...
(define-fungible-token token-54)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-54 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-54)))
