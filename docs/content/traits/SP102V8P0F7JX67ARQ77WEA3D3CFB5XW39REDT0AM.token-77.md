...
(define-fungible-token token-77)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-77 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-77)))
