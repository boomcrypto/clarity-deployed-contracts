---
title: "Trait test-bitflow-nobf-stxcity-dex"
draft: true
---
```
...
(define-constant token-supply u19000000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP2QGQ3R0RH96SEGEV6YBK8QDPF7CQ0ATC2E7FH67.test-bitflow-nobf-stxcity)
