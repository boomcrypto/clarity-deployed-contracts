---
title: "Trait keeper-action-2-v-1-1"
draft: true
---
```
;; keeper-action-2-v-1-1
...
(define-private (swap-sa
  ...
  (let (
    ...
    (swap-b (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (stableswap-sa amount token-trait-c token-trait-d stableswap-pool-trait-a))
        (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-swap-helper-v-1-2 swap-helper-a amount u0 tokens-tuple-b xyk-pools-tuple))
      )
      (if (is-eq swaps-reversed false)
        (try! (stableswap-qa amount token-trait-c token-trait-d stableswap-pool-trait-a))
        (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-swap-helper-v-1-2 get-quote-a amount tokens-tuple-b xyk-pools-tuple))
      )
    ))
  )
...
(define-private (swap-sb
  ...
  (let (
    ...
    (swap-b (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (stableswap-sa amount token-trait-e token-trait-f stableswap-pool-trait-a))
        (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-swap-helper-v-1-2 swap-helper-b amount u0 tokens-tuple-b xyk-pools-tuple))
      )
      (if (is-eq swaps-reversed false)
        (try! (stableswap-qa amount token-trait-e token-trait-f stableswap-pool-trait-a))
        (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-swap-helper-v-1-2 get-quote-b amount tokens-tuple-b xyk-pools-tuple))
      )
    ))
  )
...
(define-private (swap-sc
  ...
  (let (
    ...
    (swap-b (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (stableswap-sa amount token-trait-g token-trait-h stableswap-pool-trait-a))
        (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-swap-helper-v-1-2 swap-helper-c amount u0 tokens-tuple-b xyk-pools-tuple))
      )
      (if (is-eq swaps-reversed false)
        (try! (stableswap-qa amount token-trait-g token-trait-h stableswap-pool-trait-a))
        (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-swap-helper-v-1-2 get-quote-c amount tokens-tuple-b xyk-pools-tuple))
      )
    ))
  )
...
(define-private (swap-sd
  ...
  (let (
    ...
    (swap-b (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (stableswap-sa amount token-trait-i token-trait-j stableswap-pool-trait-a))
        (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-swap-helper-v-1-2 swap-helper-d amount u0 tokens-tuple-b xyk-pools-tuple))
      )
      (if (is-eq swaps-reversed false)
        (try! (stableswap-qa amount token-trait-i token-trait-j stableswap-pool-trait-a))
        (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-swap-helper-v-1-2 get-quote-d amount tokens-tuple-b xyk-pools-tuple))
      )
    ))
  )
...
(define-private (swap-se
  ...
  (let (
    ...
    (swap-b (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (stableswap-sa amount token-trait-k token-trait-l stableswap-pool-trait-a))
        (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-swap-helper-v-1-2 swap-helper-e amount u0 tokens-tuple-b xyk-pools-tuple))
      )
      (if (is-eq swaps-reversed false)
        (try! (stableswap-qa amount token-trait-k token-trait-l stableswap-pool-trait-a))
        (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-swap-helper-v-1-2 get-quote-e amount tokens-tuple-b xyk-pools-tuple))
      )
    ))
  )
