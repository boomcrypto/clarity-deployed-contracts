---
title: "Trait ballot-vote-with-atalex-Itvaq"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with atALEX) Approve Launch of OrdzGames on the ALEX Launchpad")
    ...
    (var-set options (list "610b005d-5477-4fe1-83a8-399da56b132e" "153c0fa3-3335-48df-993a-a987f1583cc0"))
    (var-set start u132659)
    (var-set end u133091)
    (map-set results {id: "610b005d-5477-4fe1-83a8-399da56b132e"} {count: u0, name: u"Approve Launch of OrdzGames on the ALEX Launchpad"}) (map-set results {id: "153c0fa3-3335-48df-993a-a987f1583cc0"} {count: u0, name: u"Disapprove Launch of OrdzGames on the ALEX Launchpad"})
```
