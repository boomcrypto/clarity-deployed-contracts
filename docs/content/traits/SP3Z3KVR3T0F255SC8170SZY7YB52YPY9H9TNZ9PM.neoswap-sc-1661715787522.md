---
title: "Trait neoswap-sc-1661715787522"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u2220000 tx-sender agent-1)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1100000 tx-sender agent-2)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP1XPG9QFX5M95G36SGN9R8YJ4KJ0JB7ZXNH892N6.consensus-2022 transfer u117 tx-sender agent-3)))
	(unwrap-panic (as-contract (contract-call? 'SP1XPG9QFX5M95G36SGN9R8YJ4KJ0JB7ZXNH892N6.consensus-2022 transfer u175 tx-sender agent-3)))
	...
	(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u3138 tx-sender agent-6)))
	(unwrap-panic (begin
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u3430000 tx-sender agent-3)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u3430000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
