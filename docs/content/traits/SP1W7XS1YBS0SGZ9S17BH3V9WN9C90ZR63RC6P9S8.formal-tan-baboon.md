...
(define-public (mint (recipient principal))
  ...
  (let ((token-id (+ (var-get last-token-id) u1)))
    ...
    (try! (contract-call? 'SP1W7XS1YBS0SGZ9S17BH3V9WN9C90ZR63RC6P9S8.just-a-test123 transfer (var-get price) tx-sender CONTRACT_OWNER none))
