---
title: "Trait testbitflow5-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPSWQN1SJMZAEG815S7BMFSFRYA4X2S5AE91R88A.testbitflow5-stxcity)
...
(var-set token-balance u9999666677777408)
