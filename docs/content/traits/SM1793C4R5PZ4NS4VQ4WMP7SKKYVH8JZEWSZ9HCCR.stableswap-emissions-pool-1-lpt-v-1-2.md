---
title: "Trait stableswap-emissions-pool-1-lpt-v-1-2"
draft: true
---
```

;; stableswap-emissions-pool-1-lpt-v-1-2
...
(define-constant DEPLOYMENT_HEIGHT u893791)
...
(define-private (transfer-rewards-token (amount uint) (sender principal) (recipient principal))
  (let (
    (call-a (unwrap! (contract-call?
                     'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-pool-stx-ststx-v-1-4 transfer
...
(define-private (get-contract-token-balance)
  (let (
    (call-a (unwrap! (contract-call?
                     'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-pool-stx-ststx-v-1-4 get-balance
