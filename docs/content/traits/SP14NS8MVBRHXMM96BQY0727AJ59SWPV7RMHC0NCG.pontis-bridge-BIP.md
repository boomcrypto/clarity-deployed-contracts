...
(define-data-var token-name (string-ascii 32) "BASED.INTERNET.PANDA")
(define-data-var token-symbol (string-ascii 10) "BIP")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmZGjow3Ba6xkDHC9a2g655XWEN8JHSCT2JSjxKHhf1VkR"))
;; 848143:1826
