---
title: "Trait swan-with-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPWECF3XYVRBRCN23CJJCX9XKSF8RFWQPAQMWXT.swan-with-stxcity)
...
(var-set token-balance u999777827149522)
(var-set stx-balance u222222)
