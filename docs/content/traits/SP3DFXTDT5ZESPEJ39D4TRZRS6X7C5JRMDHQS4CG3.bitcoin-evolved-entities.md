---
title: "Trait bitcoin-evolved-entities"
draft: true
---
```
;; bitcoin-evolved-entities
;; contractType: public

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token bitcoin-evolved-entities uint)
...
;; Internal variables
(define-data-var mint-limit uint u333)
(define-data-var last-id uint u1)
(define-data-var total-price uint u33000000)
(define-data-var artist-address principal 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmVUZ1ANivSBYMdrCaATNidwRCJCREKfFhdZ45oRpJR7Sk/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? bitcoin-evolved-entities next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? bitcoin-evolved-entities token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? bitcoin-evolved-entities token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? bitcoin-evolved-entities token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? bitcoin-evolved-entities id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? bitcoin-evolved-entities id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? bitcoin-evolved-entities id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u83674)
...
;; Alt Minting Default
(define-data-var total-price-usda uint u22000000)
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u52070000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u47589000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u152000000)
...
;; Alt Minting Default
(define-data-var total-price-slime uint u2155000000)
...
;; Alt Minting Default
(define-data-var total-price-alex uint u53600000000)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u0) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u1) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u2) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u3) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u4) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u5) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u6) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u7) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u8) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u9) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u10) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u11) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u12) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u13) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u14) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u15) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u16) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u17) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u18) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u19) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u20) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u21) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u22) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u23) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u24) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u25) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u26) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u27) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u28) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u29) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u30) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u31) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u32) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u33) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u34) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u35) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u36) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u37) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u38) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u39) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u40) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u41) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u42) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u43) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u44) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u45) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u46) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u47) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u48) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u49) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u50) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u51) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u52) 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3))
      (map-set token-count 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3 (+ (get-balance 'SP3DFXTDT5ZESPEJ39D4TRZRS6X7C5JRMDHQS4CG3) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u53) 'SP5E89574DMC3X47K930P4TB58B1E8PXXCTAVAE4))
      (map-set token-count 'SP5E89574DMC3X47K930P4TB58B1E8PXXCTAVAE4 (+ (get-balance 'SP5E89574DMC3X47K930P4TB58B1E8PXXCTAVAE4) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u54) 'SP5E89574DMC3X47K930P4TB58B1E8PXXCTAVAE4))
      (map-set token-count 'SP5E89574DMC3X47K930P4TB58B1E8PXXCTAVAE4 (+ (get-balance 'SP5E89574DMC3X47K930P4TB58B1E8PXXCTAVAE4) u1))
      (try! (nft-mint? bitcoin-evolved-entities (+ last-nft-id u55) 'SP5E89574DMC3X47K930P4TB58B1E8PXXCTAVAE4))
      (map-set token-count 'SP5E89574DMC3X47K930P4TB58B1E8PXXCTAVAE4 (+ (get-balance 'SP5E89574DMC3X47K930P4TB58B1E8PXXCTAVAE4) u1))
