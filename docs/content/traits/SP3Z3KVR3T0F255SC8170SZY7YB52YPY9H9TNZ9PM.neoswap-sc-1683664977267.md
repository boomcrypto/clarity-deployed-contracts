---
title: "Trait neoswap-sc-1683664977267"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/zvOaRr3A2kSd7LhonYlg
;; SwapId: E7L4wJwwBJcLSIQYNYDf
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (contract-call? 'SP3D6PV2ACBPEKYJTCMH7HEN02KP87QSP8KTEH335.megapont-robot-component-nft transfer u53208 tx-sender TRADER-1)))
	    )
            true
        )
