---
title: "Trait ballot-vote-with-alex-a-lshU6"
draft: true
---
```
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with ALEX) Approve Launch of HuMaNz and Chamcha on the ALEX Launchpad")
    ...
    (var-set options (list "670a15b6-6744-4250-90be-a3c9b17cb12a" "bec575ef-b4d9-4a15-a4b7-be8b46ac955d"))
    (var-set start u116578)
    (var-set end u117586)
    (map-set results {id: "670a15b6-6744-4250-90be-a3c9b17cb12a"} {count: u0, name: u"HuMaNz"}) (map-set results {id: "bec575ef-b4d9-4a15-a4b7-be8b46ac955d"} {count: u0, name: u"Chamcha"})
```
