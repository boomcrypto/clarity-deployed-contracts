---
title: "Trait stacks-bull-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP9HPAXY8XD3BCP64X0SVZYXM1PDPN43DGQB76HG.stacks-bull-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u949367088607594)
