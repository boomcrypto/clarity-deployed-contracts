...
(define-data-var token-name (string-ascii 32) "SHORT.THE.DOLLAR")
(define-data-var token-symbol (string-ascii 10) "STD")
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://ipfs.io/ipfs/QmVLwQiESkpD8pPr64DxGpRuEM5kzzBw7iBY88pMt7Uwqo"))
;; 848528:2735
