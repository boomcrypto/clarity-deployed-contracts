---
title: "Trait memegoat-community-vote-013"
draft: true
---
```
;;
...
(define-public (execute (sender principal) (opt uint))
  (begin
    (try! (is-dao-or-extension))
    (try! (contract-call? .memegoat-community-pools-v2 set-approval-status 'SP3Y2ZSH8P7D50B0VBTSX11S7XSG24M1VB9YFQA4K.token-aewbtc u29 true))

    (try! (contract-call? .memegoat-staking-v1e move-user-records
      (list 
        'SP1AWVYG9Y93EAR9KKQS6EQ2ZR6HF2QWZHCW3S36N
      )
    ))
