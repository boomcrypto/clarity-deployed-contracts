---
title: "Trait test-update-may-1-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP2DRM5DKDJX6ECFJH9XDT66DZV8FK2H1A27JZHCA.test-update-may-1-stxcity)
