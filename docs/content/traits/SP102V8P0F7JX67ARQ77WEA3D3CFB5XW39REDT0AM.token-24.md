...
(define-fungible-token token-24)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-24 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-24)))
