---
title: "Trait pacmoon-bonding-curve"
draft: true
---
```
...
;; DEFINE METADATA
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://gaia.hiro.so/hub/17QjwxqttHtn7hwpANw5793dmDNQaKfjFQ/pacmoon-0-decimals.json"))
...
(begin
    ...
    (try! (ft-mint? Pac u1000000000000000 'SP33QYJHG988R7XD10B5MPKG7NCWQJ77ETKMA2HK4.pacmoon-dex))
)
