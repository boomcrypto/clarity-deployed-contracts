---
title: "Trait virtual-roo-dexterity"
draft: true
---
```
;; Virtual Roo - LP Token, AMM DEX and Hold-to-Earn Engine
;; SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.virtual-roo-dexterity
...
(define-constant MAX_SWAP_FEE u500000) ;; 50%
(define-constant PRECISION u1000000)
(define-constant ALPHA u990000)

;; Storage
(define-data-var owner principal DEPLOYER)
(define-data-var energy-burn-amount uint u100000000)
(define-data-var swap-fee uint u500000) ;; Default to 50%
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/api/v0/indexes/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.virtual-roo-dexterity"))
...
(define-public (swap (forward bool) (amt-in uint))
  (let (
    ...
    (try! (as-contract (contract-call? 'SP2C1WREHGM75C7TGFAEJPFKTFTEGZKF6DFT6E2GE.kangaroo transfer (/ (- raw-out amt-out) u2) CONTRACT .redemption-vault-v0 none)))
