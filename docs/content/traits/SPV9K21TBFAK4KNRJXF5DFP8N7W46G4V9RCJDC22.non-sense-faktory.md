---
title: "Trait non-sense-faktory"
draft: true
---
```

;; 
;; nonsense Powered By Faktory.fun v1.0 
...
(define-fungible-token NONSENSE MAX)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       (asserts! (is-eq tx-sender sender) (err ERR-NOT-AUTHORIZED))
        (ft-transfer? NONSENSE amount sender recipient)
    )
)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance NONSENSE account))
)
...
(begin 
    ...
    (try! (ft-mint? NONSENSE u69000000000000 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.non-sense-faktory-dex)) ;; supply-left
