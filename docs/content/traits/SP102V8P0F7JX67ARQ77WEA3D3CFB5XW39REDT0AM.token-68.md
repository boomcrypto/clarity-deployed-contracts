...
(define-fungible-token token-68)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-68 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-68)))
