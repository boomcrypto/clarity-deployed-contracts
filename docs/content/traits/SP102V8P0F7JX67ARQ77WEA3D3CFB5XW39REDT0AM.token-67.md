...
(define-fungible-token token-67)
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance token-67 who)))
(define-read-only (get-total-supply)
	(ok (ft-get-supply token-67)))
