---
title: "Trait neoswap-sc-1690324123952"
draft: true
---
```
;; multiway-swap
...
;; Room: https://neoswap.xyz/rooms/8QpKSjfpJToACvte4OBM
;; SwapId: TJNoeLKqMiOIWugdDaiw

;; traders
(define-constant TRADER-1 'SP3B3CF6ZSY1M6X7V2BM2GS3MME1VTA0H0DXT1GNS)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u915236 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u915236 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u915236 tx-sender TRADER-2)))
