---
title: "Trait ballot-vote-with-atalex-4GLGC"
draft: true
---
```
    ...
    (var-set options (list "5d9c2107-39d0-4c04-81e0-19db490673bf" "227c3571-de9b-4987-815e-095e25ef00e6"))
    (var-set start u132583)
    (var-set end u133015)
    (map-set results {id: "5d9c2107-39d0-4c04-81e0-19db490673bf"} {count: u0, name: u"Approve Launch of OrdzGames on the ALEX Launchpad"}) (map-set results {id: "227c3571-de9b-4987-815e-095e25ef00e6"} {count: u0, name: u"Disapprove Launch of OrdzGames on the ALEX Launchpad"})
```
