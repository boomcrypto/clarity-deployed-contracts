---
title: "Trait StoneTempleRun"
draft: true
---
```
;; updated contract on 24-04-2025 for temple run game
;; contract updated on 27-03-2025 to change logic of enter contest function
;; =======================
...
;;used our own wallet addresses for testing purpose
...
(define-public (set-secondary-percentages
  ...
  (begin
    ...
    (asserts!
      (is-eq (+ new-multisig new-burn new-kryptomind) u10000)
    ...
    (ok {multisig: new-multisig, burn: new-burn, krypto: new-kryptomind})
  )
)
...
;;changes pricing for stone temple run game to 0.001 for 5 , 0.002 for 25, 0.003 for 50 and 0.004 for 100 gems on 24-04-2025
;; ========================================
;; Purchase Gems
;; ========================================
