---
title: "Trait neoswap-sc-1653508302955"
draft: true
---
```
...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u12927915 tx-sender agent-1)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u7067915 tx-sender agent-2)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u7067915 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
