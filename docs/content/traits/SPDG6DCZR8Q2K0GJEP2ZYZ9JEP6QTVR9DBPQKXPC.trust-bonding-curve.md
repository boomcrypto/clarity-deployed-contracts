---
title: "Trait trust-bonding-curve"
draft: true
---
```
...
;; DEFINE METADATA
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://gaia.hiro.so/hub/197dHzJ7KHCnu3A97hpsrk7E34vNM6ewSz/trust-0-decimals.json"))
...
(begin
    ...
    (try! (ft-mint? TRUST u69000000000000000 'SPDG6DCZR8Q2K0GJEP2ZYZ9JEP6QTVR9DBPQKXPC.trust-dex))
)
