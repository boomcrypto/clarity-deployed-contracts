...
(define-non-fungible-token tokenmobiles-1 uint)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmWJd7fpbAFLY4oa7eMw45VDYiHCegkcfDfKGqmoPMKXEU/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (or (is-eq (var-get mint-limit) u0) (<= next-id (var-get mint-limit)))
    (begin
      (unwrap! (nft-mint? tokenmobiles-1 next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? tokenmobiles-1 token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? tokenmobiles-1 token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? tokenmobiles-1 token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? tokenmobiles-1 id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? tokenmobiles-1 id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? tokenmobiles-1 id) (err ERR-NOT-FOUND)))
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? tokenmobiles-1 (+ last-nft-id u0) 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC))
      (map-set token-count 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC (+ (get-balance 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC) u1))
      (try! (nft-mint? tokenmobiles-1 (+ last-nft-id u1) 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC))
      (map-set token-count 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC (+ (get-balance 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC) u1))
      (try! (nft-mint? tokenmobiles-1 (+ last-nft-id u2) 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC))
      (map-set token-count 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC (+ (get-balance 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC) u1))
      (try! (nft-mint? tokenmobiles-1 (+ last-nft-id u3) 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC))
      (map-set token-count 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC (+ (get-balance 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC) u1))
      (try! (nft-mint? tokenmobiles-1 (+ last-nft-id u4) 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC))
      (map-set token-count 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC (+ (get-balance 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC) u1))
      (try! (nft-mint? tokenmobiles-1 (+ last-nft-id u5) 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC))
      (map-set token-count 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC (+ (get-balance 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC) u1))
      (try! (nft-mint? tokenmobiles-1 (+ last-nft-id u6) 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC))
      (map-set token-count 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC (+ (get-balance 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC) u1))
      (try! (nft-mint? tokenmobiles-1 (+ last-nft-id u7) 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC))
      (map-set token-count 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC (+ (get-balance 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC) u1))
      (try! (nft-mint? tokenmobiles-1 (+ last-nft-id u8) 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC))
      (map-set token-count 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC (+ (get-balance 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC) u1))
      (try! (nft-mint? tokenmobiles-1 (+ last-nft-id u9) 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC))
      (map-set token-count 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC (+ (get-balance 'SP1YZ7GYG4F7DGRAY0TDN5Z2GGPXDYKN7NGFDWEJC) u1))
