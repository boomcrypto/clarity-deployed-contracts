---
title: "Trait curve-farming-core-v1_0_0-0000"
draft: true
---
```
...
(define-constant STAKING-TOKEN .curve-lp-token-v1_0_0-0000)
...
(define-public (stake (amt uint))
  (let ((user      tx-sender)
    ...
    ;; Update global state
    (try! (contract-call? .curve-lp-token-v1_0_0-0000 transfer amt user protocol none))
    ...
    ;; Postconditions
    (asserts!
      (>= (unwrap-panic (contract-call? .curve-lp-token-v1_0_0-0000 get-balance protocol))
...
(define-public (unstake (amt uint))
  (let ((user      tx-sender)
    ...
    ;; Update global state
    (try! (as-contract (contract-call? .curve-lp-token-v1_0_0-0000 transfer amt protocol user none)))
