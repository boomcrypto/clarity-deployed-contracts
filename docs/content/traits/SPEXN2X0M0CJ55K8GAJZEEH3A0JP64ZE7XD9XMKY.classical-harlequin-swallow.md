---
title: "Trait classical-harlequin-swallow"
draft: true
---
```
  ...
  (let (
    ...
    (quote-b (if (is-eq swaps-reversed false)
                 ...
                 (unwrap-panic (if (is-eq (get a stableswap-reversals) false)
                                   ...
                                   (unwrap! (stableswap-qb scaled-amount-a stableswap-tokens stableswap-pools) ERR_QUOTE_B)))))
  )
    (ok quote-b)
  )
)
  ...
  (let (
    ...
    (swap-b (if (is-eq swaps-reversed false)
                ...
                (if (is-eq (get a stableswap-reversals) false)
                    ...
                    (unwrap! (stableswap-sb scaled-amount-a stableswap-tokens stableswap-pools) ERR_SWAP_B))))
  )
    (begin
