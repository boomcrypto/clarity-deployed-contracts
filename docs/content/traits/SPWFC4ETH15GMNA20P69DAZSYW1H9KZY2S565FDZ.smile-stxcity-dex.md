...
(define-constant allow-token 'SPB78FX86W27FQVEFPN7C2T7GMBABMARZY8FHPMW.earth-stxcity)
...
(define-public (buy (token-trait <sip-010-trait>) (stx-amount uint) ) 
  (begin
    ...
    (let (
      (buy-info (unwrap! (get-buyable-tokens u1000000 ) BUY-INFO-ERROR))
      ...
      (try! (stx-transfer? (- stx-amount u1000000) tx-sender (var-get TOKEN_OWNER)))
