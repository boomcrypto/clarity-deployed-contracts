...
(define-constant allow-token 'SP21STS8TSBP2MAP057H91SPEND4PWV5BA5Z8A4NX.aids-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u67591836734693880)
    (var-set stx-balance u16666667)
