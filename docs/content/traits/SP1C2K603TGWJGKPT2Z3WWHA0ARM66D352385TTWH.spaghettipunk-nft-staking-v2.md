---
title: "Trait spaghettipunk-nft-staking-v2"
draft: true
---
```
...
(define-data-var prev-bonus-check (list 100 principal) (list ))
...
(define-read-only (check-collect (staker principal))
  (let (
      ...
      (bonus-addresses (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.principal-lists lookup tx-sender bonus-indexer))
      (bonus-points (if (> (len bonus-addresses) u0) (fold + (map get-bonus-points all-bonus bonus-addresses ) u0) u0))
    )
...
(print (bonus-add (list 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-bulls 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-bears 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.bitcoin-whales) u288 block-height u4015))
```
