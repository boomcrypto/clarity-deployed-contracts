---
title: "Trait banana-marketplace-v2"
draft: true
---
```
...
(define-public (buy-item (collection <nft-trait>) (collection-id (string-ascii 256)) (item-id uint))
  (let (
    ...
    (bid (get-item-bid collection-id item-id))
    (to-burn (/ (* (get price item) (var-get burn-rate)) u10000))
    (to-vault (/ (* (get price item) (- u10000 (var-get burn-rate))) u10000))
    (listed (var-get listed-items))
  )
    ...
    (var-set bananas-burned (+ (var-get bananas-burned) (/ (* (get price item) (var-get burn-rate)) u10000)))
