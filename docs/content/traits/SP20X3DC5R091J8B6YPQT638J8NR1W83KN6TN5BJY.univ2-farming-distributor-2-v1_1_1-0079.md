---
title: "Trait univ2-farming-distributor-2-v1_1_1-0079"
draft: true
---
```
...
(define-public
  ...
  (let ((epoch (contract-call? .univ2-farming-core-v1_1_1-0079 current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .univ2-farming-core-v1_1_1-0079 get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .univ2-farming-core-v1_1_1-0079 current-epoch))
