---
title: "Trait farming-wstx-boden-distributor"
draft: true
---
```
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constants
(define-constant REWARD-TOKEN 'SP234612X2B5YRC59WMZYJXQJRVRE40HQ54328D5S.jeo-boden)
...
(define-public
  ...
  (let ((epoch (contract-call? .farming-wstx-boden-core current-epoch))
...
(define-read-only
  ...
  (let ((share   (try! (contract-call? .farming-wstx-boden-core get-share-at user epoch)))
...
(define-read-only (mkepochs (start-epoch uint))
  (let ((current (contract-call? .farming-wstx-boden-core current-epoch))
