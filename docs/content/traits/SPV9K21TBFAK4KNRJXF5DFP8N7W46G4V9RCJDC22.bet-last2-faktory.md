---
title: "Trait bet-last2-faktory"
draft: true
---
```

;; 35a99860f3725cee35aa7dbcdf8162ecefb1c5fe0767bd8b13b6243561454276
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? last amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(begin 
    ...
    (try! (ft-mint? last u69000000000000 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.bet-last2-faktory-dex)) ;; supply-left
