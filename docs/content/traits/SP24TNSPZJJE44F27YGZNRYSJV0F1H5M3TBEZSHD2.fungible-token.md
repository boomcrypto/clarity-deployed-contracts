...
(define-fungible-token clarity-coin u2100000000 )
...
(define-constant TOKEN_NAME "lulul")
(define-constant TOKEN_SYMBOL "luc")
(define-constant TOKEN_DECIMALS u4) ;; 6 units displayed past decimal, e.g. 1.000_000 = 1 token
