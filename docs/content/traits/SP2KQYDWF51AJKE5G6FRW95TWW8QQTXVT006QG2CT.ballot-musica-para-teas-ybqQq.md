---
title: "Trait ballot-musica-para-teas-ybqQq"
draft: true
---
```
    ...
    (var-set options (list "e7aba67a-eb27-4945-9ade-3c13f9d3b1cb" "caf50426-96ed-4696-a6d4-fd10e5f1f942" "0bf1b04f-e7a4-46f9-9d84-eacbbc6b89bf" "ac16ec52-3852-4089-b68e-24022198b029"))
    (var-set start u143199)
    (var-set end u145671)
    (map-set results {id: "e7aba67a-eb27-4945-9ade-3c13f9d3b1cb"} {count: u0, name: u"La%20Soledad"}) (map-set results {id: "caf50426-96ed-4696-a6d4-fd10e5f1f942"} {count: u0, name: u"Cancion%20de%20A"}) (map-set results {id: "0bf1b04f-e7a4-46f9-9d84-eacbbc6b89bf"} {count: u0, name: u"Manuelita"}) (map-set results {id: "ac16ec52-3852-4089-b68e-24022198b029"} {count: u0, name: u"Ninguna%20de%20estas%20opciones"})
```
