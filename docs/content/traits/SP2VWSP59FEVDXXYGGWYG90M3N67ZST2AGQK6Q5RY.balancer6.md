...
(define-public (balancer_i (in uint) (mrc uint) (ta uint))
    (begin 
        ...
        (let 
            ...
            (let 
                ...
                (and (> ba ta) (try! (stx-transfer? (- ba ta) tx-sender 'SP2VWSP59FEVDXXYGGWYG90M3N67ZST2AGQK6Q5RY)))
                (ok (list bb ba))
            ) 
        )
    )
