---
title: "Trait neoswap-sc-1653593026954"
draft: true
---
```
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u3867915 tx-sender agent-2)))
	)
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u472085 tx-sender agent-3)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u3867915 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (stx-transfer? u472085 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
