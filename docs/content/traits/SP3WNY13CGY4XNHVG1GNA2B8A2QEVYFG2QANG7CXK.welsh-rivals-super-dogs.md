---
title: "Trait welsh-rivals-super-dogs"
draft: true
---
```
;; welsh-rivals-super-dogs
;; contractType: public

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token welsh-rivals-super-dogs uint)
...
(define-data-var artist-address principal 'SP3WNY13CGY4XNHVG1GNA2B8A2QEVYFG2QANG7CXK)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmVhWybaJWHp7vY3Tk5q9xFBywrbWceG4DGu6nNbSdSa2J/json/")
(define-data-var mint-paused bool false)
(define-data-var premint-enabled bool false)
(define-data-var sale-enabled bool false)
(define-data-var metadata-frozen bool false)
(define-data-var airdrop-called bool false)
(define-data-var mint-cap uint u15)
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? welsh-rivals-super-dogs next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? welsh-rivals-super-dogs token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? welsh-rivals-super-dogs token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? welsh-rivals-super-dogs token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? welsh-rivals-super-dogs id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? welsh-rivals-super-dogs id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? welsh-rivals-super-dogs id) (err ERR-NOT-FOUND)))
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? welsh-rivals-super-dogs (+ last-nft-id u0) 'SP28JP1FEVX7G3YFDJ59GKKQTZEVQQ49YDM0FDFK4))
      (map-set token-count 'SP28JP1FEVX7G3YFDJ59GKKQTZEVQQ49YDM0FDFK4 (+ (get-balance 'SP28JP1FEVX7G3YFDJ59GKKQTZEVQQ49YDM0FDFK4) u1))
      (try! (nft-mint? welsh-rivals-super-dogs (+ last-nft-id u1) 'SP1AQDVJF18XEFVXMWTRAW9TQ0N2DCN0178FKW03R))
      (map-set token-count 'SP1AQDVJF18XEFVXMWTRAW9TQ0N2DCN0178FKW03R (+ (get-balance 'SP1AQDVJF18XEFVXMWTRAW9TQ0N2DCN0178FKW03R) u1))
      (try! (nft-mint? welsh-rivals-super-dogs (+ last-nft-id u2) 'SP1AQDVJF18XEFVXMWTRAW9TQ0N2DCN0178FKW03R))
      (map-set token-count 'SP1AQDVJF18XEFVXMWTRAW9TQ0N2DCN0178FKW03R (+ (get-balance 'SP1AQDVJF18XEFVXMWTRAW9TQ0N2DCN0178FKW03R) u1))
