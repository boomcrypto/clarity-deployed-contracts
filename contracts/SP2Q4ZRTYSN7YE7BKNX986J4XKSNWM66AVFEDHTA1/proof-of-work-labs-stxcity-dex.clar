...
(define-constant STX_TARGET_AMOUNT u4000000000)
(define-constant VIRTUAL_STX_VALUE u800000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u80000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP2Q4ZRTYSN7YE7BKNX986J4XKSNWM66AVFEDHTA1.proof-of-work-labs-stxcity)
...
(var-set token-balance u734140080674734)
(var-set stx-balance u289710290)
