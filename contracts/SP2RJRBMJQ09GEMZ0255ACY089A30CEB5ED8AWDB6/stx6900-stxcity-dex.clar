...
(define-constant STX_TARGET_AMOUNT u7000000000)
(define-constant VIRTUAL_STX_VALUE u1400000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u140000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP2RJRBMJQ09GEMZ0255ACY089A30CEB5ED8AWDB6.stx6900-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u64404289329958704)
    (var-set stx-balance u99900100)
