...
(impl-trait .sip-010-trait-ft-standard-v1-0.sip-010-trait)

;; BSD Protocol 
(impl-trait .bsd-trait-v1-0.bsd-trait)
...
;; Initialization 
(map-set authorized-protocol-callers .registry-v1-0 true)
(map-set authorized-protocol-callers .vault-v1-0 true)
(map-set authorized-protocol-callers .redeem-v1-0 true)
(map-set authorized-protocol-callers .stability-v1-0 true)
(map-set authorized-protocol-callers .timelock-v1-0 true)

;; Initialize the privileged principals list
(var-set privileged-principals-list (list .registry-v1-0 .vault-v1-0 .redeem-v1-0 .stability-v1-0 .timelock-v1-0))