...
(define-data-var bitcoin-blocks-per-year uint u1300)
...
;; Network-specific initialization
(var-set current-cycle-bitcoin-block-height u921265)
(var-set snapshots-per-cycle u5)
(var-set blocks-per-snapshot u10)
