...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP1XPG9QFX5M95G36SGN9R8YJ4KJ0JB7ZXNH892N6.consensus-2022 transfer u93 tx-sender agent-1)))
	(unwrap-panic (begin
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u280000 tx-sender agent-4)))
	)
	(unwrap-panic (begin
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u2660000 tx-sender agent-1)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1XPG9QFX5M95G36SGN9R8YJ4KJ0JB7ZXNH892N6.consensus-2022 transfer u93 tx-sender agent-2)))
	(var-set agent-2-status false))
	true)
	(if (is-eq (var-get agent-3-status) true)
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u3997 tx-sender agent-3)))
