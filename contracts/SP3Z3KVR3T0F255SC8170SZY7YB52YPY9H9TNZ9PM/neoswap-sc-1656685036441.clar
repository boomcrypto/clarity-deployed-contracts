...
(begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u8100000 tx-sender agent-4)))
	)
	...
	(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u2334 tx-sender agent-6)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPFRNSJ3T6HSW1PJN2TAJZVKY3REYFCFDHETWJWG.stacks-punk-reloaded transfer u273 tx-sender agent-3)))
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1780000 tx-sender agent-5)))
	)
