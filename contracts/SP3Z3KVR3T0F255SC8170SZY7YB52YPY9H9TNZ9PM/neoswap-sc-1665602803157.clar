...
(begin
	...
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP1W61GBSSTV6QFR16N7VEW549M07XP6BD0RXBW6B.btccustoms-components- transfer u19 tx-sender agent-7)))
		(as-contract (stx-transfer? u1641979 tx-sender agent-7)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u502125 tx-sender agent-8)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u137024 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1W61GBSSTV6QFR16N7VEW549M07XP6BD0RXBW6B.btccustoms-components- transfer u19 tx-sender agent-8)))
