...
(define-constant TRADER-2 'SP2S872HVH23Q1M1VQ6Z55VM11V8Z7YG8V3TZTR96)
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u34500 tx-sender RECEIVER-1)))
	(unwrap-panic (as-contract (stx-transfer? u715500 tx-sender TRADER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u1155 tx-sender TRADER-1)))
	    )
            true
        )
