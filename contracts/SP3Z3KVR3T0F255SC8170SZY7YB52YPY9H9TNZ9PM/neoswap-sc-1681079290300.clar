...
(define-constant TRADER-3 'SPP28QCMZ51GVN9933VFH9TXKQ3XCT4WE5A07533)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (contract-call? 'SP2YS6QDVENG4GK46W6BRB8TCJ22VFZH7A54T2293.spirits-of-elden transfer u31 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
	    )
            true
        )
	(if (is-eq tx-sender TRADER-2)
            (begin
		(unwrap! (stx-transfer? u3143000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
		(unwrap! (contract-call? 'SP19WKA4H1ZVCWRCY82SPGJHJ3GXD02D60YQT7Y7H.shinigami-pfp transfer u3 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
		(unwrap! (contract-call? 'SP19WKA4H1ZVCWRCY82SPGJHJ3GXD02D60YQT7Y7H.shinigami-pfp transfer u1 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
	    )
            true
        )
	(if (is-eq tx-sender TRADER-3)
            (begin
		(unwrap! (stx-transfer? u5191000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
		(unwrap! (contract-call? 'SP2J4TG4H9KYMTTG267KMR82JDM20WHET6XNR0PWQ.bitcoin-owlz transfer u2290 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
		(unwrap! (contract-call? 'SP2YS6QDVENG4GK46W6BRB8TCJ22VFZH7A54T2293.spirits-of-elden transfer u283 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
	    )
            true
        )
...
(define-private (release-escrow) 
    (begin
	(unwrap-panic (as-contract (contract-call? 'SP2J4TG4H9KYMTTG267KMR82JDM20WHET6XNR0PWQ.bitcoin-owlz transfer u2290 tx-sender TRADER-2)))
	(unwrap-panic (as-contract (contract-call? 'SP2YS6QDVENG4GK46W6BRB8TCJ22VFZH7A54T2293.spirits-of-elden transfer u31 tx-sender TRADER-2)))
	(unwrap-panic (as-contract (contract-call? 'SP2YS6QDVENG4GK46W6BRB8TCJ22VFZH7A54T2293.spirits-of-elden transfer u283 tx-sender TRADER-2)))
	(unwrap-panic (as-contract (contract-call? 'SP19WKA4H1ZVCWRCY82SPGJHJ3GXD02D60YQT7Y7H.shinigami-pfp transfer u1 tx-sender TRADER-3)))
	(unwrap-panic (as-contract (contract-call? 'SP19WKA4H1ZVCWRCY82SPGJHJ3GXD02D60YQT7Y7H.shinigami-pfp transfer u3 tx-sender TRADER-3)))

	(unwrap-panic (as-contract (stx-transfer? u5922000 tx-sender TRADER-1)))
	(unwrap-panic (as-contract (stx-transfer? u2412000 tx-sender RECEIVER-1)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (contract-call? 'SP2YS6QDVENG4GK46W6BRB8TCJ22VFZH7A54T2293.spirits-of-elden transfer u31 tx-sender TRADER-1)))
	    )
            true
        )
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u3143000 tx-sender TRADER-2)))
		(unwrap-panic (as-contract (contract-call? 'SP19WKA4H1ZVCWRCY82SPGJHJ3GXD02D60YQT7Y7H.shinigami-pfp transfer u3 tx-sender TRADER-2)))
		(unwrap-panic (as-contract (contract-call? 'SP19WKA4H1ZVCWRCY82SPGJHJ3GXD02D60YQT7Y7H.shinigami-pfp transfer u1 tx-sender TRADER-2)))
	    )
            true
        )
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-3)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u5191000 tx-sender TRADER-3)))
		(unwrap-panic (as-contract (contract-call? 'SP2J4TG4H9KYMTTG267KMR82JDM20WHET6XNR0PWQ.bitcoin-owlz transfer u2290 tx-sender TRADER-3)))
		(unwrap-panic (as-contract (contract-call? 'SP2YS6QDVENG4GK46W6BRB8TCJ22VFZH7A54T2293.spirits-of-elden transfer u283 tx-sender TRADER-3)))
	    )
            true
        )
