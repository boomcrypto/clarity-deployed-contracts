...
(begin
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1583625 tx-sender agent-1)))
	)
	(unwrap-panic (begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1122750 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u12710000 tx-sender agent-5)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u12710000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
