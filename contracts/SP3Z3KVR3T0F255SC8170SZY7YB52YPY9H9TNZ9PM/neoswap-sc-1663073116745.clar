...
(define-constant agent-1 'SPCJKDG7D6MTWMSDKNKWGQFK5QRXN59HF6WDBQGX)
...
(begin
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1610000 tx-sender agent-1)))
	)
	(unwrap-panic (begin
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP2RJP81KF3V6NJVZEZ2SR8DD73VQJC98EJSTQWDV.dcards-v4 transfer u291 tx-sender agent-1)))
	(var-set agent-1-status false))
	true)
	(if (is-eq (var-get agent-2-status) true)
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.stx-youth transfer u3158 tx-sender agent-2)))
