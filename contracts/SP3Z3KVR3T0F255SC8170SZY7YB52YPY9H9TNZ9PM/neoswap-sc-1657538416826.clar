...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP1XJ6GNTDVF6HR1VHPQDMFZJY87D9W6TGMH3QCP.colors-of-love transfer u8 tx-sender agent-4)))
	(unwrap-panic (begin
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1XJ6GNTDVF6HR1VHPQDMFZJY87D9W6TGMH3QCP.colors-of-love transfer u8 tx-sender agent-2)))
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4630000 tx-sender agent-4)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-satoshi-knights transfer u12 tx-sender agent-5)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP20F15MKEWE4C2GACJK6EJS5ERYQKVCJTV84RYC0.free-and-abstract transfer u6 tx-sender agent-6)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SP1XJ6GNTDVF6HR1VHPQDMFZJY87D9W6TGMH3QCP.colors-of-love transfer u8 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
