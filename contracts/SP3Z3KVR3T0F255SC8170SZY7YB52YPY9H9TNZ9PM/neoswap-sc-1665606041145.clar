...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4871025 tx-sender agent-1)))
	)
	(unwrap-panic (begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u228343 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u6049368 tx-sender agent-3)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u6049368 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
