...
(define-constant agent-6 'SPECW310NYWYZQXJMG734PQKPMAVXYY3YGWZ9YJB)
...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1310000 tx-sender agent-1)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u10900000 tx-sender agent-2)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u1630000 tx-sender agent-3)))
	)
	...
	(unwrap-panic (begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPJJYJVZ4H7B34GG8D3SSN70WVWDYSHCC9E9ZV4V.bitcoin-toadz transfer u2294 tx-sender agent-4)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u1630000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
