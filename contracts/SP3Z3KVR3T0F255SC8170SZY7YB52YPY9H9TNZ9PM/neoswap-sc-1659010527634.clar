...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP3QWNA75CY7QAK7S9XG7T258KSVQE1DW4HGTVRA3.king-katz transfer u348 tx-sender agent-5)))
	(unwrap-panic (begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP497E7RX3233ATBS2AB9G4WTHB63X5PBSP5VGAQ.boom-nfts transfer u12513 tx-sender agent-8)))
	(unwrap-panic (as-contract (contract-call? 'SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.monkey-coin transfer u151 tx-sender agent-9)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u2600000 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.monkey-coin transfer u151 tx-sender agent-1)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP497E7RX3233ATBS2AB9G4WTHB63X5PBSP5VGAQ.boom-nfts transfer u12513 tx-sender agent-6)))
	(var-set agent-6-status false))
	true)
	(if (is-eq (var-get agent-7-status) true)
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP3QWNA75CY7QAK7S9XG7T258KSVQE1DW4HGTVRA3.king-katz transfer u348 tx-sender agent-7)))
		(as-contract (stx-transfer? u12320000 tx-sender agent-7)))
	)
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u34650000 tx-sender agent-9)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.monkey-coin transfer u151 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
		...
		(asserts! (is-ok (stx-transfer? u12320000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
