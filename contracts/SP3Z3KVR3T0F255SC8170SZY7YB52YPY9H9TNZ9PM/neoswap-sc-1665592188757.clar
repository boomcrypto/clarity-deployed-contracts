...
(begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u86499400 tx-sender agent-4)))
	)
	...
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.citadels transfer u1005 tx-sender agent-5)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4577306 tx-sender agent-0)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u91006264 tx-sender agent-1)))
	)
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u70442 tx-sender agent-5)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u91006264 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (stx-transfer? u70442 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
