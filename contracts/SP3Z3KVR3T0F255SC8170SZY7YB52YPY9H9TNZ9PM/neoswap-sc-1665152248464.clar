...
(begin
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u14293625 tx-sender agent-2)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1701375 tx-sender agent-3)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4200000 tx-sender agent-4)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u873625 tx-sender agent-0)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u21068625 tx-sender agent-1)))
	)
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u2348 tx-sender agent-4)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u21068625 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
