...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u60087422 tx-sender agent-3)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP1G6NBZ22B184MM26QY1DVH657K8KP01GW8RDRM1.citybulls-nft transfer u86 tx-sender agent-5)))
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u922432 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1G6NBZ22B184MM26QY1DVH657K8KP01GW8RDRM1.citybulls-nft transfer u86 tx-sender agent-3)))
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u60632000 tx-sender agent-5)))
	)
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u377854 tx-sender agent-6)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SP1G6NBZ22B184MM26QY1DVH657K8KP01GW8RDRM1.citybulls-nft transfer u86 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
		...
		(asserts! (is-ok (stx-transfer? u60632000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (stx-transfer? u377854 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
