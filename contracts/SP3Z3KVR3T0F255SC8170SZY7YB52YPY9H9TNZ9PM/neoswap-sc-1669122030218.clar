...
(define-constant agent-4 'SP2NHZDAMMEEASE4DKHYYCVAG8RF8PA7YHPPW40BX)
...
(begin
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u40531250 tx-sender agent-2)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u5362500 tx-sender agent-3)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u27000000 tx-sender agent-4)))
	)
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP3QSAJQ4EA8WXEDSRRKMZZ29NH91VZ6C5X88FGZQ.crashpunks-v2 transfer u2003 tx-sender agent-5)))
		(as-contract (stx-transfer? u80041250 tx-sender agent-5)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP3K22XKPT9WJFCE957J94J6XXVZHP7747YNPDTFD.crash-punks-termination-shock transfer u236 tx-sender agent-6)))
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP1CSHTKVHMMQJ7PRQRFYW6SB4QAW6SR3XY2F81PA.crash-punks-boxes transfer u268 tx-sender agent-7)))
		(as-contract (stx-transfer? u32750000 tx-sender agent-7)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u19571250 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP3QSAJQ4EA8WXEDSRRKMZZ29NH91VZ6C5X88FGZQ.crashpunks-v2 transfer u2003 tx-sender agent-2)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1CSHTKVHMMQJ7PRQRFYW6SB4QAW6SR3XY2F81PA.crash-punks-boxes transfer u2360 tx-sender agent-4)))
	(var-set agent-4-status false))
	true)
	(if (is-eq (var-get agent-5-status) true)
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP3QSAJQ4EA8WXEDSRRKMZZ29NH91VZ6C5X88FGZQ.crashpunks-v2 transfer u2620 tx-sender agent-5)))
	(var-set agent-5-status false))
	true)
	(if (is-eq (var-get agent-6-status) true)
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u5637500 tx-sender agent-6)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1CSHTKVHMMQJ7PRQRFYW6SB4QAW6SR3XY2F81PA.crash-punks-boxes transfer u2399 tx-sender agent-7)))
		(unwrap-panic (as-contract (contract-call? 'SP1CSHTKVHMMQJ7PRQRFYW6SB4QAW6SR3XY2F81PA.crash-punks-boxes transfer u2401 tx-sender agent-7)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SP3QSAJQ4EA8WXEDSRRKMZZ29NH91VZ6C5X88FGZQ.crashpunks-v2 transfer u2003 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
