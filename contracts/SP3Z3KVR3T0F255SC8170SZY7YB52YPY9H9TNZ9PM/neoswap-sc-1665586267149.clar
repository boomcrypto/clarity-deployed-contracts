...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u2778750 tx-sender agent-3)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP32AEEF6WW5Y0NMJ1S8SBSZDAY8R5J32NBZFPKKZ.free-punks-v0 transfer u4549 tx-sender agent-7)))
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.venice-visuals transfer u28 tx-sender agent-7)))
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP1GWHGESCF29TV10Q6X0VZYWH4QJ6CM9NK6DSH9J.big-mans-choice transfer u38 tx-sender agent-8)))
		(as-contract (stx-transfer? u11229824 tx-sender agent-8)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u868196 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u14876770 tx-sender agent-7)))
	)
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.venice-visuals transfer u28 tx-sender agent-8)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u14876770 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
