...
(begin
	...
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.citadels transfer u1625 tx-sender agent-4)))
		(as-contract (stx-transfer? u7694840 tx-sender agent-4)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3411915 tx-sender agent-8)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u753520 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u11860275 tx-sender agent-3)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.citadels transfer u1625 tx-sender agent-8)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u11860275 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
