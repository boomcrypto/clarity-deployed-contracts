...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.deruptars transfer u1511 tx-sender agent-2)))
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u8070000 tx-sender agent-2)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u8070000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
