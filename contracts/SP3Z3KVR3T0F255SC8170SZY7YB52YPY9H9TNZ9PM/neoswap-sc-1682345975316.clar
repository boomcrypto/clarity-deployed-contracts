...
;; Room: https://neoswap.xyz/rooms/vNzS8LESIXLjUWEteAqh
;; SwapId: IaxkmHK8n5luvJLEgzSc
...
(define-private (release-escrow) 
	...
	(unwrap-panic (as-contract (stx-transfer? u975000 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u1075000 tx-sender TRADER-1)))
	    )
            true
        )
