...
;; Room: https://neoswap.xyz/rooms/dgwSKqkgO5lJSqCJs42B
;; SwapId: WKXFdsVWpypWBW3lJiSL
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (contract-call? 'SP27F9EJH20K3GT6GHZG0RD08REZKY2TDMD6D9M2Z.btc-badgers-v2 transfer u1192 tx-sender TRADER-2)))
	    )
            true
        )
