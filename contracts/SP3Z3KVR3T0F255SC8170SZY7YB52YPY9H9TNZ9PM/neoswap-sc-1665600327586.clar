...
(begin
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1645949 tx-sender agent-5)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u84408 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1730357 tx-sender agent-1)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP213KNHB5QD308TEESY1ZMX1BP8EZDPG4JWD0MEA.web4 transfer u10349 tx-sender agent-5)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u1730357 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
