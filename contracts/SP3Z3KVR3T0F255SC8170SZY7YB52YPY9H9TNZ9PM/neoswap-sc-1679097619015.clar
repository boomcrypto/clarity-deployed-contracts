...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (contract-call? 'SP37PGRC42BRJ33HMC2SN4DT9QN8RHGC6AZ7DRGH9.stacks-checks transfer u216 tx-sender TRADER-2)))
		(unwrap-panic (as-contract (contract-call? 'SPJPTE6B8CBQH8VWGYHE4871VXBEKFMC96WSJ9J4.dollicon-avatars-stacks transfer u9 tx-sender TRADER-2)))
	    )
            true
        )
