...
(begin
	...
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP2W58YQZEAC870M2MKE6QEKS1DPG0RMZZ2BGXSM4.tickets-90stx-mini-raffle-26 transfer u51 tx-sender agent-2)))
		(as-contract (stx-transfer? u922375 tx-sender agent-2)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u102625 tx-sender agent-3)))
	)
	(unwrap-panic (begin
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP2W58YQZEAC870M2MKE6QEKS1DPG0RMZZ2BGXSM4.tickets-90stx-mini-raffle-26 transfer u51 tx-sender agent-1)))
		(as-contract (stx-transfer? u1127625 tx-sender agent-1)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'SP2W58YQZEAC870M2MKE6QEKS1DPG0RMZZ2BGXSM4.tickets-90stx-mini-raffle-26 transfer u51 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
		(asserts! (is-ok (stx-transfer? u1127625 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
