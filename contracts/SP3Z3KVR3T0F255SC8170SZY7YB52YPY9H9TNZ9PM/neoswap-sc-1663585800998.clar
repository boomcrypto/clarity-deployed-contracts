...
(begin
	(unwrap-panic (as-contract (contract-call? 'SP3QBDVP816NV03PZRT3FWV99NA9G1PRTQ8E6FM9Z.randomwallpaper transfer u8 tx-sender agent-1)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u8530000 tx-sender agent-2)))
	)
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u215000 tx-sender agent-4)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP3R8APMXYQRQC6JZAE376ZDVKJAQG5KYMTPV3F9E.bitcoin-flowers transfer u124 tx-sender agent-5)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u215000 tx-sender agent-0)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u2590000 tx-sender agent-1)))
	)
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SP3QBDVP816NV03PZRT3FWV99NA9G1PRTQ8E6FM9Z.randomwallpaper transfer u8 tx-sender agent-2)))
	(var-set agent-2-status false))
	true)
	(if (is-eq (var-get agent-3-status) true)
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u6300000 tx-sender agent-3)))
	)
