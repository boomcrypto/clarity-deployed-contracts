...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u2886765 tx-sender agent-1)))
	)
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u475195 tx-sender agent-3)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP213KNHB5QD308TEESY1ZMX1BP8EZDPG4JWD0MEA.web4 transfer u10346 tx-sender agent-6)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u328040 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3690000 tx-sender agent-6)))
	)
