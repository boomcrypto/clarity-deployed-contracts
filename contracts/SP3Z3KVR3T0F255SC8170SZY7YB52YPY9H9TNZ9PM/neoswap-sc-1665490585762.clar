...
(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP1GWHGESCF29TV10Q6X0VZYWH4QJ6CM9NK6DSH9J.bitmetaverse transfer u15 tx-sender agent-4)))
		(as-contract (stx-transfer? u78887500 tx-sender agent-4)))
	)
	(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.frontier transfer u524 tx-sender agent-6)))
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.hback-whales-nft transfer u404 tx-sender agent-6)))
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u540600 tx-sender agent-8)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u3184400 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
		...
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.frontier transfer u524 tx-sender agent-4)))
	(var-set agent-4-status false))
	true)
	(if (is-eq (var-get agent-6-status) true)
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u82612500 tx-sender agent-6)))
	)
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP1GWHGESCF29TV10Q6X0VZYWH4QJ6CM9NK6DSH9J.bitmetaverse transfer u15 tx-sender agent-8)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u82612500 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
