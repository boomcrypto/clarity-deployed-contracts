...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u4771961 tx-sender agent-1)))
	)
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u40098039 tx-sender agent-3)))
	)
	(unwrap-panic (begin
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u47250000 tx-sender agent-2)))
	)
