...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u14950803 tx-sender agent-5)))
	)
	(unwrap-panic (begin
		(as-contract (stx-transfer? u8221544 tx-sender agent-6)))
	)
	(unwrap-panic (as-contract (contract-call? 'SP1MX3R99FENJJJVKW27DSA6X2M6SDSVJH4Y0HE23.pepepunks transfer u790 tx-sender agent-8)))
	...
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.steady-lads transfer u750 tx-sender agent-8)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u1188326 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.wasteland-apes-nft transfer u994 tx-sender agent-5)))
		(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.steady-lads transfer u750 tx-sender agent-5)))
	...
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u24360673 tx-sender agent-8)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u24360673 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
