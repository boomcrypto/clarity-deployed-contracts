...
(begin
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u400875 tx-sender agent-1)))
	)
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u228250 tx-sender agent-0)))
	)
...
(begin        
	...
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u629125 tx-sender agent-2)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u629125 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
