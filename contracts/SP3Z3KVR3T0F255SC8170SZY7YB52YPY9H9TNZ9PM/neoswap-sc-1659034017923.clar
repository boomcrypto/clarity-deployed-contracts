...
(define-constant agent-2 'SP17YP1HGWK7DP5Q69GRG14W34E078S4D78YM1FA5)
...
(begin
	...
	(unwrap-panic (as-contract (contract-call? 'SP497E7RX3233ATBS2AB9G4WTHB63X5PBSP5VGAQ.boom-nfts transfer u5346 tx-sender agent-1)))
	...
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy transfer u2039 tx-sender agent-5)))
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP2N3BAG4GBF8NHRPH6AY4YYH1SP6NK5TGCY7RDFA.stacks-mfers transfer u1406 tx-sender agent-2)))
		...
		(as-contract (stx-transfer? u11330000 tx-sender agent-2)))
	)
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u11330000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
