...
(define-private (release-escrow) 
    (begin
	(unwrap-panic (as-contract (contract-call? 'SP19WKA4H1ZVCWRCY82SPGJHJ3GXD02D60YQT7Y7H.web3-fortune-crystals transfer u27 tx-sender TRADER-2)))

	(unwrap-panic (as-contract (stx-transfer? u6748405 tx-sender TRADER-1)))
