...
(define-constant agent-5 'SP2QDMH88MEZ8FFAYHW4B0BTXJRTHX8XBD54FE7HJ)
...
(begin
	(unwrap-panic (begin
		...
		(as-contract (stx-transfer? u141950000 tx-sender agent-1)))
	)
	...
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.magic-ape-school transfer u1345 tx-sender agent-4)))
	...
	(unwrap-panic (as-contract (contract-call? 'SP3AJC728JY0Y43E8RT6K4VDWPT265RDMXJ8M0VH0.bitbombs-v2 transfer u37 tx-sender agent-6)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u13100000 tx-sender agent-7)))
	)
	...
	(unwrap-panic (begin
		(as-contract (stx-transfer? u18360000 tx-sender agent-0)))
	)
...
(begin        
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-cyborg transfer u18 tx-sender agent-1)))
	(var-set agent-1-status false))
	true)
	(if (is-eq (var-get agent-2-status) true)
	(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u6710000 tx-sender agent-2)))
	)
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP364J7EDJXRE1FPDZDABP9M58HPY4G88BFCP2HD0.descanso-motion-blur transfer u40 tx-sender agent-4)))
		(as-contract (stx-transfer? u167700000 tx-sender agent-4)))
	)
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'SP3BS8RXKKAAM7HA76SFDKG4Q2YSG0X8K5K44XNDV.jelly-nft transfer u198 tx-sender agent-5)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.stacks-pops transfer u278 tx-sender agent-7)))
		(unwrap-panic (as-contract (contract-call? 'SP3AJC728JY0Y43E8RT6K4VDWPT265RDMXJ8M0VH0.bitbombs-v2 transfer u37 tx-sender agent-7)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.magic-ape-school transfer u1345 tx-sender agent-9)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (stx-transfer? u6710000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
		...
		(asserts! (is-ok (stx-transfer? u167700000 tx-sender (as-contract tx-sender))) cannot-escrow-stx )
