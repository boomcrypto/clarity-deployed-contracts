...
(begin
	(unwrap-panic (begin
		(as-contract (stx-transfer? u12090000 tx-sender agent-1)))
	)
	...
	(unwrap-panic (as-contract (contract-call? 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.rehab-resort transfer u139 tx-sender agent-3)))
	(unwrap-panic (begin
		(as-contract (stx-transfer? u300000 tx-sender agent-4)))
	)
	(unwrap-panic (begin
