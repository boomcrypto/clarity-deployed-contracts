...
(try! (contract-call? .self-listing-helper-v2-03 approve-token-x .token-wsbtc true u100000))
(try! (contract-call? .self-listing-helper-v2-03 approve-token-x 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.token-abtc true u100000))
