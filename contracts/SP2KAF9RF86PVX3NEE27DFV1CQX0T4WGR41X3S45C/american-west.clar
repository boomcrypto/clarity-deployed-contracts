...
(define-non-fungible-token american-west uint)
...
(define-data-var artist-address (list 1000 principal) (list 'SP1GR33848GSTMFR955Z77DAB835XYE9FZG19Y7NX )) 

(define-data-var private-sale-active bool false)
(define-data-var sale-active bool false)
(define-data-var private-target-block-height uint u63468)
(define-data-var public-target-block-height uint u63468)
(define-data-var admin principal tx-sender)

(define-data-var stx-cost-per-mint uint u500000000)
;; Get mint limit
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? american-west id sender recipient)
        success
          (let
...
(define-read-only (get-owner (id uint))
  ;; Make sure to replace american-west
  (ok (nft-get-owner? american-west id)))
...
(define-private (mint (new-owner principal))
    (let (
      ...
      (match (nft-mint? american-west next-id new-owner)
        success
        (let
...
(define-public (burn (id uint) (owner principal))
    ...
    (match (nft-burn? american-west id owner)
        success
        (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? american-west id) false)))
...
(define-public (buy-in-ustx (id uint) (comm <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? american-west id) ERR-NOT-FOUND))
...
(define-public (pay (id uint) (price uint))
    (if (> (var-get secondary-commission) u0)
        (begin  
                ...
                ;; total of 5% = u500
                  (try! (stx-transfer? (/ (* price u800) u10000) tx-sender 'SP1GR33848GSTMFR955Z77DAB835XYE9FZG19Y7NX))
...
(begin
  (try! (set-private-wl 'SPCRDMAJ0RJYPQ3BMNN9VV01BFSCG1SQ1WJZB558 u1))
  (try! (set-private-wl 'SP2Q0WBARZ46DJG2HWSYQFYNGQ9GMHZJVXJ2W8HN8 u1))
  (try! (set-private-wl 'SPJT8G4DA24ZDF35WMY5FZEQ9YJNK38DBN2D48QH u1))
  (try! (set-private-wl 'SP1CE3NQXDKCJ2KEFFGCVFA5C196S9F0RRX93HY87 u1))
  (try! (set-private-wl 'SP197GMEG6WGBRDTCTGGWMRA1G77E65TRXWYKGCT7 u1))
  (try! (set-private-wl 'SP2F2KH0RVX6GF1Y9FWMMSR9RHG0TW3NN72D724NX u1))
  (try! (set-private-wl 'SP3GNAE8V8KZ24T31JC10TT184F6NQ4YDYHGVFZ10 u1))
  (try! (set-private-wl 'SP2F18PH7FP22EHS0J0X3A6EFZ9PAW0EZJRET0GXZ u1))
  (try! (set-private-wl 'SP3EZ3H7H49CEE49X8HE9W6QX0Y29W8R5T1MMY7AJ u1))
  (try! (set-private-wl 'SP1XPG9QFX5M95G36SGN9R8YJ4KJ0JB7ZXNH892N6 u1))
  (try! (set-private-wl 'SP1WGFPEVNTK7N41JKAMEKEY9HK14MJP99BZ016N9 u1))
  (try! (set-private-wl 'SP364J7EDJXRE1FPDZDABP9M58HPY4G88BFCP2HD0 u1))
  (try! (set-private-wl 'SP3DXVC12KG5PV0545PJF15VQVN6CZ641QH82GYYQ u1))
  (try! (set-private-wl 'SP2E03GHWY145XMFDTHX4Z913EADP4RMZ0P0DCTE9 u1))
  (ok true)
)