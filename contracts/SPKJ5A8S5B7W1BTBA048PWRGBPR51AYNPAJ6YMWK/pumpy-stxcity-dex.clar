...
(define-constant token-supply u100000000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPKJ5A8S5B7W1BTBA048PWRGBPR51AYNPAJ6YMWK.pumpy-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u63314358001265016)
    (var-set stx-balance u57942058)
