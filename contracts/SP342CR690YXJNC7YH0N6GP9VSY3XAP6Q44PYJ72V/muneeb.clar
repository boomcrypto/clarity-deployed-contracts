...
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://memefun.s3.ap-northeast-1.amazonaws.com/metadata/e0v76agqrmh61yloztjr6rgn5y1ho6x3.json?"))
(define-data-var is-minted bool false)


(define-fungible-token muneeb token-max-supply)
...
(define-public (mint (amount uint) (recipient principal)) 
    (begin 
        ...
        (try! (ft-mint? muneeb amount recipient))
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34)))) 
    (begin
        ...
        (try! (ft-transfer? muneeb amount sender recipient))
...
(define-public (burn (amount uint))
    (ft-burn? muneeb amount tx-sender))
