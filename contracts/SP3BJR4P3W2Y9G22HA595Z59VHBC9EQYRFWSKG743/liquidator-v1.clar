    ...
    (let (
      ...
      (if (> total-collateral-value u0) 
        ...
        (let (
            ...
            (burned-staking-lp-tokens (try! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.state-v1 socialize-user-bad-debt user remaining-debt lp-part staked-part protocol-part updated-total-borrowed-amount .staking-v1 staked-lp-tokens)))
          )
          (print {
            user: user,
