...
(define-non-fungible-token cartoons uint)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmYrb8qZSGSpeeTxrGCqhibGDW9UuXNnq4hy4Y69DA8b9L/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? cartoons next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? cartoons token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? cartoons token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? cartoons token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? cartoons id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? cartoons id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? cartoons id) (err ERR-NOT-FOUND)))
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? cartoons (+ last-nft-id u0) 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN))
      (map-set token-count 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN (+ (get-balance 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN) u1))
      (try! (nft-mint? cartoons (+ last-nft-id u1) 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN))
      (map-set token-count 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN (+ (get-balance 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN) u1))
      (try! (nft-mint? cartoons (+ last-nft-id u2) 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN))
      (map-set token-count 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN (+ (get-balance 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN) u1))
      (try! (nft-mint? cartoons (+ last-nft-id u3) 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN))
      (map-set token-count 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN (+ (get-balance 'SP12SS6DZHF4MWBNRJCF5FVWQHHQ1F4D8C773VVMN) u1))
