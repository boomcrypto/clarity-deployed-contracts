...
(define-constant allow-token 'SP1S7RXE1MHGV5PCP18F6GK4V04C7NKA347DAWXK0.sdog-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u98523622047244096)
    (var-set stx-balance u29970030)
