...
(define-constant allow-token 'SPVJX4WFSZ2ZFZS15597YW8BKH8CA5G4E3DVP9FJ.sendme-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u2839619592782398)
    (var-set stx-balance u334765235)
