    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Build Bridge from ERC20 to STX")
    (var-set description u"Just Like other cross chain protocol")
    (var-set voting-system "block")
    (var-set options (list "e3925409-05b2-45b4-8f35-9501ed824b46" "be5e7ffe-9ca1-4c19-95cf-5387b5343b90"))
    (var-set start u80171)
    (var-set end u80453)
    (map-set results {id: "e3925409-05b2-45b4-8f35-9501ed824b46"} {count: u0, name: u"Yes"}) (map-set results {id: "be5e7ffe-9ca1-4c19-95cf-5387b5343b90"} {count: u0, name: u"No"})