...
(define-non-fungible-token ordinal-dogs uint)
...
(define-data-var total-price uint u55000000)
(define-data-var artist-address principal 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmYE1p1eumRNwwdZdWGEbnA3VazrahazM4RDYErHcRsQZb/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? ordinal-dogs next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? ordinal-dogs token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? ordinal-dogs token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? ordinal-dogs token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? ordinal-dogs id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? ordinal-dogs id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? ordinal-dogs id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u73757)
...
;; Alt Minting Default
(define-data-var total-price-usda uint u19000000)
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u43799000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u44969000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u532000000)
...
;; Alt Minting Default
(define-data-var total-price-slime uint u7605000000)
...
;; Alt Minting Default
(define-data-var total-price-alex uint u129400000000)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u0) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u1) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u2) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u3) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u4) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u5) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u6) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u7) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u8) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u9) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u10) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u11) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u12) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u13) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
      (try! (nft-mint? ordinal-dogs (+ last-nft-id u14) 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ))
      (map-set token-count 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ (+ (get-balance 'SP1SNK3RM7DKFE0Y8TQST4WKRJ4CZJZG5C2XN95AQ) u1))
