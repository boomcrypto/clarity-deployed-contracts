...
(define-non-fungible-token ordinalogres uint)
...
;; Internal variables
(define-data-var mint-limit uint u963)
(define-data-var last-id uint u1)
(define-data-var total-price uint u5000000)
(define-data-var artist-address principal 'SP37PZMNKJ7S67ND0BZKN3WKBXGFQVNVW1WD5EJM2)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmRMthEH3hCKNtMArF72wZs5PrBNFSG6Hkc3rgAFAyvgss/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? ordinalogres next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? ordinalogres token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? ordinalogres token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? ordinalogres token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? ordinalogres id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? ordinalogres id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? ordinalogres id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u14308)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? ordinalogres (+ last-nft-id u0) 'SP15BRQ6EZ8XXR29PS5GKCGK4PTMPS9SNYF4G525F))
      (map-set token-count 'SP15BRQ6EZ8XXR29PS5GKCGK4PTMPS9SNYF4G525F (+ (get-balance 'SP15BRQ6EZ8XXR29PS5GKCGK4PTMPS9SNYF4G525F) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u1) 'SP3JW93DTYCY61T8REESXCTASQNGPPWYZQ031R7RX))
      (map-set token-count 'SP3JW93DTYCY61T8REESXCTASQNGPPWYZQ031R7RX (+ (get-balance 'SP3JW93DTYCY61T8REESXCTASQNGPPWYZQ031R7RX) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u2) 'SP2PFHAERWSJSGFD59W1PJQQGZQ5RC8C0HQS7DWKT))
      (map-set token-count 'SP2PFHAERWSJSGFD59W1PJQQGZQ5RC8C0HQS7DWKT (+ (get-balance 'SP2PFHAERWSJSGFD59W1PJQQGZQ5RC8C0HQS7DWKT) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u3) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u4) 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436))
      (map-set token-count 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436 (+ (get-balance 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u5) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u6) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u7) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u8) 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436))
      (map-set token-count 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436 (+ (get-balance 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u9) 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436))
      (map-set token-count 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436 (+ (get-balance 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u10) 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436))
      (map-set token-count 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436 (+ (get-balance 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u11) 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436))
      (map-set token-count 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436 (+ (get-balance 'SPE25P42PKRQVR9BCFX60T0XZGJXSZDJGTE98436) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u12) 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6))
      (map-set token-count 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6 (+ (get-balance 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u13) 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6))
      (map-set token-count 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6 (+ (get-balance 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u14) 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6))
      (map-set token-count 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6 (+ (get-balance 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u15) 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6))
      (map-set token-count 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6 (+ (get-balance 'SP2GY0B86SJHQA985Z0HQ3D4H305W4BF3F5329BZ6) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u16) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u17) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u18) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
      (try! (nft-mint? ordinalogres (+ last-nft-id u19) 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR))
      (map-set token-count 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR (+ (get-balance 'SP3MCCJN36WCGTV0Y38Y3EB42DWR3Z8C3ZB4TNAGR) u1))
