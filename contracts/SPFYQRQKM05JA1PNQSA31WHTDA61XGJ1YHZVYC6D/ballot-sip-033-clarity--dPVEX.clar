    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4216936))
                (let
                    (
    ...
    (var-set options (list "98a95eb6-90ec-4fbb-bd5e-310128c9a552" "81db5d34-2d10-40ed-86d2-76ec19471d4d"))
    (var-set start u919335)
    (var-set end u921445)
    (map-set results {id: "98a95eb6-90ec-4fbb-bd5e-310128c9a552"} {count: u0, name: u"Yes%20-%20In%20Favor%20of%20SIP-033", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "81db5d34-2d10-40ed-86d2-76ec19471d4d"} {count: u0, name: u"No%20-%20Not%20in%20Favor%20of%20SIP-033", locked-stx: u0, unlocked-stx: u0})