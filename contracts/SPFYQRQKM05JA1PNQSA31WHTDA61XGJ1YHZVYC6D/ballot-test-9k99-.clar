    ...
    (define-map users {id: principal} {id: uint, vote: (list 3 (string-ascii 36)), volume: (list 3 uint), voting-power: uint, locked-stx: uint, unlocked-stx: uint})
    (define-map register {id: uint} {user: principal, vote: (list 3 (string-ascii 36)), volume: (list 3 uint), voting-power: uint, locked-stx: uint, unlocked-stx: uint})
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4212320))
                (let
                    (
    ...
    (var-set options (list "389cbdef-2a48-45bd-9da1-2a4d68cdf0be" "23efc4d4-2c82-4f4c-8290-285c96f564b5" "bf3ad88d-6c06-4073-9e93-acd76a10eb29"))
    (var-set start u919297)
    (var-set end u919299)
    (map-set results {id: "389cbdef-2a48-45bd-9da1-2a4d68cdf0be"} {count: u0, name: u"Choice%201", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "23efc4d4-2c82-4f4c-8290-285c96f564b5"} {count: u0, name: u"Choice%202", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "bf3ad88d-6c06-4073-9e93-acd76a10eb29"} {count: u0, name: u"Choice%203", locked-stx: u0, unlocked-stx: u0})