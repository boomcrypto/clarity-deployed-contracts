    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4211953))
                (let
                    (
    ...
    (var-set description u"%3Cp%3E%3Cstrong%3E%3Cem%3ESIP-033%20-%20Clarity%204%3A%20High%20Demand%20New%20Builtins%3C%2Fem%3E%3C%2Fstrong%3E%26nbsp%3Bintroduces%20upgrades%20that%20make%20smart%20contracts%20faster%2C%20more%20efficient%2C%20and%20easier%20to%20build.%20The%20changes%20improve%20performance%2C%20expand%20language%20flexibility%2C%20and%20enable%20more%20efficient%20liquidity%20across%20the%20Stacks%20network%20while%20maintaining%20full%20backward%20compatibility.%3C%2Fp%3E%3Cp%3E%3Cbr%3E%3C%2Fp%3E%3Cp%3EKey%20Impro")
    (var-set voting-system "fptp")
    (var-set options (list "134e88a2-77ff-47fe-9ccf-e3725403cd43" "3efdde6e-3f42-49be-8466-da4ef95c2ac6" "47e738de-34ad-4e6c-92fb-f7de4b9c60e3" "9e38a967-227b-444b-afe0-ff9b28461df1"))
    (var-set start u919370)
    (var-set end u921453)
    (map-set results {id: "134e88a2-77ff-47fe-9ccf-e3725403cd43"} {count: u0, name: u"Yes%20-%20In%20Favor%20of%20SIP-033", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "3efdde6e-3f42-49be-8466-da4ef95c2ac6"} {count: u0, name: u"No%20-%20Not%20in%20Favor%20of%20SIP-033", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "47e738de-34ad-4e6c-92fb-f7de4b9c60e3"} {count: u0, name: u"Yes%20(STX%20Dust%20Transaction)", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "9e38a967-227b-444b-afe0-ff9b28461df1"} {count: u0, name: u"No%20(STX%20Dust%20Transaction)", locked-stx: u0, unlocked-stx: u0})