    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4208616))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Ballot%20Test")
    (var-set description u"")
    (var-set voting-system "fptp")
    (var-set options (list "1216c993-8cb4-43af-a133-b62b2b57217a" "6f16c9fc-45a2-480c-ba5b-920ff036dbb4" "7b8412e8-7b16-4ae6-a765-6554d5d09507" "016bfd49-ca66-4c10-be1f-b93a96be347d"))
    (var-set start u919265)
    (var-set end u919276)
    (map-set results {id: "1216c993-8cb4-43af-a133-b62b2b57217a"} {count: u0, name: u"YES", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "6f16c9fc-45a2-480c-ba5b-920ff036dbb4"} {count: u0, name: u"NO", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "7b8412e8-7b16-4ae6-a765-6554d5d09507"} {count: u0, name: u"YES%20(STX%20Dust%20Vote)", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "016bfd49-ca66-4c10-be1f-b93a96be347d"} {count: u0, name: u"NO%20(STX%20Dust%20Vote)", locked-stx: u0, unlocked-stx: u0})