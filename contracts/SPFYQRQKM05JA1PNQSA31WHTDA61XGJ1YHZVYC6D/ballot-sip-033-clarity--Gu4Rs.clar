    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4210813))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"SIP-033%20(Clarity%204)%20Community%20Vote")
    (var-set description u"%3Cp%3E%3Cstrong%3E%3Cem%3ESIP-033%20-%20Clarity%204%3A%20High%20Demand%20New%20Builtins%3C%2Fem%3E%3C%2Fstrong%3E%20introduces%20upgrades%20that%20make%20smart%20contracts%20faster%2C%20more%20efficient%2C%20and%20easier%20to%20build.%20The%20changes%20improve%20performance%2C%20expand%20language%20flexibility%2C%20and%20enable%20more%20efficient%20liquidity%20across%20the%20Stacks%20network%20while%20maintaining%20full%20backward%20compatibility.%3C%2Fp%3E%3Cp%3E%3Cbr%3E%3C%2Fp%3E%3Cp%3EKey%20Improvements")
    (var-set voting-system "fptp")
    (var-set options (list "ba76a93a-25d4-464c-9afb-f9220f56c22a" "c8129299-c6fc-4a34-9b0a-8e2480f3eba7" "f681012e-26e0-4f9d-9732-3b8e419712ba" "eda252b4-b304-48a1-b10e-373c227eaa72"))
    (var-set start u919361)
    (var-set end u921443)
    (map-set results {id: "ba76a93a-25d4-464c-9afb-f9220f56c22a"} {count: u0, name: u"Yes%20-%20In%20Favor%20of%20SIP-033", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "c8129299-c6fc-4a34-9b0a-8e2480f3eba7"} {count: u0, name: u"No%20-%20Not%20in%20Favor%20of%20SIP-033", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "f681012e-26e0-4f9d-9732-3b8e419712ba"} {count: u0, name: u"Yes%20(STX%20Dust%20Transaction)", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "eda252b4-b304-48a1-b10e-373c227eaa72"} {count: u0, name: u"No%20(STX%20Dust%20Transaction)", locked-stx: u0, unlocked-stx: u0})