    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4204897))
                (let
                    (
    ...
    (var-set options (list "9d8b72f6-c397-440a-b456-9fff9ea47c66" "5c438c51-8593-493b-9edc-7c54d08b84ae"))
    (var-set start u919241)
    (var-set end u919243)
    (map-set results {id: "9d8b72f6-c397-440a-b456-9fff9ea47c66"} {count: u0, name: u"Choice%201", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "5c438c51-8593-493b-9edc-7c54d08b84ae"} {count: u0, name: u"Choice%202", locked-stx: u0, unlocked-stx: u0})