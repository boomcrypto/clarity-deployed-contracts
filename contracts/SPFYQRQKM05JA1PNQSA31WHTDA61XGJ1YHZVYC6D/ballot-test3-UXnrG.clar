    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4210684))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"test3")
    (var-set description u"")
    (var-set voting-system "fptp")
    (var-set options (list "89849c50-dd95-4e19-bdfb-87867df0775a" "dc4ca308-a385-4dd5-b17f-4008addd6ae1" "0244773b-7bc3-42cb-ab3b-33af82d1b363" "7c7b9c4a-8117-4167-8ebd-4c7341b17298"))
    (var-set start u919282)
    (var-set end u919284)
    (map-set results {id: "89849c50-dd95-4e19-bdfb-87867df0775a"} {count: u0, name: u"yes", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "dc4ca308-a385-4dd5-b17f-4008addd6ae1"} {count: u0, name: u"no", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "0244773b-7bc3-42cb-ab3b-33af82d1b363"} {count: u0, name: u"yes%20-%20dust", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "7c7b9c4a-8117-4167-8ebd-4c7341b17298"} {count: u0, name: u"no%20-%20dust", locked-stx: u0, unlocked-stx: u0})