...
(define-private (dispatch (i (buff 2)) (amt-in uint))
  ...
  (if (< i 0x0df2) 
  (contract-call? .fuck-kim-jong-un-50 dispatch i amt-in)
  (if (< i 0x0e38) 
  (contract-call? .fuck-kim-jong-un-51 dispatch i amt-in)
  (if (< i 0x0e7e) 
  (contract-call? .fuck-kim-jong-un-52 dispatch i amt-in)
  (if (< i 0x0ec4) 
  (contract-call? .fuck-kim-jong-un-53 dispatch i amt-in)
  (contract-call? .fuck-kim-jong-un-54 dispatch i amt-in)))))))))))))))))
)