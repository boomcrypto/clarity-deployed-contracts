...
(define-private (dispatch (ii (buff 2)) (amt-in uint))
  (if (< ii 0x0802) 
  (contract-call? .fuck-kim-jong-un-40 dispatch ii amt-in)
  (if (< ii 0x0834) 
  (contract-call? .fuck-kim-jong-un-41 dispatch ii amt-in)
  (if (< ii 0x0866) 
  (contract-call? .fuck-kim-jong-un-42 dispatch ii amt-in)
  (if (< ii 0x0898) 
  (contract-call? .fuck-kim-jong-un-43 dispatch ii amt-in)
  (if (< ii 0x08ca) 
  (contract-call? .fuck-kim-jong-un-44 dispatch ii amt-in)
  (if (< ii 0x08fc) 
  (contract-call? .fuck-kim-jong-un-45 dispatch ii amt-in)
  (if (< ii 0x092e) 
  (contract-call? .fuck-kim-jong-un-46 dispatch ii amt-in)
  (if (< ii 0x0960) 
  (contract-call? .fuck-kim-jong-un-47 dispatch ii amt-in)
  (if (< ii 0x0992) 
  (contract-call? .fuck-kim-jong-un-48 dispatch ii amt-in)
  (contract-call? .fuck-kim-jong-un-49 dispatch ii amt-in))))))))))
)