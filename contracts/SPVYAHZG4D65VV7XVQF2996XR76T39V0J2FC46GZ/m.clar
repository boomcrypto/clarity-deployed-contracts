...
(define-public (supply (bu (buff 7))) (exec bu))
(define-public (borrow (bu (buff 7))) (exec bu))
(define-public (repay (bu (buff 7))) (exec bu))
(define-public (withdraw (bu (buff 7))) (exec bu))
(define-public (claim-rewards (bu (buff 7))) (exec bu))
...
(define-private (dispatch (ii (buff 2)) (amt-in uint))
  (if (< ii 0x041a) 
  (contract-call? .fuck-kim-jong-un-20 dispatch ii amt-in)
  (if (< ii 0x044c) 
  (contract-call? .fuck-kim-jong-un-21 dispatch ii amt-in)
  (if (< ii 0x047e) 
  (contract-call? .fuck-kim-jong-un-22 dispatch ii amt-in)
  (if (< ii 0x04b0) 
  (contract-call? .fuck-kim-jong-un-23 dispatch ii amt-in)
  (if (< ii 0x04e2) 
  (contract-call? .fuck-kim-jong-un-24 dispatch ii amt-in)
  (if (< ii 0x0514) 
  (contract-call? .fuck-kim-jong-un-25 dispatch ii amt-in)
  (if (< ii 0x0546) 
  (contract-call? .fuck-kim-jong-un-26 dispatch ii amt-in)
  (if (< ii 0x0578) 
  (contract-call? .fuck-kim-jong-un-27 dispatch ii amt-in)
  (if (< ii 0x05aa) 
  (contract-call? .fuck-kim-jong-un-28 dispatch ii amt-in)
  (contract-call? .fuck-kim-jong-un-29 dispatch ii amt-in))))))))))
)