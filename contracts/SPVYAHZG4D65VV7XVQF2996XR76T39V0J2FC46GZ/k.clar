...
(define-private (dispatch (ii (buff 2)) (amt-in uint))
  (if (< ii 0x0032) 
  (contract-call? .fuck-kim-jong-un-0 dispatch ii amt-in)
  (if (< ii 0x0064) 
  (contract-call? .fuck-kim-jong-un-1 dispatch ii amt-in)
  (if (< ii 0x0096) 
  (contract-call? .fuck-kim-jong-un-2 dispatch ii amt-in)
  (if (< ii 0x00c8) 
  (contract-call? .fuck-kim-jong-un-3 dispatch ii amt-in)
  (if (< ii 0x00fa) 
  (contract-call? .fuck-kim-jong-un-4 dispatch ii amt-in)
  (if (< ii 0x012c) 
  (contract-call? .fuck-kim-jong-un-5 dispatch ii amt-in)
  (if (< ii 0x015e) 
  (contract-call? .fuck-kim-jong-un-6 dispatch ii amt-in)
  (if (< ii 0x0190) 
  (contract-call? .fuck-kim-jong-un-7 dispatch ii amt-in)
  (if (< ii 0x01c2) 
  (contract-call? .fuck-kim-jong-un-8 dispatch ii amt-in)
  (contract-call? .fuck-kim-jong-un-9 dispatch ii amt-in))))))))))
)