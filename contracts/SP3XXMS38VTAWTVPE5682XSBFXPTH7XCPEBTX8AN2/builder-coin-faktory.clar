...
;; 26983947cabefa6efbc49e0b9e662a2aceae3cfb61b4fdc58e75c9d1c325a2d6
...
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://szigdtxfspmofhxoytra.supabase.co/storage/v1/object/public/uri/1s8hob9p-metadata.json"))
...
(begin 
    ...
    (try! (ft-mint? BILD u20990670808310 'SP3XXMS38VTAWTVPE5682XSBFXPTH7XCPEBTX8AN2.builder-coin-faktory-dex)) ;; supply-left
    (try! (ft-mint? BILD u9329191690 tx-sender)) ;; ft-amount-bought


    
      ;; STX distribution (first buy premium fee)
      (try! (stx-transfer-to 'SP3XXMS38VTAWTVPE5682XSBFXPTH7XCPEBTX8AN2.builder-coin-faktory-dex u666667)) ;; stx-in-dex
    ...
    (print { 
        ...
        name: "Builder Coin",
        symbol: "BILD",
        token-uri: u"https://szigdtxfspmofhxoytra.supabase.co/storage/v1/object/public/uri/1s8hob9p-metadata.json", 
        tokenContract: (as-contract tx-sender),
        supply: MAX, 
        decimals: u6, 
        targetStx: u6000000000,
        tokenToDex: u20990670808310,
        tokenToDeployer: u9329191690,
        stxToDex: u666667,
