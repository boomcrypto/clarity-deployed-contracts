...
(define-public (is-dao-or-extension)
  (ok (asserts!
    (or
      (is-eq tx-sender 'SP248NZ0P20BH3M3ZTM9DS69EMC9G6H3MQC6KM3E.inc-aqua-crawdad)
      (contract-call? 'SP248NZ0P20BH3M3ZTM9DS69EMC9G6H3MQC6KM3E.inc-aqua-crawdad is-extension contract-caller))
    ERR_UNAUTHORIZED
  ))
)
...
(define-public (direct-execute (proposal <proposal-trait>))
  (let
    ...
    (and (>= signals (var-get signalsRequired))
      (try! (contract-call? 'SP248NZ0P20BH3M3ZTM9DS69EMC9G6H3MQC6KM3E.inc-aqua-crawdad execute proposal tx-sender))
    )
