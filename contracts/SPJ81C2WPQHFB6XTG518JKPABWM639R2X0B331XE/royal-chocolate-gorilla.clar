...
(define-public (is-dao-or-extension)
  (ok (asserts!
    (or
      (is-eq tx-sender 'SPJ81C2WPQHFB6XTG518JKPABWM639R2X0B331XE.free-tan-beaver)
      (contract-call? 'SPJ81C2WPQHFB6XTG518JKPABWM639R2X0B331XE.free-tan-beaver is-extension contract-caller))
    ERR_UNAUTHORIZED
  ))
)
...
(define-public (direct-execute (proposal <proposal-trait>))
  (let
    ...
    (and (>= signals (var-get signalsRequired))
      (try! (contract-call? 'SPJ81C2WPQHFB6XTG518JKPABWM639R2X0B331XE.free-tan-beaver execute proposal tx-sender))
    )
