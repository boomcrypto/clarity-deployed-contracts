...
;; 102ffe4b08c52b8892123452376776bdbca1b5df4f423c1b2128ce8de8d1c53a
...
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://szigdtxfspmofhxoytra.supabase.co/storage/v1/object/public/uri/xsjb1lro-metadata.json"))
...
(begin 
    ...
    (try! (ft-mint? GEEK u19687499975391 'SP3S2565C4DP2MGR3CMANMGYDCDA314Q258CG2R7C.geek-faktory-dex)) ;; supply-left
    (try! (ft-mint? GEEK u1312500024609 tx-sender)) ;; ft-amount-bought


    
      ;; STX distribution (first buy premium fee)
      (try! (stx-transfer-to 'SP3S2565C4DP2MGR3CMANMGYDCDA314Q258CG2R7C.geek-faktory-dex u33333334)) ;; stx-in-dex
    ...
    (print { 
        ...
        name: "geek",
        symbol: "GEEK",
        token-uri: u"https://szigdtxfspmofhxoytra.supabase.co/storage/v1/object/public/uri/xsjb1lro-metadata.json", 
        tokenContract: (as-contract tx-sender),
        supply: MAX, 
        decimals: u6, 
        targetStx: u2000000000,
        tokenToDex: u19687499975391,
        tokenToDeployer: u1312500024609,
        stxToDex: u33333334,
