    ...
    (let (
      ...
      (if (> total-collateral-value u0) 
        ...
        (let (
            ...
            (updated-total-borrowed-amount (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.math-v1 safe-sub total-borrowed-amount principal-part))
            (staked-lp-tokens (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.staking-v1 get-total-staked-lp-tokens))
            (burned-staking-lp-tokens (try! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.state-v1 socialize-user-bad-debt user remaining-debt lp-part staked-part protocol-part updated-total-borrowed-amount 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.staking-v1 staked-lp-tokens)))
          )
          (print {
            user: user,
          ...
          (asserts! (<= burned-staking-lp-tokens u0) (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.staking-v1 slash-total-staked-lp-tokens burned-staking-lp-tokens))
          SUCCESS
      ))
    )
))
