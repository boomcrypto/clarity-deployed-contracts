    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"My new poll")
    (var-set description u"Poll description")
    (var-set voting-system "fptp")
    (var-set options (list "9ea0585f-2b17-4522-b667-e23e6f16ae3f" "85a176aa-845c-4182-bd27-95b8012e5af4"))
    (var-set start u76018)
    (var-set end u78034)
    (map-set results {id: "9ea0585f-2b17-4522-b667-e23e6f16ae3f"} {count: u0, name: u"Choice 1"}) (map-set results {id: "85a176aa-845c-4182-bd27-95b8012e5af4"} {count: u0, name: u"Choice 2"})