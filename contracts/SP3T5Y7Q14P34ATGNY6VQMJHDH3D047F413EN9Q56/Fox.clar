(impl-trait 'SP20X3DC5R091J8B6YPQT638J8NR1W83KN6TN5BJY.ft-trait.ft-trait)
  ...
  (define-fungible-token Fox MAX_SUPPLY)
  ...
  (define-read-only (get-name)                   (ok "Fox"))
  (define-read-only (get-symbol)                 (ok "FOX"))
  (define-read-only (get-decimals)               (ok u8))
  (define-read-only (get-balance (of principal)) (ok (ft-get-balance Fox of)))
  (define-read-only (get-total-supply)           (ok (ft-get-supply Fox)))
