(impl-trait 'SP20X3DC5R091J8B6YPQT638J8NR1W83KN6TN5BJY.ft-trait.ft-trait)
  ...
  (define-fungible-token EDON MAX_SUPPLY)
  ...
  (define-read-only (get-name)                   (ok "EDON"))
  (define-read-only (get-symbol)                 (ok "EDON"))
  (define-read-only (get-decimals)               (ok u6))
  (define-read-only (get-balance (of principal)) (ok (ft-get-balance EDON of)))
  (define-read-only (get-total-supply)           (ok (ft-get-supply EDON)))
