...
(define-non-fungible-token mr-steal-your-bags uint)
...
(define-data-var base-uri (string-ascii 100) "ipfs://QmUBqowsoZd1hJf6guA76wiw1U6FKDaejiPPWVX4ygGybc/mr-steal-your-bags/")
...
(define-data-var public-target-block-height uint u89942)
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? mr-steal-your-bags id sender recipient)
        success
          (let
...
(define-read-only (get-owner (id uint))
  ;; Make sure to replace mr-steal-your-bags
  (ok (nft-get-owner? mr-steal-your-bags id)))
...
(define-private (mint (new-owner principal))
    (let (
      ...
      (match (nft-mint? mr-steal-your-bags next-id new-owner)
        success
        (let
...
(define-public (burn (id uint) (owner principal))
    ...
    (match (nft-burn? mr-steal-your-bags id owner)
        success
        (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? mr-steal-your-bags id) false)))
...
(define-public (buy-in-ustx (id uint) (comm <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? mr-steal-your-bags id) ERR-NOT-FOUND))
