...
(define-public (is-dao-or-extension)
  (ok (asserts!
    (or
      (is-eq tx-sender 'SPYF9PC72BSWS0DGA33FR24GCG81MG1Z96463H68.pretty-tan-aphid)
      (contract-call? 'SPYF9PC72BSWS0DGA33FR24GCG81MG1Z96463H68.pretty-tan-aphid is-extension contract-caller))
    ERR_UNAUTHORIZED
  ))
)
...
(define-public (direct-execute (proposal <proposal-trait>))
  (let
    ...
    (and (>= signals (var-get signalsRequired))
      (try! (contract-call? 'SPYF9PC72BSWS0DGA33FR24GCG81MG1Z96463H68.pretty-tan-aphid execute proposal tx-sender))
    )
