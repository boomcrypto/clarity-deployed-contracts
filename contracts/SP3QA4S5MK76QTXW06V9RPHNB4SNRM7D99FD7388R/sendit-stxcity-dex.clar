...
(define-constant allow-token 'SP3QA4S5MK76QTXW06V9RPHNB4SNRM7D99FD7388R.sendit-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u26664002929843568)
    (var-set stx-balance u233366633)
