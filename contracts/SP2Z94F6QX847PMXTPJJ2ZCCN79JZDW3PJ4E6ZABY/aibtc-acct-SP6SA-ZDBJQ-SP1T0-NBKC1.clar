...
(define-constant ACCOUNT_OWNER 'SP6SA6BTPNN5WDAWQ7GWJF1T5E2KWY01K9SZDBJQ) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP1T0X6ARFGERYBSJNHR2RQEZN1NJMWS11BXNBKC1) ;; agent (can only take approved actions)
