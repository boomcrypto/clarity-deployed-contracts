...
(define-constant ACCOUNT_OWNER 'SP2P34PMZGP1CPA4KJ1TJHVVD4DA57QG279Q81GQ2) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP3CTHTFVF4MCR9822TASMZDT2B24FG7W34WMV5R9) ;; agent (can only take approved actions)
