...
(define-constant ACCOUNT_OWNER 'SPQKQFZDEGX6HG9ZKTVNTTJ40ZC2Y0TFQWN76KQS) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP38G7P0MVP5XK68KJBNYKHW46EA1D0DBADW6F55K) ;; agent (can only take approved actions)
