...
(define-constant ACCOUNT_OWNER 'SP3THN394AGQ6NA5JSMAF3NSJ2G74A12RN8JXCVA5) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP353HRCV0SD5S671105VN1013G825RCVR7GQ036F) ;; agent (can only take approved actions)
