...
(define-constant ACCOUNT_OWNER 'SP9C39XV8GD9XBQ41JDYG37ZP7PFPHYHQ89HHRAA) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SPV72QQVZ424R5RKYV5E93F13Z4XBCYJ6THBWN0Y) ;; agent (can only take approved actions)
