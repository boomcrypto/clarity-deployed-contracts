...
(define-constant ACCOUNT_OWNER 'SP7R99ZG2E6W1MS0D22E1Y4B8JPMX1TA0JMGZTFP) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP1ZHJP9GPVEA1N7HCKB5QN4HRWAVN6SBP851TD8S) ;; agent (can only take approved actions)
