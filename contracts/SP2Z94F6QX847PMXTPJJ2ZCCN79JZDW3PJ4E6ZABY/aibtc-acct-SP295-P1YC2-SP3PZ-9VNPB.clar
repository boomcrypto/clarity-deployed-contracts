...
(define-constant ACCOUNT_OWNER 'SP295MNE41DC74QYCPRS8N37YYMC06N6Q3T5P1YC2) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP3PZ83J4A58DA5QAZWSVBB0J2CX0HWJ0BQ39VNPB) ;; agent (can only take approved actions)
