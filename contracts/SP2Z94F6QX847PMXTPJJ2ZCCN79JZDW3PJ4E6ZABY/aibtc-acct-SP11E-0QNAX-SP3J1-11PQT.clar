...
(define-constant ACCOUNT_OWNER 'SP11E3PE71YK9WHZW7MBYFHV4VFKQ1A186860QNAX) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP3J1EZZ1QW9W4GW4PH2T7Z24Q3ETA1P2KC511PQT) ;; agent (can only take approved actions)
