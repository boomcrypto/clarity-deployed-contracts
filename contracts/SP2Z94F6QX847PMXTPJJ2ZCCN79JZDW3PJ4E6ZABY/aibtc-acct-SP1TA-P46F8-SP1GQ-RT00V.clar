...
(define-constant ACCOUNT_OWNER 'SP1TA5M9PCE2C2YJMF0KW02X6RB22B829375P46F8) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP1GQPPYK4AENYH1Q33SM8YY71B3BHEPAB34RT00V) ;; agent (can only take approved actions)
