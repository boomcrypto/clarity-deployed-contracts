...
(define-constant ACCOUNT_OWNER 'SP1NJAE3751499JWH5A4JANQ02VQ7XNECJ0ZJV57J) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP1YNDFE7SS14NZZ0P9NHWR0BGCH3CTA20QWKT3EN) ;; agent (can only take approved actions)
