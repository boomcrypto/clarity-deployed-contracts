...
(define-constant ACCOUNT_OWNER 'SP31JK4ZKKK14N7V3WDNSNKMJBRC1DNH66RTHN5AJ) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP32W4Y48JD78TEJZ279Q5T44CMK6F76WV7TNEF8W) ;; agent (can only take approved actions)
