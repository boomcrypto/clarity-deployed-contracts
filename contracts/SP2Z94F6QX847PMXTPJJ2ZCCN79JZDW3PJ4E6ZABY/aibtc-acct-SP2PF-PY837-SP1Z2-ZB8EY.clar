...
(define-constant ACCOUNT_OWNER 'SP2PF4VYW8B62TASG7AKFESQ04CKTWM21X09PY837) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP1Z26739NAY9KMJSY3G8H25SRM0ZRN8HKH4ZB8EY) ;; agent (can only take approved actions)
