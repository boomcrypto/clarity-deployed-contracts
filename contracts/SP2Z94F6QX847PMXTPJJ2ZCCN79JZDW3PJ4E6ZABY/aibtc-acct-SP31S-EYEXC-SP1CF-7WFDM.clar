...
(define-constant ACCOUNT_OWNER 'SP31S76S7P99YHZK9TFYNMN6FG4A57KZ5542EYEXC) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP1CFGPJ5CD0M2VMC4QEDVH85MYYVABYY40V7WFDM) ;; agent (can only take approved actions)
