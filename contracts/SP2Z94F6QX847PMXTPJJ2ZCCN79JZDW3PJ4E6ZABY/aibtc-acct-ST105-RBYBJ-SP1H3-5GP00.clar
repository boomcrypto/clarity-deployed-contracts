...
(define-constant ACCOUNT_OWNER 'ST105HCS1RTR7D61EZET8CWNEF24ENEN3V6ARBYBJ) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP1H3RWJ2ZX917Q9AT149R3B2VCDGWA4XK9J5GP00) ;; agent (can only take approved actions)
