...
(define-constant ACCOUNT_OWNER 'SP1Q51S90KJ0ED1ARYW3H3M2BT58QYQ9PYZR9330A) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP3KQAWTG762Z3377FSN6JDD5B3M7BJCPY5PSG355) ;; agent (can only take approved actions)
