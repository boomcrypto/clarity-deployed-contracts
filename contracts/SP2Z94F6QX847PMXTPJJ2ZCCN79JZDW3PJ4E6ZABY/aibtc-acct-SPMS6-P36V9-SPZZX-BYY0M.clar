...
(define-constant ACCOUNT_OWNER 'SPMS64W628PC7P6YPWV5S5DXSKHZAZJ0AWPP36V9) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SPZZXV5SJ9B5SB514BNXKDCJ4M5J6JJKZAGBYY0M) ;; agent (can only take approved actions)
