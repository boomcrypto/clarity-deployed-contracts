...
(define-constant ACCOUNT_OWNER 'SPMR93J5G7M76EYKZG4DRQYZEZENYM6XMFXSCVC2) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP5H70M3KA69DH4211ZTGW74EGNGAA693VKETQV9) ;; agent (can only take approved actions)
