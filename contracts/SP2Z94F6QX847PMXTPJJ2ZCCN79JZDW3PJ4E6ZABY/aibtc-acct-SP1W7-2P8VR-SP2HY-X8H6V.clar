...
(define-constant ACCOUNT_OWNER 'SP1W7DQEJS2E6APJ6CYN8S7Q5QBFXC16E6252P8VR) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP2HYNJ13BFF70Y2JFPWACBQ3JNAJ249XB3AX8H6V) ;; agent (can only take approved actions)
