...
(define-constant ACCOUNT_OWNER 'SP1ZJANFG3H554MB4T32ZQKE9ZSN8SMX68G03NH4M) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP3QQ4Q1DPWN9SMAZB7FQSS4M311V9AY5CDHCFJ73) ;; agent (can only take approved actions)
