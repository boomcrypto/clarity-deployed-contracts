...
(define-constant ACCOUNT_OWNER 'SP168APDMNB7MAZB7HM4AGEB8JNN2R2SAF3G57WJ2) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP10303DM5A77DS7QD1158S7F80EPV5XNJEC2K314) ;; agent (can only take approved actions)
