...
(define-constant ACCOUNT_OWNER 'SPHPEC67DXBT5R37FFD4HKWFZWGZWJVSYKYS1W9V) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP2XBV4A7598WBD7DKMJ2SWM9QBT927R919XYY58T) ;; agent (can only take approved actions)
