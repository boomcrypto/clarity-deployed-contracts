...
(define-constant ACCOUNT_OWNER 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP20ZFNNYND2GK8R1XMWE6NHA4DMHA70V6QSEJ7D) ;; agent (can only take approved actions)
