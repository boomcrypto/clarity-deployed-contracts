...
(define-constant ACCOUNT_OWNER 'SP16PP6EYRCB7NCTGWAC73DH5X0KXWAPEQ8RKWAKS) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP25B0M7ZFN1NXGKEWVV1EFGX68VVACM63MZBPE09) ;; agent (can only take approved actions)
