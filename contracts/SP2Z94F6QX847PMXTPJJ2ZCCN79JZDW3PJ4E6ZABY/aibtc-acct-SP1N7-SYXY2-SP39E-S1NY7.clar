...
(define-constant ACCOUNT_OWNER 'SP1N7KEG77663M3833PZMN9J18X5RS0ADRHCSYXY2) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP39ENVWA1YVMYFBTDJP2S3SFGFXX52KEPC7S1NY7) ;; agent (can only take approved actions)
