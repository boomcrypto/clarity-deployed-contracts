...
(define-constant ACCOUNT_OWNER 'SP2EMZSA1CQQCGJEQ9JSDBWBV0NFDJ59EH5P9E56V) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP3M37P3CJF90FR504TRH6YPA30HE59RT3XHGRXMA) ;; agent (can only take approved actions)
