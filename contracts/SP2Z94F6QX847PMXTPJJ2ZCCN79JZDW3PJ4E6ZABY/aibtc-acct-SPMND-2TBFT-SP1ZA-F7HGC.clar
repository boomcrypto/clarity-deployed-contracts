...
(define-constant ACCOUNT_OWNER 'SPMNDVGTYJBRSYMAFAX0KYW2NB3AWFBWZ6Q2TBFT) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP1ZA4BNKYN245JMV1MXDA3F3YZ87NH6PWW7F7HGC) ;; agent (can only take approved actions)
