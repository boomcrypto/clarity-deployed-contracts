...
(define-constant ACCOUNT_OWNER 'SPAAJMEECTP070DR03X5NTA9GZHFKD5Z9H9TG23C) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP3PS8ASRZ8RS9X82H0925EEZP2BQ3YXXEYN48VVA) ;; agent (can only take approved actions)
