...
(define-constant ACCOUNT_OWNER 'SP2RXD17F40XRFPTJQ2W96V8M22DEE42GFSFVXJF6) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SPY7AZTY4JRG9K8AD7MVM6W36THT2R17V3Q7AYMS) ;; agent (can only take approved actions)
