...
(define-constant ACCOUNT_OWNER 'SP15JW68V8FWK09JEBEEYX31SCD7NK2CWK16511M7) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SPMRQE4FSCYG01DX3FHZE90ZTN7GNSR7SECS5ZG2) ;; agent (can only take approved actions)
