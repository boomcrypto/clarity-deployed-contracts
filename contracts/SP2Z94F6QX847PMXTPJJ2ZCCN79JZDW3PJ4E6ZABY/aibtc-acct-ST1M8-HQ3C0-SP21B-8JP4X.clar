...
(define-constant ACCOUNT_OWNER 'ST1M8KHCJXB3SBRQRDBCG3J3859AA1CN0AXDHQ3C0) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP21BRH5364YDNRXF3G35Q4FRY73KF905J3D8JP4X) ;; agent (can only take approved actions)
