...
(define-constant ACCOUNT_OWNER 'SP1E0SKRT4ETC4PBQ6JJVEH6NDWDPRWGEV2ZB62T1) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP328BZQKKMC4F6BKRDTS4FP1H20VBM83W8K2VDFF) ;; agent (can only take approved actions)
