...
(define-constant ACCOUNT_OWNER 'SP2MYZX4PFMPXH652AKVR9Q6G24KR2Y2Y00XTQKR9) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP78TXRDJFW7QQAKQB6JWGPXAEBXXCDQWHG81CMD) ;; agent (can only take approved actions)
