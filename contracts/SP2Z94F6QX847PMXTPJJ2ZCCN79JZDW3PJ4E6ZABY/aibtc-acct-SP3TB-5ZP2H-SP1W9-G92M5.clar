...
(define-constant ACCOUNT_OWNER 'SP3TB3AJ0XMZ9S6CGY2CQ6R06H1Z6DJQ1SH15ZP2H) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP1W9E9R5Q9X5ATX2SRYK46QK8BFEPF67M01G92M5) ;; agent (can only take approved actions)
