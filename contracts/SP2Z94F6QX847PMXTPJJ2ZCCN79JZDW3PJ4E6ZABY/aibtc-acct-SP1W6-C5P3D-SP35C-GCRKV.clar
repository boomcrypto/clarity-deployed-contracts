...
(define-constant ACCOUNT_OWNER 'SP1W6F3MWQMHCHM9PXE70M3RBGT1VV93GWFKC5P3D) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP35CM6RQJQM1FQH4Q33XVDH5RJ4CJ8B2K8ZGCRKV) ;; agent (can only take approved actions)
...
(begin
  ...
  (contract-call? 'SP29D6YMDNAKN1P045T6Z817RTE1AC0JAA99WAX2B.agent-account-registry auto-register-agent-account
