...
(define-constant ACCOUNT_OWNER 'SP3CK642B6119EVC6CT550PW5EZZ1AJW661ZMQTYD) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP2VZ4JVZRN9SB0S9ARZ1JP2QKEY652DHXQ6PDV7V) ;; agent (can only take approved actions)
