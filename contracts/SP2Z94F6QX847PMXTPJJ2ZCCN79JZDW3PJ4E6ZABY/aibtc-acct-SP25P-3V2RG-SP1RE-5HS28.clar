...
(define-constant ACCOUNT_OWNER 'SP25P7M4D49R8BS411R4FAKD7WC38GVSQJS13V2RG) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SP1RENFPF8ZTKA4M74C1YNCS5BH9SZHXWPPP5HS28) ;; agent (can only take approved actions)
