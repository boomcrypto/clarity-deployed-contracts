...
(define-constant ACCOUNT_OWNER 'SPH7H3DSG1D2XDBXBX5BNPJG1W6HE9KC58VJYT2C) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SPEA9PF1GV8PD4XE6J2FDG2HH0DDJHPCSPFHDTDW) ;; agent (can only take approved actions)
