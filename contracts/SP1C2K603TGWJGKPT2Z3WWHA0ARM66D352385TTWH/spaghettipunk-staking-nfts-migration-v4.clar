...
(define-private (migrate-bull (item uint))
    (begin
        ...
        (try! (contract-call? .spaghettipunk-staking-helper-v4 set-stake-pass 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-bulls item true))
        (try! (contract-call? .spaghettipunk-staking-helper-v4 stake 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-bulls 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.bull-multipliers item))
        (ok true)
    )
)
...
(define-private (migrate-bear (item uint))
    (begin
        ...
        (try! (contract-call? .spaghettipunk-staking-helper-v4 set-stake-pass 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-bears item true))
        (try! (contract-call? .spaghettipunk-staking-helper-v4 stake 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.byzantion-bitcoin-bears 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.bear-multipliers item))
        (ok true)
    )
)
...
(define-private (migrate-whale (item uint))
    (begin
        ...
        (try! (contract-call? .spaghettipunk-staking-helper-v4 set-stake-pass 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.bitcoin-whales item true))
        (try! (contract-call? .spaghettipunk-staking-helper-v4 stake 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.bitcoin-whales 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.whale-multipliers item))
        (ok true)
    )
)
...
(define-private (migrate-goat (item uint))
    (begin
        ...
        (try! (contract-call? .spaghettipunk-staking-helper-v4 set-stake-pass .bitcoin-goats item true))
        (try! (contract-call? .spaghettipunk-staking-helper-v4 stake .bitcoin-goats 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.goat-multipliers item))
        (ok true)
    )
)
...
(define-private (stake-item (item uint))
    (let (
        ...
        (try! (contract-call? .spaghettipunk-staking-helper-v4 set-stake-pass .the-cavalry id true))
        (try! (contract-call? .spaghettipunk-staking-helper-v4 stake .the-cavalry .the-cavalry-multipliers id))
        (ok true)
    )
)
...
(try! (contract-call? .spaghettipunk-staking-helper-v4 migration-change (as-contract tx-sender)))