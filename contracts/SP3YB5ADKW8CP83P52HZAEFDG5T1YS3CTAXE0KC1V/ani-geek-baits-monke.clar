;; ani-geek-baits-monke
;; contractType: editions

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token ani-geek-baits-monke uint)
...
(define-data-var artist-address principal 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmUahH4zmwWgFfC7SppYedbDCFSiKdih7krEn4mXwV1cDS/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (or (is-eq (var-get mint-limit) u0) (<= next-id (var-get mint-limit)))
    (begin
      (unwrap! (nft-mint? ani-geek-baits-monke next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? ani-geek-baits-monke token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? ani-geek-baits-monke token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? ani-geek-baits-monke token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? ani-geek-baits-monke id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? ani-geek-baits-monke id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? ani-geek-baits-monke id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u199747)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? ani-geek-baits-monke (+ last-nft-id u0) 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V))
      (map-set token-count 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V (+ (get-balance 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V) u1))
      (try! (nft-mint? ani-geek-baits-monke (+ last-nft-id u1) 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V))
      (map-set token-count 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V (+ (get-balance 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V) u1))
      (try! (nft-mint? ani-geek-baits-monke (+ last-nft-id u2) 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V))
      (map-set token-count 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V (+ (get-balance 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V) u1))
      (try! (nft-mint? ani-geek-baits-monke (+ last-nft-id u3) 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V))
      (map-set token-count 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V (+ (get-balance 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V) u1))
      (try! (nft-mint? ani-geek-baits-monke (+ last-nft-id u4) 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V))
      (map-set token-count 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V (+ (get-balance 'SP3YB5ADKW8CP83P52HZAEFDG5T1YS3CTAXE0KC1V) u1))
