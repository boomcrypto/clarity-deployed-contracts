    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Testing Testing")
    (var-set description u"Should I write testing again?")
    (var-set voting-system "fptp")
    (var-set options (list "7c6a7eeb-999f-4e6f-8d76-c1d15ad42093" "50ceac61-a628-42b0-97af-b71def99a7d0"))
    (var-set start u81341)
    (var-set end u81485)
    (map-set results {id: "7c6a7eeb-999f-4e6f-8d76-c1d15ad42093"} {count: u0, name: u"Yes, testing"}) (map-set results {id: "50ceac61-a628-42b0-97af-b71def99a7d0"} {count: u0, name: u"No, *******"})