...
(begin
  ...
  (map-set reward-tokens  { token: 'SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.Wrapped-Bitcoin } { whitelisted: true })
  (map-set reward-tokens  { token: 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.auto-alex } { whitelisted: true })
)