...
(define-constant allow-token 'SP1212HT52C8JSG7E50WRCB0S5G6HDZWHH01KCH27.walrus-with-mop-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u545950368148350)
    (var-set stx-balance u332667333)
