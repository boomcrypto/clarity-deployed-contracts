...
(define-constant activation-delay u1008)
...
(map-set minting-contracts { address: .minting-otc-v1 } { active: true, burn-block-height: (some burn-block-height) })
(map-set minting-contracts { address: .controller-v1 } { active: true, burn-block-height: (some burn-block-height) })
(map-set minting-contracts { address: .emergency-recover-v1 } { active: true, burn-block-height: (some burn-block-height) })
(map-set minting-contracts { address: .staking-v1 } { active: true, burn-block-height: (some burn-block-height) })