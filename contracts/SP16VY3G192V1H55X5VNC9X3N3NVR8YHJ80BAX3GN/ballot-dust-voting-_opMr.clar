    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4402555))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Dust%20Voting")
    (var-set description u"")
    (var-set voting-system "fptp")
    (var-set options (list "f1033e65-42fb-4039-b5cc-07d7f66462a7" "aaf02577-9937-48b3-8b08-58428ace9a07"))
    (var-set start u920795)
    (var-set end u930795)
    (map-set results {id: "f1033e65-42fb-4039-b5cc-07d7f66462a7"} {count: u0, name: u"Choice%201", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "aaf02577-9937-48b3-8b08-58428ace9a07"} {count: u0, name: u"Choice%202", locked-stx: u0, unlocked-stx: u0})