        ...
        reserve-data
          (if (is-eq (get principal-borrow-balance user-data) u0)
            ...
            (let (
              ...
              (compounded-balance 
                (contract-call? 'SP2VCQJGH7PHP2DJK7Z0V48AGBHQAW3R3ZW1QF4N.pool-read get-compounded-borrow-balance
              ...
              { 
                ...
                balance-increase: (if (>= compounded-balance principal) (- compounded-balance principal) u0)
              }
            )
          )
        { principal-balance: u0, compounded-balance: u0, balance-increase: u0 }
