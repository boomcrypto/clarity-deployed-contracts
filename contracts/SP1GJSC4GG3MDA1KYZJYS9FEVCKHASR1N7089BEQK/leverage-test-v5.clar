...
(define-private (leverage-helper 
  ...
  (let 
    ...
    (sbtc-balance (unwrap-panic (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token get-balance SELF)))
      ...
      ;; deposit sBTC
      (try! (as-contract (contract-call? 'SP2Q5KYRHR7C07D5H5Y0QMN6K9F9410X1CS0J7YS0.borrower-v1 add-collateral 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token sbtc-balance (some user))))
      ;; borrow
