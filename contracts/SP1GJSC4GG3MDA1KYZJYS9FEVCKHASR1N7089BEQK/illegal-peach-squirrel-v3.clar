...
(define-public (leverage-helper 
  ...
  (let 
    (
      ...
      ;; deposit sBTC
      (try! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.borrower-v1 add-collateral 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token sbtc-out))
      ;; borrow
      (try! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.borrower-v1 borrow pyth-price-feed-data borrow-amount))
      SUCCESS
    )
)
