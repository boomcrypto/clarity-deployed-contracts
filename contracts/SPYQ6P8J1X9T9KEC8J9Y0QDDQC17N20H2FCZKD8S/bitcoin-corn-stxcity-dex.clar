...
(define-constant allow-token 'SPYQ6P8J1X9T9KEC8J9Y0QDDQC17N20H2FCZKD8S.bitcoin-corn-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u933333333333333)
    (var-set stx-balance u28571429)
