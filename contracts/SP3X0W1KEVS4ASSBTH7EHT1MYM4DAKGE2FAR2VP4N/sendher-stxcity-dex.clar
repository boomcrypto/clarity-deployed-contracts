...
(define-constant token-supply u12345678789000000) ;; match with the token's supply (6 decimals)
(define-constant BONDING-DEX-ADDRESS (as-contract tx-sender)) ;; one contract per token

;; bonding curve config
(define-constant STX_TARGET_AMOUNT u500000000)
(define-constant VIRTUAL_STX_VALUE u100000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u10000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP3X0W1KEVS4ASSBTH7EHT1MYM4DAKGE2FAR2VP4N.sendher-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u3086419697250000)
    (var-set stx-balance u300000000)
