...
(define-private (stableswap-add-liquidity
  ...
  (let (
    ...
    (add-liquidity-result (if is-executing
      (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-core-v-1-4 add-liquidity 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-pool-stx-ststx-v-1-4 token-trait-a token-trait-b x-amount y-amount u1))
      (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-core-v-1-4 get-dlp 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-pool-stx-ststx-v-1-4 token-trait-a token-trait-b x-amount y-amount))
    ))

    ;; Get keeper fee and calculate updated dlp
    (keeper-fee-amount (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.keeper-4-helper-v-1-1 get-keeper-fee-amount add-liquidity-result) ERR_INVALID_HELPER_DATA))
    ...
    (if (and transfer-to-owner is-executing) (try! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-pool-stx-ststx-v-1-4 transfer dlp-after-keeper-fee tx-sender owner-address none)) false)
