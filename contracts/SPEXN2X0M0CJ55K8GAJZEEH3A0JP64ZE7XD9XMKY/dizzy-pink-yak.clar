;; router-stableswap-xyk-multihop-v-1-5

(use-trait ft-trait 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.sip-010-trait-ft-standard-v-1-1.sip-010-trait)
(use-trait stableswap-v-1-4-pool-trait 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-pool-trait-v-1-4.stableswap-pool-trait)
(use-trait stableswap-v-1-2-pool-trait 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-pool-trait-v-1-2.stableswap-pool-trait)
...
(define-public (get-quote-a
    ...
    (swaps-reversed bool)
    (stableswap-v-1-4-tokens (tuple (a <ft-trait>) (b <ft-trait>)))
    (stableswap-v-1-4-pools (tuple (a <stableswap-v-1-4-pool-trait>)))
    (stableswap-v-1-2-tokens (tuple (a <ft-trait>) (b <ft-trait>)))
    (stableswap-v-1-2-pools (tuple (a <stableswap-v-1-2-pool-trait>)))
  ...
  (let (
    ...
    (quote-a (if (is-eq swaps-reversed false)
                 (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-4 get-quote-a amount-after-aggregator-fees stableswap-v-1-4-tokens stableswap-v-1-4-pools) ERR_QUOTE_A)
    ...
    (quote-b (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-2 get-quote-a quote-a stableswap-v-1-2-tokens stableswap-v-1-2-pools) ERR_QUOTE_B))
    (quote-c (if (is-eq swaps-reversed false)
                 ...
                 (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-4 get-quote-a quote-b stableswap-v-1-4-tokens stableswap-v-1-4-pools) ERR_QUOTE_C)))
  )
    (ok quote-c)
  )
)
...
(define-public (get-quote-c
  ...
  (let (
    ...
    (quote-a (if (is-eq swaps-reversed false)
                 (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-4 get-quote-a amount-after-aggregator-fees stableswap-v-1-4-tokens stableswap-v-1-4-pools) ERR_QUOTE_A)
                 (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-2 get-quote-a amount-after-aggregator-fees stableswap-v-1-2-tokens stableswap-v-1-2-pools) ERR_QUOTE_A)))
    (quote-b (if (is-eq swaps-reversed false)
                 (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-2 get-quote-a quote-a stableswap-v-1-2-tokens stableswap-v-1-2-pools) ERR_QUOTE_B)
                 (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-4 get-quote-a quote-a stableswap-v-1-4-tokens stableswap-v-1-4-pools) ERR_QUOTE_B)))
  )
    (ok quote-b)
  )
)
...
(define-public (swap-helper-a
  ...
  (let (
    (aggregator-fee-token (if (is-eq swaps-reversed false) (get a stableswap-v-1-4-tokens) (get a xyk-tokens)))
    ...
    (swap-a (if (is-eq swaps-reversed false)
                (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-4 swap-helper-a amount-after-aggregator-fees u0 stableswap-v-1-4-tokens stableswap-v-1-4-pools) ERR_SWAP_A)
    ...
    (swap-b (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-2 swap-helper-a swap-a u0 stableswap-v-1-2-tokens stableswap-v-1-2-pools) ERR_SWAP_B))
    (swap-c (if (is-eq swaps-reversed false)
                ...
                (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-4 swap-helper-a swap-b u0 stableswap-v-1-4-tokens stableswap-v-1-4-pools) ERR_SWAP_C)))
  )
    (begin
      ...
      (print {
        ...
        data: {
          ...
          stableswap-v-1-4-data: {
            stableswap-v-1-4-tokens: stableswap-v-1-4-tokens,
            stableswap-v-1-4-pools: stableswap-v-1-4-pools,
            stableswap-v-1-4-swaps: {
              a: (if (is-eq swaps-reversed false) swap-a swap-c)
            }
          },
          stableswap-v-1-2-data: {
            stableswap-v-1-2-tokens: stableswap-v-1-2-tokens,
            stableswap-v-1-2-pools: stableswap-v-1-2-pools,
            stableswap-v-1-2-swaps: {
              a: swap-b
            }
          },
          xyk-data: {
...
(define-public (swap-helper-c
  ...
  (let (
    (aggregator-fee-token (if (is-eq swaps-reversed false) (get a stableswap-v-1-4-tokens) (get a stableswap-v-1-2-tokens)))
    (amount-after-aggregator-fees (try! (transfer-aggregator-fees aggregator-fee-token provider amount)))
    (amount-check (asserts! (> amount-after-aggregator-fees u0) ERR_INVALID_AMOUNT))
    (swap-a (if (is-eq swaps-reversed false)
                (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-4 swap-helper-a amount-after-aggregator-fees u0 stableswap-v-1-4-tokens stableswap-v-1-4-pools) ERR_SWAP_A)
                (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-2 swap-helper-a amount-after-aggregator-fees u0 stableswap-v-1-2-tokens stableswap-v-1-2-pools) ERR_SWAP_A)))
    (swap-b (if (is-eq swaps-reversed false)
                (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-2 swap-helper-a swap-a u0 stableswap-v-1-2-tokens stableswap-v-1-2-pools) ERR_SWAP_B)
                (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-swap-helper-v-1-4 swap-helper-a swap-a u0 stableswap-v-1-4-tokens stableswap-v-1-4-pools) ERR_SWAP_B)))
  )
    (begin
