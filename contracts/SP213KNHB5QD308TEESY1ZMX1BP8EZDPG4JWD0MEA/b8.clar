...
(define-public (burn-all (token-id uint))
    (begin
      ...
      (unwrap-panic (contract-call? 'SP213KNHB5QD308TEESY1ZMX1BP8EZDPG4JWD0MEA.web4 delete-place 
      ...
      (unwrap-panic (contract-call? 'SP213KNHB5QD308TEESY1ZMX1BP8EZDPG4JWD0MEA.web4 delete-transfer-utility token-id ))
