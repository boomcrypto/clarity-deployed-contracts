...
(define-data-var fees           uint u2000000)      ;;: ad registration fees
(define-data-var min-usd        uint u1)            ;;: default price in USD
(define-data-var min-fari       uint u140000000000) ;;: default price in FARI
(define-data-var min-stx        uint u450000000)    ;;: default price in STX
...
;; ;; STX mint
;; ;; @returns bool 
(define-public (stx-mint (id uint) (amount-stx uint) 
                (advertiser principal) (json (string-ascii 256)) 
                (network principal) (title (string-ascii 256)) 
                (copy (string-ascii 512)) (art-url (string-ascii 256))  
                (click-url (string-ascii 256)) (aural-url (string-ascii 256))
