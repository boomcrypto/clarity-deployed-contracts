...
(define-constant allow-token 'SP2RA4SKJ2RTE261FQNN9E4FY30KQ6S9RZEJ4CSAV.goldfish-with-mirror-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u704433497536945)
    (var-set stx-balance u419580420)
