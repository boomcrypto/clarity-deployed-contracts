;; ballot
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"BTC holder")
    (var-set description u"BTC holder should be able to vote")
    (var-set voting-system "single")
    (var-set options (list "1f1fe5de-86b4-4177-8a7a-fa49311899cd" "c9fa964c-a661-4362-87ed-0e7878d22041"))
    (var-set start u75197)
    (var-set end u78072)
    (map-set results {id: "1f1fe5de-86b4-4177-8a7a-fa49311899cd"} {count: u0, name: u"Yes"}) (map-set results {id: "c9fa964c-a661-4362-87ed-0e7878d22041"} {count: u0, name: u"No"})