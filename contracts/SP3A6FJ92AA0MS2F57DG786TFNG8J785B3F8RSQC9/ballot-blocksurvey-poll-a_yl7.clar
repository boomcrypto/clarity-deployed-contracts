    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"BlockSurvey Poll on 28Jul2023")
    (var-set description u"Description")
    (var-set voting-system "fptp")
    (var-set options (list "46fcb705-ed22-4ddd-b706-f97ba8756293" "35f1d05c-51d6-4fca-bc7d-9492694e9a63"))
    (var-set start u114876)
    (var-set end u163552)
    (map-set results {id: "46fcb705-ed22-4ddd-b706-f97ba8756293"} {count: u0, name: u"Choice 1"}) (map-set results {id: "35f1d05c-51d6-4fca-bc7d-9492694e9a63"} {count: u0, name: u"Choice 2"})