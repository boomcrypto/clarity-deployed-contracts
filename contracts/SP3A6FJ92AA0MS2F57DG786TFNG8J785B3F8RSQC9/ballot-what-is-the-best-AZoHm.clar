    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"What is the best cryptocurrency?")
    (var-set description u"Let us know your thoughts!")
    (var-set voting-system "block")
    (var-set options (list "1f44919b-baa0-4d2f-a926-c7bf34c44cca" "19d433b1-bf40-4c7d-a130-6b66f5252930" "6a49b201-21a8-4e42-a16b-64f117bb6493"))
    (var-set start u83888)
    (var-set end u136427)
    (map-set results {id: "1f44919b-baa0-4d2f-a926-c7bf34c44cca"} {count: u0, name: u"Bitcoin"}) (map-set results {id: "19d433b1-bf40-4c7d-a130-6b66f5252930"} {count: u0, name: u"Ethereum"}) (map-set results {id: "6a49b201-21a8-4e42-a16b-64f117bb6493"} {count: u0, name: u"Dogecoin"})