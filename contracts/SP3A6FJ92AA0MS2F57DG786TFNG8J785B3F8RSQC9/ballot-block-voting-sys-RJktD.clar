    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Block voting system without strategy")
    (var-set description u"Block voting system without strategy")
    (var-set voting-system "block")
    (var-set options (list "b2e2166e-f5c6-408a-85b7-ce26f2a257f6" "521980a4-5f86-4728-b72a-9d7ccfca7faa"))
    (var-set start u75744)
    (var-set end u78044)
    (map-set results {id: "b2e2166e-f5c6-408a-85b7-ce26f2a257f6"} {count: u0, name: u"Choice 1"}) (map-set results {id: "521980a4-5f86-4728-b72a-9d7ccfca7faa"} {count: u0, name: u"Choice 2"})