    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Quadratic voting system without strategy")
    (var-set description u"Quadratic voting system without strategy")
    (var-set voting-system "quadratic")
    (var-set options (list "388fccd7-62d6-4db6-970e-46d23e1ae6c9" "a19c8c15-0afe-43c7-b7e2-729af6189559"))
    (var-set start u75744)
    (var-set end u78044)
    (map-set results {id: "388fccd7-62d6-4db6-970e-46d23e1ae6c9"} {count: u0, name: u"Choice 1"}) (map-set results {id: "a19c8c15-0afe-43c7-b7e2-729af6189559"} {count: u0, name: u"Choice 2"})