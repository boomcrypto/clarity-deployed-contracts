    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"FPTP voting system without strategy")
    (var-set description u"FPTP voting system without strategy")
    (var-set voting-system "fptp")
    (var-set options (list "d8f38fab-d5f7-417b-9ea7-aa4407f88100" "8dfd5b05-a5a2-44ce-abac-2f9d22bdcda3"))
    (var-set start u75744)
    (var-set end u78044)
    (map-set results {id: "d8f38fab-d5f7-417b-9ea7-aa4407f88100"} {count: u0, name: u"Choice 1"}) (map-set results {id: "8dfd5b05-a5a2-44ce-abac-2f9d22bdcda3"} {count: u0, name: u"Choice 2"})