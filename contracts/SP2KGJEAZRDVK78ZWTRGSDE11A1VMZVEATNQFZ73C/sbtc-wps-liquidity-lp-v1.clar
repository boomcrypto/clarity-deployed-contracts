...
(begin
    ;; Set token URI
    (var-set token-uri (some u"https://metadata.charisma.rocks/api/v1/metadata/SP2KGJEAZRDVK78ZWTRGSDE11A1VMZVEATNQFZ73C.sbtc-wps-liquidity-lp-v1"))
)