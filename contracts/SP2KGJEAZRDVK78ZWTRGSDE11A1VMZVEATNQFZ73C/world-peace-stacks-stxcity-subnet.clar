;; title: world-peace-stacks-stxcity-subnet
;; author: rozar.btc
;; summary: Intent-based subnet token wrapper for world-peace-stacks-stxcity using blaze-intent verifier.
...
(define-read-only (get-name)         (contract-call? 'SP14J806BWEPQAXVA0G6RYZN7GNA126B7JFRRYTEM.world-peace-stacks-stxcity get-name))
(define-read-only (get-symbol)       (contract-call? 'SP14J806BWEPQAXVA0G6RYZN7GNA126B7JFRRYTEM.world-peace-stacks-stxcity get-symbol))
(define-read-only (get-decimals)     (contract-call? 'SP14J806BWEPQAXVA0G6RYZN7GNA126B7JFRRYTEM.world-peace-stacks-stxcity get-decimals))
(define-read-only (get-token-uri)    (contract-call? 'SP14J806BWEPQAXVA0G6RYZN7GNA126B7JFRRYTEM.world-peace-stacks-stxcity get-token-uri))
(define-read-only (get-total-supply) (contract-call? 'SP14J806BWEPQAXVA0G6RYZN7GNA126B7JFRRYTEM.world-peace-stacks-stxcity get-total-supply))
...
(define-public (deposit (amount uint) (recipient (optional principal)))
  (let ((sender tx-sender)
    ...
    (try! (contract-call? 'SP14J806BWEPQAXVA0G6RYZN7GNA126B7JFRRYTEM.world-peace-stacks-stxcity transfer amount sender (as-contract tx-sender) none))
...
(define-public (withdraw (amount uint) (recipient (optional principal)))
  (let ((owner tx-sender)
    ...
    (try! (as-contract (contract-call? 'SP14J806BWEPQAXVA0G6RYZN7GNA126B7JFRRYTEM.world-peace-stacks-stxcity transfer amount tx-sender recv none)))
