...
(define-constant allow-token 'SP1EEDA40PARSPAWFGGPKVCHBPW5TRKT9C09MWENT.winklevoss-bitcoin-treasury-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u800159872102318)
    (var-set stx-balance u499500500)
