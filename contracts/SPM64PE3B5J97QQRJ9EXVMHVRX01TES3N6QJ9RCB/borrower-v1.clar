  ...
  (begin
    ...
    (let
      (
        ...
        (borrow-params (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.state-v1 get-borrow-repay-params contract-caller))
        ...
        (market-asset-price (unwrap! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.pyth-adapter-v1 read-price 'SP3Y2ZSH8P7D50B0VBTSX11S7XSG24M1VB9YFQA4K.token-aeusdc) ERR-MISSING-MARKET-PRICE))
  ...
  (begin
    (let
      (
        ...
        (add-collateral-params (try! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.state-v1 get-collateral-params collateral-token contract-caller)))
...
(define-public (remove-collateral (pyth-price-feed-data (optional (buff 8192))) (collateral <token-trait>) (amount uint))
  (begin
    ...
    (let
      (
        (collateral-token (contract-of collateral))
        (remove-collateral-params (try! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.state-v1 get-collateral-params collateral-token contract-caller)))
        ...
        (collateral-prices (try! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.pyth-adapter-v1 bulk-read-collateral-prices (get position-collaterals remove-user-collateral-info))))
      ...
      (try! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.state-v1 transfer-to collateral contract-caller amount))
      (print {
          collateral: collateral-token,
...
(define-read-only (get-user-collaterals-value (account principal))
  ...
  (let
    (
      ...
      (collateral-prices (try! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.pyth-adapter-v1 bulk-read-collateral-prices posted-collaterals)))
    )
    (begin
  ...
  (let ((remaining-amount (unwrap! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.math-v1 sub prev-amount amount) ERR-INSUFFICIENT-BALANCE)))
    (if (is-eq remaining-amount u0)
      (let ((updated-position-collaterals (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.state-v1 remove-item position-collaterals collateral)))
        ...
        (try! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.state-v1 update-remove-collateral contract-caller collateral debt-shares (get new-list updated-position-collaterals) borrowed-amount borrowed-block))
        (ok {
      ...
      (begin
        ...
        (try! (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.state-v1 update-user-collateral contract-caller collateral remaining-amount))
        (ok {
          remaining-amount: remaining-amount,
