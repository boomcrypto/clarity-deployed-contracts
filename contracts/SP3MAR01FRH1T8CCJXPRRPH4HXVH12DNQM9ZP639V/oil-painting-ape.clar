...
(define-non-fungible-token oil-painting-ape uint)
...
(define-data-var base-uri (string-ascii 100) "ipfs://QmNxqoBd3y8i5t1yPM3r4U7pg3eQsFwJJPf6Si7s9MdaPS/oil-painting-ape/")
...
(define-data-var artist-address (list 1000 principal) (list 'SP2SC0EAWCRKC597KMEBJ52TEHFSQAV4ZCXJD5J1Y )) 
...
(define-data-var public-target-block-height uint u64731)
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? oil-painting-ape id sender recipient)
        success
          (let
...
(define-read-only (get-owner (id uint))
  ;; Make sure to replace oil-painting-ape
  (ok (nft-get-owner? oil-painting-ape id)))
...
(define-private (mint (new-owner principal))
    (let (
      ...
      (match (nft-mint? oil-painting-ape next-id new-owner)
        success
        (let
...
(define-public (burn (id uint) (owner principal))
    ...
    (match (nft-burn? oil-painting-ape id owner)
        success
        (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? oil-painting-ape id) false)))
...
(define-public (buy-in-ustx (id uint) (comm <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? oil-painting-ape id) ERR-NOT-FOUND))
