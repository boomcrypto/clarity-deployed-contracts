...
(define-non-fungible-token simply-bitcoin uint)
...
(define-data-var total-price uint u2288000000)
(define-data-var artist-address principal 'SP1CASW24FCM4G0Y9ZXP2D6GNXDBRDKEHDDYHCCVG)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmPQXBp8v1edDCMNHC2sjQHwk8yDupiWkf7w1sGU9HQvxk/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (or (is-eq (var-get mint-limit) u0) (<= next-id (var-get mint-limit)))
    (begin
      (unwrap! (nft-mint? simply-bitcoin next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? simply-bitcoin token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? simply-bitcoin token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? simply-bitcoin token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? simply-bitcoin id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? simply-bitcoin id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? simply-bitcoin id) (err ERR-NOT-FOUND)))
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? simply-bitcoin (+ last-nft-id u0) 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4))
      (map-set token-count 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4 (+ (get-balance 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4) u1))
      (try! (nft-mint? simply-bitcoin (+ last-nft-id u1) 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4))
      (map-set token-count 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4 (+ (get-balance 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4) u1))
      (try! (nft-mint? simply-bitcoin (+ last-nft-id u2) 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4))
      (map-set token-count 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4 (+ (get-balance 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4) u1))
      (try! (nft-mint? simply-bitcoin (+ last-nft-id u3) 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4))
      (map-set token-count 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4 (+ (get-balance 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4) u1))
      (try! (nft-mint? simply-bitcoin (+ last-nft-id u4) 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4))
      (map-set token-count 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4 (+ (get-balance 'SP3MSEDBB8XMZTGGVBW6FXNRFV3ZKNYKV7WJQ0JH4) u1))
