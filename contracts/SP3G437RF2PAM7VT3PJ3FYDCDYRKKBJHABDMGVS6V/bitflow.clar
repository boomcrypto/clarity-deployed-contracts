...
(define-constant TOKEN_URI u"https://quicknode.quicknode-ipfs.com/ipfs/QmVkFaVZg6epQ5wKMpQDoaCkRdp8taPCVJ6VH32eiNoMZy") ;; utf-8 string with token metadata host
(define-constant TOKEN_NAME "bitflow.fi")
(define-constant TOKEN_SYMBOL "bitflow.fi")
