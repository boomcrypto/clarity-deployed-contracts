...
(define-public (swap-a-to-b
  ...
  (let (
    ...
    (print {
      ...
      amount-in: amount,
      token-out: 'SP2VG7S0R4Z8PYNYCAQ04HCBX1MH75VT11VXCWQ6G.built-on-bitcoin-stxcity,
      amount-out: dy-d,
...
(define-public (swap-b-to-a (amount uint) (min-y-out uint))
  (let (
    ...
    (print {
      type: "sell",
      sender: sender,
      token-in: 'SP2VG7S0R4Z8PYNYCAQ04HCBX1MH75VT11VXCWQ6G.built-on-bitcoin-stxcity,
      amount-in: amount,
...
(define-public (add-liquidity (amount uint))
  (let (
    ...
    (print {
      ...
      token-a-amount: dx-d,
      token-b: 'SP2VG7S0R4Z8PYNYCAQ04HCBX1MH75VT11VXCWQ6G.built-on-bitcoin-stxcity,
      token-b-amount: dy-d,
      lp-tokens: dk-d,
      pool-reserves: (get-reserves-quote),
      pool-contract: CONTRACT,
