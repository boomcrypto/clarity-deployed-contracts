...
(define-public (swap-a-to-b
  ...
  (let (
    ...
    (print {
      ...
      amount-in: amount,
      token-out: 'SP3BRXZ9Y7P5YP28PSR8YJT39RT51ZZBSECTCADGR.skullcoin-stxcity,
      amount-out: dy-d,
...
(define-public (swap-b-to-a (amount uint) (min-y-out uint))
  (let (
    ...
    (print {
      type: "sell",
      sender: sender,
      token-in: 'SP3BRXZ9Y7P5YP28PSR8YJT39RT51ZZBSECTCADGR.skullcoin-stxcity,
      amount-in: amount,
...
(define-public (add-liquidity (amount uint))
  (let (
    ...
    (print {
      ...
      token-a-amount: dx-d,
      token-b: 'SP3BRXZ9Y7P5YP28PSR8YJT39RT51ZZBSECTCADGR.skullcoin-stxcity,
      token-b-amount: dy-d,
      lp-tokens: dk-d,
      pool-reserves: (get-reserves-quote),
      pool-contract: CONTRACT,
