      ...
      ;; Title: sBTC-rock lp-token (Single Pool)
      ;; Version: 1.0.0
      ...
      (define-public (swap-a-to-b (amount uint) (min-y-out uint))
          (let (
              ...
              (try! (as-contract (contract-call? 'SP4M2C88EE8RQZPYTC4PZ88CE16YGP825EYF6KBQ.stacks-rock transfer dy-d CONTRACT sender none)))
              (print {
                  type: "buy",
                  sender: sender,
      ...
      (define-public (add-liquidity (amount uint))
          (let (
              ...
              (try! (contract-call? 'SP4M2C88EE8RQZPYTC4PZ88CE16YGP825EYF6KBQ.stacks-rock transfer dy-d sender CONTRACT none))
