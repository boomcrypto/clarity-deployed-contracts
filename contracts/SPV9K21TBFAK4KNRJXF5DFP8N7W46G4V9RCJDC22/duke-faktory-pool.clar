      ...
      ;; Title: sBTC-DUKE lp-token (Single Pool)
      ;; Version: 1.0.0
      ...
      ;; Define LP token
      (define-fungible-token sBTC-DUKE)
      ...
      (define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
          (begin
              ...
              (try! (ft-transfer? sBTC-DUKE amount sender recipient))
      ...
      (define-read-only (get-balance (who principal))
          (ok (ft-get-balance sBTC-DUKE who)))
  
      (define-read-only (get-total-supply)
          (ok (ft-get-supply sBTC-DUKE)))
      ...
      (define-public (swap-a-to-b (amount uint) (min-y-out uint))
          (let (
              ...
              (try! (as-contract (contract-call? 'SPVXNRDM0BF03DD70WZ285925S3A20NC86VYFB9A.duke-stxcity transfer dy-d CONTRACT sender none)))
              (print {
                  type: "buy",
                  sender: sender,
                  token-in: 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token,
                  amount-in: amount,
                  token-out: 'SPVXNRDM0BF03DD70WZ285925S3A20NC86VYFB9A.duke-stxcity,
                  amount-out: dy-d,
      ...
      (define-public (swap-b-to-a (amount uint) (min-y-out uint))
          (let (
              ...
              (try! (contract-call? 'SPVXNRDM0BF03DD70WZ285925S3A20NC86VYFB9A.duke-stxcity transfer amount sender CONTRACT none))
              ...
              (print {
                  type: "sell",
                  sender: sender,
                  token-in: 'SPVXNRDM0BF03DD70WZ285925S3A20NC86VYFB9A.duke-stxcity,
                  amount-in: amount,
      ...
      (define-public (add-liquidity (amount uint))
          (let (
              ...
              (try! (contract-call? 'SPVXNRDM0BF03DD70WZ285925S3A20NC86VYFB9A.duke-stxcity transfer dy-d sender CONTRACT none))
              (try! (ft-mint? sBTC-DUKE dk-d sender))
              (print {
                  type: "add-liquidity",
                  sender: sender,
                  token-a: 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token,
                  token-a-amount: dx-d,
                  token-b: 'SPVXNRDM0BF03DD70WZ285925S3A20NC86VYFB9A.duke-stxcity,
                  token-b-amount: dy-d,
                  lp-tokens: dk-d,
                  pool-reserves: (get-reserves-quote),
                  pool-contract: CONTRACT
      ...
      (define-public (remove-liquidity (amount uint))
          (let (
              ...
              (dy-d (get dy delta))
              (dk-d (get dk delta)))
              (try! (ft-burn? sBTC-DUKE dk-d sender))
      ...
      (define-private (get-reserves)
          { 
            ...
            b: (unwrap-panic (contract-call? 'SPVXNRDM0BF03DD70WZ285925S3A20NC86VYFB9A.duke-stxcity get-balance CONTRACT))
          })
      ...
      (define-read-only (get-reserves-quote)
          (let (
              (reserves (get-reserves))
              (supply (ft-get-supply sBTC-DUKE)))
              {
                dx: (get a reserves),
                dy: (get b reserves),
                dk: supply
      ...
      (begin
        ...
        (try! (add-liquidity u170000))
        ;; Transfer additional token B to achieve desired ratio
        (try! (contract-call?
          'SPVXNRDM0BF03DD70WZ285925S3A20NC86VYFB9A.duke-stxcity
          transfer u3539862830000 tx-sender CONTRACT none
        ))
        (print {
