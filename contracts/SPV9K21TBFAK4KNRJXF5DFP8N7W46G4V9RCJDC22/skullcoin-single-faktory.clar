...
(define-public (initialize-pool (token-amount uint))
  (begin
    ...
    (try! (contract-call? 'SP3BRXZ9Y7P5YP28PSR8YJT39RT51ZZBSECTCADGR.skullcoin-stxcity 
    ...
    (print {
      ...
      ft: 'SP3BRXZ9Y7P5YP28PSR8YJT39RT51ZZBSECTCADGR.skullcoin-stxcity,
...
(define-public (deposit-sbtc-for-lp (lp-amount uint))
    (let (
          ...
          (lp-result (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.skullcoin-faktory-pool 
...
(define-public (withdraw-lp-tokens)
  (let ((unlock-block (+ (var-get creation-block) LOCK_PERIOD))
    ...
    (let ((remove-result (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.skullcoin-faktory-pool 
        ...
        (try! (as-contract (contract-call? 'SP3BRXZ9Y7P5YP28PSR8YJT39RT51ZZBSECTCADGR.skullcoin-stxcity 
...
(define-read-only (get-quote-for-lp (lp-amount uint))
  (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.skullcoin-faktory-pool 
...
(define-read-only (get-config) 
    {
        ft: 'SP3BRXZ9Y7P5YP28PSR8YJT39RT51ZZBSECTCADGR.skullcoin-stxcity,
        pool: 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.skullcoin-faktory-pool,
