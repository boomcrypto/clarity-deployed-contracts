...
(define-public (initialize-pool (token-amount uint))
  (begin
    ...
    (try! (contract-call? 'SP3E8B51MF5E28BD82FM95VDSQ71VK4KFNZX7ZK2R.frog-faktory 
    ...
    (print {
      ...
      ft: 'SP3E8B51MF5E28BD82FM95VDSQ71VK4KFNZX7ZK2R.frog-faktory,
...
(define-public (deposit-sbtc-for-lp (lp-amount uint))
    (let (
          ...
          (lp-result (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.froggy-faktory-pool 
...
(define-public (withdraw-lp-tokens)
  (let ((unlock-block (+ (var-get creation-block) LOCK_PERIOD))
    ...
    (let ((remove-result (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.froggy-faktory-pool 
        ...
        (try! (as-contract (contract-call? 'SP3E8B51MF5E28BD82FM95VDSQ71VK4KFNZX7ZK2R.frog-faktory 
...
(define-read-only (get-quote-for-lp (lp-amount uint))
  (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.froggy-faktory-pool 
...
(define-read-only (get-config) 
    {
        ft: 'SP3E8B51MF5E28BD82FM95VDSQ71VK4KFNZX7ZK2R.frog-faktory,
        pool: 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.froggy-faktory-pool,
