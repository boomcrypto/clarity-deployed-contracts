...
(define-constant ERR_DA (err u2401))
(define-constant ERR_DB (err u2402))
...
(define-constant T_SUSDT "m")
(define-constant T_WELSH "n")
...
(define-private (wstx-susdt-a (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.amm-swap-pool-v1-1 swap-helper
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx
...
(define-private (susdt-wstx-a (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.amm-swap-pool-v1-1 swap-helper
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-susdt
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx
...
(define-private (susdt-xusd-a (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.amm-swap-pool-v1-1 swap-helper
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-susdt
...
(define-private (xusd-susdt-a (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.amm-swap-pool-v1-1 swap-helper
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wxusd
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-susdt
...
(define-private (wstx-welsh-a (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.amm-swap-pool-v1-1 swap-helper
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx
...
(define-private (welsh-wstx-a (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.amm-swap-pool-v1-1 swap-helper
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wcorgi
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx
...
(define-private (swap-a
  ...
  (if (is-eq a T_STX)
    ...
    (if (is-eq b T_SUSDT) (wstx-susdt-a x)
    (if (is-eq b T_WELSH) (wstx-welsh-a x)
    ERR_AB))))
  (if (is-eq a T_XBTC)
  ...
  (if (is-eq a T_DIKO)
    ...
    ERR_AB)
  (if (is-eq a T_XUSD)
    (if (is-eq b T_SUSDT) (xusd-susdt-a x)
    ERR_AB)
  (if (is-eq a T_SUSDT)
    (if (is-eq b T_STX) (susdt-wstx-a x)
    (if (is-eq b T_XUSD) (susdt-xusd-a x)
    ERR_AB))
  (if (is-eq a T_WELSH)
    (if (is-eq b T_STX) (welsh-wstx-a x)
    ERR_AB)
  ERR_AA)))))))
)
...
(define-private (wstx-welsh-d (x uint))
(match (contract-call?
'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-swap-v2-1 swap-x-for-y
'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.wrapped-stx-token
...
(define-private (welsh-wstx-d (x uint))
(match (contract-call?
'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-swap-v2-1 swap-y-for-x
'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.wrapped-stx-token
'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token
...
(define-private (swap-b
  ...
  (if (is-eq a T_STX)
    ...
    (if (is-eq b T_WELSH) (wstx-welsh-d x)
    ERR_BB)))
  (if (is-eq a T_DIKO)
  ...
  (if (is-eq a T_XBTC)
    ...
    ERR_BB)
  (if (is-eq a T_WELSH)
    (if (is-eq b T_STX) (welsh-wstx-d x)
    ERR_BB)
  ERR_BA)))))
)
...
(define-private (swap-c
  ...
  (if (is-eq a T_STSW)
    ...
    (if (is-eq b T_WELSH) (stsw-welsh-s x)
    ERR_CB)))
  (if (is-eq a T_LBTC)
    ...
    ERR_CB))
  (if (is-eq a T_WELSH)
    (if (is-eq b T_STSW) (welsh-stsw-s x)
    ERR_CB)
  ERR_CA))))))
)

(define-private (wstx-xbtc-ac (x uint))
(match (contract-call?
...
(define-private (xbtc-wstx-ac (x uint))
(match (contract-call?
...
(define-private (wstx-alex-ac (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.fixed-weight-pool-v1-01 swap-wstx-for-y
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.age000-governance-token
u50000000 (* x u100) none)
...
(define-private (alex-wstx-ac (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.fixed-weight-pool-v1-01 swap-y-for-wstx
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.age000-governance-token
u50000000 x none)
...
(define-private (alex-usda-ac (x uint))
(match (contract-call?
...
(define-private (usda-alex-ac (x uint))
(match (contract-call?
...
(define-private (wstx-xusd-ac (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.fixed-weight-pool-v1-01 swap-wstx-for-y
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wxusd
u50000000 (* x u100) none)
...
(define-private (xusd-wstx-ac (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.fixed-weight-pool-v1-01 swap-y-for-wstx
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wxusd
u50000000 x none)
...
(define-private (swap-d
  ...
  (if (is-eq a T_STX)
    (if (is-eq b T_XBTC) (wstx-xbtc-ac x)
    (if (is-eq b T_ALEX) (wstx-alex-ac x)
    (if (is-eq b T_XUSD) (wstx-xusd-ac x)
    ERR_DB)))
  (if (is-eq a T_XBTC)
    (if (is-eq b T_STX) (xbtc-wstx-ac x)
    ERR_DB)
  (if (is-eq a T_ALEX)
    (if (is-eq b T_STX) (alex-wstx-ac x)
    (if (is-eq b T_USDA) (alex-usda-ac x)
    ERR_DB))
  (if (is-eq a T_XUSD)
    (if (is-eq b T_STX) (xusd-wstx-ac x)
    ERR_DB)
  (if (is-eq a T_USDA)
    (if (is-eq b T_ALEX) (usda-alex-ac x)
    ERR_DB)
  ERR_DA)))))
)
...
(define-private (xfer
  ...
  (if (is-eq a T_SUSDT) (contract-call? 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-susdt transfer amt src dst none)
  (if (is-eq a T_WELSH) (contract-call? 'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token transfer amt src dst none)
  ERR_X))))))))))))
)
