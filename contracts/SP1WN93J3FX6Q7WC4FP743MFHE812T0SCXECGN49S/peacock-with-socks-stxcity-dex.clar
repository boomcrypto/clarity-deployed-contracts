...
(define-constant token-supply u2003000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP1WN93J3FX6Q7WC4FP743MFHE812T0SCXECGN49S.peacock-with-socks-stxcity)
...
(var-set token-balance u2002000000000)
(var-set stx-balance u999001)
