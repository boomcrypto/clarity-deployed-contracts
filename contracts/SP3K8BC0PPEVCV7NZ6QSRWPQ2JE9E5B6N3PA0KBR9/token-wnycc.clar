...
(define-read-only (get-balance (account principal))
  ...
  (ok (/ (* (unwrap-panic (contract-call? 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-token-v2 get-balance account)) (pow-decimals)) (pow u10 u6)))
)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    ...
    ;;NOTE V2 is expected to have 6 decimals
    (contract-call? 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-token-v2 transfer (/ (* amount (pow u10 u6)) (pow-decimals)) sender recipient memo)
  )
)
