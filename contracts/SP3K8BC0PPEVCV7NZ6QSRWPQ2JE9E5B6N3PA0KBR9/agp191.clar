...
(define-constant emissions 
	(list 
		{ sft: false, token: .fwp-wstx-wbtc-50-50-v1-01, token-id: u0, amount: u103200 }
		{ sft: false, token: .fwp-alex-wban, token-id: u0, amount: u800 }
		{ sft: false, token: .fwp-alex-usda, token-id: u0, amount: u2000 }
		{ sft: false, token: .fwp-wstx-wxusd-50-50-v1-01, token-id: u0, amount: u4000 }
	)
)
