...
(define-constant message-domain 0xa2a2221ace8a76ed4729b2838098dd80712796258c80e454c818590c2e26333f)
	...
	(begin
		...
		(let 
			...
			(and
				...
				(as-contract (unwrap! (contract-call? .stxdx-wallet-zero transfer (mul-down (get sender-fee order) amount) (get maker order) fee-address-id (get maker-asset order)) err-sender-fee-payment-failed))
			)
		)
		(ok true)
	)
