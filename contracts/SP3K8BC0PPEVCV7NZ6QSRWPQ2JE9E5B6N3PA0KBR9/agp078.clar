...
(define-public (execute (sender principal))
	(begin		
		...
		(try! (contract-call? .token-apower add-approved-contract .cofarm-apower-helper))
		(try! (contract-call? .age000-governance-token edg-add-approved-contract .lottery-claim-helper))
		(ok true)
	)
)