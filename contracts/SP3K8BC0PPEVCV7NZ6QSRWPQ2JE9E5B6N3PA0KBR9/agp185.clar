...
(define-constant address-60 'SP32ABRNH9PA9PDSNQQKGRVXDF91JF5VZ3BWW0BFW)
(define-constant name-60 "gsr.io")
(define-constant schedule-60 (list
...
(define-constant address-61 'SP30HSKC24MTTAA9A9PE043WS9SM357EK0CRAF6VH)
(define-constant name-61 "gsg")
(define-constant schedule-61 (list
{ vesting-id: u1, vesting-timestamp: u1667174400, amount: u1543212500000 }
{ vesting-id: u2, vesting-timestamp: u1669766400, amount: u1543212500000 }
{ vesting-id: u3, vesting-timestamp: u1672444800, amount: u1543212500000 }
{ vesting-id: u4, vesting-timestamp: u1675123200, amount: u1543212500000 }
...
(define-public (execute (sender principal))
    (let 
        (
(recipient-60 (try! (contract-call? .age009-token-lock set-recipient address-60 name-60)))
(recipient-61 (try! (contract-call? .age009-token-lock set-recipient address-61 name-61)))
(vesting-60 (generate-schedule-many recipient-60 schedule-60))
(vesting-61 (generate-schedule-many recipient-61 schedule-61))
        )
(unwrap-panic (contract-call? .age009-token-lock set-vesting-schedule-many vesting-60))
(unwrap-panic (contract-call? .age009-token-lock set-vesting-schedule-many vesting-61))
        (ok true)
    )
)
