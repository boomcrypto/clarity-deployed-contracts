...
(define-constant emissions 
	(list 
		...
		{ sft: false, token: .fwp-alex-wban, token-id: u0, amount: u400 }
		{ sft: false, token: .fwp-alex-usda, token-id: u0, amount: u1000 }
		{ sft: false, token: .fwp-wstx-wxusd-50-50-v1-01, token-id: u0, amount: u2000 }
	)
)
