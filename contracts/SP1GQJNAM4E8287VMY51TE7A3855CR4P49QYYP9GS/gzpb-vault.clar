...
;; Vault Metadata
(define-data-var token-uri (optional (string-utf8 256)) (some u"data:application/json;base64,eyJuYW1lIjoiR1pQQiIsImltYWdlIjoiZGF0YTppbWFnZS9wbmc7YmFzZTY0LGlWQk9SdzBLR2dvQUFBQU5TVWhFVWdBQUFBRUFBQUFCQ0FZQUFBQWZGY1NKQUFBQUFYTlNSMElBcnM0YzZRQUFBQTFKUkVGVUdGZGpXR1g4L3o4QUJrTUMzTFFyRk5VQUFBQUFTVVZPUks1Q1lJST0ifQ=="))
...
(define-public (deposit (amount uint) (recipient principal))
    (begin
        (try! (contract-call? 'SP1GQJNAM4E8287VMY51TE7A3855CR4P49QYYP9GS.gas-futures-subnet deposit amount (some recipient)))
        (ok {dx: amount, dy: amount, dk: u0})))

(define-public (withdraw (amount uint) (recipient principal))
    (begin
        (try! (contract-call? 'SP1GQJNAM4E8287VMY51TE7A3855CR4P49QYYP9GS.gas-futures-subnet withdraw amount (some recipient)))
        (ok {dx: amount, dy: amount, dk: u0})))