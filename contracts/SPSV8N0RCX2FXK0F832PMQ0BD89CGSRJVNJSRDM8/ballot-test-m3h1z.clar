    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4186441))
                (let
                    (
    ...
    (var-set options (list "89d3dff8-44ed-41d1-85d7-35c352553be2" "5b010e98-b48c-4ce1-b58e-2e07bab9d6ed"))
    (var-set start u919100)
    (var-set end u919102)
    (map-set results {id: "89d3dff8-44ed-41d1-85d7-35c352553be2"} {count: u0, name: u"Choice%201", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "5b010e98-b48c-4ce1-b58e-2e07bab9d6ed"} {count: u0, name: u"Choice%202", locked-stx: u0, unlocked-stx: u0})