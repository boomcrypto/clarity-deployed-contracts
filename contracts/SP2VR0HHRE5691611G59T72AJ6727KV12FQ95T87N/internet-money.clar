...
;; DEFINE METADATA
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://gaia.hiro.so/hub/1KfAaVYS167WaoLEDdYSwTCxNq2EDyMcot/internet-money-2-decimals.json"))
...
(begin
    ...
    (try! (ft-mint? MON MAXSUPPLY (var-get contract-owner)))
)
