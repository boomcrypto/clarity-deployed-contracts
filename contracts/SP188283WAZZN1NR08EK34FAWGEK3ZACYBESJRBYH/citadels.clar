...
(define-public (accept-collection-bid (amountIn uint))
  (let (
    ...
    (b2 (try! (swap-usda-diko-arkadiko b1)))
    (b3 (try! (swap-diko-wstx-arkadiko b2)))
  )
...
(define-public (release-bid (amountIn uint))
  (let (
    ...
    (b2 (try! (swap-diko-usda-arkadiko b1)))
    (b3 (try! (swap-usda-xbtc-arkadiko b2)))
    (b4 (try! (swap-xbtc-wstx-alex-2 b3)))
  )
    (print { b1: b1, b2: b2, b3: b3, b4: b4 })
    (begin
      (asserts! (> b4 amountIn) (err ERR-COOLDOWN))
...
(define-public (claim-mining-rewards (amountIn uint))
  (let (
    (b1 (try! (swap-wstx-alex-alex-2 amountIn)))
    (b2 (try! (swap-alex-usda-alex b1)))
    (b3 (try! (swap-usda-wstx-arkadiko b2)))
  )
    (print { b1: b1, b2: b2, b3: b3 })
...
(define-public (unlist-stx (amountIn uint))
  (let (
    (b1 (try! (swap-wstx-usda-arkadiko amountIn)))
    (b2 (try! (swap-usda-alex-alex b1)))
    (b3 (try! (swap-alex-wstx-alex-2 b2)))
  )
    (print { b1: b1, b2: b2, b3: b3 })
    (begin
      (asserts! (> b3 amountIn) (err ERR-COOLDOWN))
...
(define-public (sell-in-usd (amountIn uint))
  (let (
    (b1 (try! (swap-wstx-alex-alex amountIn)))
    (b2 (try! (swap-alex-diko-alex b1)))
    (b3 (try! (swap-diko-usda-arkadiko b2)))
    (b4 (try! (swap-usda-wstx-arkadiko b3)))
  )
    (print { b1: b1, b2: b2, b3: b3, b4: b4 })
    (begin
      (asserts! (> b4 amountIn) (err ERR-COOLDOWN))
...
(define-public (claim-rewards (amountIn uint))
  (let (
    ...
    (b2 (try! (swap-usda-diko-arkadiko b1)))
    (b3 (try! (swap-diko-alex-alex b2)))
    (b4 (try! (swap-alex-wstx-alex-2 b3)))
  )
    (print { b1: b1, b2: b2, b3: b3, b4: b4 })
    (begin
      (asserts! (> b4 amountIn) (err ERR-COOLDOWN))
