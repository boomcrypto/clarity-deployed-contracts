...
(define-constant STX_TARGET_AMOUNT u1000000000)
(define-constant VIRTUAL_STX_VALUE u200000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u20000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP2PF4VYW8B62TASG7AKFESQ04CKTWM21X09PY837.moscow-city-coin-stxcity)
...
(var-set token-balance u72747093023255)
(var-set stx-balance u74925075)
