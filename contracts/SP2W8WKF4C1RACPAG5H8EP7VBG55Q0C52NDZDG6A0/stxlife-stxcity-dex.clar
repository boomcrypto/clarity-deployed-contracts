...
(define-constant allow-token 'SP2W8WKF4C1RACPAG5H8EP7VBG55Q0C52NDZDG6A0.stxlife-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u99995029821073558)
    (var-set stx-balance u4995005)
