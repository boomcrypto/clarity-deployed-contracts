...
(define-data-var artist-address principal 'SP1NYHBF7GNF9CE7P5KB27VZTHK3V8XANTMXNHD2)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmdvZjEcTDuBdWpwNKeiN3n2TLtaBwgfJ2LJYypSNziZgF/json/")
...
(map-set mint-passes 'SP1NYHBF7GNF9CE7P5KB27VZTHK3V8XANTMXNHD2 u3)
(map-set mint-passes 'SP1RW8644DAFE03DTPS4MMJ83TCVBCBEMVAQG62T6 u2)
...
(map-set mint-passes 'SP1YVF9EWSK6HM0JZR4B3KCM7V3NKVE18VVNFSQV5 u3)
(map-set mint-passes 'SP24X692XB6CZB0Z70ZGWRNCY22PZ5FED3P9KBGS8 u2)
...
(map-set mint-passes 'SP28YEDDDBM8GT23KVS9HEEGVRD4X35H542K100SC u4)
...
(map-set mint-passes 'SP2PBW5WPNJ88BZVNDVP4KCTN9HJGNNR1BQA6G1W6 u13)
(map-set mint-passes 'SP2RQ9MEEQA2E3DZ7DQY24D3F1XESVR4721PZZ63Q u1)
(map-set mint-passes 'SP2S1JA1G39BAS9C6W48P7TX01ABJCDJ8ETR32T4J u2)
(map-set mint-passes 'SP2X5KYYXWFCCH30FHQSAP1XVVAVXFT8P8FS44VRY u2)
(map-set mint-passes 'SP30HDQ1WGZRD1YTBRPPPYZHKQJ7E8CVYZCTHXKVX u9)
(map-set mint-passes 'SP3866CAJYT8HXF36JT0B24DD6WPFSSEWA9CSA1W9 u2)
...
(map-set mint-passes 'SP3ZCZ0CDR5EH8XYYXQ9H6P5G43N6YYCYYYX0BTMJ u4)
(map-set mint-passes 'SP3ZMEFW7VH796ZQAH1JMAJT4WC4VPEZZFB6W5CAD u8)
(map-set mint-passes 'SP4QA0NHP03T3T9GJKR5KEA7VQ2KNSXRK5JC74NG u1)
(map-set mint-passes 'SP6VV2AFXM7ZMT5V3ZAE8M6JXK9EA5N1GPFHJC4M u2)
...
(map-set mint-passes 'SPCRDMAJ0RJYPQ3BMNN9VV01BFSCG1SQ1WJZB558 u2)
