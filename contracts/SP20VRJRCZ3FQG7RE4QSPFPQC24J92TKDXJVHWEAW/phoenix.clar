...
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://charisma.rocks/api/v0/metadata/SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.phoenix"))
...
(begin
    ...
    (try! (add-liquidity u180000))
    ;; Transfer additional token B to achieve desired ratio
    (try! (contract-call? 'SP20VRJRCZ3FQG7RE4QSPFPQC24J92TKDXJVHWEAW.charisma-phoenix-stxcity transfer u999999820000 tx-sender CONTRACT none)))