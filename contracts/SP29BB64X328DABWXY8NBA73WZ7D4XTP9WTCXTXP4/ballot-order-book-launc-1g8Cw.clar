    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Order book launch")
    (var-set description u"To run the order book and the bridge")
    (var-set voting-system "fptp")
    (var-set options (list "7560d678-88e9-4f37-ab10-11d48a485f4f" "70e3a82f-01a5-46ec-958e-f3bbbef3aaf7" "c6c2dc91-6b6e-424d-932d-dc9cd76966cd"))
    (var-set start u100533)
    (var-set end u101253)
    (map-set results {id: "7560d678-88e9-4f37-ab10-11d48a485f4f"} {count: u0, name: u"Yes"}) (map-set results {id: "70e3a82f-01a5-46ec-958e-f3bbbef3aaf7"} {count: u0, name: u"No "}) (map-set results {id: "c6c2dc91-6b6e-424d-932d-dc9cd76966cd"} {count: u0, name: u"abstained"})