...
(define-constant token-supply u88888888888000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP1AFDC75ZX26CXB4JXPG7PQVT8HBF022GYBV1WWY.sendor-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u27555830838305360)
    (var-set stx-balance u222577423)
