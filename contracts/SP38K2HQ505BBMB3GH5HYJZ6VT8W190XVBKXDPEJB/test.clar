...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/Qmdz3i7hf2KnyqUqBoGAMnVuAZ9RdEMViJdnzwosHtL5iz/json/")
...
(define-private (mint-for-many-iter (recipient principal) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      ...
      (unwrap! (nft-transfer? test next-id tx-sender recipient) next-id)
