...
(define-non-fungible-token metaverse-3d-homes uint)
...
(define-data-var artist-address principal 'SP1RF59E004ZR94R9BS9H8SS3315DXTQHYK7GRB7R)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmWfgMF1M897v5TGU7PUTWGBx2XRC67ichmE62LfUJv8Fg/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? metaverse-3d-homes next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? metaverse-3d-homes token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? metaverse-3d-homes token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? metaverse-3d-homes token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? metaverse-3d-homes id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? metaverse-3d-homes id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? metaverse-3d-homes id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u33317)
...
;; Alt Minting Default
(define-data-var total-price-usda uint u8000000)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? metaverse-3d-homes (+ last-nft-id u0) 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07))
      (map-set token-count 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07 (+ (get-balance 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07) u1))
      (try! (nft-mint? metaverse-3d-homes (+ last-nft-id u1) 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07))
      (map-set token-count 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07 (+ (get-balance 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07) u1))
      (try! (nft-mint? metaverse-3d-homes (+ last-nft-id u2) 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07))
      (map-set token-count 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07 (+ (get-balance 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07) u1))
      (try! (nft-mint? metaverse-3d-homes (+ last-nft-id u3) 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07))
      (map-set token-count 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07 (+ (get-balance 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07) u1))
      (try! (nft-mint? metaverse-3d-homes (+ last-nft-id u4) 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07))
      (map-set token-count 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07 (+ (get-balance 'SP2B4SZ37395Q85JS0SEGPFC207FFJJX0SDNTSQ07) u1))
      (try! (nft-mint? metaverse-3d-homes (+ last-nft-id u5) 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ))
      (map-set token-count 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ (+ (get-balance 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ) u1))
      (try! (nft-mint? metaverse-3d-homes (+ last-nft-id u6) 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ))
      (map-set token-count 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ (+ (get-balance 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ) u1))
      (try! (nft-mint? metaverse-3d-homes (+ last-nft-id u7) 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ))
      (map-set token-count 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ (+ (get-balance 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ) u1))
      (try! (nft-mint? metaverse-3d-homes (+ last-nft-id u8) 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ))
      (map-set token-count 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ (+ (get-balance 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ) u1))
      (try! (nft-mint? metaverse-3d-homes (+ last-nft-id u9) 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ))
      (map-set token-count 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ (+ (get-balance 'SP20FCTZJAM1T7V7326JK3CNVCM5FBJVVYFKJHFKZ) u1))
