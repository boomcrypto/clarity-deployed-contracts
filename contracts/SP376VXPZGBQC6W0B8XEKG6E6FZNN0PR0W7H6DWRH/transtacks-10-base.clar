...
(define-public (transfer-mix-many-10-0
	...
	(begin
		 ...
		 (unwrap-panic (contract-call? .transtacks-dope transfer-ft-many recipients-for-ft-6 token-contract-6))
		 (unwrap-panic (contract-call? .transtacks-dope transfer-ft-many recipients-for-ft-7 token-contract-7))
		 (unwrap-panic (contract-call? .transtacks-dope transfer-ft-many recipients-for-ft-8 token-contract-8))
		 (unwrap-panic (contract-call? .transtacks-dope transfer-ft-many recipients-for-ft-9 token-contract-9))
		 (contract-call? .transtacks-dope transfer-ft-many recipients-for-ft-10 token-contract-10)
	)
)
...
(define-public (transfer-mix-many-10-1
	...
	(begin
		 ...
		 (unwrap-panic (contract-call? .transtacks-dope transfer-ft-many recipients-for-ft-8 token-contract-8))
		 (unwrap-panic (contract-call? .transtacks-dope transfer-ft-many recipients-for-ft-9 token-contract-9))
		 (unwrap-panic (contract-call? .transtacks-dope transfer-ft-many recipients-for-ft-10 token-contract-10))
