;; dawn-of-the-planet-of-checks
;; contractType: editions

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token dawn-of-the-planet-of-checks uint)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmcJpFa3Yte4BAkKCbT78meATiXiRfm7Km3rAPMmGqkU6X/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (or (is-eq (var-get mint-limit) u0) (<= next-id (var-get mint-limit)))
    (begin
      (unwrap! (nft-mint? dawn-of-the-planet-of-checks next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? dawn-of-the-planet-of-checks token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? dawn-of-the-planet-of-checks token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? dawn-of-the-planet-of-checks token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? dawn-of-the-planet-of-checks id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? dawn-of-the-planet-of-checks id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? dawn-of-the-planet-of-checks id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u32814)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? dawn-of-the-planet-of-checks (+ last-nft-id u0) 'SP10H2FHJJWFA1SW3E5AKGJ3EW2S544G103MZNHTM))
      (map-set token-count 'SP10H2FHJJWFA1SW3E5AKGJ3EW2S544G103MZNHTM (+ (get-balance 'SP10H2FHJJWFA1SW3E5AKGJ3EW2S544G103MZNHTM) u1))
      (try! (nft-mint? dawn-of-the-planet-of-checks (+ last-nft-id u1) 'SP2TW1D8YF5CE0NDP5VCR5NMTPHQ4PQR1KBB4NQ5Q))
      (map-set token-count 'SP2TW1D8YF5CE0NDP5VCR5NMTPHQ4PQR1KBB4NQ5Q (+ (get-balance 'SP2TW1D8YF5CE0NDP5VCR5NMTPHQ4PQR1KBB4NQ5Q) u1))
      (try! (nft-mint? dawn-of-the-planet-of-checks (+ last-nft-id u2) 'SP2EMZSA1CQQCGJEQ9JSDBWBV0NFDJ59EH5P9E56V))
      (map-set token-count 'SP2EMZSA1CQQCGJEQ9JSDBWBV0NFDJ59EH5P9E56V (+ (get-balance 'SP2EMZSA1CQQCGJEQ9JSDBWBV0NFDJ59EH5P9E56V) u1))
      (try! (nft-mint? dawn-of-the-planet-of-checks (+ last-nft-id u3) 'SPQ2HN9TYF8ZYY9D3G45NGYA9GHA6QZHQ8AXF5QM))
      (map-set token-count 'SPQ2HN9TYF8ZYY9D3G45NGYA9GHA6QZHQ8AXF5QM (+ (get-balance 'SPQ2HN9TYF8ZYY9D3G45NGYA9GHA6QZHQ8AXF5QM) u1))
      (try! (nft-mint? dawn-of-the-planet-of-checks (+ last-nft-id u4) 'SP3EB7YHV5NERS2HMCGSGKNMN0BEH52W9H7YE4T9C))
      (map-set token-count 'SP3EB7YHV5NERS2HMCGSGKNMN0BEH52W9H7YE4T9C (+ (get-balance 'SP3EB7YHV5NERS2HMCGSGKNMN0BEH52W9H7YE4T9C) u1))
      (try! (nft-mint? dawn-of-the-planet-of-checks (+ last-nft-id u5) 'SP2XJJC2T3MGRYQKPJQBBNQJVCV2HHHQ0P32KRNXH))
      (map-set token-count 'SP2XJJC2T3MGRYQKPJQBBNQJVCV2HHHQ0P32KRNXH (+ (get-balance 'SP2XJJC2T3MGRYQKPJQBBNQJVCV2HHHQ0P32KRNXH) u1))
      (try! (nft-mint? dawn-of-the-planet-of-checks (+ last-nft-id u6) 'SP1WKB47VCHNQXA0EMKXQZ41X3KXA79R7VDK54578))
      (map-set token-count 'SP1WKB47VCHNQXA0EMKXQZ41X3KXA79R7VDK54578 (+ (get-balance 'SP1WKB47VCHNQXA0EMKXQZ41X3KXA79R7VDK54578) u1))
      (try! (nft-mint? dawn-of-the-planet-of-checks (+ last-nft-id u7) 'SP5Q4A3AZ4NYE1PF1CM8C38MH4WPB65281DRTXMN))
      (map-set token-count 'SP5Q4A3AZ4NYE1PF1CM8C38MH4WPB65281DRTXMN (+ (get-balance 'SP5Q4A3AZ4NYE1PF1CM8C38MH4WPB65281DRTXMN) u1))
      (try! (nft-mint? dawn-of-the-planet-of-checks (+ last-nft-id u8) 'SP20RWYAAF6QNSFWGYJXEMR41X22QP9M7YAY1C7J9))
      (map-set token-count 'SP20RWYAAF6QNSFWGYJXEMR41X22QP9M7YAY1C7J9 (+ (get-balance 'SP20RWYAAF6QNSFWGYJXEMR41X22QP9M7YAY1C7J9) u1))
      (try! (nft-mint? dawn-of-the-planet-of-checks (+ last-nft-id u9) 'SP20RWYAAF6QNSFWGYJXEMR41X22QP9M7YAY1C7J9))
      (map-set token-count 'SP20RWYAAF6QNSFWGYJXEMR41X22QP9M7YAY1C7J9 (+ (get-balance 'SP20RWYAAF6QNSFWGYJXEMR41X22QP9M7YAY1C7J9) u1))
