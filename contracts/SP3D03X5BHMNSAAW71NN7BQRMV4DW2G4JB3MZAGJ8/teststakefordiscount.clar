    ...
    (let 
        ...
        (asserts! (is-none staker-map) ERR-SENDER-STAKED-BEFORE)
                ...
                (map-set staked-by-principal tx-sender
                    {
                        collection-badger: 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.testbadgers,
                        staked-badger: badger-list,

                        collection-baby: 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.testbabybadgers,
...
(define-private (baby-badger-ownership-proof (item uint))
    (let
        ( 
            (baby-owner (unwrap! (contract-call? 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.testbabybadgers get-owner item) ERR-UNWRAP))
        )
...
(define-private (badger-ownership-proof (item uint))
    (let
        ( 
            (badger-owner (unwrap! (contract-call? 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.testbadgers get-owner item) ERR-UNWRAP))
        )
...
(define-private (baby-badger-transfer (item uint))
    (ok (unwrap! (contract-call? 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.testbabybadgers transfer item tx-sender 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.staking) ERR-UNWRAP))
)

(define-private (badger-transfer (item uint))
    (ok (unwrap! (contract-call? 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.testbadgers transfer item tx-sender 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.staking) ERR-UNWRAP))
)
...
(define-private (baby-badger-transfer-from-contract (item uint))
    (ok (unwrap! (as-contract (contract-call? 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.testbabybadgers transfer item 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.staking (var-get owner))) ERR-UNWRAP))
)

(define-private (badger-transfer-from-contract (item uint))
    (ok (unwrap! (as-contract (contract-call? 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.testbadgers transfer item 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.staking (var-get owner))) ERR-UNWRAP))
)
