...
;; This first release, with a total of 8000 Equipment(s), maps the initial collection size of lost-shipment(s)
...
(define-public (mint-equipment (lost-shipment-id uint))
  (let
    ...
    (asserts! (is-eq tx-sender (unwrap-panic (unwrap-panic (contract-call? 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.p-i-l-s-s-test get-owner lost-shipment-id)))) ERR-GET-OWNER-FAILED)

    ;; burn lost-shipments NFTs
    (try! (contract-call? 'SP3D03X5BHMNSAAW71NN7BQRMV4DW2G4JB3MZAGJ8.p-i-l-s-s-test burn-lost-shipment lost-shipment-id))
