...
(define-public (mock-handout-referral-reward 
  ...
  (begin
    ...
    (let (
      (some-ref-addr (unwrap! (contract-call? .specific-scarlet-badger get-referral-address referral-code) (err ERR-REFERRAL-NOT-FOUND)))
      ...
      (print { action: "handout-referral-reward", code: referral-code, address: some-ref-addr, reward: total-reward, mints: qty })
      (ok true))))
