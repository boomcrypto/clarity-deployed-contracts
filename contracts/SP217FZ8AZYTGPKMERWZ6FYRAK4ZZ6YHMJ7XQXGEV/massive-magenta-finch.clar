...
(define-public (spaghettipunk-club-claim-one-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-club u1 none))
    (ok true)))
...
(define-public (spaghettipunk-club-claim-two-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-club u2 none))
    (ok true)))
...
(define-public (spaghettipunk-club-claim-five-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-club u5 none))
    (ok true)))
...
(define-public (spaghettipunk-club-claim-ten-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-club u10 none))
    (ok true)))
...
(define-public (spaghettipunk-club-claim-fifteen-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-club u15 none))
    (ok true)))
...
(define-public (spaghettipunk-club-claim-twenty-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-club u20 none))
    (ok true)))
...
(define-public (spaghettipunk-club-claim-twentyfive-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-club u25 none))
    (ok true)))
...
(define-public (bitcoin-bears-claim-one-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-bears u1 none))
    (ok true)))
...
(define-public (bitcoin-bears-claim-two-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-bears u2 none))
    (ok true)))
...
(define-public (bitcoin-bears-claim-five-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-bears u5 none))
    (ok true)))
...
(define-public (bitcoin-bears-claim-ten-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-bears u10 none))
    (ok true)))
...
(define-public (bitcoin-bears-claim-fifteen-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-bears u15 none))
    (ok true)))
...
(define-public (bitcoin-bears-claim-twenty-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-bears u20 none))
    (ok true)))
...
(define-public (bitcoin-bears-claim-twentyfive-with-referral (ref-code (string-ascii 30)))
  (begin
    ...
    (try! (contract-call? .working-green-herring handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-bears u25 none))
    (ok true)))