;;Contract that enables the subscription of nfts in collection SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-club to gain spoints.
...
(define-constant collection-address 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-club)
;;maps
...
(define-data-var multipliers principal 'SP217FZ8AZYTGPKMERWZ6FYRAK4ZZ6YHMJ7XQXGEV.spaghettipunk-club-base-multipliers)
...
(define-public (collect (spc-id uint) (amount uint) (points <points-trait>))
  (let (
    ...
    (begin      
      (map-set subscription-per-address { address: tx-sender} {time: stacks-block-height, points-balance: (- to-collect amount), total-multiplier: total-multiplier })
