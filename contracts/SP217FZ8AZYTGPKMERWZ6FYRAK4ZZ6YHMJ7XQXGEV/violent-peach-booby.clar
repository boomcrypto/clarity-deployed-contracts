...
(define-public (spaghettipunk-club-claim-one-with-referral (ref-code (string-ascii 30)))
  (let (
    ...
    (spoint-reward (contract-call? .attractive-olive-hamster get-spoint-referral-bonus-reward))
    (mints u1)
    ...
    (if (> spoint-reward u0)
      (begin
        (try! (contract-call? .attractive-olive-hamster handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-club mints (some (+ last-id u1))))
        (print { action: "claim-with-referral", code: ref-code, address: some-ref-addr, mints: mints, reward: reward, spoint-reward: spoint })
      )
      (begin
        (try! (contract-call? .attractive-olive-hamster handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.spaghettipunk-club mints none))
...
(define-public (bitcoin-bears-claim-one-with-referral (ref-code (string-ascii 30)))
  (let (
    ...
    (try! (contract-call? .attractive-olive-hamster handout-referral-reward ref-code 'SP1C2K603TGWJGKPT2Z3WWHA0ARM66D352385TTWH.bitcoin-bears mints none))
