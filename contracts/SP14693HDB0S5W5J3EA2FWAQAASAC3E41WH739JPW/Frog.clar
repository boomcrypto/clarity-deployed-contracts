...
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://gaia.hiro.so/hub/1JQNznqmHm8fmR5keiZKe9tCaruSBm6Bo1/mr-frog.json"))
...
(begin
  (try! (ft-mint? Frog u1000000000000 contract-owner))
)
