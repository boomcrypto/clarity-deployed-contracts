...
(define-private (dispatch (i (buff 2)) (amt-in uint))
  ...
  (if (< i 0x04a6) (contract-call? .fuck-kim-jong-un-16 dispatch i amt-in) 
  (if (< i 0x04ec) (contract-call? .fuck-kim-jong-un-17 dispatch i amt-in) 
  (if (< i 0x0532) (contract-call? .fuck-kim-jong-un-18 dispatch i amt-in) 
  (if (< i 0x0578) (contract-call? .fuck-kim-jong-un-19 dispatch i amt-in) 
  (if (< i 0x05be) (contract-call? .fuck-kim-jong-un-20 dispatch i amt-in) 
  (if (< i 0x0604) (contract-call? .fuck-kim-jong-un-21 dispatch i amt-in) 
  (if (< i 0x064a) (contract-call? .fuck-kim-jong-un-22 dispatch i amt-in) 
  (if (< i 0x0690) (contract-call? .fuck-kim-jong-un-23 dispatch i amt-in) 
  (if (< i 0x06d6) (contract-call? .fuck-kim-jong-un-24 dispatch i amt-in) 
  (if (< i 0x071c) (contract-call? .fuck-kim-jong-un-25 dispatch i amt-in) 
  (if (< i 0x0762) (contract-call? .fuck-kim-jong-un-26 dispatch i amt-in) 
  (if (< i 0x07a8) (contract-call? .fuck-kim-jong-un-27 dispatch i amt-in) 
