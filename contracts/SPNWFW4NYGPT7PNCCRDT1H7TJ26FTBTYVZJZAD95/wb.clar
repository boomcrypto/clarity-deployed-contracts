...
(define-data-var contract-owner principal 'SPNWFW4NYGPT7PNCCRDT1H7TJ26FTBTYVZJZAD95)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? B (/ (* MAX u70) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.b-faktory-dex))
    (try! (ft-mint? B (/ (* MAX u20) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.b-pre-faktory))
    (try! (ft-mint? B (/ (* MAX u10) u100) 'SPNWFW4NYGPT7PNCCRDT1H7TJ26FTBTYVZJZAD95))
    (print { 
