...
(define-private (refill-bucket-amount (last-updated-at uint) (time-now uint) (max-bucket uint) (current-bucket uint) (inflow uint))
  (let (
      (refill-window (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.withdrawal-caps-v1 get-refill-time-window))
...
(define-private (decay-bucket-amount (last-updated-at uint) (time-now uint) (max-bucket uint) (current-bucket uint) (inflow uint))
  (let (
      ...
      (decay-window (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.withdrawal-caps-v1 get-decay-time-window))
...
(define-read-only (get-lp-bucket (inflow uint))
  (let
    (
      ...
      (last-ts (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.withdrawal-caps-v1 get-last-lp-bucket-update))
      ...
      (max-lp-bucket (/ (* total-liquidity (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.withdrawal-caps-v1 get-lp-cap-factor)) SCALING-FACTOR))
      (current-bucket (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.withdrawal-caps-v1 get-lp-bucket))
...
(define-read-only (get-debt-bucket (inflow uint))
  (let
    (
      (time-now (get-time-now))
      (last-ts (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.withdrawal-caps-v1 get-last-debt-bucket-update))
      (total-liquidity (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.state-v1 get-borrowable-balance))
      (max-debt-bucket (/ (* total-liquidity (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.withdrawal-caps-v1 get-debt-cap-factor)) SCALING-FACTOR))
      (current-bucket (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.withdrawal-caps-v1 get-debt-bucket))
...
(define-read-only (get-collateral-bucket (inflow uint))
  (let
    (
      ...
      (last-ts (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.withdrawal-caps-v1 get-last-collateral-bucket-update collateral-token))
      ...
      (max-collateral-bucket (/ (* total-liquidity (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.withdrawal-caps-v1 get-collateral-cap-factor collateral-token)) SCALING-FACTOR))
      (current-bucket (contract-call? 'SP3BJR4P3W2Y9G22HA595Z59VHBC9EQYRFWSKG743.withdrawal-caps-v1 get-collateral-bucket collateral-token))
