...
(define-public (log-like-message 
  ...
  (let 
    ...
    (print 
      {
        event: "like-message", author-principal: author-principal,  like-total: like-total, liked-txid: liked-txid,
...
(define-public (log-dislike-message 
  ...
  (let 
    ...
    (print 
      {
        event: "dislike-message", author-principal: author-principal, dislike-total: dislike-total, disliked-txid: disliked-txid,
