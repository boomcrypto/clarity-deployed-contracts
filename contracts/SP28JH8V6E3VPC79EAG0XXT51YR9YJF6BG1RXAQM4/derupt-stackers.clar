...
;; Log Stack
(define-public (log-stack (stacker principal) (cityName (string-ascii 10)) (dislike-amount uint) (lockPeriod uint))
  (let
    ...
    (print { event: "stack", stacker: stacker, cityName: cityName, dislike-total: dislike-amount })
    (ok true)
  )
)
