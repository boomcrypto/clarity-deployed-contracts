...
(define-public (C-A-st (dx uint) (min uint) (owner-address principal) (prev-owner (optional principal))) 
  (begin
    ...
    (let
      (
        ...
        (b2 (unwrap-panic (redeem owner-address b1 prev-owner)))
        (received (get collateral-received b2)) 
      )
