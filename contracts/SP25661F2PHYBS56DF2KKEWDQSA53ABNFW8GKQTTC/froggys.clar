...
;;Our community will be a blend of the daring and the dreamy, where risk-taking meets reflection, and innovation meets introspection. Let's embark on ;;this journey together, with the wisdom of The Little Prince guiding our Degen spirits.
...
(define-data-var artist-address principal 'SP25661F2PHYBS56DF2KKEWDQSA53ABNFW8GKQTTC)
...
(define-data-var froggy-agent principal 'SP25661F2PHYBS56DF2KKEWDQSA53ABNFW8GKQTTC)
...
(define-public (get-contract-owner (contract-owner principal))
  (let
    (
      (con-tract (as-contract contract-owner))
...
;; Life was created so that we can hop, hop.