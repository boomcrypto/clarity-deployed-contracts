...
(define-public (is-dao-or-extension)
  (ok (asserts!
    (or
      (is-eq tx-sender 'SP22W9VHJZ0AB4P5HX6K4C3F86TAA02WE0B6GXZKH.relieved-white-cephalopod)
      (contract-call? 'SP22W9VHJZ0AB4P5HX6K4C3F86TAA02WE0B6GXZKH.relieved-white-cephalopod is-extension contract-caller))
    ERR_UNAUTHORIZED
  ))
)
...
(define-public (direct-execute (proposal <proposal-trait>))
  (let
    ...
    (and (>= signals (var-get signalsRequired))
      (try! (contract-call? 'SP22W9VHJZ0AB4P5HX6K4C3F86TAA02WE0B6GXZKH.relieved-white-cephalopod execute proposal tx-sender))
    )
