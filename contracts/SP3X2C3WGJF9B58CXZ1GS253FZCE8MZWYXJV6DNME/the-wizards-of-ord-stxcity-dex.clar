...
(define-constant token-supply u33330000000000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP3X2C3WGJF9B58CXZ1GS253FZCE8MZWYXJV6DNME.the-wizards-of-ord-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u16665000000000000)
    (var-set stx-balance u400000000)
