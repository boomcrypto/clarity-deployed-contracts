...
;; Internal variables
(define-data-var mint-limit uint u62)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmcUQ97qiKUABjjtwxt2k8KVWvgKyJV8L49Gwmo7ZANvat/json/")
...
(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? test token-id) false)))
