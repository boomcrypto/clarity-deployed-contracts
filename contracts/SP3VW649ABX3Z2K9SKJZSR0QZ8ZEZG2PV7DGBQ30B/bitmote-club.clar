...
(define-non-fungible-token bitmote-club uint)
...
(define-data-var artist-address principal 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/Qmbm6iJ34fbx7jxvHdnQL2YbzKgWoUs6rWewTcb8vtRMzd/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? bitmote-club next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? bitmote-club token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? bitmote-club token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? bitmote-club token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? bitmote-club id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? bitmote-club id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? bitmote-club id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u22853)
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u14960000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u11193000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u41000000)
...
;; Alt Minting Default
(define-data-var total-price-slime uint u526000000)
...
;; Alt Minting Default
(define-data-var total-price-alex uint u5500000000)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? bitmote-club (+ last-nft-id u0) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u1) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u2) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u3) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u4) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u5) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u6) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u7) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u8) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u9) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u10) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u11) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u12) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u13) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u14) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u15) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u16) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u17) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u18) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u19) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u20) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u21) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u22) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u23) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u24) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u25) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u26) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u27) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u28) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u29) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u30) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u31) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u32) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u33) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u34) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u35) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u36) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u37) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u38) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u39) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u40) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u41) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u42) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u43) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u44) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u45) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u46) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u47) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u48) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u49) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u50) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u51) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u52) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u53) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u54) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u55) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u56) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u57) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u58) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u59) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u60) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u61) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u62) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u63) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u64) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u65) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u66) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u67) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u68) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u69) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u70) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u71) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u72) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u73) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u74) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u75) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u76) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u77) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u78) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u79) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u80) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u81) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u82) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u83) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u84) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u85) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u86) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u87) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u88) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u89) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u90) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u91) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u92) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u93) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u94) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u95) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u96) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u97) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
      (try! (nft-mint? bitmote-club (+ last-nft-id u98) 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B))
      (map-set token-count 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B (+ (get-balance 'SP3VW649ABX3Z2K9SKJZSR0QZ8ZEZG2PV7DGBQ30B) u1))
