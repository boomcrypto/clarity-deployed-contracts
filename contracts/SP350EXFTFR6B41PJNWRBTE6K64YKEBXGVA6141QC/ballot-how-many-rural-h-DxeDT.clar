    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"How%20many%20rural%20hospitals%20in%20the%20US%20will%20close%20in%20the%20fourth%20quarter%20of%202026%3F")
    ...
    (var-set options (list "adeefed6-e27e-4959-b565-b5a83daa478b" "b9e93414-2767-4e1a-b80c-90d21865ba28" "fcb2b0ca-bebe-4cf8-89ec-5d5905010c9d" "fc1993b5-1850-4554-b6d8-a8faca63b009"))
    (var-set start u918746)
    (var-set end u969578)
    (map-set results {id: "adeefed6-e27e-4959-b565-b5a83daa478b"} {count: u0, name: u"0"}) (map-set results {id: "b9e93414-2767-4e1a-b80c-90d21865ba28"} {count: u0, name: u"1-4"}) (map-set results {id: "fcb2b0ca-bebe-4cf8-89ec-5d5905010c9d"} {count: u0, name: u"5-10"}) (map-set results {id: "fc1993b5-1850-4554-b6d8-a8faca63b009"} {count: u0, name: u"%3E10"})