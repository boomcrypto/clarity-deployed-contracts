    ...
    (var-set description u"This%20forecast%20will%20be%20resolved%20using%20Grok%2C%20the%20UNC%20Sheps%20Center%20for%20Health%20Service%20Research%2C%20KFF%2C%20and%20other%20reputable%20institutions.%20Visit%20Guessors.xyz%20for%20details")
    (var-set voting-system "fptp")
    (var-set options (list "3614dec5-d9a7-4380-bf0d-055749b7ade3" "5978353f-f7d3-413a-a7f6-4ebd6308751a" "0f0be61a-985c-41c3-b024-2e755f1e06bc" "111d604b-725c-42c6-9184-07c4d749bbcc"))
    (var-set start u215605)
    (var-set end u266874)
    (map-set results {id: "3614dec5-d9a7-4380-bf0d-055749b7ade3"} {count: u0, name: u"0"}) (map-set results {id: "5978353f-f7d3-413a-a7f6-4ebd6308751a"} {count: u0, name: u"1-4"}) (map-set results {id: "0f0be61a-985c-41c3-b024-2e755f1e06bc"} {count: u0, name: u"5-10"}) (map-set results {id: "111d604b-725c-42c6-9184-07c4d749bbcc"} {count: u0, name: u"%3E10"})