    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"How%20many%20rural%20hospitals%20in%20the%20US%20will%20close%20in%20the%20second%20quarter%20of%202026%3F")
    (var-set description u"%3Cp%3EThis%20forecast%20will%20be%20resolved%20using%20Grok%2C%20the%20UNC%20Sheps%20Center%20for%20Health%20Service%20Research%2C%20KFF%2C%20and%20other%20reputable%20institutions.%20Visit%20Guessors.xyz%20for%20details.%3C%2Fp%3E")
    (var-set voting-system "fptp")
    (var-set options (list "20416944-4711-4ccd-9d04-0d650bbcd817" "8d9579a2-2f98-4ecc-9230-27959fe91b84" "ba3f42bc-7d48-4ad4-8f20-3ed969c19a9f" "b9e20a97-7970-409a-909b-4f33f376932b"))
    (var-set start u918745)
    (var-set end u969577)
    (map-set results {id: "20416944-4711-4ccd-9d04-0d650bbcd817"} {count: u0, name: u"0"}) (map-set results {id: "8d9579a2-2f98-4ecc-9230-27959fe91b84"} {count: u0, name: u"1-4"}) (map-set results {id: "ba3f42bc-7d48-4ad4-8f20-3ed969c19a9f"} {count: u0, name: u"5-10"}) (map-set results {id: "b9e20a97-7970-409a-909b-4f33f376932b"} {count: u0, name: u"%3E10"})