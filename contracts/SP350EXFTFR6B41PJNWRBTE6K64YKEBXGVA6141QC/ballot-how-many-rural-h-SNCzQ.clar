    ...
    (var-set description u"This%20forecast%20will%20be%20resolved%20using%20Grok%2C%20the%20UNC%20Sheps%20Center%20for%20Health%20Service%20Research%2C%20KFF%2C%20and%20other%20reputable%20institutions.%0AVisit%20Guessors.xyz%20for%20details.")
    (var-set voting-system "fptp")
    (var-set options (list "5ef53ab3-8d3b-4ab7-b44e-60a5fcde6417" "3cabc37f-c22f-46fa-b8bb-931890ed3bf3" "b6c33d49-3eff-49e8-97c2-90caed8f922e" "81782027-561f-4a07-a713-f1c4df69f22e"))
    (var-set start u215610)
    (var-set end u266874)
    (map-set results {id: "5ef53ab3-8d3b-4ab7-b44e-60a5fcde6417"} {count: u0, name: u"0"}) (map-set results {id: "3cabc37f-c22f-46fa-b8bb-931890ed3bf3"} {count: u0, name: u"1-4"}) (map-set results {id: "b6c33d49-3eff-49e8-97c2-90caed8f922e"} {count: u0, name: u"5-10"}) (map-set results {id: "81782027-561f-4a07-a713-f1c4df69f22e"} {count: u0, name: u"%3E10"})