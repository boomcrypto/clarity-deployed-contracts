    ...
    (var-set description u"%3Cp%3EJust%20a%20test%3C%2Fp%3E")
    (var-set voting-system "fptp")
    (var-set options (list "bf9cc03d-4922-473f-a38f-b5aa4bf90b8f" "9cd64dc7-3f06-43fe-b1bc-d19bf03c60ea"))
    (var-set start u918743)
    (var-set end u918770)
    (map-set results {id: "bf9cc03d-4922-473f-a38f-b5aa4bf90b8f"} {count: u0, name: u"Choice%201"}) (map-set results {id: "9cd64dc7-3f06-43fe-b1bc-d19bf03c60ea"} {count: u0, name: u"Choice%202"})