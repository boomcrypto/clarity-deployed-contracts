    ...
    (var-set description u"%3Cp%3EJust%20a%20test%202%3C%2Fp%3E")
    (var-set voting-system "fptp")
    (var-set options (list "e5a44dce-3994-4290-b297-9a29ff03d6a7" "905c6310-105f-4028-af21-71781083ebd0"))
    (var-set start u918743)
    (var-set end u918770)
    (map-set results {id: "e5a44dce-3994-4290-b297-9a29ff03d6a7"} {count: u0, name: u"Choice%201"}) (map-set results {id: "905c6310-105f-4028-af21-71781083ebd0"} {count: u0, name: u"Choice%202"})