;; ordinal-pokymons-gen-1
;; contractType: public

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token ordinal-pokymons-gen-1 uint)
...
(define-data-var artist-address principal 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmXD6FJrc5UWUDwuK1fUNSLCzp2j3krtnWuxDfY4Y766w4/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? ordinal-pokymons-gen-1 next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? ordinal-pokymons-gen-1 token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? ordinal-pokymons-gen-1 token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? ordinal-pokymons-gen-1 token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? ordinal-pokymons-gen-1 id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? ordinal-pokymons-gen-1 id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? ordinal-pokymons-gen-1 id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u12940)
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u12278000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u10593000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u85000000)
...
;; Alt Minting Default
(define-data-var total-price-slime uint u802000000)
...
;; Alt Minting Default
(define-data-var total-price-alex uint u5800000000)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u0) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u1) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u2) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u3) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u4) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u5) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u6) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u7) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u8) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u9) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u10) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u11) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u12) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u13) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u14) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u15) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u16) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u17) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u18) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u19) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
      (try! (nft-mint? ordinal-pokymons-gen-1 (+ last-nft-id u20) 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM))
      (map-set token-count 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM (+ (get-balance 'SP75TAYG2AEE2ZRX8G4YZS97JQC16BJJS3XJR1DM) u1))
