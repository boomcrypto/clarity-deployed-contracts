...
(impl-trait .sip-010-trait-ft-standard-vpv-17.sip-010-trait)

;; BSD Protocol 
(impl-trait .bsd-trait-vpv-17.bsd-trait)
...
;; Owner
(define-data-var owner principal 'SMXMB6WZDTGHAGQ69J5S5RVHA70SWWPDWBEET01Z)
(define-data-var proposed-owner principal 'SMXMB6WZDTGHAGQ69J5S5RVHA70SWWPDWBEET01Z)
...
;; Initialization 
(map-set authorized-protocol-callers .registry-vpv-17 true)
(map-set authorized-protocol-callers .vault-vpv-17 true)
(map-set authorized-protocol-callers .redeem-vpv-17 true)
(map-set authorized-protocol-callers .stability-vpv-17 true)
(map-set authorized-protocol-callers .timelock-vpv-17 true)

;; Initialize the privileged principals list
(var-set privileged-principals-list (list .registry-vpv-17 .vault-vpv-17 .redeem-vpv-17 .stability-vpv-17 .timelock-vpv-17))