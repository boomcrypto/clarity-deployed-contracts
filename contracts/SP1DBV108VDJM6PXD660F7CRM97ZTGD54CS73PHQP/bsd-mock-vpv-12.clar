...
(impl-trait .sip-010-trait-ft-standard-vpv-12.sip-010-trait)

;; BSD Protocol 
(impl-trait .bsd-trait-vpv-12.bsd-trait)
...
;; Owner
(define-data-var owner principal 'SM2XE7M534J439HB2WFVMCVZD5XH9E5XX4DJ7J36Q)
(define-data-var proposed-owner principal 'SM2XE7M534J439HB2WFVMCVZD5XH9E5XX4DJ7J36Q)
...
;; Initialization 
(map-set authorized-protocol-callers .registry-vpv-12 true)
(map-set authorized-protocol-callers .vault-vpv-12 true)
(map-set authorized-protocol-callers .redeem-vpv-12 true)
(map-set authorized-protocol-callers .stability-vpv-12 true)
(map-set authorized-protocol-callers .timelock-vpv-12 true)

;; Initialize the privileged principals list
(var-set privileged-principals-list (list .registry-vpv-12 .vault-vpv-12 .redeem-vpv-12 .stability-vpv-12 .timelock-vpv-12))