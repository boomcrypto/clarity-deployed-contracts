...
(impl-trait .registry-trait-vpv-12.registry-trait)
...
(define-data-var protocol-fee-destination principal 'SM2XE7M534J439HB2WFVMCVZD5XH9E5XX4DJ7J36Q) ;; update
...
(define-public (set-processed-epoch (new-epoch uint))
    (let
        (
            (keeper (unwrap-panic (contract-call? .controller-vpv-12 is-keeper tx-sender)))
        )
...
(define-public (hot-pause)
    (begin
        (try! (contract-call? .controller-vpv-12 is-hot-pause-caller tx-sender))
