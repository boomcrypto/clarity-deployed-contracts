(impl-trait .registry-trait-vpv-17.registry-trait)
...
(define-public (set-processed-epoch (new-epoch uint))
  (let ((keeper (unwrap-panic (contract-call? .controller-vpv-17 is-keeper tx-sender))))
...
(define-public (set-protocol-state (new-state uint))
  (begin
    (try! (contract-call? .controller-vpv-17 is-admin tx-sender))
    (asserts!
      (or
...
(define-public (hot-pause)
  (begin
    (try! (contract-call? .controller-vpv-17 is-hot-pause-caller tx-sender))
