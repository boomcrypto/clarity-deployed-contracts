...
;; Initialization
(map-set privileged-protocol-principals .registry-vpv-16 true)
(map-set privileged-protocol-principals .vault-vpv-16 true)
(map-set privileged-protocol-principals .redeem-vpv-16 true)
(map-set privileged-protocol-principals .stability-vpv-16 true)
(map-set privileged-protocol-principals .timelock-vpv-16 true)

;; Initialize the privileged principals lists
(var-set privileged-protocol-principals-list (list .registry-vpv-16 .vault-vpv-16 .redeem-vpv-16 .stability-vpv-16 .timelock-vpv-16))
...
(var-set approved-contracts-list (list 
	'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.bsd-mock-vpv-16
	'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.sBTC-mock-vpv-16
	'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.oracle-vpv-16
	'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.registry-vpv-16
	'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.vault-vpv-16
	'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.stability-vpv-16
	'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.sorted-vaults-vpv-16
))
...
(map-set contracts
    { name: "bsd" }
    {
      ...
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.bsd-mock-vpv-16
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.sBTC-mock-vpv-16
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.oracle-vpv-16
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.registry-vpv-16
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.vault-vpv-16
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.stability-vpv-16
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.sorted-vaults-vpv-16
    }
)
