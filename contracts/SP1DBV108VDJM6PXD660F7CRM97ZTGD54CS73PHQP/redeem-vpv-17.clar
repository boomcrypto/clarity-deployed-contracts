...
;; Redeem Trait 
(impl-trait .redeem-trait-vpv-17.redeem-trait)
...
(define-public (redeem-wrapper (bsd-amount uint) (price-data (optional (buff 8192))) (bsd <bsd-trait>) (sbtc <sbtc-trait>) (oracle <oracle-trait>) (registry <registry-trait>) (vault <vault-trait>) (sorted-vaults <sorted-vaults-trait>))
    (let 
        (
            ...
            (valid-vault (try! (contract-call? .controller-vpv-17 check-approved-contract "vault" (contract-of vault))))
            (valid-registry (try! (contract-call? .controller-vpv-17 check-approved-contract "registry" (contract-of registry))))
            (valid-oracle (try! (contract-call? .controller-vpv-17 check-approved-contract "oracle" (contract-of oracle))))
