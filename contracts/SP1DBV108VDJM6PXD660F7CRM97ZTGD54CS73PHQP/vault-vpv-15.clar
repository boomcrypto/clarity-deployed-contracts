...
;; Vault Trait 
(impl-trait .vault-trait-vpv-15.vault-trait)
...
;; stability
(use-trait stability-trait .stability-trait-vpv-15.stability-trait)
...
(define-public (new-vault-wrapper (collateral-sbtc uint) (loan-bsd uint) (interest uint) (hint (optional uint)) (price-data (optional (buff 8192))) (bsd <bsd-trait>) (sbtc <sbtc-trait>) (oracle <oracle-trait>) (registry <registry-trait>) (stability <stability-trait>) (sorted-vaults <sorted-vaults-trait>))
    (let 
        (
            ...
            (valid-stability (try! (contract-call? .controller-vpv-15 check-approved-contract "stability" (contract-of stability))))
...
(define-public (process-epoch-rates (vaults (list 100 uint)) (hints (list 100 (optional uint))) (registry <registry-trait>) (sorted-vaults <sorted-vaults-trait>))
    (let
        (
            (valid-registry (try! (contract-call? .controller-vpv-15 check-approved-contract "registry" (contract-of registry))))
            (valid-sorted-vaults (try! (contract-call? .controller-vpv-15 check-approved-contract "sorted-vaults" (contract-of sorted-vaults))))
            (is-keeper (unwrap! (contract-call? .controller-vpv-15 is-keeper tx-sender) ERR_NO_KEEPER))
        )
...
(define-private (accrue-vault (vault-id uint) (bsd <bsd-trait>) (registry <registry-trait>))
    (let 
        (
            ...
            (is-keeper (unwrap-panic (contract-call? .controller-vpv-15 is-keeper tx-sender)))
        )
...
(define-private (attempt-liquidate-vault (vault-id uint) (sbtc-price uint) (bsd <bsd-trait>) (sbtc <sbtc-trait>) (registry <registry-trait>) (stability <stability-trait>) (sorted-vaults <sorted-vaults-trait>))
    (let 
        (
            ...
            (stability-pool-bsd (get aggregate-bsd stability-pool-data))
            (stability-adjustment-bsd (if (> stability-pool-bsd ONE_FULL_UNIT) ONE_FULL_UNIT stability-pool-bsd))
            (stability-pool-aggregate-bsd (- stability-pool-bsd stability-adjustment-bsd))
        ...
        (if (> accrued-vault-loan-bsd stability-pool-aggregate-bsd)
            ...
            (let
                (
                    ...
                    (vault-sbtc (- vault-collateral-sbtc stability-sbtc))
