(impl-trait .registry-trait-vpv-16.registry-trait)
...
(define-public (set-processed-epoch (new-epoch uint))
  (let ((keeper (unwrap-panic (contract-call? .controller-vpv-16 is-keeper tx-sender))))
...
(define-public (hot-pause)
  (begin
    (try! (contract-call? .controller-vpv-16 is-hot-pause-caller tx-sender))
...
(define-public (set-decay-parameters
  ...
  (begin
    (try! (contract-call? .controller-vpv-16 is-protocol-caller contract-caller))
    (asserts!
