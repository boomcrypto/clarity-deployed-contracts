...
;; Initialization
(map-set privileged-protocol-principals .registry-vpv-10 true)
(map-set privileged-protocol-principals .vault-vpv-10 true)
(map-set privileged-protocol-principals .redeem-vpv-10 true)
(map-set privileged-protocol-principals .stability-vpv-10 true)
(map-set privileged-protocol-principals .timelock-vpv-10 true)

;; Initialize the privileged principals lists
(var-set privileged-protocol-principals-list (list .registry-vpv-10 .vault-vpv-10 .redeem-vpv-10 .stability-vpv-10 .timelock-vpv-10))
...
(map-set contracts
    { name: "bsd" }
    {
      ...
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.bsd-mock-vpv-10
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.sBTC-mock-vpv-10
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.oracle-mock-vpv-10
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.registry-vpv-10
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.vault-vpv-10
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.stability-vpv-10
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.sorted-vaults-vpv-10
    }
)
