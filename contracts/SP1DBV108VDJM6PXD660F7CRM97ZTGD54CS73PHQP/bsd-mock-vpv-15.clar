...
(impl-trait .sip-010-trait-ft-standard-vpv-15.sip-010-trait)

;; BSD Protocol 
(impl-trait .bsd-trait-vpv-15.bsd-trait)
...
;; Initialization 
(map-set authorized-protocol-callers .registry-vpv-15 true)
(map-set authorized-protocol-callers .vault-vpv-15 true)
(map-set authorized-protocol-callers .redeem-vpv-15 true)
(map-set authorized-protocol-callers .stability-vpv-15 true)
(map-set authorized-protocol-callers .timelock-vpv-15 true)

;; Initialize the privileged principals list
(var-set privileged-principals-list (list .registry-vpv-15 .vault-vpv-15 .redeem-vpv-15 .stability-vpv-15 .timelock-vpv-15))