;; title: stability-vpv-11

;; Stability Trait 
(impl-trait .stability-trait-vpv-11.stability-trait)
...
(define-public (remove-liquidity-wrapper (amount uint) (bsd <bsd-trait>) (sbtc <sbtc-trait>) (registry <registry-trait>) (sorted-vaults <sorted-vaults-trait>))
    (let
        ...
        (if (or (is-eq amount compounded-deposit) (>= (- compounded-deposit amount) min-stability-provider-balance))
