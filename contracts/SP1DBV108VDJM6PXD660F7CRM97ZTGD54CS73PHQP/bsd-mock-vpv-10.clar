...
(impl-trait .sip-010-trait-ft-standard-vpv-10.sip-010-trait)

;; BSD Protocol 
(impl-trait .bsd-trait-vpv-10.bsd-trait)
...
;; Initialization 
(map-set authorized-protocol-callers .registry-vpv-10 true)
(map-set authorized-protocol-callers .vault-vpv-10 true)
(map-set authorized-protocol-callers .redeem-vpv-10 true)
(map-set authorized-protocol-callers .stability-vpv-10 true)
(map-set authorized-protocol-callers .timelock-vpv-10 true)

;; Initialize the privileged principals list
(var-set privileged-principals-list (list .registry-vpv-10 .vault-vpv-10 .redeem-vpv-10 .stability-vpv-10 .timelock-vpv-10))