...
(impl-trait .sip-010-trait-ft-standard-vpv-16.sip-010-trait)

;; BSD Protocol 
(impl-trait .bsd-trait-vpv-16.bsd-trait)
...
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://lavender-rear-sturgeon-658.mypinata.cloud/ipfs/bafkreifrrj5wopau2vjmlrketbu4b2gmsch62ojc2viiykxdxavrk7rgji"))
...
;; Owner
(define-data-var owner principal 'SM12WW29PGKPBWD8FTDNGXX90JCPPHDCRNZ9S2DZP)
(define-data-var proposed-owner principal 'SM12WW29PGKPBWD8FTDNGXX90JCPPHDCRNZ9S2DZP)
...
(define-public (remove-privileged-protocol-principal (protocol-principal principal))
	(begin 
		...
		(ok (var-set privileged-principals-list (get new-list (try! (fold remove-principal-from-list (var-get privileged-principals-list) (ok {compare-principal: protocol-principal, new-list: (list )}))))))
	)
)
...
;; Initialization 
(map-set authorized-protocol-callers .registry-vpv-16 true)
(map-set authorized-protocol-callers .vault-vpv-16 true)
(map-set authorized-protocol-callers .redeem-vpv-16 true)
(map-set authorized-protocol-callers .stability-vpv-16 true)
(map-set authorized-protocol-callers .timelock-vpv-16 true)

;; Initialize the privileged principals list
(var-set privileged-principals-list (list .registry-vpv-16 .vault-vpv-16 .redeem-vpv-16 .stability-vpv-16 .timelock-vpv-16))