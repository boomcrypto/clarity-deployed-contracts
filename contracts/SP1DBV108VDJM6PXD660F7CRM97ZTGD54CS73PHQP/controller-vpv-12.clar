...
;; Proposed Admin
(define-data-var proposed-admin principal 'SM2XE7M534J439HB2WFVMCVZD5XH9E5XX4DJ7J36Q)

;; Admin for maintaining the sensitive elements of the protocol
(define-data-var admin principal 'SM2XE7M534J439HB2WFVMCVZD5XH9E5XX4DJ7J36Q) ;; update
...
;; Initialization
(map-set privileged-protocol-principals .registry-vpv-12 true)
(map-set privileged-protocol-principals .vault-vpv-12 true)
(map-set privileged-protocol-principals .redeem-vpv-12 true)
(map-set privileged-protocol-principals .stability-vpv-12 true)
(map-set privileged-protocol-principals .timelock-vpv-12 true)

;; Initialize the privileged principals lists
(var-set privileged-protocol-principals-list (list .registry-vpv-12 .vault-vpv-12 .redeem-vpv-12 .stability-vpv-12 .timelock-vpv-12))
...
(map-set contracts
    { name: "bsd" }
    {
      ...
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.bsd-mock-vpv-12
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.sBTC-mock-vpv-12
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.oracle-vpv-12
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.registry-vpv-12
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.vault-vpv-12
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.stability-vpv-12
    }
)
...
(map-set contracts
    ...
    {
      address: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP,
      qualified-name: 'SP1DBV108VDJM6PXD660F7CRM97ZTGD54CS73PHQP.sorted-vaults-vpv-12
    }
)
