...
(define-constant allow-token 'SP2427N7VHR8V90YPZ6VVR53Q8FEWYR0JRFVVFYRT.the-little-meme-that-could-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u972789115646258)
    (var-set stx-balance u27972028)
