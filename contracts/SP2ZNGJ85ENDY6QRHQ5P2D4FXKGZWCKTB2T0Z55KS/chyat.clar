;; Chyat Token
;; CHA-GYAT LP token with configurable metadata
...
(define-data-var token-name (string-ascii 32) "Chyat")
(define-data-var token-symbol (string-ascii 10) "CHYAT")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/chyat/metadata.json"))
