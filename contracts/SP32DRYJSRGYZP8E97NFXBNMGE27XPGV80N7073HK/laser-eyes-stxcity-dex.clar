...
(define-constant allow-token 'SP32DRYJSRGYZP8E97NFXBNMGE27XPGV80N7073HK.laser-eyes-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u62406304445442296)
    (var-set stx-balance u44955045)
