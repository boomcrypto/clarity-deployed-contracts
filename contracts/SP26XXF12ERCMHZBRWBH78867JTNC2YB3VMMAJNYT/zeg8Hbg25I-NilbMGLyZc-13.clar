...
(define-public (jCNlDTWjRAKdEN
    ...
    (step1-pXfHvdKmHDUGJjF uint)
    (step1-cMUfNFrmT8z3bzk uint)
    ...
    (let
        ...
        (let
            (
                (lgOKJUDXNTYsaE (unwrap-panic (lIrZANWJdVyFpL step1-gSdwYJmyTzoWDD step1-WwVyVrEOHQxVXy step1-pXfHvdKmHDUGJjF step1-cMUfNFrmT8z3bzk dx)))
...
(define-public (ZyPMebpnWHRDUT
    ...
    (step2-pXfHvdKmHDUGJjF uint)
    (step2-cMUfNFrmT8z3bzk uint)
    (dx uint)
    (jnJe1z8sXPa46T bool)
)
    (let
        ...
        (let
            (
                ...
                (nmoFJdZDqlSrMz (unwrap-panic (lIrZANWJdVyFpL step2-gSdwYJmyTzoWDD step2-WwVyVrEOHQxVXy step2-pXfHvdKmHDUGJjF step2-cMUfNFrmT8z3bzk lgOKJUDXNTYsaE)))
            )
            (if (is-eq jnJe1z8sXPa46T true)
                (begin (try! (as-contract (stx-transfer? nmoFJdZDqlSrMz tx-sender z89U2vcrbMgcMz3))))
                (if (is-eq step1-PcvSXbBlExqEQR true)
...
(define-public (FcC8sQDJmVwkjdv
    ...
    (step2-pXfHvdKmHDUGJjF uint)
    (step2-cMUfNFrmT8z3bzk uint)
    (step3-gSdwYJmyTzoWDD <NcEfqXWqwCGSVR>)
    (step3-WwVyVrEOHQxVXy <NcEfqXWqwCGSVR>)
    (step3-pXfHvdKmHDUGJjF uint)
    (step3-cMUfNFrmT8z3bzk uint)
    (dx uint)
    (jnJe1z8sXPa46T bool)
)
    (let
        ...
        (let
            (
                (x-amount (unwrap-panic (lIrZANWJdVyFpL step1-gSdwYJmyTzoWDD step1-WwVyVrEOHQxVXy step1-pXfHvdKmHDUGJjF step1-cMUfNFrmT8z3bzk dx)))
                (lgOKJUDXNTYsaE (unwrap-panic (lIrZANWJdVyFpL step2-gSdwYJmyTzoWDD step2-WwVyVrEOHQxVXy step2-pXfHvdKmHDUGJjF step2-cMUfNFrmT8z3bzk x-amount)))
                (nmoFJdZDqlSrMz (unwrap-panic (lIrZANWJdVyFpL step3-gSdwYJmyTzoWDD step3-WwVyVrEOHQxVXy step3-pXfHvdKmHDUGJjF step3-cMUfNFrmT8z3bzk lgOKJUDXNTYsaE)))
            )
            (if (is-eq jnJe1z8sXPa46T true)
                (begin (try! (as-contract (stx-transfer? nmoFJdZDqlSrMz tx-sender z89U2vcrbMgcMz3))))
                (begin (try! (as-contract (contract-call? step1-gSdwYJmyTzoWDD transfer nmoFJdZDqlSrMz tx-sender z89U2vcrbMgcMz3 none))))
