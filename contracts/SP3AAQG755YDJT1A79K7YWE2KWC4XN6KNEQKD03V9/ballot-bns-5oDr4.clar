    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"BNS")
    (var-set description u"Sell BNS for Companies ")
    (var-set voting-system "fptp")
    (var-set options (list "e61c6498-1f74-48f8-8ebe-51c7360bfe08" "1fcd0728-1743-40db-bd87-bbbd86243635" "bcfae08a-b2de-4cfd-8f7a-0f28eb50976b"))
    (var-set start u128654)
    (var-set end u130382)
    (map-set results {id: "e61c6498-1f74-48f8-8ebe-51c7360bfe08"} {count: u0, name: u"Sell for free"}) (map-set results {id: "1fcd0728-1743-40db-bd87-bbbd86243635"} {count: u0, name: u"Sell for Future Income"}) (map-set results {id: "bcfae08a-b2de-4cfd-8f7a-0f28eb50976b"} {count: u0, name: u"Other"})