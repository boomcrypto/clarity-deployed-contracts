...
(define-constant MAX_BLOCKS_PER_ROUND u6)
(define-constant DRAW_CD_BLOCKS u1)
(define-constant CANCEL_CD_BLOCKS u72)
...
(define-data-var price-list (list 3 uint) (list u500000 u5000000 u50000000))
