...
(define-constant ACCOUNT_OWNER 'SP2Z94F6QX847PMXTPJJ2ZCCN79JZDW3PJ4E6ZABY) ;; owner (user/creator of account, full access)
(define-constant ACCOUNT_AGENT 'SPW8QZNWKZGVHX012HCBJVJVPS94PXFG578P53TM) ;; agent (can only take approved actions)
