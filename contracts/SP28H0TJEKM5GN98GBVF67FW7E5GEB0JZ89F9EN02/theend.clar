;;TODO last time test real (multiple)
...
(define-constant ONE_ROUND_DURATION_BLOCKS u2) ;;TODO u36 6 hours
...
(define-data-var price-list (list 3 uint) (list u1000000 u2000000 u3000000)) ;;TODO:
...
(define-read-only (get-bet-summary (bet-type uint) (round uint))
  (let
    (
      ...
      (end-time (default-to u0 (get end-time bet-summary)))
      (real-end-time (if (> end-time u0) end-time (default-to u0 (get-block-info? time end-at))))
    )
    {
      bet-type: bet-type,
      round: round,
