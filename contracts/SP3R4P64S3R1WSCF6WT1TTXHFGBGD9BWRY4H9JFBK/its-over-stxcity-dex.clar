...
(define-constant allow-token 'SP3R4P64S3R1WSCF6WT1TTXHFGBGD9BWRY4H9JFBK.its-over-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u35406817487007032)
    (var-set stx-balance u96063936)
