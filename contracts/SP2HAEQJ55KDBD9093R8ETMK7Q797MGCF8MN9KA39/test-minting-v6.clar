...
(define-public (confirm-redeem (request-id uint) (price uint) (amount-usdh-confirmed uint) (redeeming-asset <sip-010-trait>) (memo (optional (buff 34))))
  (let (
    ...
    (try! (contract-call? .test-redeeming-reserve-v3 transfer amount-asset-confirmed requester redeeming-asset memo))
    (if (> amount-asset-fee u0) (try! (contract-call? .test-redeeming-reserve-v3 transfer amount-asset-fee fee-address redeeming-asset none)) true)
