...
;; beast1 Powered By Faktory.fun v1.0 
...
(define-fungible-token BEAST1 MAX)
(define-constant MAX u100000000000000000)
(define-data-var contract-owner principal 'SP331D6T77PNS2YZXR03CDC4G3XN0SYBPV69D8JW5.beast1-token-owner)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? BEAST1 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance BEAST1 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? BEAST1 (/ (* MAX u80) u100) 'SP331D6T77PNS2YZXR03CDC4G3XN0SYBPV69D8JW5.beast1-treasury)) ;; 80% treasury
    (try! (ft-mint? BEAST1 (/ (* MAX u16) u100) 'SP331D6T77PNS2YZXR03CDC4G3XN0SYBPV69D8JW5.beast1-faktory-dex))
    (try! (ft-mint? BEAST1 (/ (* MAX u4) u100) 'SP331D6T77PNS2YZXR03CDC4G3XN0SYBPV69D8JW5.beast1-pre-faktory))
