  ...
  (define-constant DEX-TOKEN 'SP331D6T77PNS2YZXR03CDC4G3XN0SYBPV69D8JW5.beast1-faktory)
  ...
  (define-public (buy (ft <faktory-token>) (ubtc uint))
    (begin
      ...
      (let (
        ...
        (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
                    transfer pre-fee tx-sender 'SP331D6T77PNS2YZXR03CDC4G3XN0SYBPV69D8JW5.beast1-pre-faktory none))
        (try! (as-contract (contract-call? 'SP331D6T77PNS2YZXR03CDC4G3XN0SYBPV69D8JW5.beast1-pre-faktory create-fees-receipt pre-fee))) 
        (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
        ...
        (if (>= new-stx TARGET_STX)
            (let ((premium-amount (/ (* new-ft (var-get premium)) u100))
              ...
              (try! (as-contract (contract-call? 'SP331D6T77PNS2YZXR03CDC4G3XN0SYBPV69D8JW5.beast1-pre-faktory toggle-bonded))) 
  ...
  (define-public (open-market) 
    (let ((is-prelaunch-allowing (unwrap-panic (contract-call? 'SP331D6T77PNS2YZXR03CDC4G3XN0SYBPV69D8JW5.beast1-pre-faktory is-market-open))))
    ...
    (begin
      ...
      (var-set ft-balance u16000000000000000)
        (print { 
            ...
            poolName: 'SP331D6T77PNS2YZXR03CDC4G3XN0SYBPV69D8JW5.xyk-pool-sbtc-beast1-v-1-1
       })
      (ok true))