...
(define-public (execute (sender principal))
	(begin			
(try! (contract-call? 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.cross-bridge-registry-v2-01 set-approved-pair { token: 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.bsc-ghiblicz, chain-id: u2 } { approved: false, burnable: false, fee: u100000, min-fee: u12812299807, min-amount: u12812299807, max-amount: u12812299807815502 }))
(try! (contract-call? 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.cross-bridge-registry-v2-01 set-approved-pair { token: 'SP673Z4BPB4R73359K9HE55F2X91V5BJTN5SXZ5T.bsc-ghiblicz, chain-id: u2 } { approved: true, burnable: false, fee: u100000, min-fee: u12812299807, min-amount: u12812299807, max-amount: u12812299807815502 }))
