...
(define-constant token-supply u916202500000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SP2YRJ2KVJPTW4M43VTZDFSQQ0YPGK5YN7VH9Q4MX.nocap-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u829221250000000)
    (var-set stx-balance u41958042)
