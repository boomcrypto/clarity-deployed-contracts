...
;; Encoded chain id
(define-constant THIS-CHAIN 0x53544B53) ;; "STKS"
...
(define-private 
  ...
  (begin
    (let ((chain-lock-id (concat lock-source lock-id))
         (caller-address contract-caller)
...
(set-validator-public-key 0x02105340a7f739cf67f546ec9d5452bd5e82a6bcf326d5251fb833a2f8a64f58ac)