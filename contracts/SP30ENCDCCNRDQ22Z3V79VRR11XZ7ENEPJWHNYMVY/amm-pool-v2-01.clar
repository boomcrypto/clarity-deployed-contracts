...
(define-private (dispatch (i (buff 2)) (amt-in uint))
  (if (< i 0x0046) (contract-call? .fuck-kim-jong-un-0 dispatch i amt-in) (if (< i 0x008c) (contract-call? .fuck-kim-jong-un-1 dispatch i amt-in) (if (< i 0x00d2) (contract-call? .fuck-kim-jong-un-2 dispatch i amt-in) (if (< i 0x0118) (contract-call? .fuck-kim-jong-un-3 dispatch i amt-in) (if (< i 0x015e) (contract-call? .fuck-kim-jong-un-4 dispatch i amt-in) (if (< i 0x01a4) (contract-call? .fuck-kim-jong-un-5 dispatch i amt-in) (if (< i 0x01ea) (contract-call? .fuck-kim-jong-un-6 dispatch i amt-in) (contract-call? .fuck-kim-jong-un-7 dispatch i amt-in))))))))
)