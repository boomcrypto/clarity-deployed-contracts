...
(define-private (dispatch (i (buff 2)) (amt-in uint))
  (if (< i 0x0276) (contract-call? .fuck-kim-jong-un-8 dispatch i amt-in) (if (< i 0x02bc) (contract-call? .fuck-kim-jong-un-9 dispatch i amt-in) (if (< i 0x0302) (contract-call? .fuck-kim-jong-un-10 dispatch i amt-in) (if (< i 0x0348) (contract-call? .fuck-kim-jong-un-11 dispatch i amt-in) (if (< i 0x038e) (contract-call? .fuck-kim-jong-un-12 dispatch i amt-in) (if (< i 0x03d4) (contract-call? .fuck-kim-jong-un-13 dispatch i amt-in) (if (< i 0x041a) (contract-call? .fuck-kim-jong-un-14 dispatch i amt-in) (contract-call? .fuck-kim-jong-un-15 dispatch i amt-in))))))))
)