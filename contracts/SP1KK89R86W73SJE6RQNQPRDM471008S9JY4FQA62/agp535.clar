...
(define-public (execute (sender principal))
	(begin
		(try! (process-expired-balance { address: 'SP3FBFNFFFGK1VKN17SFNHX8WKJXJZK175PJ2T5H7, cycle: u292, token-x-trait: 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wstx-v2, token-y-trait: 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wlqstx-v3, factor: u5000000 }))
		(try! (process-expired-balance { address: 'SP17WGFQPDT20CWHCC9S4VVDZ5NBT6HZ52MGX4WG5, cycle: u292, token-x-trait: 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex, token-y-trait: 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wlialex, factor: u5000000 }))
		(try! (process-expired-balance { address: 'SP17WGFQPDT20CWHCC9S4VVDZ5NBT6HZ52MGX4WG5, cycle: u292, token-x-trait: 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wstx-v2, token-y-trait: 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-wlqstx-v3, factor: u5000000 }))
		(ok true)))
