...
(define-constant REGISTRATION_PERIOD u72) ;; 0.5 day
...
(define-public (execute (sender principal))
	(let (
		(transfer-abtc (try! (contract-call? .alex-launchpad-v2-03d transfer-all-to-dao 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.token-abtc)))		
		(distribution-id (try! (contract-call? .alex-launchpad-v2-03e create-pool 
	{
...
(try! (contract-call? .alex-launchpad-v2-03e set-use-whitelist distribution-id true))
(try! (contract-call? .alex-launchpad-v2-03e set-whitelisted distribution-id WHITELIST))
(try! (contract-call? .alex-launchpad-v2-03e add-to-position distribution-id SUPPLY_TICKETS 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.token-abtc))			

(try! (contract-call? 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-apower add-approved-contract .alex-launchpad-v2-03e))
(try! (contract-call? .alex-launchpad-v2-03e add-approved-operator 'SP17JDRQ402PC603JJK5YH9N0XRP9RBRGQ91RJHA3))
(try! (contract-call? .alex-launchpad-v2-03e add-approved-operator 'SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.executor-dao))	

(try! (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.migrate-legacy-v2-wl finalise-migrate 'SP1R0X4XT4B3731JYXM52BZ7HSYHNREFCGY12W9N0))
(try! (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.migrate-legacy-v2-wl finalise-migrate 'SPYEE1VDCHE686A91MESKPXXATFSZ9PBJ3YXPP7M))
...
(try! (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.migrate-legacy-v2-wl finalise-migrate 'SP30ARNSK59ZPMJW4D172VZ6F5DZ0JX40ZHN56797))
(try! (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.migrate-legacy-v2-wl finalise-migrate 'SP1KFG66YNN0NBK578H2KDQ202SMMNTY7X1SN4PVG))
(try! (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.migrate-legacy-v2-wl finalise-migrate 'SP13Q1T579E33KYV96SS8RZ3K7CAT3T6PB0C8TA6Z))
		(ok true)))
