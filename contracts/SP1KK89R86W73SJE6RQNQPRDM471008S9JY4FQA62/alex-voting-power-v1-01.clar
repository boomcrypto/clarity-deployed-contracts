    ...
    (match pool-tokens
      success
        (let ((pool-details (unwrap-panic (contract-call? 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.amm-pool-v2-01 get-pool-details 
            ...
            (alex-from-x (if (or (is-eq (get token-x success) 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex) 
                          ...
                          u0))
            (alex-from-y (if (or (is-eq (get token-y success) 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex) 
