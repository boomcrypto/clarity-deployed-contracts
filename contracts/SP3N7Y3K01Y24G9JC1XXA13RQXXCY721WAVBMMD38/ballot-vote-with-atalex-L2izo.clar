    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with atALEX) Approve Launch of HuMaNz on the ALEX Launchpad")
    (var-set description u"This proposal is to approve HuMaNz for the ALEX Decentralized Launchpad. Information on the project is available on the application form HuMaNz has submitted.Humanz: https://cdn.alexlab.co/pdf/launch-candidates/HuMaNz.pdfVote to either approve or disapprove the project to launch on ALEX. The ALEX Lab Foundation does NOT sponsor the projects approved for the ALEX Launchpad. Community members must do their own research on how to vote.The ALEX Lab Foundation will hold a Twitter Spaces AMA (https://twitter.com/")
    (var-set voting-system "fptp")
    (var-set options (list "700db3b5-6f6c-44c4-940c-e558c05fcc0a" "f3d964ee-17a9-43b3-9ce6-abfe58b62622"))
    (var-set start u118426)
    (var-set end u119434)
    (map-set results {id: "700db3b5-6f6c-44c4-940c-e558c05fcc0a"} {count: u0, name: u"For"}) (map-set results {id: "f3d964ee-17a9-43b3-9ce6-abfe58b62622"} {count: u0, name: u"Against"})