    ...
    (var-set options (list "094ec962-c31f-4bb3-a24e-d8415740ff2d" "56a11fe1-4a34-47f7-848a-ff0d03accce6"))
    (var-set start u114883)
    (var-set end u115405)
    (map-set results {id: "094ec962-c31f-4bb3-a24e-d8415740ff2d"} {count: u0, name: u"Yes"}) (map-set results {id: "56a11fe1-4a34-47f7-848a-ff0d03accce6"} {count: u0, name: u"No"})