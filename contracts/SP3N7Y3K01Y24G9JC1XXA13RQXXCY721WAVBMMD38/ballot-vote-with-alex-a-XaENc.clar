    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with ALEX) Approve Launch of HuMaNz on the ALEX Launchpad")
    ...
    (var-set options (list "a88fa06f-dab5-413a-aff4-31c27b76e1d3" "446dcd08-8bcf-494c-b16a-1a1b1b1078b5"))
    (var-set start u118426)
    (var-set end u119434)
    (map-set results {id: "a88fa06f-dab5-413a-aff4-31c27b76e1d3"} {count: u0, name: u"For"}) (map-set results {id: "446dcd08-8bcf-494c-b16a-1a1b1b1078b5"} {count: u0, name: u"Against"})