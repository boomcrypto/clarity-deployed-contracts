    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with atALEX) Approve Launch of Bluewheel Mining on the ALEX Launchpad")
    ...
    (var-set start u114825)
    (var-set end u115401)
    (map-set results {id: "9c4ee60d-a299-400b-b412-6ae70779e8ae"} {count: u0, name: u"Yes"}) (map-set results {id: "786e67a6-c5de-4140-b307-0d13c2c4c74e"} {count: u0, name: u"No"})