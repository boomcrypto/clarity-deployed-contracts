    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with AutoALEX) Proposal for the gradual shift of emission from old liquidity pools to new")
    ...
    (var-set options (list "b62979f5-70d7-47cc-a88e-2db23c3f20c1" "60d1f215-4152-4135-8763-05f27e3f61be"))
    (var-set start u104819)
    (var-set end u105248)
    (map-set results {id: "b62979f5-70d7-47cc-a88e-2db23c3f20c1"} {count: u0, name: u"For"}) (map-set results {id: "60d1f215-4152-4135-8763-05f27e3f61be"} {count: u0, name: u"Against"})