    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"(Vote with ALEX)  Approve Launch of Bluewheel Mining on the ALEX Launchpad")
    (var-set description u"This proposal is to approve the launch of Bluewheel Mining on the ALEX Decentralized Launchpad. => Background <= Bluewheel Mining (https://www.bluewheelmining.com/) builds BTC mining operations backed by cost-effective renewable energy. Bluewheel is raising to increase mining capacity through Ordinals NFTs which will be airdropped Bitcoin. Bluewheel Mining seeks to launch 200 Ordinal NFTs on ALEX at a price of $550 USD each. The Ordinals will be pre-minted through Gamma.io (http://www.gamma.io) by the Bluew")
    (var-set voting-system "fptp")
    (var-set options (list "df1c478b-d0dc-4ff1-9a99-e0549cb702da" "ccd85ddd-13f9-4c3f-a0c6-c911ce2cdb5e"))
    (var-set start u114863)
    (var-set end u115403)
    (map-set results {id: "df1c478b-d0dc-4ff1-9a99-e0549cb702da"} {count: u0, name: u"Choice 1"}) (map-set results {id: "ccd85ddd-13f9-4c3f-a0c6-c911ce2cdb5e"} {count: u0, name: u"Choice 2"})