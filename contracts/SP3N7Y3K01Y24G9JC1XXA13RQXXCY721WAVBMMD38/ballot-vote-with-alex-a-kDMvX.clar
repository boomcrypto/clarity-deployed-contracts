    ...
    (var-set options (list "e137859a-2933-4943-b0cc-09a7a6df07cf" "aa3c4f05-406e-4dba-9b4c-e6d19052182f"))
    (var-set start u114859)
    (var-set end u115405)
    (map-set results {id: "e137859a-2933-4943-b0cc-09a7a6df07cf"} {count: u0, name: u"Yes"}) (map-set results {id: "aa3c4f05-406e-4dba-9b4c-e6d19052182f"} {count: u0, name: u"No"})