...
(define-public (get-can-update-midpoint)
  (let (
    (pool-data (unwrap! (contract-call? .stableswap-pool-stx-ststx-v-1-4 get-pool) ERR_NO_POOL_DATA))
    (primary-denominator (get midpoint-primary-denominator pool-data))
    (updated-denominator (try! (contract-call? 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.data-core-v3 get-stx-per-ststx
...
(define-public (update-midpoint)
  (let (
    ...
    (begin
      ...
      (try! (as-contract (contract-call? .stableswap-core-v-1-4 set-midpoint
                         .stableswap-pool-stx-ststx-v-1-4 primary-numerator updated-denominator
