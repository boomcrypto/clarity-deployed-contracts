...
(define-public (quote-ststx-for-ststxbtc
  ...
  (let (
    ...
    (stx-ststx (try! (contract-call? 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.data-core-v3 get-stx-per-ststx
                     reserve)))
...
(define-public (swap-ststx-for-ststxbtc
  ...
  (let (
    ...
    (swap-a (try! (contract-call?
                  'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.swap-ststx-ststxbtc-v2 swap-ststx-for-ststxbtc
...
(define-public (swap-ststxbtc-for-ststx
  ...
  (let (
    (amount-after-aggregator-fees (try! (transfer-aggregator-fees 'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.ststxbtc-token-v2 provider amount)))
    (swap-a (try! (contract-call?
                  'SP4SZE494VC2YC5JYG7AYFQ44F5Q4PYV7DVMDPBG.swap-ststx-ststxbtc-v2 swap-ststxbtc-for-ststx
                  amount-after-aggregator-fees reserve)))
  )
    (asserts! (>= swap-a min-received) ERR_MINIMUM_RECEIVED)
    (print {
