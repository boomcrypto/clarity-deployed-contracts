...
(define-public (execute-action 
  ...
  (let (
    ...
    (keeper-fee-amount (unwrap! (contract-call? .keeper-4-helper-v-1-1 get-keeper-fee-amount dlp) ERR_INVALID_HELPER_DATA))
...
(define-private (stableswap-withdraw-liquidity
  ...
  (let (
    ...
    (withdraw-liquidity-result (try! (contract-call? .stableswap-core-v-1-4 withdraw-imbalanced-liquidity .stableswap-pool-stx-ststx-v-1-4 token-trait-a token-trait-b x-amount y-amount max-dlp)))
