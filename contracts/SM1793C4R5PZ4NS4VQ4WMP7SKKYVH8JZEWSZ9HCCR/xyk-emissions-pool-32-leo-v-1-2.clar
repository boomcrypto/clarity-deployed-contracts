...
;; xyk-emissions-pool-32-leo-v-1-2
...
(define-constant DEPLOYMENT_HEIGHT u900097)
...
(define-private (transfer-rewards-token (amount uint) (sender principal) (recipient principal))
  (let (
    (call-a (unwrap! (contract-call?
                     'SP1AY6K3PQV5MRT6R4S671NWW2FRVPKM0BR162CT6.leo-token transfer
...
(define-private (get-contract-token-balance)
  (let (
    (call-a (unwrap! (contract-call?
                     'SP1AY6K3PQV5MRT6R4S671NWW2FRVPKM0BR162CT6.leo-token get-balance
...
(define-private (get-external-user-data (user principal) (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     .xyk-staking-leo-stx-v-1-2 get-user-at-cycle
...
(define-private (get-external-cycle-data (cycle uint))
  (let (
    (call-a (unwrap! (contract-call?
                     .xyk-staking-leo-stx-v-1-2 get-lp-staked-at-cycle
