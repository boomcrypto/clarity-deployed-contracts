...
(define-public (get-output
  ...
  (let (
    ...
    ;; Get swaps reversed (false = Stableswap -> XYK)
  ...
  (let (
    ...
    (swap-a (if is-swap
      (if (is-eq swaps-reversed false)
        ...
        (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-a amount u0 tokens-tuple-a xyk-pools-tuple))
      )
      (if (is-eq swaps-reversed false)
        (try! (stableswap-qa amount token-trait-a token-trait-b stableswap-pool-trait-a))
        (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-a amount tokens-tuple-a xyk-pools-tuple))
      )
    ))
    (swap-b (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-a swap-a u0 tokens-tuple-b xyk-pools-tuple))
        (try! (stableswap-sa swap-a token-trait-c token-trait-d stableswap-pool-trait-a))
      )
      (if (is-eq swaps-reversed false)
        (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-a swap-a tokens-tuple-b xyk-pools-tuple))
...
(define-private (swap-sb
  ...
  (let (
    ...
    (swap-a (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (stableswap-sa amount token-trait-a token-trait-b stableswap-pool-trait-a))
        (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-b amount u0 tokens-tuple-a xyk-pools-tuple))
      )
      (if (is-eq swaps-reversed false)
        (try! (stableswap-qa amount token-trait-a token-trait-b stableswap-pool-trait-a))
        (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-b amount tokens-tuple-a xyk-pools-tuple))
      )
    ))
    (swap-b (if is-swap
      (if (is-eq swaps-reversed false)
      ...
      (if (is-eq swaps-reversed false)
        (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-b swap-a tokens-tuple-b xyk-pools-tuple))
...
(define-private (swap-sc
  ...
  (let (
    ...
    (swap-a (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (stableswap-sa amount token-trait-a token-trait-b stableswap-pool-trait-a))
        (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-c amount u0 tokens-tuple-a xyk-pools-tuple))
      )
      (if (is-eq swaps-reversed false)
        (try! (stableswap-qa amount token-trait-a token-trait-b stableswap-pool-trait-a))
        (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-c amount tokens-tuple-a xyk-pools-tuple))
      )
    ))
    (swap-b (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-c swap-a u0 tokens-tuple-b xyk-pools-tuple))
        (try! (stableswap-sa swap-a token-trait-g token-trait-h stableswap-pool-trait-a))
      )
      (if (is-eq swaps-reversed false)
        (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-c swap-a tokens-tuple-b xyk-pools-tuple))
...
(define-private (swap-sd
  ...
  (let (
    ...
    (swap-a (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (stableswap-sa amount token-trait-a token-trait-b stableswap-pool-trait-a))
        (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-d amount u0 tokens-tuple-a xyk-pools-tuple))
      )
      (if (is-eq swaps-reversed false)
        (try! (stableswap-qa amount token-trait-a token-trait-b stableswap-pool-trait-a))
        (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-d amount tokens-tuple-a xyk-pools-tuple))
      )
    ))
    (swap-b (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-d swap-a u0 tokens-tuple-b xyk-pools-tuple))
        (try! (stableswap-sa swap-a token-trait-i token-trait-j stableswap-pool-trait-a))
      )
      (if (is-eq swaps-reversed false)
        (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-d swap-a tokens-tuple-b xyk-pools-tuple))
...
(define-private (swap-se
  ...
  (let (
    ...
    (swap-a (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (stableswap-sa amount token-trait-a token-trait-b stableswap-pool-trait-a))
        (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-e amount u0 tokens-tuple-a xyk-pools-tuple))
      )
      (if (is-eq swaps-reversed false)
        (try! (stableswap-qa amount token-trait-a token-trait-b stableswap-pool-trait-a))
        (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-e amount tokens-tuple-a xyk-pools-tuple))
      )
    ))
    (swap-b (if is-swap
      (if (is-eq swaps-reversed false)
        (try! (contract-call? .xyk-swap-helper-v-1-2 swap-helper-e swap-a u0 tokens-tuple-b xyk-pools-tuple))
        (try! (stableswap-sa swap-a token-trait-k token-trait-l stableswap-pool-trait-a))
      )
      (if (is-eq swaps-reversed false)
        (try! (contract-call? .xyk-swap-helper-v-1-2 get-quote-e swap-a tokens-tuple-b xyk-pools-tuple))
