...
(define-public (get-can-update-midpoint)
  (let (
    (pool-data (unwrap! (contract-call? .stableswap-pool-usdh-susdh-v-1-4 get-pool) ERR_NO_POOL_DATA))
  ...
  (let (
    ...
    (begin
      ...
      (try! (as-contract (contract-call? .stableswap-core-v-1-4 set-midpoint
                         .stableswap-pool-usdh-susdh-v-1-4 primary-numerator updated-denominator
