...
(define-private (swap-sa
  ...
  (let (
    ...
    (swap-a (if is-swap
      (try! (contract-call? .stableswap-swap-helper-v-1-2 swap-helper-a amount u0 tokens-tuple stableswap-pools-tuple))
      (try! (contract-call? .stableswap-swap-helper-v-1-2 get-quote-a amount tokens-tuple stableswap-pools-tuple))
    ))
  )
...
(define-private (swap-sb
  ...
  (let (
    ...
    ;; Perform swap or get quote result
    (swap-a (if is-swap
      (try! (contract-call? .stableswap-swap-helper-v-1-2 swap-helper-b amount u0 tokens-tuple stableswap-pools-tuple))
      (try! (contract-call? .stableswap-swap-helper-v-1-2 get-quote-b amount tokens-tuple stableswap-pools-tuple))
    ))
  )
...
(define-private (swap-sc
  ...
  (let (
    ...
    ;; Perform swap or get quote result
    (swap-a (if is-swap
      (try! (contract-call? .stableswap-swap-helper-v-1-2 swap-helper-c amount u0 tokens-tuple stableswap-pools-tuple))
      (try! (contract-call? .stableswap-swap-helper-v-1-2 get-quote-c amount tokens-tuple stableswap-pools-tuple))
    ))
  )
...
(define-private (swap-sd
  ...
  (let (
    ...
    ;; Perform swap or get quote result
    (swap-a (if is-swap
      (try! (contract-call? .stableswap-swap-helper-v-1-2 swap-helper-d amount u0 tokens-tuple stableswap-pools-tuple))
      (try! (contract-call? .stableswap-swap-helper-v-1-2 get-quote-d amount tokens-tuple stableswap-pools-tuple))
    ))
  )
...
(define-private (swap-se
  ...
  (let (
    ...
    ;; Perform swap or get quote result
    (swap-a (if is-swap
      (try! (contract-call? .stableswap-swap-helper-v-1-2 swap-helper-e amount u0 tokens-tuple stableswap-pools-tuple))
      (try! (contract-call? .stableswap-swap-helper-v-1-2 get-quote-e amount tokens-tuple stableswap-pools-tuple))
    ))
  )
