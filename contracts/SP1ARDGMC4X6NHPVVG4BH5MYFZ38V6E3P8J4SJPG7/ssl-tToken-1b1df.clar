...
(define-read-only (get-name) (contract-call? 'SP1ARDGMC4X6NHPVVG4BH5MYFZ38V6E3P8J4SJPG7.tToken get-name))
(define-read-only (get-symbol) (contract-call? 'SP1ARDGMC4X6NHPVVG4BH5MYFZ38V6E3P8J4SJPG7.tToken get-symbol))
(define-read-only (get-base-decimals) (contract-call? 'SP1ARDGMC4X6NHPVVG4BH5MYFZ38V6E3P8J4SJPG7.tToken get-decimals))
(define-read-only (get-token-uri) (contract-call? 'SP1ARDGMC4X6NHPVVG4BH5MYFZ38V6E3P8J4SJPG7.tToken get-token-uri))
(define-read-only (get-balance (who principal)) (if (is-eq who VAULT) (ok (ft-get-balance wrapped-token who)) (ok (decimals-to-fixed (unwrap-panic (contract-call? 'SP1ARDGMC4X6NHPVVG4BH5MYFZ38V6E3P8J4SJPG7.tToken get-balance who))))))
(define-read-only (get-total-supply) (ok (decimals-to-fixed (unwrap-panic (contract-call? 'SP1ARDGMC4X6NHPVVG4BH5MYFZ38V6E3P8J4SJPG7.tToken get-total-supply)))))
...
(define-read-only (get-base-token)
  'SP1ARDGMC4X6NHPVVG4BH5MYFZ38V6E3P8J4SJPG7.tToken)
  ...
  (begin
    ...
    (if (is-eq sender VAULT)
			(begin
				...
				(as-contract (contract-call? 'SP1ARDGMC4X6NHPVVG4BH5MYFZ38V6E3P8J4SJPG7.tToken transfer (fixed-to-decimals amount) tx-sender recipient memo)))
			(begin
				(and (is-eq recipient VAULT) (try! (ft-mint? wrapped-token amount recipient)))
				(contract-call? 'SP1ARDGMC4X6NHPVVG4BH5MYFZ38V6E3P8J4SJPG7.tToken transfer (fixed-to-decimals amount) tx-sender (if (is-eq recipient VAULT) (as-contract tx-sender) recipient) memo)))))
