...
(define-public (is-dao-or-extension)
  (ok (asserts!
    (or
      (is-eq tx-sender 'SP2X27ZA972JEPEKZPNBJ15EMBB7A9Q48E10181EC.wicked-amethyst-puma)
      (contract-call? 'SP2X27ZA972JEPEKZPNBJ15EMBB7A9Q48E10181EC.wicked-amethyst-puma is-extension contract-caller))
    ERR_UNAUTHORIZED
  ))
)
...
(define-public (direct-execute (proposal <proposal-trait>))
  (let
    ...
    (and (>= signals (var-get signalsRequired))
      (try! (contract-call? 'SP2X27ZA972JEPEKZPNBJ15EMBB7A9Q48E10181EC.wicked-amethyst-puma execute proposal tx-sender))
    )
