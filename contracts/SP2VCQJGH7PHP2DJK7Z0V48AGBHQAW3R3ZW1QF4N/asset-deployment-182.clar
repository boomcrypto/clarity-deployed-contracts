...
(define-constant ststx-debt-ceiling u400000000000000)
(define-constant ststxbtc-debt-ceiling u150000000000000)
...
(define-public (run-update)
  (let (
    ...
    (try!
      (contract-call? .pool-borrow-v2-2 set-reserve ststx-token
        (merge reserve-data-1 { debt-ceiling: ststx-debt-ceiling })
      )
    )

    (try!
      (contract-call? .pool-borrow-v2-2 set-reserve ststxbtc-token
