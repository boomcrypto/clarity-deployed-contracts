...
(define-public (run-update)
  (begin
    ...
    (try! (contract-call? .zwstx-v2-0 set-approved-contract .liquidation-manager-v2-1 false))
    (try! (contract-call? .zwstx-v2-0 set-approved-contract .liquidation-manager-v2-2 true))
