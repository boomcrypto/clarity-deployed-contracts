...
(define-non-fungible-token crazy-parrots uint)
...
(define-data-var artist-address principal 'SP356A6FKGP140RBRHPECM7X0MF1QDYHC44TZKE56)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmUkf5oys11Tnimk5wcrNYF1UF6zUA4QXkMu6gubyGz6vu/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? crazy-parrots next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? crazy-parrots token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? crazy-parrots token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? crazy-parrots token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? crazy-parrots id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? crazy-parrots id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? crazy-parrots id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u17083)
...
;; Alt Minting Default
(define-data-var total-price-usda uint u4000000)
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u6878000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u6150000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u33000000)
...
;; Alt Minting Default
(define-data-var total-price-slime uint u465000000)
...
;; Alt Minting Default
(define-data-var total-price-alex uint u5100000000)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? crazy-parrots (+ last-nft-id u0) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u1) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u2) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u3) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u4) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u5) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u6) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u7) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u8) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u9) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u10) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u11) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u12) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u13) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u14) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u15) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u16) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u17) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u18) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u19) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u20) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u21) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u22) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u23) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u24) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u25) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u26) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u27) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u28) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u29) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u30) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u31) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u32) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u33) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u34) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u35) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u36) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u37) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u38) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u39) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u40) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u41) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u42) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
      (try! (nft-mint? crazy-parrots (+ last-nft-id u43) 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1))
      (map-set token-count 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1 (+ (get-balance 'SP2EVCFEDHES7NMYM6JYMGYFNVKEEGX4NJVJR1QR1) u1))
