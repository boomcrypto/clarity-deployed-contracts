      ...
      (if (is-some swap-data)
        (let 
          (
            ...
            (swap-result (try! (swap-alex (merge (unwrap-panic swap-data) {dx: collateral-obtained, min-out: (some asset-min-out)}))))
...
(define-private (batch-liquidate-position
  ...
  (as-contract (contract-call? 'SP1M6MHD4EJ70MPJSH1C0PXSHCQ3D9C881AB7CVAZ.liquidator-v1 batch-liquidate
