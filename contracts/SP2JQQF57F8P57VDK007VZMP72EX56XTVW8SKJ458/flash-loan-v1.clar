...
(define-public (flash-loan (amount uint) (callback <callback-trait>) (data (optional (buff 20480))))
  (let (
      (flash-loan-fee (contract-call? 'SP2R995XG7W1KHYSTGC6Q8AT0C79379W7C6133AQZ.math-v1 divide-round-up (* amount fee) max-fee))
    ...
    (try! (contract-call? 'SP2R995XG7W1KHYSTGC6Q8AT0C79379W7C6133AQZ.state-v1 transfer-to 'SP3Y2ZSH8P7D50B0VBTSX11S7XSG24M1VB9YFQA4K.token-aeusdc caller amount))
    (try! (contract-call? callback on-granite-flash-loan amount flash-loan-fee data))
    (try! (contract-call? 'SP2R995XG7W1KHYSTGC6Q8AT0C79379W7C6133AQZ.state-v1 transfer-from 'SP3Y2ZSH8P7D50B0VBTSX11S7XSG24M1VB9YFQA4K.token-aeusdc caller amount))
    (try! (contract-call? 'SP3Y2ZSH8P7D50B0VBTSX11S7XSG24M1VB9YFQA4K.token-aeusdc transfer flash-loan-fee caller 'SP2R995XG7W1KHYSTGC6Q8AT0C79379W7C6133AQZ.governance-v1 none))
    (print {
      action: "flash-loan",
      amount: amount,
      fee: flash-loan-fee,
