...
(define-non-fungible-token bitcoin-skulls uint)
...
(define-data-var artist-address principal 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmcWo2psThAf7DniQYt9NK3fHJHG14H1jPhzZE6d4ieAA3/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? bitcoin-skulls next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? bitcoin-skulls token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? bitcoin-skulls token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? bitcoin-skulls token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? bitcoin-skulls id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? bitcoin-skulls id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? bitcoin-skulls id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u26221)
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u10640000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u9633000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u56000000)
...
;; Alt Minting Default
(define-data-var total-price-slime uint u809000000)
...
;; Alt Minting Default
(define-data-var total-price-alex uint u7800000000)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u0) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u1) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u2) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u3) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u4) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u5) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u6) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u7) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u8) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u9) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u10) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u11) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u12) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u13) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u14) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u15) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u16) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u17) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u18) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u19) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u20) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u21) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u22) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u23) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u24) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u25) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u26) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u27) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u28) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u29) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u30) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u31) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u32) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u33) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u34) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u35) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u36) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u37) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u38) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u39) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u40) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u41) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u42) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u43) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u44) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u45) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u46) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u47) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u48) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u49) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u50) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u51) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u52) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u53) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u54) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u55) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u56) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u57) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u58) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u59) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u60) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u61) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u62) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u63) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u64) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u65) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u66) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u67) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u68) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u69) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u70) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u71) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u72) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u73) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u74) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u75) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u76) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u77) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u78) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u79) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u80) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u81) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u82) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u83) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u84) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u85) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u86) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u87) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u88) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u89) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u90) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u91) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u92) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u93) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u94) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u95) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u96) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u97) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
      (try! (nft-mint? bitcoin-skulls (+ last-nft-id u98) 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143))
      (map-set token-count 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143 (+ (get-balance 'SPQ2RTWH56VM7X2T0TG8Y553AZD0J5253F08A143) u1))
