    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4286667))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"BTC%20Dust%20Voting%20for%20pox%20Cycle%20118%2C119%2C120")
    (var-set description u"")
    (var-set voting-system "fptp")
    (var-set options (list "9b36fb43-3ffd-46c0-b548-be843ac4768f" "06008b70-4a89-44a4-95a7-05217316b8b3"))
    (var-set start u919892)
    (var-set end u929892)
    (map-set results {id: "9b36fb43-3ffd-46c0-b548-be843ac4768f"} {count: u0, name: u"Choice%201", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "06008b70-4a89-44a4-95a7-05217316b8b3"} {count: u0, name: u"Choice%202", locked-stx: u0, unlocked-stx: u0})