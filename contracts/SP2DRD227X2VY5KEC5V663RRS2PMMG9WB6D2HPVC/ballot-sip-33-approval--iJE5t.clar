    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4210425))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"SIP%2033%20Approval%20Poll")
    (var-set description u"%3Cp%3E%3Cbr%3E%3C%2Fp%3E%3Cp%3EBTC%20Dust%20Tx%20Details%3C%2Fp%3E%3Cp%3EHere%20are%20the%20address%20for%20voting%3A%3C%2Fp%3E%3Cp%3EYes%2011111111111mdWK2VXcrA1ebz4vAVd%3C%2Fp%3E%3Cp%3ENo%20111111111111ACW5wa4RwyeosCaEC9%3C%2Fp%3E%3Cp%3E%3Cbr%3E%3C%2Fp%3E%3Cp%3EDust%20amount%20is%3A%200.0001%3C%2Fp%3E")
    (var-set voting-system "fptp")
    (var-set options (list "cf3b0306-a043-4fb7-9452-0930cb9a1819" "8af97e17-887d-4269-9f7e-67a872f372a4"))
    (var-set start u919281)
    (var-set end u929281)
    (map-set results {id: "cf3b0306-a043-4fb7-9452-0930cb9a1819"} {count: u0, name: u"Yes", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "8af97e17-887d-4269-9f7e-67a872f372a4"} {count: u0, name: u"No", locked-stx: u0, unlocked-stx: u0})