    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"New%20Poll%20on%2027%20Sep%202025")
    (var-set description u"test")
    (var-set voting-system "fptp")
    (var-set options (list "136fd820-d80f-46d0-b720-510c93fd7516" "cd49ef63-acaa-4f13-b8c5-0e4d923db1cd"))
    (var-set start u214139)
    (var-set end u314139)
    (map-set results {id: "136fd820-d80f-46d0-b720-510c93fd7516"} {count: u0, name: u"Choice%201"}) (map-set results {id: "cd49ef63-acaa-4f13-b8c5-0e4d923db1cd"} {count: u0, name: u"Choice%202"})