    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u214484))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Poll%20with%20STX%20gating")
    (var-set description u"")
    (var-set voting-system "weighted")
    (var-set options (list "6c42f5ce-7bb7-4abb-b738-4e130bb569f9" "05e9e1dd-34c9-4dd0-8c29-30d4dbc6ecfe"))
    (var-set start u214484)
    (var-set end u224484)
    (map-set results {id: "6c42f5ce-7bb7-4abb-b738-4e130bb569f9"} {count: u0, name: u"Yes"}) (map-set results {id: "05e9e1dd-34c9-4dd0-8c29-30d4dbc6ecfe"} {count: u0, name: u"No"})