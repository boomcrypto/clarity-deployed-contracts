    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4203555))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Dust%20Polling%20with%20STX")
    (var-set description u"")
    (var-set voting-system "fptp")
    (var-set options (list "478eacac-052d-46f1-adf7-450babb6cdb4" "11d52078-723f-437f-976b-f6f8cbf76452"))
    (var-set start u919233)
    (var-set end u929233)
    (map-set results {id: "478eacac-052d-46f1-adf7-450babb6cdb4"} {count: u0, name: u"Yes", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "11d52078-723f-437f-976b-f6f8cbf76452"} {count: u0, name: u"No", locked-stx: u0, unlocked-stx: u0})