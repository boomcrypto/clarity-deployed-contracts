    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4265660))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"BTC%20Dust%20Voting")
    (var-set description u"")
    (var-set voting-system "fptp")
    (var-set options (list "3b1eaeb2-852f-43ed-b897-c4de50fa34c6" "74aef635-ef2d-4066-ac5b-7ad2570bccec"))
    (var-set start u919731)
    (var-set end u929731)
    (map-set results {id: "3b1eaeb2-852f-43ed-b897-c4de50fa34c6"} {count: u0, name: u"Yes", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "74aef635-ef2d-4066-ac5b-7ad2570bccec"} {count: u0, name: u"No", locked-stx: u0, unlocked-stx: u0})