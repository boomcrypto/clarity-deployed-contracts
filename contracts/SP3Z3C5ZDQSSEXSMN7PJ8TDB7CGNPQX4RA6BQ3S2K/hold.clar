...
;; $HOLD TGE / Total 100B
(begin
  (try! (ft-mint? HODL u10000000000000000 tx-sender)) 
)
;; Define the owner address
(define-data-var owner-address principal tx-sender) 
(define-data-var treasury-address principal 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5)
(define-data-var dev-wallet-address principal 'ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG)
