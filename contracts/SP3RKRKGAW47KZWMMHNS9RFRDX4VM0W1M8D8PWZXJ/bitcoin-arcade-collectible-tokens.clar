;; bitcoin-arcade-collectible-tokens
;; contractType: public

(impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.nft-trait.nft-trait)

(define-non-fungible-token bitcoin-arcade-collectible-tokens uint)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmQXigDrNkeLba9Qrd4qn6g9Nhd2evy9AEtKMhCn4Q4HbS/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? bitcoin-arcade-collectible-tokens next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? bitcoin-arcade-collectible-tokens token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? bitcoin-arcade-collectible-tokens token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? bitcoin-arcade-collectible-tokens token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? bitcoin-arcade-collectible-tokens id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? bitcoin-arcade-collectible-tokens id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? bitcoin-arcade-collectible-tokens id) (err ERR-NOT-FOUND)))
...
(map-set mint-passes 'SP2HN4M5NJVH5VEZ32JVWF1XSRVNHFJ04K5TWQ4P4 u9)
(map-set mint-passes 'SP1SHMD0WTEYENHC56S1D8QH283EGJKJ56GHJXGS9 u9)
(map-set mint-passes 'SP1RR941EJWD105F07TAS0J2RJBNHNWWJZCY51VTC u8)
(map-set mint-passes 'SPAFPBD7M89973WDEN68FKYW761RQVYNHSEFQZB9 u8)
(map-set mint-passes 'SP6GT5H78G88AWVCFCGPMAGPJ98X4777HHV0GX1T u5)
(map-set mint-passes 'SPGMTQN3MR9RXGP4WGJ49KMJXFG87FPMCJ3VAX1X u5)
(map-set mint-passes 'SPPDZ2G6ZCY2VHVTTRVPVZS5KCG4JG8T6WEHTC7Z u5)
(map-set mint-passes 'SP2N4P4HH1Q7Q6FGPY2X0YS7YDQCG2VQB2HXRJMTH u4)
...
(map-set mint-passes 'SP2K5N6HZGJ3X7R14625AR0PGEBMYR0Z71X632GQ7 u2)
(map-set mint-passes 'SP14NSM2BAB9MGMYNXJB93NY4EF4NFRW3G3EFBZDX u2)
(map-set mint-passes 'SPQPGTADAXTM1SDBBW3A2E5D6YB9GVG6QHPRAT9W u2)
(map-set mint-passes 'SPBNAM3RV2ZTXAYRV70PETHWSJ65NA319JXCQX08 u1)
(map-set mint-passes 'SP2Z4HPQ6B5S9181TBWGX78AN6ADVJ22RPEQX1W7W u1)
...
(map-set mint-passes 'SP1BFMJZ9QMGAA682FSKGHKQ7ADWMK7V23GHFR9R6 u1)
...
(map-set mint-passes 'SP25HAV8ZKNE8B7QCT1FPKPD8JQF2KK06VKQE6JSE u1)
...
(map-set mint-passes 'SPBT99HP63WJVRCTN8PET0YDA3F4C7H6FR65RF43 u1)
...
(map-set mint-passes 'SP2E8KZ7MFVFZ8D4YQAGBF28F5RZKR186R95AP2PN u1)
