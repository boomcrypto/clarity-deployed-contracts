...
(use-trait alex-ft-trait .alex-trait-sip-010.sip-010-trait)
(use-trait alex-pool-trait .alex-pool-trait.pool-trait)
  ...
  (let 
    ...
    (if (and (is-some token-z) (is-some token-w) (is-some token-v))
      (begin 
        ...
        (ok (try! (contract-call? pool swap-helper-c
          token-x
          token-y
      ...
      (if (and (is-some token-z) (is-some token-w))
          (begin 
              ...
              (ok (try! (contract-call? pool swap-helper-b
                token-x
                token-y
                (unwrap-panic token-z)
                (unwrap-panic token-w)
          ...
          (if (is-some token-z)
              (begin 
                ...
                (ok (try! (contract-call? pool swap-helper-a
                  token-x
                  token-y
                  (unwrap-panic token-z)
                  factor-x
              ...
              (begin
                ...
                (ok (try! (contract-call? pool swap-helper
                  token-x
                  token-y
                  factor-x
                  dx
