...
(define-public (a16 (amountIn uint))
(let (
...
(define-public (a15 (amountIn uint))
(let (
...
(ok (list amountIn b1 (/ b2 u100)))
)
)

(define-public (a3 (amountIn uint))
(let (
...
(define-public (a5 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-xbtc-arkadiko amountIn)))
...
(define-public (a38 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-xbtc-alex (* amountIn u100))))
(b2 (unwrap-panic (swap-xbtc-usda-arkadiko b1)))
(b3 (unwrap-panic (swap-usda-wstx-arkadiko b2)))
...
(define-public (a10 (amountIn uint))
(let (
...
(define-public (a4 (amountIn uint))
(let (
...
(define-public (a9 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-usda-arkadiko amountIn)))
(b2 (unwrap-panic (swap-usda-xbtc-arkadiko b1)))
...
(define-public (a8 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-usda-arkadiko amountIn)))
(b2 (unwrap-panic (swap-usda-xbtc-arkadiko b1)))
...
(define-public (a2 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-usda-arkadiko amountIn)))
...
(define-public (a6 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-diko-arkadiko amountIn)))
(b2 (unwrap-panic (swap-diko-usda-arkadiko b1)))
(b3 (unwrap-panic (swap-usda-xbtc-arkadiko b2)))
...
(define-public (a7 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-xbtc-arkadiko amountIn)))
(b2 (unwrap-panic (swap-xbtc-usda-arkadiko b1)))
...
(define-public (a14 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-xbtc-alex (* amountIn u100))))
(b2 (unwrap-panic (swap-xbtc-usda-arkadiko b1)))
(b3 (unwrap-panic (swap-usda-diko-arkadiko b2)))
...
(define-public (a13 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-xbtc-alex-2 (* amountIn u100))))
(b2 (unwrap-panic (swap-xbtc-usda-arkadiko b1)))
(b3 (unwrap-panic (swap-usda-diko-arkadiko b2)))
...
(define-public (a20 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-usda-arkadiko amountIn)))
...
(define-public (a19 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-usda-arkadiko amountIn)))
(b2 (unwrap-panic (swap-usda-alex-alex (* b1 u100))))
...
(define-public (a18 (amountIn uint))
(let (
...
(define-public (a17 (amountIn uint))
(let (
...
(define-public (ua32 (amountIn uint))
(let (
...
(define-public (a33 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-usda-cryptomate amountIn)))
(b2 (unwrap-panic (swap-usda-alex-alex (* b1 u100))))
(b3 (unwrap-panic (swap-alex-wstx-alex b2)))
...
(define-public (a34 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-alex-alex (* amountIn u100))))
(b2 (unwrap-panic (swap-alex-usda-alex b1)))
...
(define-public (a1 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-xbtc-alex (* amountIn u100))))
...
(define-public (a37 (amountIn uint))
(let (
...
(define-public (a35 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-xbtc-arkadiko amountIn)))
(b2 (unwrap-panic (swap-xbtc-wstx-cryptomate b1)))
)
...
(define-public (a36 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-xbtc-cryptomate amountIn)))
(b2 (unwrap-panic (swap-xbtc-wstx-arkadiko b1)))
)
...
(define-public (a26 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-usda-arkadiko amountIn)))
...
(define-public (a25 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-alex-alex (* amountIn u100))))
(b2 (unwrap-panic (swap-alex-usda-alex b1)))
...
(define-public (a24 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-wxusd-alex (* amountIn u100))))
(b2 (unwrap-panic (swap-wxusd-usda-alex b1)))
...
(define-public (a23 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-wxusd-alex (* amountIn u100))))
(b2 (unwrap-panic (swap-wxusd-usda-alex b1)))
(b3 (unwrap-panic (swap-usda-alex-alex b2)))
...
(define-public (a28 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-usda-arkadiko amountIn)))
(b2 (unwrap-panic (swap-usda-diko-arkadiko b1)))
...
(define-public (a27 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-usda-arkadiko amountIn)))
(b2 (unwrap-panic (swap-usda-diko-arkadiko b1)))
(b3 (unwrap-panic (swap-diko-alex-alex (* b2 u100))))
...
(define-public (a30 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-alex-alex (* amountIn u100))))
...
(define-public (a29 (amountIn uint))
(let (
(b1 (unwrap-panic (swap-wstx-alex-alex-2 (* amountIn u100))))
(b2 (unwrap-panic (swap-alex-diko-alex b1)))
(b3 (unwrap-panic (swap-diko-usda-arkadiko (/ b2 u100))))
