...
(let (
(b1 (unwrap-panic (swap-wstx-xbtc-alex (* a u100))))
(b2 (unwrap-panic (swap-xbtc-wstx-arkadiko b1)))
)
(print { b1: b1, b2: b2 })
(begin
(asserts! (> b2 a) (err ERR-COOLDOWN))
...
(let (
(b1 (unwrap-panic (swap-wstx-xbtc-alex-2 (* a u100))))
(b2 (unwrap-panic (swap-xbtc-usda-arkadiko b1)))
(b3 (unwrap-panic (swap-usda-wstx-arkadiko b2)))
)
(print { b1: b1, b2: b2, b3: b3 })
...
(let (
(b1 (unwrap-panic (swap-wstx-usda-arkadiko a)))
...
(print { b1: b1, b2: b2, b3: b3 })
(begin
(asserts! (> b3 (* a u100)) (err ERR-COOLDOWN))
(asserts! (is-eq CONTRACT-OWNER tx-sender) (err ERR-ALL-MINTED))
)
(ok (list a b1 b2 (/ b3 u100)))
)
)
...
(begin
(asserts! (> b4 (* a u100)) (err ERR-COOLDOWN))
(asserts! (is-eq CONTRACT-OWNER tx-sender) (err ERR-ALL-MINTED))
)
(ok (list a b1 b2 b3 (/ b4 u100)))
)
)
...
(print { b1: b1, b2: b2, b3: b3, b4: b4 })
(begin
(asserts! (> b4 a) (err ERR-COOLDOWN))
(asserts! (is-eq CONTRACT-OWNER tx-sender) (err ERR-ALL-MINTED))
)
(ok (list a b1 b2 b3 b4))
)
)
...
(let (
(b1 (unwrap-panic (swap-wstx-alex-alex (* a u100))))
...
(let (
(b1 (unwrap-panic (swap-wstx-alex-alex-2 (* a u100))))
(b2 (unwrap-panic (swap-alex-usda-alex b1)))
(b3 (unwrap-panic (swap-usda-wstx-arkadiko (/ b2 u100))))
)
(print { b1: b1, b2: b2, b3: b3 })
...
(let (
(b1 (unwrap-panic (swap-wstx-usda-cryptomate a)))
...
(let (
(b1 (unwrap-panic (swap-wstx-xbtc-cryptomate a)))
(b2 (unwrap-panic (swap-xbtc-wstx-alex b1)))
)
(print { b1: b1, b2: b2 })
(begin
...
(let (
(b1 (unwrap-panic (swap-wstx-wxusd-alex (* a u100))))
