    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Do you think Owl Link should have NFTs?")
    (var-set description u"Owl Link (https://owl.link) is a decentralized alternative to Linktree. A bio-link tool built on top of the .btc namespace. There have been 200 profiles created approximately six months after the launch. Many community members aren't aware of it, so there hasn't been much growth. An NFT collection may be able to bootstrap Owl Link, thereby creating awareness and adoption. The funds will be used to develop and grow Owl Link. NFT holders would receive a revenue share from Owl Link sales. Would you mind voting")
    (var-set voting-system "fptp")
    (var-set options (list "cd7732bc-a250-4a16-a4ec-78ee28816dce" "91b46c91-c4c1-4c8c-b8db-be651100fb8c"))
    (var-set start u76734)
    (var-set end u77886)
    (map-set results {id: "cd7732bc-a250-4a16-a4ec-78ee28816dce"} {count: u0, name: u"Yes"}) (map-set results {id: "91b46c91-c4c1-4c8c-b8db-be651100fb8c"} {count: u0, name: u"No"})