    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"BlockSurvey%20Rebrand%20")
    (var-set description u"Would%20you%20be%20okay%20rebranding%20BlockSurvey%20to%20a%20new%20name%3F%20")
    (var-set voting-system "fptp")
    (var-set options (list "869b2dad-792e-49cd-a0fb-0f869aac2b71" "c75f1169-fdb4-46a9-b21c-7cab5a780285"))
    (var-set start u214145)
    (var-set end u214155)
    (map-set results {id: "869b2dad-792e-49cd-a0fb-0f869aac2b71"} {count: u0, name: u"Yes"}) (map-set results {id: "c75f1169-fdb4-46a9-b21c-7cab5a780285"} {count: u0, name: u"No"})