...
(define-public (request-new-trading-asset (token <ft>) (price-feed-id (buff 32)) (new-max-slippage uint) (is-stablecoin bool))
  (let (
    ...
    (print { action: "request-new-trading-asset", user: contract-caller, data: { old-value: (get-trading-asset token-address), new-value: new-entry } })
...
(define-public (remove-trading-asset (address principal))
  (begin
    (try! (contract-call? .test-hq-vaults-v1 check-is-owner contract-caller))
    (print { action: "remove-trading-asset", user: contract-caller, data: { old-value: (get-trading-asset address) } })
...
(define-public (request-new-connection (address principal))
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v1 check-is-owner contract-caller))
    (print { action: "request-new-connection", user: contract-caller, data: { old-value: (get-connection address), new-value: new-entry } })
...
(define-public (remove-connection (address principal))
  (begin
    (try! (contract-call? .test-hq-vaults-v1 check-is-owner contract-caller))
    (print { action: "remove-connection", user: contract-caller, data: { old-value: (get-connection address) } })
...
(define-public (request-new-silo (address principal))
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v1 check-is-owner contract-caller))
    (print { action: "request-new-silo", user: contract-caller, data: { old-value: (get-silo address), new-value: new-entry } })
...
(define-public (remove-silo (address principal))
  (begin
    (try! (contract-call? .test-hq-vaults-v1 check-is-owner contract-caller))
    (print { action: "remove-silo", user: contract-caller, data: { old-value: (get-silo address) } })
...
;; Initialize silos
(map-set silos { address: .test-silo-hbtc-v1 } { active: true, ts: init-ts })
