...
(define-public (hermetica-stake
  ...
  (let (
    ...
    (try! (contract-call? .test-state-hbtc2-v1 check-is-connection contract))
    (try! (contract-call? .test-reserve-hbtc2-v1 transfer 'SPN5AKG35QZSK2M8GAMR4AFX45659RJHDW353HSG.usdh-token-v1 amount this-contract))
    (try! (as-contract (contract-call? staking-trait stake amount none)))
    (try! (as-contract (contract-call? 'SPN5AKG35QZSK2M8GAMR4AFX45659RJHDW353HSG.susdh-token-v1 transfer susdh-amount this-contract .test-reserve-hbtc2-v1 none)))
...
(define-public (hermetica-unstake
  ...
  (let (
    (contract (contract-of staking-trait))
    (transfer-result (try! (contract-call? .test-reserve-hbtc2-v1 transfer 'SPN5AKG35QZSK2M8GAMR4AFX45659RJHDW353HSG.susdh-token-v1 amount this-contract)))
...
(define-public (hermetica-withdraw
  ...
  (let (
    ...
    (try! (as-contract (contract-call? 'SPN5AKG35QZSK2M8GAMR4AFX45659RJHDW353HSG.usdh-token-v1 transfer amount this-contract .test-reserve-hbtc2-v1 none)))
...
(define-public (hermetica-unstake-and-withdraw
  ...
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v1 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc2-v1 check-is-trading-enabled))
    (try! (contract-call? .test-state-hbtc2-v1 check-connections-and-assets staking-contract (some staking-silo-contract) none none))
    (try! (as-contract (contract-call? staking-silo-trait withdraw claim-id)))
    (try! (as-contract (contract-call? 'SPN5AKG35QZSK2M8GAMR4AFX45659RJHDW353HSG.usdh-token-v1 transfer usdh-amount this-contract .test-reserve-hbtc2-v1 none)))
...
(define-public (hermetica-mint
  ...
  (let (
    ...
    (minting-asset-data (contract-call? .test-state-hbtc2-v1 get-trading-asset minting-asset))
    ...
    (try! (contract-call? .test-hq-vaults-v1 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc2-v1 check-is-trading-enabled))
    (try! (contract-call? .test-state-hbtc2-v1 check-connections-and-assets minting-contract none (some minting-asset) none))
    (try! (contract-call? .test-reserve-hbtc2-v1 transfer minting-asset-trait amount-asset this-contract))
    ...
    (try! (as-contract (contract-call? 'SPN5AKG35QZSK2M8GAMR4AFX45659RJHDW353HSG.usdh-token-v1 transfer amount-usdh this-contract .test-reserve-hbtc2-v1 none)))
...
(define-public (hermetica-redeem
  ...
  (let (
    ...
    (redeeming-asset-data (contract-call? .test-state-hbtc2-v1 get-trading-asset redeeming-asset))
    ...
    (try! (contract-call? .test-hq-vaults-v1 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc2-v1 check-is-trading-enabled))
    (try! (contract-call? .test-state-hbtc2-v1 check-connections-and-assets minting-contract none (some redeeming-asset) none))    
    (try! (contract-call? .test-reserve-hbtc2-v1 transfer 'SPN5AKG35QZSK2M8GAMR4AFX45659RJHDW353HSG.usdh-token-v1 amount-usdh this-contract))
    ...
    (let (
      ...
      (try! (as-contract (contract-call? redeeming-asset-trait transfer asset-received this-contract .test-reserve-hbtc2-v1 none)))
