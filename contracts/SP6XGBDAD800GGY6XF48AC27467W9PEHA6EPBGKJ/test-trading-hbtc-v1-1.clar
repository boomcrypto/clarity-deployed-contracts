...
(define-public (open-position-zest
  ...
  (begin
    ...
    (try! (contract-call? .test-hermetica-interface-hbtc-v1-1 hermetica-stake
      usdh-borrow-amount
      staking-trait))
...
(define-public (close-position-zest
  ...
  (begin
    ...
    (try! (contract-call? .test-hermetica-interface-hbtc-v1-1 hermetica-unstake-and-withdraw
