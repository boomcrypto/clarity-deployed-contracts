...
(define-data-var mint-confirmation-window uint u2)
(define-data-var redeem-confirmation-window uint u2)
...
(define-data-var min-amount-usdh-requested uint (* u10 usdh-base))
