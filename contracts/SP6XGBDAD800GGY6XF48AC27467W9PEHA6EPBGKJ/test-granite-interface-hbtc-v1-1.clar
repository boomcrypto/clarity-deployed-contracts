...
(define-public (granite-borrow
  ...
  (let (
    ...
    (try! (contract-call? .test-state-hbtc-v1-1 check-connections-and-assets borrower-contract none (some asset) none))
...
(define-public (granite-add-collateral
  ...
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v1-1 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v1-1 check-is-trading-enabled))
    (try! (contract-call? .test-state-hbtc-v1-1 check-connections-and-assets borrower-contract none (some collateral) none))
    (try! (contract-call? .test-reserve-hbtc-v1-1 transfer collateral-trait amount this-contract))
