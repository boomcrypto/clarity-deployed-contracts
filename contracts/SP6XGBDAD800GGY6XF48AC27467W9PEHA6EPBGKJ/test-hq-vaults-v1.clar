...
(map-set vaults { address: .test-vault-hbtc-v1 } { active: true, ts: (some (get-current-ts)) })

;; Initialize protocols
(map-set protocol { address: .test-controller-hbtc-v1 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-vault-hbtc-v1 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-silo-hbtc-v1 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-reserve-fund-hbtc-v1 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-zest-interface-hbtc-v1 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-hermetica-interface-hbtc-v1 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-bitflow-interface-hbtc-v1 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-granite-interface-hbtc-v1 } { active: true, ts: (some (get-current-ts)) })
