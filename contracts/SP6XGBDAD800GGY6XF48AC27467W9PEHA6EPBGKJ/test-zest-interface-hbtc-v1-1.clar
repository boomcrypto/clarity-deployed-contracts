...
(define-public (zest-supply
  ...
  (let (
    ...
    (try! (contract-call? .test-state-hbtc-v1-1 check-connections-and-assets borrow-helper-contract none (some asset) none))
    (try! (contract-call? .test-reserve-hbtc-v1-1 transfer asset-trait amount this-contract))
...
(define-public (zest-borrow
  ...
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v1-1 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v1-1 check-is-trading-enabled))
    (try! (contract-call? .test-state-hbtc-v1-1 check-connections-and-assets borrow-helper-contract none (some asset-to-borrow) none))
    (try! (write-feed price-feed-bytes1))
    (try! (write-feed price-feed-bytes2))
...
(define-public (zest-repay
  ...
  (let (
    ...
    (try! (contract-call? .test-state-hbtc-v1-1 check-is-trading-enabled))
    (try! (contract-call? .test-state-hbtc-v1-1 check-connections-and-assets borrow-helper-contract none (some asset) none))
    (try! (contract-call? .test-reserve-hbtc-v1-1 transfer asset-trait amount-to-repay this-contract))
...
(define-public (zest-claim-rewards
  ...
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v1-1 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v1-1 check-is-trading-enabled))
    (try! (contract-call? .test-state-hbtc-v1-1 check-connections-and-assets borrow-helper-contract none (some asset) (some reward-asset)))
    (try! (write-feed price-feed-bytes1))
    (try! (write-feed price-feed-bytes2))
