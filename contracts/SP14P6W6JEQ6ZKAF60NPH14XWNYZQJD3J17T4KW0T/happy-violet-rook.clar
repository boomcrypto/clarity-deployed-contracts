(impl-trait 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.trait-initializable-farm-v1a.initializable-farm-trait)
 ...
 (define-data-var reward_token_1 principal 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.null-token-v1a)
 (define-data-var reward_token_2 principal 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.null-token-v1a)
 (define-data-var reward_token_3 principal 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.null-token-v1a)
 (define-data-var reward_token_4 principal 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.null-token-v1a)
 ...
 (define-public (initialize 
   ...
   (begin
     ...
     (asserts! (is-eq contract-caller (unwrap-panic (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-dao-v5k get-qualified-name-by-name "one-step-mint-group-farm"))) (err ERR_DAO_ACCESS))
     ...
     (if (is-eq 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.null-token-v1a (contract-of reward_token_1_in))
       false
       (begin
         ...
         (map-set RewardData {
             stakingToken: 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b,
             rewardToken: (contract-of reward_token_1_in)
           }
     ...
     (if (is-eq 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.null-token-v1a (contract-of reward_token_2_in))
       false
       (begin
     ...
     (if (is-eq 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.null-token-v1a (contract-of reward_token_3_in))
       false
       (begin
     ...
     (if (is-eq 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.null-token-v1a (contract-of reward_token_4_in))
       false
       (begin
   ...
   (ok
     {
       ...
       nft_staked_gold: (getTotalDataOrDefault 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b),
       nft_staked_silver: (getTotalDataOrDefault 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-silver-pass-v1b),
   ...
   (ok
     {
       ...
       nft_reward: 
       (list 
         (getRewardDataOrDefault 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b reward_token_1_temp)
         (getRewardDataOrDefault 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b reward_token_2_temp)
         (getRewardDataOrDefault 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b reward_token_3_temp)
         (getRewardDataOrDefault 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b reward_token_4_temp)
       ),
     }
   )
 )
 ...
 (define-private (transferToGolds (id uint))
   (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b transfer id tx-sender (as-contract tx-sender))
 )
 
 (define-private (transferToSilvers (id uint))
   (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-silver-pass-v1b transfer id tx-sender (as-contract tx-sender))
 )
 ...
 (define-private (transferFromGolds (id uint))
   (let
     ...
     (as-contract (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b transfer id tx-sender user))
   )
 )
 (define-private (transferFromSilvers (id uint))
   (let
     ...
     (as-contract (contract-call? 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-silver-pass-v1b transfer id tx-sender user))
   )
 )
 ...
 (define-public (stakeNFTs (gold_list (list 50 uint)) (silver_list (list 50 uint)))
   (let (
       ...
       (tempTotalGold (getTotalDataOrDefault 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b))
       (tempTotalSilver (getTotalDataOrDefault 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-silver-pass-v1b))
     ...
     (map-set TotalData
       'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b
       (+ tempTotalGold amount_gold)
     )
     (map-set TotalData
       'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-silver-pass-v1b
 ...
 (define-private (getUserRewardP2 (rewardToken principal) (tvl uint) (uvl_total uint) (uvl_in_count uint) (nft_count_takes_t uint) (nft_count_limit_t uint))
   (let (
       (reward (getRewardDataOrDefault 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b rewardToken))
       (in_count_sum 
 ...
 (define-private (getEntitledNFTStakingReward (user principal) (stacksHeight uint))
   (let
     (
       (silverTotalData (getTotalDataOrDefault 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-silver-pass-v1b))
       (goldTotalData (getTotalDataOrDefault 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stackswap-gold-pass-v1b))
