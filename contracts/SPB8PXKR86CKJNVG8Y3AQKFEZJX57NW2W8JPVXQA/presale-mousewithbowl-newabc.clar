...
(define-constant TOKEN_TO_LIST u5000000) ;; parameter, user will replace it while creating presale
(define-constant TOKEN_TO_SELL u20000000) ;; parameter,
(define-constant START_BLOCK u907065) ;; parameter, 
(define-constant END_BLOCK u907069) ;; parameter, 
(define-constant WHITELIST_END_BLOCK u907068) ;; parameter, End of whitelist period, start of public sale

;; Constants for STXCITY fee distribution
(define-constant STXCITY_FEE_PERCENT u5)  ;; 5% STXCITY fee
(define-constant DEPLOYER_PERCENT u15)   ;; Percentage of raise for deployer
...
;; Milestone 3: Block 2 - 50% (0.0 days)
;; Milestone 4: Block 3 - 69% (0.0 days)
...
(define-constant MILESTONE_3_PERCENT u50)    
(define-constant MILESTONE_4_PERCENT u69)    
...
(begin
    ...
    (try! (contract-call? 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.mouse-with-bowl transfer u25000000 tx-sender 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.presale-mousewithbowl-newabc none))
