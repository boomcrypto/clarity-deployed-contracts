...
(define-constant LAUNCHPAD_TOKEN 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.testpresaledecimals)
...
(define-constant TOKEN_TO_LIST u1000000000000000) ;; parameter, user will replace it while creating presale
(define-constant TOKEN_TO_SELL u1000000000000000) ;; parameter,
(define-constant START_BLOCK u907091) ;; parameter, 
(define-constant END_BLOCK u907093) ;; parameter, 
(define-constant WHITELIST_END_BLOCK u907091) ;; parameter, End of whitelist period, start of public sale
...
;; Milestone 5: Block 1000 - 100% (6.9 days)
...
(define-constant MILESTONE_5_BLOCKS u1000)   
...
(begin
    ...
    (try! (contract-call? 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.testpresaledecimals transfer u2000000000000000 tx-sender 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.presale-testpresaledecimals-exso none))
