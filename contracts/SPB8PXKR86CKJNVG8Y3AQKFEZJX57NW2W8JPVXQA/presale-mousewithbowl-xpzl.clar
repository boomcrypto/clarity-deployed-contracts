...
(define-constant TOKEN_TO_LIST u4131005) ;; parameter, user will replace it while creating presale
(define-constant TOKEN_TO_SELL u6196508) ;; parameter,
(define-constant START_BLOCK u909950) ;; parameter, 
(define-constant END_BLOCK u909960) ;; parameter, 
(define-constant WHITELIST_END_BLOCK u909950) ;; parameter, End of whitelist period, start of public sale
...
(begin
    ...
    (try! (contract-call? 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.mouse-with-bowl transfer u10327513 tx-sender 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.presale-mousewithbowl-xpzl none))
