...
(define-constant TOKEN_TO_LIST u47211490) ;; parameter, user will replace it while creating presale
(define-constant TOKEN_TO_SELL u70817235) ;; parameter,
(define-constant START_BLOCK u909944) ;; parameter, 
(define-constant END_BLOCK u909948) ;; parameter, 
(define-constant WHITELIST_END_BLOCK u909944) ;; parameter, End of whitelist period, start of public sale
...
(begin
    ...
    (try! (contract-call? 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.mouse-with-bowl transfer u118028725 tx-sender 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.presale-mousewithbowl-dqjh none))
