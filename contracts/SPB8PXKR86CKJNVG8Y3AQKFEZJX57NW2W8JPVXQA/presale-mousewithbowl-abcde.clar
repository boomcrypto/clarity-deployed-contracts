...
(define-constant TOKEN_TO_LIST u4995000) ;; parameter, user will replace it while creating presale
(define-constant TOKEN_TO_SELL u4995000) ;; parameter,
(define-constant START_BLOCK u907060) ;; parameter, 
(define-constant END_BLOCK u907062) ;; parameter, 
(define-constant WHITELIST_END_BLOCK u907060) ;; parameter, End of whitelist period, start of public sale
...
(begin
    ...
    (try! (contract-call? 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.mouse-with-bowl transfer u9990000 tx-sender 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.presale-mousewithbowl-abcde none))
