...
(define-constant allow-token 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.xenojellyfishsurge-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u999900009999000)
    (var-set stx-balance u99900)
