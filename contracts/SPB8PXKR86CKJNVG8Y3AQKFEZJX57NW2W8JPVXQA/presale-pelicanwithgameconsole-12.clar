...
(define-constant TOKEN_TO_LIST u400000000) ;; parameter, user will replace it while creating presale
(define-constant TOKEN_TO_SELL u160000000) ;; parameter,
(define-constant START_BLOCK u906908) ;; parameter, 
(define-constant END_BLOCK u916808) ;; parameter, 
(define-constant WHITELIST_END_BLOCK u906908) ;; parameter, End of whitelist period, start of public sale
...
(define-data-var presale-hardcap uint u3000000)  ;; parameter
...
(begin
    ...
    ;; (try! (contract-call? 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.pelican-with-game-console transfer u560000000 tx-sender 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.presale-pelicanwithgameconsole-abcde none))
