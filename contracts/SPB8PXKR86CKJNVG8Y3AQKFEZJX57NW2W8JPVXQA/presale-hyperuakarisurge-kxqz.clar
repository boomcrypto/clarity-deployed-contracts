...
(define-constant LAUNCHPAD_TOKEN 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.hyperuakarisurge)
(define-constant LAUNCHPAD_ADDRESS (as-contract tx-sender))
(define-constant AMM_WALLET 'SP1N76MP7KXCF3M76QW77DZKSB9SK2SQFDP3SAY3P) ;; TODO: replace real Velar address here
(define-constant STXCITY_WALLET 'SP3HGE2GH9SAD0PKY66XAVA7F0G3CYVE1E2DQ7HV0) ;; STXCITY wallet
(define-constant TOKEN_TO_LIST u49900000) ;; parameter, user will replace it while creating presale
(define-constant TOKEN_TO_SELL u49900000) ;; parameter,
(define-constant START_BLOCK u909388) ;; parameter, 
(define-constant END_BLOCK u909488) ;; parameter, 
(define-constant WHITELIST_END_BLOCK u909388) ;; parameter, End of whitelist period, start of public sale
...
(begin
    ...
    (try! (contract-call? 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.hyperuakarisurge transfer u99800000 tx-sender 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.presale-hyperuakarisurge-kxqz none))
