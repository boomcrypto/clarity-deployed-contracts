...
(define-constant LAUNCHPAD_TOKEN 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.mouse-with-bowl)
...
(define-constant TOKEN_TO_LIST u4945050) ;; parameter, user will replace it while creating presale
(define-constant TOKEN_TO_SELL u14835150) ;; parameter,
(define-constant START_BLOCK u907165) ;; parameter, 
(define-constant END_BLOCK u907169) ;; parameter, 
(define-constant WHITELIST_END_BLOCK u907168) ;; parameter, End of whitelist period, start of public sale

;; Constants for STXCITY fee distribution
(define-constant STXCITY_FEE_PERCENT u5)  ;; 5% STXCITY fee
(define-constant DEPLOYER_PERCENT u20)   ;; Percentage of raise for deployer
...
;; Milestone 2: Block 1 - 50% (0.0 days)
;; Milestone 3: Block 2 - 60% (0.0 days)
;; Milestone 4: Block 3 - 90% (0.0 days)
...
(define-constant MILESTONE_2_PERCENT u50)    
(define-constant MILESTONE_3_PERCENT u60)    
(define-constant MILESTONE_4_PERCENT u90)    
...
(define-data-var max-buy uint u1200000)             ;; parameter
...
(begin
    ...
    (try! (contract-call? 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.mouse-with-bowl transfer u19780200 tx-sender 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.presale-mousewithbowl-new none))
    (var-set initialized true)
    
    ;; Transfer STX fee to stxcity wallet
    (try! (stx-transfer? u200000 tx-sender 'SP13WKEGYP2ENJEVMK5VT1YKDBHGGRN2Z7Z79FFZ6))
