...
(define-constant allow-token 'SPB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W8JPVXQA.squirrel-with-nails-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u20994751312171)
    (var-set stx-balance u100000)
