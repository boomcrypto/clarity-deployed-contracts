(use-trait commission-trait 'SP6P4EJF0VG8V0RB3TQQKJBHDQKEF6NVRD1KZE3C.commission-trait.commission)
...
(define-public (buy-item (collection <marketplace>) (item-id uint) (comm <commission-trait>) (referer uint))
    (let (
        (item (contract-call? 'SP6P4EJF0VG8V0RB3TQQKJBHDQKEF6NVRD1KZE3C.satoshibles get-listing-in-ustx item-id))
