...
(define-non-fungible-token blue-hobbit-cloud-4 uint)
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? blue-hobbit-cloud-4 id sender recipient)
        success
          (let
...
(define-read-only (get-owner (id uint))
  ;; Make sure to replace blue-hobbit-cloud-4
  (ok (nft-get-owner? blue-hobbit-cloud-4 id)))
...
(define-private (mint (new-owner principal))
    (let (
      ...
      (match (nft-mint? blue-hobbit-cloud-4 next-id new-owner)
        success
        (let
...
(define-public (burn (id uint) (owner principal))
    ...
    (match (nft-burn? blue-hobbit-cloud-4 id owner)
        success
        (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? blue-hobbit-cloud-4 id) false)))
...
(define-public (buy-in-ustx (id uint) (comm <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? blue-hobbit-cloud-4 id) ERR-NOT-FOUND))
