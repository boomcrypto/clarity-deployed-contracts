...
(define-public (execute)
  (let (
    ...
    (reward-list (map + 
      ...
      (list last-id last-id last-id last-id last-id last-id last-id last-id last-id last-id last-id last-id last-id last-id last-id)
    ))
    (total-list (list total-ids total-ids total-ids total-ids total-ids total-ids total-ids total-ids total-ids total-ids total-ids total-ids total-ids total-ids total-ids))
  )
    ...
    (if (has-claimed-all) 
      (var-set last-total-reward-ids (+ last-id u15))
      true
    )
