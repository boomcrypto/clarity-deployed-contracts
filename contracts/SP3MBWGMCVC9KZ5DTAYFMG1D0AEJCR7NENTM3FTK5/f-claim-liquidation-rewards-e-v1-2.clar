...
(define-data-var last-total-reward-ids uint u35)
...
(define-public (execute)
  (let (
    ...
    (if (< id-1 total-reward-ids) (unwrap-panic (claim-liquidation-rewards id-1)) false)
    (if (< id-2 total-reward-ids) (unwrap-panic (claim-liquidation-rewards id-2)) false)
    (if (< id-3 total-reward-ids) (unwrap-panic (claim-liquidation-rewards id-3)) false)
    (if (< id-4 total-reward-ids) (unwrap-panic (claim-liquidation-rewards id-4)) false)
    (if (< id-5 total-reward-ids) (unwrap-panic (claim-liquidation-rewards id-5)) false)
    (if (< id-6 total-reward-ids) (unwrap-panic (claim-liquidation-rewards id-6)) false)
    (if (< id-7 total-reward-ids) (unwrap-panic (claim-liquidation-rewards id-7)) false)
    (if (< id-8 total-reward-ids) (unwrap-panic (claim-liquidation-rewards id-8)) false)
    (if (< id-9 total-reward-ids) (unwrap-panic (claim-liquidation-rewards id-9)) false)
    (if (< id-10 total-reward-ids) (unwrap-panic (claim-liquidation-rewards id-10)) false)
