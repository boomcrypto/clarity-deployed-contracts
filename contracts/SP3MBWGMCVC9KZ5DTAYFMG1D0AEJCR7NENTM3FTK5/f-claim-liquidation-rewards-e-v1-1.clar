...
(define-public (execute)
  (let (
    ...
    (id-1 (+ (var-get last-total-reward-ids) u0))
    (id-2 (+ (var-get last-total-reward-ids) u1))
    (id-3 (+ (var-get last-total-reward-ids) u2))
    (id-4 (+ (var-get last-total-reward-ids) u3))
    (id-5 (+ (var-get last-total-reward-ids) u4))
  )
    ...
    (if (< id-5 total-reward-ids) 
      (var-set last-total-reward-ids id-5)
