;; @contract Compound DIKO from DAO to DIKO/USDA
;; @version 1.1
...
(define-private (execute-return-usda)
  (let (
    ...
    (contract-call? 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token transfer balance .lydian-dao .treasury-v1-1 none)
  )
)
