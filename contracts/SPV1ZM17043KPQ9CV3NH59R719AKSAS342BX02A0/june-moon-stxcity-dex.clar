...
(define-constant token-supply u83338883338000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPV1ZM17043KPQ9CV3NH59R719AKSAS342BX02A0.june-moon-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u66671106670400000)
    (var-set stx-balance u100000000)
