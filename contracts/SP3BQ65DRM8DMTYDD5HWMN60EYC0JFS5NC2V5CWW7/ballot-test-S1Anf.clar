    ...
    (var-set options (list "af5d79a0-7090-47cd-8726-8b0ce9e81060" "db9e6f43-6cb9-41b7-9b67-1e5d535cb52d"))
    (var-set start u81339)
    (var-set end u81483)
    (map-set results {id: "af5d79a0-7090-47cd-8726-8b0ce9e81060"} {count: u0, name: u"Good"}) (map-set results {id: "db9e6f43-6cb9-41b7-9b67-1e5d535cb52d"} {count: u0, name: u"Bad"})