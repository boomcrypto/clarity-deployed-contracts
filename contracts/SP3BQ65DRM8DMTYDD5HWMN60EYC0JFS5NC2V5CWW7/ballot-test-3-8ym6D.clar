    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"test #3")
    (var-set description u"this is test #3")
    (var-set voting-system "fptp")
    (var-set options (list "04353247-da90-49b6-b98b-c7d21f733b16" "8501f89a-a01b-423f-8356-1f1c4a2d23a9"))
    (var-set start u80368)
    (var-set end u80512)
    (map-set results {id: "04353247-da90-49b6-b98b-c7d21f733b16"} {count: u0, name: u"Yes"}) (map-set results {id: "8501f89a-a01b-423f-8356-1f1c4a2d23a9"} {count: u0, name: u"No"})