    ...
    (var-set options (list "bb6cdfc5-262b-4a3c-bd34-50f11c433dd1" "e532ac48-0a46-4826-a807-5c13eabdb7f2"))
    (var-set start u104816)
    (var-set end u105248)
    (map-set results {id: "bb6cdfc5-262b-4a3c-bd34-50f11c433dd1"} {count: u0, name: u"Choice 1"}) (map-set results {id: "e532ac48-0a46-4826-a807-5c13eabdb7f2"} {count: u0, name: u"Choice 2"})