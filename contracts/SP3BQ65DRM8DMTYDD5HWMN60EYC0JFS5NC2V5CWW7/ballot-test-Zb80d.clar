    ...
    (var-set options (list "3c93bef0-d299-4340-84b9-bce54bd4ac0f" "14e83014-c571-4922-a9ac-848abf2a8658"))
    (var-set start u103516)
    (var-set end u103516)
    (map-set results {id: "3c93bef0-d299-4340-84b9-bce54bd4ac0f"} {count: u0, name: u"Choice 1"}) (map-set results {id: "14e83014-c571-4922-a9ac-848abf2a8658"} {count: u0, name: u"Choice 2"})