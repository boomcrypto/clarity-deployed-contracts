    ...
    (var-set options (list "3c8f8793-d49a-4afc-b5d9-5e96facf9f1d" "7e5ae208-f1a0-46c5-99d2-5cd0705765d9"))
    (var-set start u114863)
    (var-set end u114869)
    (map-set results {id: "3c8f8793-d49a-4afc-b5d9-5e96facf9f1d"} {count: u0, name: u"Choice 1"}) (map-set results {id: "7e5ae208-f1a0-46c5-99d2-5cd0705765d9"} {count: u0, name: u"Choice 2"})