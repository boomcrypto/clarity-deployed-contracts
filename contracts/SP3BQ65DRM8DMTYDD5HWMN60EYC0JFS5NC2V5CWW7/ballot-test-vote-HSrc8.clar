    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Test Vote")
    (var-set description u"This is a test vote")
    (var-set voting-system "fptp")
    (var-set options (list "22bb0551-b553-42c5-9e83-de55fce84cf2" "c12a11ba-db6e-4fb5-9bff-3bba64917368"))
    (var-set start u80070)
    (var-set end u80072)
    (map-set results {id: "22bb0551-b553-42c5-9e83-de55fce84cf2"} {count: u0, name: u"Yes"}) (map-set results {id: "c12a11ba-db6e-4fb5-9bff-3bba64917368"} {count: u0, name: u"No"})