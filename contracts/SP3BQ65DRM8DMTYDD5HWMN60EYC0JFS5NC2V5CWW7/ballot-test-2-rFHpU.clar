    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"test #2")
    (var-set description u"test #2")
    (var-set voting-system "fptp")
    (var-set options (list "51138963-d799-407e-964a-c96219321ea4" "8703067c-d1b3-423f-8129-9dd29e89d7fa"))
    (var-set start u80291)
    (var-set end u80435)
    (map-set results {id: "51138963-d799-407e-964a-c96219321ea4"} {count: u0, name: u"Yes"}) (map-set results {id: "8703067c-d1b3-423f-8129-9dd29e89d7fa"} {count: u0, name: u"No"})