    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Test2")
    (var-set description u"Test")
    (var-set voting-system "fptp")
    (var-set options (list "b9712f69-b9b8-42b9-be88-1e7215cb46ae" "5a96f825-f2d4-47f4-99f9-3a8806fd0b00"))
    (var-set start u103541)
    (var-set end u103544)
    (map-set results {id: "b9712f69-b9b8-42b9-be88-1e7215cb46ae"} {count: u0, name: u"Choice 1"}) (map-set results {id: "5a96f825-f2d4-47f4-99f9-3a8806fd0b00"} {count: u0, name: u"Choice 2"})