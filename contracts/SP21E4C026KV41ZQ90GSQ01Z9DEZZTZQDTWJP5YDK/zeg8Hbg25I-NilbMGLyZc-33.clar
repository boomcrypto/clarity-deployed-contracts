...
(define-private (lIrZANWJdVyFpL
    ...
    (KnKttLSP2Bg7cb6-decimals uint)
    (TPksrk9EaNzhmtf-decimals uint)
    (dx uint)
 )
    (let
        (
            (pXfHvdKmHDUGJjF (try! (contract-call? gSdwYJmyTzoWDD get-decimals)))
            (cMUfNFrmT8z3bzk (try! (contract-call? WwVyVrEOHQxVXy get-decimals)))
            (alex-dx (gqyGnZJgEuDTGv dx KnKttLSP2Bg7cb6-decimals pXfHvdKmHDUGJjF))
            (hVpH7SXShUTSB3e (unwrap! (as-contract (contract-call? 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.swap-helper-v1-03 swap-helper gSdwYJmyTzoWDD WwVyVrEOHQxVXy alex-dx none)) (err ERR-SWAP-ALEX-FAILED)))
            ;; (lgOKJUDXNTYsaE (SKhZ8LVzFT9NBhJ hVpH7SXShUTSB3e TPksrk9EaNzhmtf-decimals cMUfNFrmT8z3bzk))
        )
        (ok hVpH7SXShUTSB3e)
    )
)
...
(define-read-only (gqyGnZJgEuDTGv
    (amount uint)
    (token-decimals uint)
    (PWuyHpzaB2MRbKfs uint)
)
    (/ (* amount (pow u10 PWuyHpzaB2MRbKfs)) (pow u10 token-decimals))
)

(define-read-only (SKhZ8LVzFT9NBhJ
    (amount uint)
    (token-decimals uint)
    (PWuyHpzaB2MRbKfs uint)
)
    (/ (* amount (pow u10 token-decimals)) (pow u10 PWuyHpzaB2MRbKfs))
)
...
(define-public (withdraw-token (token-trait <AxSDVMnsiYamlC>) (amount uint))
    (let (
        (z89U2vcrbMgcMz3 tx-sender)
    )
        (asserts! (is-eq tx-sender contract-owner) ERR-NOT-OWNER)
        (try! (as-contract (contract-call? token-trait transfer amount tx-sender z89U2vcrbMgcMz3 none)))
        (ok amount)
    )
)

(define-public (swap-helper-1
    ...
    (let
        ...
        (asserts! (is-eq tx-sender contract-owner) ERR-NOT-OWNER)
        (if (is-eq KnKttLSP2Bg7cb6 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.wrapped-stx-token)
        ...
        (let
            (
                (lgOKJUDXNTYsaE (try! (VCQGoSAdvbxUQE REZaDNbWLaV7mk3 KnKttLSP2Bg7cb6 TPksrk9EaNzhmtf dx)))
            )
            ;; (if (is-eq TPksrk9EaNzhmtf 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.wrapped-stx-token)
            ;;     (begin (try! (as-contract (stx-transfer? lgOKJUDXNTYsaE tx-sender z89U2vcrbMgcMz3))))
            ;;     (begin (try! (as-contract (contract-call? esHhZSmChD5PCRU transfer lgOKJUDXNTYsaE tx-sender z89U2vcrbMgcMz3 none))))
            ;; )
            (ok lgOKJUDXNTYsaE)
        )
    )
...
(define-public (swap-helper-2
    ...
    (let
        ...
        (let
            (
                (lgOKJUDXNTYsaE (try! (VCQGoSAdvbxUQE REZaDNbWLaV7mk3 KnKttLSP2Bg7cb6 TPksrk9EaNzhmtf dx)))
                (nmoFJdZDqlSrMz (try! (VCQGoSAdvbxUQE B2ScWCyaYXQhb8x TPksrk9EaNzhmtf KnKttLSP2Bg7cb6 lgOKJUDXNTYsaE)))
            )
            (if (is-eq jnJe1z8sXPa46T true)
...
(define-public (swap-helper-3
    (gmf9MFsEr5uXqn6 <AxSDVMnsiYamlC>)
    (esHhZSmChD5PCRU <AxSDVMnsiYamlC>)
    (wQr8gDaERtpureL <AxSDVMnsiYamlC>)
    (REZaDNbWLaV7mk3 (string-ascii 10))
    (B2ScWCyaYXQhb8x (string-ascii 10))
    (wJYQXHsHjjkAjGQ (string-ascii 10))
    (dx uint)
    (jnJe1z8sXPa46T bool)
)
    (let
        (
            ...
            (KnKttLSP2Bg7cb6 (contract-of gmf9MFsEr5uXqn6))
            (TPksrk9EaNzhmtf (contract-of esHhZSmChD5PCRU))
            (KQy3z6rX2kaVbuV (contract-of wQr8gDaERtpureL))
        )
        (asserts! (is-eq tx-sender contract-owner) ERR-NOT-OWNER)
        (if (is-eq jnJe1z8sXPa46T true)
            (begin (try! (stx-transfer? dx tx-sender (as-contract tx-sender))))
        ...
        (let
            (
                (YdQCD5C9ed6Rsmk (try! (VCQGoSAdvbxUQE REZaDNbWLaV7mk3 KnKttLSP2Bg7cb6 TPksrk9EaNzhmtf dx)))
                (lgOKJUDXNTYsaE (try! (VCQGoSAdvbxUQE B2ScWCyaYXQhb8x TPksrk9EaNzhmtf KQy3z6rX2kaVbuV YdQCD5C9ed6Rsmk)))
                (nmoFJdZDqlSrMz (try! (VCQGoSAdvbxUQE wJYQXHsHjjkAjGQ KQy3z6rX2kaVbuV KnKttLSP2Bg7cb6 lgOKJUDXNTYsaE)))
            )
            (if (is-eq jnJe1z8sXPa46T true)
                (begin (try! (as-contract (stx-transfer? nmoFJdZDqlSrMz tx-sender z89U2vcrbMgcMz3))))
                (begin (try! (as-contract (contract-call? gmf9MFsEr5uXqn6 transfer nmoFJdZDqlSrMz tx-sender z89U2vcrbMgcMz3 none))))
...
(define-private (jCNlDTWjRAKdEN
    ...
    (ok
        ...
        (if (and (is-eq KnKttLSP2Bg7cb6 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.wrapped-stx-token) (is-eq TPksrk9EaNzhmtf 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.age000-governance-token))
            (try! (lIrZANWJdVyFpL 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.age000-governance-token u6 u8 dx))
            (if (and (is-eq KnKttLSP2Bg7cb6 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.age000-governance-token) (is-eq TPksrk9EaNzhmtf 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.wrapped-stx-token))
                (try! (lIrZANWJdVyFpL 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.age000-governance-token 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx u8 u6 dx))
        (if (and (is-eq KnKttLSP2Bg7cb6 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.age000-governance-token) (is-eq TPksrk9EaNzhmtf 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token))
            (try! (lIrZANWJdVyFpL 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.age000-governance-token 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wusda u8 u6 dx))
            (if (and (is-eq KnKttLSP2Bg7cb6 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token) (is-eq TPksrk9EaNzhmtf 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.age000-governance-token))
                (try! (lIrZANWJdVyFpL 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wusda 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.age000-governance-token u6 u8 dx))
        (if (and (is-eq KnKttLSP2Bg7cb6 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.wrapped-stx-token) (is-eq TPksrk9EaNzhmtf 'SP2TZK01NKDC89J6TA56SA47SDF7RTHYEQ79AAB9A.Wrapped-USD))
            (try! (lIrZANWJdVyFpL 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wxusd u6 u8 dx))
            (if (and (is-eq KnKttLSP2Bg7cb6 'SP2TZK01NKDC89J6TA56SA47SDF7RTHYEQ79AAB9A.Wrapped-USD) (is-eq TPksrk9EaNzhmtf 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.wrapped-stx-token))
                (try! (lIrZANWJdVyFpL 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wxusd 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx u8 u6 dx))
        (if (and (is-eq KnKttLSP2Bg7cb6 'SP2TZK01NKDC89J6TA56SA47SDF7RTHYEQ79AAB9A.Wrapped-USD) (is-eq TPksrk9EaNzhmtf 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token))
            (try! (lIrZANWJdVyFpL 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wxusd 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wusda u8 u6 dx))
            (if (and (is-eq KnKttLSP2Bg7cb6 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token) (is-eq TPksrk9EaNzhmtf 'SP2TZK01NKDC89J6TA56SA47SDF7RTHYEQ79AAB9A.Wrapped-USD))
                (try! (lIrZANWJdVyFpL 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wusda 'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wxusd u6 u8 dx))
            (unwrap-panic (ok u0))
        ))))))))))))
    )
)
...
(define-private (wZWrGLyILlrjrJ
    ...
    (ok
        ...
        (if (and (is-eq KnKttLSP2Bg7cb6 'SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.Wrapped-Bitcoin) (is-eq TPksrk9EaNzhmtf 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token))
            (try! (jijxzMDvfRcCZC 'SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.Wrapped-Bitcoin 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token false dx))
            (if (and (is-eq KnKttLSP2Bg7cb6 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token) (is-eq TPksrk9EaNzhmtf 'SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.Wrapped-Bitcoin))
                (try! (jijxzMDvfRcCZC 'SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.Wrapped-Bitcoin 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token true dx))
        (if (and (is-eq KnKttLSP2Bg7cb6 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-token) (is-eq TPksrk9EaNzhmtf 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token))
            (try! (jijxzMDvfRcCZC 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-token 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token false dx))
            (if (and (is-eq KnKttLSP2Bg7cb6 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token) (is-eq TPksrk9EaNzhmtf 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-token))
                (try! (jijxzMDvfRcCZC 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-token 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token true dx))
            (unwrap-panic (ok u0))
        ))))))))))
    )
)
...
(define-private (ZyPMebpnWHRDUT
    ...
    (ok
        ...
        (if (and (is-eq KnKttLSP2Bg7cb6 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.wrapped-stx-token) (is-eq TPksrk9EaNzhmtf 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a))
            (try! (CVsvpVOgvZZqZL 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.wstx-token-v4a 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.liquidity-token-stx-stsw false dx))
            (if (and (is-eq KnKttLSP2Bg7cb6 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a) (is-eq TPksrk9EaNzhmtf 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.wrapped-stx-token))
                (try! (CVsvpVOgvZZqZL 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.wstx-token-v4a 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.liquidity-token-stx-stsw true dx))
        (if (and (is-eq KnKttLSP2Bg7cb6 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a) (is-eq TPksrk9EaNzhmtf 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.lbtc-token-v1c))
            (try! (CVsvpVOgvZZqZL 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.lbtc-token-v1c 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.liquidity-token-v5krqbd8nh6 false dx))
            (if (and (is-eq KnKttLSP2Bg7cb6 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.lbtc-token-v1c) (is-eq TPksrk9EaNzhmtf 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a))
                (try! (CVsvpVOgvZZqZL 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.stsw-token-v4a 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.lbtc-token-v1c 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275.liquidity-token-v5krqbd8nh6 true dx))
            (unwrap-panic (ok u0))
        ))))))))))
    )
)
