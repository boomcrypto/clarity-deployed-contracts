...
(define-constant STX_TARGET_AMOUNT u15000000000)
(define-constant VIRTUAL_STX_VALUE u3000000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u300000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP2DRM5DKDJX6ECFJH9XDT66DZV8FK2H1A27JZHCA.rw-buy-first-charisma-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u999968254976032)
    (var-set stx-balance u95238)
