...
(define-constant STX_TARGET_AMOUNT u8000000000)
(define-constant VIRTUAL_STX_VALUE u1600000000) ;; 1/5 of STX_TARGET_AMOUNT
(define-constant COMPLETE_FEE u160000000) ;; 2% of STX_TARGET_AMOUNT
...
(define-constant allow-token 'SP2DRM5DKDJX6ECFJH9XDT66DZV8FK2H1A27JZHCA.rw-no-buy-first-velar-1-stxcity)
