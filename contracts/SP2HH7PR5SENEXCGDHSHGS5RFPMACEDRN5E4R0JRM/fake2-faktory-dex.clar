  ...
  ;; ca64bf6aae333a6b9a14209ed3327a407f809234daeffb97bc014f98f68a3cdd
  ...
  (define-constant DEX-TOKEN 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake2-faktory)
  ...
  (define-public (buy (ft <faktory-token>) (ubtc uint))
    (begin
      ...
      (let (
        ...
        (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
                    transfer pre-fee tx-sender 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake2-pre-faktory none))
        (try! (as-contract (contract-call? 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake2-pre-faktory create-fees-receipt pre-fee))) 
        (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
        ...
        (if (>= new-stx TARGET_STX)
            (let ((premium-amount (/ (* new-ft (var-get premium)) u100))
              ...
              (try! (as-contract (contract-call? 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake2-pre-faktory toggle-bonded))) 
  ...
  (define-public (open-market) 
    (let ((is-prelaunch-allowing (unwrap-panic (contract-call? 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake2-pre-faktory is-market-open))))
    ...
    (begin
      ...
      (var-set ft-balance u16000000000000000)
        (print { 
            ...
            poolName: 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.xyk-pool-sbtc-fake2-v-1-1
       })
      (ok true))