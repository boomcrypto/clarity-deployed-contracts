...
;; 747d7548d59b48c935b2b621eb7f56b18d0674753f75dce657534137cf21c87a
;; fake2 Powered By Faktory.fun v1.0 
...
(define-fungible-token FAKE2 MAX)
(define-constant MAX u100000000000000000)
(define-data-var contract-owner principal 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake2-token-owner)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? FAKE2 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance FAKE2 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? FAKE2 (/ (* MAX u80) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake2-treasury)) ;; 80% treasury
    (try! (ft-mint? FAKE2 (/ (* MAX u16) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake2-faktory-dex))
    (try! (ft-mint? FAKE2 (/ (* MAX u4) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake2-pre-faktory))
