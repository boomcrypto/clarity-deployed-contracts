...
;; fee43e71eca7284f1e1ed29f6f86dc2c9782029c0e6b7a02350823742d234421
;; granui1 Powered By Faktory.fun v1.0 
...
(define-fungible-token GRANUI1 MAX)
(define-constant MAX u100000000000000000)
(define-data-var contract-owner principal 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.granui1-token-owner)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? GRANUI1 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance GRANUI1 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? GRANUI1 (/ (* MAX u80) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.granui1-treasury)) ;; 80% treasury
    (try! (ft-mint? GRANUI1 (/ (* MAX u16) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.granui1-faktory-dex))
    (try! (ft-mint? GRANUI1 (/ (* MAX u4) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.granui1-pre-faktory))
