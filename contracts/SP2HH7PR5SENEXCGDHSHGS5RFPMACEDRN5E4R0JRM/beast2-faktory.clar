...
;; 5c9449b9ef0f1778de76bccabf93b2ac67a90f5d4ae9461ea3b2613ea04b8152
;; beast2 Powered By Faktory.fun v1.0 
...
(define-fungible-token BEAST2 MAX)
(define-constant MAX u100000000000000000)
(define-data-var contract-owner principal 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.beast2-token-owner)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? BEAST2 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance BEAST2 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? BEAST2 (/ (* MAX u80) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.beast2-treasury)) ;; 80% treasury
    (try! (ft-mint? BEAST2 (/ (* MAX u16) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.beast2-faktory-dex))
    (try! (ft-mint? BEAST2 (/ (* MAX u4) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.beast2-pre-faktory))
