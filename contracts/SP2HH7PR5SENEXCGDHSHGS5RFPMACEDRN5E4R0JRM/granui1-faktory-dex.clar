  ...
  ;; 355cbbceec2e0f4ca950007af1d2ae9f87e61f645a5b3ea127b8183b9344a651
  ...
  (define-constant ORIGINATOR 'SP3N41Z9P8E9BM715R6V6189R3RK6FVVXWAGNP8P6)
  (define-constant DEX-TOKEN 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.granui1-faktory)
  ...
  (define-public (buy (ft <faktory-token>) (ubtc uint))
    (begin
      ...
      (let (
        ...
        (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
                    transfer pre-fee tx-sender 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.granui1-pre-faktory none))
        (try! (as-contract (contract-call? 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.granui1-pre-faktory create-fees-receipt pre-fee))) 
        (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
        ...
        (if (>= new-stx TARGET_STX)
            (let ((premium-amount (/ (* new-ft (var-get premium)) u100))
              ...
              (try! (as-contract 
                     (contract-call? 
                       'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-core-v-1-2 
                           create-pool 
                           'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.xyk-pool-sbtc-granui1-v-1-1
              ...
              (try! (as-contract (contract-call? 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.granui1-pre-faktory toggle-bonded))) 
  ...
  (define-public (open-market) 
    (let ((is-prelaunch-allowing (unwrap-panic (contract-call? 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.granui1-pre-faktory is-market-open))))
    ...
    (begin
      ...
      (var-set ft-balance u16000000000000000)
        (print { 
            ...
            poolName: 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.xyk-pool-sbtc-granui1-v-1-1
       })
      (ok true))