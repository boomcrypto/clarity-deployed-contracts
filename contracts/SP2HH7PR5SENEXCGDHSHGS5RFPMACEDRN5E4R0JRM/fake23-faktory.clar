...
;; 6d493eb2f52c34b8648e3248b4f0ac26a1ddc33a63c719c874ce8393f6d05dcc
;; fake23 Powered By Faktory.fun v1.0 
...
(define-fungible-token FAKE23 MAX)
(define-constant MAX u100000000000000000)
(define-data-var contract-owner principal 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake23-token-owner)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? FAKE23 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance FAKE23 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? FAKE23 (/ (* MAX u80) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake23-treasury)) ;; 80% treasury
    (try! (ft-mint? FAKE23 (/ (* MAX u16) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake23-faktory-dex))
    (try! (ft-mint? FAKE23 (/ (* MAX u4) u100) 'SP2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5E4R0JRM.fake23-pre-faktory))
