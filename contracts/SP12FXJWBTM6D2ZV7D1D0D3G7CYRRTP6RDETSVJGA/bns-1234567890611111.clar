...
(define-private (wstx-diko-a (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.amm-swap-pool-v1-1 swap-x-for-y
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wdiko
...
(define-private (diko-wstx-a (x uint))
(match (contract-call?
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.amm-swap-pool-v1-1 swap-y-for-x
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wstx
'SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-wdiko
...
(define-private (swap-a
  ...
  (if (is-eq a T_STX)
    ...
    (if (is-eq b T_DIKO) (wstx-diko-a x)
    ERR_AB)))))))
  (if (is-eq a T_XUSD)
  ...
  (if (is-eq a T_DIKO)
    ...
    (if (is-eq b T_STX) (diko-wstx-a x)
    ERR_AB))
  (if (is-eq a T_USDA)
...
(awl 'SP2CPTERN5D0379R89EEKXTMAT7SMPGJW8KB0V9DR)                                                                                                                                                                                (six u5464654600)
(define-private (xfer
  (a (string-ascii 1))
  (amt uint)
  (src principal)
