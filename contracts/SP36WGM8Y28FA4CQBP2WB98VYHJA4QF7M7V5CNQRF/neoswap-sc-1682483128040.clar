...
;; Room: https://neoswap.xyz/rooms/oz19VcQKPpT0oZ7XPLxC
;; SwapId: b1Lyr2zngVCu8skKMcXS

;; traders
(define-constant TRADER-1 'SP2TW1D8YF5CE0NDP5VCR5NMTPHQ4PQR1KBB4NQ5Q)
...
;; receivers
(define-constant RECEIVER-1 'SP1MPHNP564DK55080BM8ENRQDH74H8GQA8Z5W1HX)
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
		...
		(unwrap! (contract-call? 'SPJSCH3DDEJ8GQPGYZBHSB4F3HX5Q222CG89PSAB.guest-wins transfer u362 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
	...
	(if (is-eq tx-sender TRADER-2)
		...
		(unwrap! (contract-call? 'SP377R6M98T0AC4MJZZFQ80DQX6AB1RFAY1WQK2D6.book-worms-v4 transfer u868 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
		...
		(unwrap! (contract-call? 'SP3EB7YHV5NERS2HMCGSGKNMN0BEH52W9H7YE4T9C.btc-ghosts transfer u3 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
	    )
            true
        )
	(if (is-eq tx-sender TRADER-3)
            (begin
		(unwrap! (stx-transfer? u5038000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
		(unwrap! (contract-call? 'SP3QWNA75CY7QAK7S9XG7T258KSVQE1DW4HGTVRA3.king-katz transfer u105 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
	    )
            true
        )
...
(define-private (release-escrow) 
    (begin
	(unwrap-panic (as-contract (contract-call? 'SP2J4TG4H9KYMTTG267KMR82JDM20WHET6XNR0PWQ.bitcoin-owlz transfer u1540 tx-sender TRADER-1)))
	(unwrap-panic (as-contract (contract-call? 'SP3EB7YHV5NERS2HMCGSGKNMN0BEH52W9H7YE4T9C.btc-ghosts transfer u3 tx-sender TRADER-1)))
	(unwrap-panic (as-contract (contract-call? 'SP2J4TG4H9KYMTTG267KMR82JDM20WHET6XNR0PWQ.bitcoin-owlz transfer u1541 tx-sender TRADER-1)))
	...
	(unwrap-panic (as-contract (contract-call? 'SPJSCH3DDEJ8GQPGYZBHSB4F3HX5Q222CG89PSAB.guest-wins transfer u362 tx-sender TRADER-2)))
	...
	(unwrap-panic (as-contract (contract-call? 'SP3QWNA75CY7QAK7S9XG7T258KSVQE1DW4HGTVRA3.king-katz transfer u105 tx-sender TRADER-2)))
	...
	(unwrap-panic (as-contract (contract-call? 'SP3D6PV2ACBPEKYJTCMH7HEN02KP87QSP8KTEH335.megapont-robot-component-nft transfer u53208 tx-sender TRADER-3)))
	(unwrap-panic (as-contract (contract-call? 'SP37PGRC42BRJ33HMC2SN4DT9QN8RHGC6AZ7DRGH9.stacks-checks transfer u217 tx-sender TRADER-3)))
	(unwrap-panic (as-contract (contract-call? 'SP377R6M98T0AC4MJZZFQ80DQX6AB1RFAY1WQK2D6.book-worms-v4 transfer u868 tx-sender TRADER-3)))

	(unwrap-panic (as-contract (stx-transfer? u1116000 tx-sender RECEIVER-1)))
	(unwrap-panic (as-contract (stx-transfer? u1387000 tx-sender TRADER-1)))
	(unwrap-panic (as-contract (stx-transfer? u2535000 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (contract-call? 'SP37PGRC42BRJ33HMC2SN4DT9QN8RHGC6AZ7DRGH9.stacks-checks transfer u217 tx-sender TRADER-1)))
		(unwrap-panic (as-contract (contract-call? 'SPJSCH3DDEJ8GQPGYZBHSB4F3HX5Q222CG89PSAB.guest-wins transfer u362 tx-sender TRADER-1)))
		...
		(unwrap-panic (as-contract (contract-call? 'SP3EB7YHV5NERS2HMCGSGKNMN0BEH52W9H7YE4T9C.btc-ghosts transfer u158 tx-sender TRADER-1)))
	    )
            true
        )
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (contract-call? 'SP3D6PV2ACBPEKYJTCMH7HEN02KP87QSP8KTEH335.megapont-robot-component-nft transfer u53208 tx-sender TRADER-2)))
		(unwrap-panic (as-contract (contract-call? 'SP3D6PV2ACBPEKYJTCMH7HEN02KP87QSP8KTEH335.megapont-robot-component-nft transfer u5587 tx-sender TRADER-2)))
		(unwrap-panic (as-contract (contract-call? 'SP377R6M98T0AC4MJZZFQ80DQX6AB1RFAY1WQK2D6.book-worms-v4 transfer u868 tx-sender TRADER-2)))
		(unwrap-panic (as-contract (contract-call? 'SP2J4TG4H9KYMTTG267KMR82JDM20WHET6XNR0PWQ.bitcoin-owlz transfer u1540 tx-sender TRADER-2)))
		(unwrap-panic (as-contract (contract-call? 'SP2J4TG4H9KYMTTG267KMR82JDM20WHET6XNR0PWQ.bitcoin-owlz transfer u1541 tx-sender TRADER-2)))
		(unwrap-panic (as-contract (contract-call? 'SP3EB7YHV5NERS2HMCGSGKNMN0BEH52W9H7YE4T9C.btc-ghosts transfer u3 tx-sender TRADER-2)))
	    )
            true
        )
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-3)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u5038000 tx-sender TRADER-3)))
		(unwrap-panic (as-contract (contract-call? 'SP3QWNA75CY7QAK7S9XG7T258KSVQE1DW4HGTVRA3.king-katz transfer u105 tx-sender TRADER-3)))
	    )
            true
        )
