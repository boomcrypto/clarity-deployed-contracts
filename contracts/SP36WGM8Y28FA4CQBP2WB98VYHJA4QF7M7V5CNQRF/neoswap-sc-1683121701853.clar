...
;; Room: https://neoswap.xyz/rooms/B9PFr0SEZPgkwX1QDWdS
;; SwapId: KKhdZt6ZWpjhwpkFnZtN
...
(define-private (deposit-escrow) 
	...
	(if (is-eq tx-sender TRADER-1)
            (begin
		(unwrap! (stx-transfer? u1178000 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_STX))
		(unwrap! (contract-call? 'SP2GG6GF6ESKMPNJYWZ35PF3Q8966MEDHH0AAYX6C.bitcoin-punkz transfer u6067 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
		(unwrap! (contract-call? 'SP12RGNJDCZ3AGVA0EM5W37FK46TMVN1859BFZ08K.bitcoin-chicks transfer u1677 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
	    )
            true
        )
...
(define-private (release-escrow) 
    (begin
	(unwrap-panic (as-contract (contract-call? 'SP1QZT85MFT8HBAG3XEK7K6QY4GGP3MSG5C3H9PQ1.bitcoin-bullfrogs-by-mr-wagmi transfer u33 tx-sender TRADER-1)))
	...
	(unwrap-panic (as-contract (contract-call? 'SP12RGNJDCZ3AGVA0EM5W37FK46TMVN1859BFZ08K.bitcoin-chicks transfer u1677 tx-sender TRADER-2)))
	(unwrap-panic (as-contract (contract-call? 'SP2GG6GF6ESKMPNJYWZ35PF3Q8966MEDHH0AAYX6C.bitcoin-punkz transfer u6067 tx-sender TRADER-2)))

	(unwrap-panic (as-contract (stx-transfer? u214000 tx-sender RECEIVER-1)))
	(unwrap-panic (as-contract (stx-transfer? u964000 tx-sender TRADER-2)))
...
(define-private (return-escrow) 
	...
	(if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-1)) TRADER_STATE_CONFIRMED)
            (begin
		(unwrap-panic (as-contract (stx-transfer? u1178000 tx-sender TRADER-1)))
		(unwrap-panic (as-contract (contract-call? 'SP2GG6GF6ESKMPNJYWZ35PF3Q8966MEDHH0AAYX6C.bitcoin-punkz transfer u6067 tx-sender TRADER-1)))
		(unwrap-panic (as-contract (contract-call? 'SP12RGNJDCZ3AGVA0EM5W37FK46TMVN1859BFZ08K.bitcoin-chicks transfer u1677 tx-sender TRADER-1)))
	    )
            true
        )
