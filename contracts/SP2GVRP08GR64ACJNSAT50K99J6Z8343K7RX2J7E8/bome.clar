...
;; DEFINE METADATA
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://gaia.hiro.so/hub/197dHzJ7KHCnu3A97hpsrk7E34vNM6ewSz/bome-0-decimals.json"))
...
(begin
    ...
    (try! (ft-mint? BOME u9990000000 (var-get contract-owner)))
  (try! (ft-mint? BOME u10000000 'SP1FQ3DQDR5N9HJX3XC5DNKFCG4DHH48EFJQV6QH0))
