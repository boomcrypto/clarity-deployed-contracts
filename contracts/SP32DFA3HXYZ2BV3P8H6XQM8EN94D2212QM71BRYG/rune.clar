...
(define-fungible-token rune MAXSUPPLY)
...
(define-public (transfer
  ...
  (begin
    ...
    (try! (ft-transfer? rune amount sender recipient))
...
(begin
  ...
  (try! (ft-mint? rune u9900000000000000 contract-owner))
  (try! (ft-mint? rune u100000000000000 'SP3A2R2763JHY9FTBX19GA02H58025Y9KVX301NYP))
)
