...
(define-non-fungible-token ancient-wisdom uint)
...
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmeTwyntVWqjqLJngjKKdMHBX3R8nPsowmwLS9j4owLDLB/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? ancient-wisdom next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? ancient-wisdom token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? ancient-wisdom token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? ancient-wisdom token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? ancient-wisdom id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? ancient-wisdom id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? ancient-wisdom id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u2491)
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u2908000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u2102000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u17000000)
...
;; Alt Minting Default
(define-data-var total-price-slime uint u179000000)
...
;; Alt Minting Default
(define-data-var total-price-alex uint u1200000000)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u0) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u1) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u2) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u3) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u4) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u5) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u6) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u7) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u8) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u9) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u10) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u11) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u12) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u13) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u14) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u15) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u16) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u17) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u18) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u19) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u20) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u21) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u22) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u23) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u24) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u25) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u26) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u27) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u28) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u29) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u30) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u31) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? ancient-wisdom (+ last-nft-id u32) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
