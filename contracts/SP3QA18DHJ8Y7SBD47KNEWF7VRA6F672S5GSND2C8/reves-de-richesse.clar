...
(define-non-fungible-token reves-de-richesse uint)
...
;; Internal variables
(define-data-var mint-limit uint u9990)
(define-data-var last-id uint u1)
(define-data-var total-price uint u6000000)
(define-data-var artist-address principal 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmPnd8qfMeW6vKyDXPzsiATxoUYRLhmbd43J9ezrxDXuWs/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? reves-de-richesse next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? reves-de-richesse token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? reves-de-richesse token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? reves-de-richesse token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? reves-de-richesse id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? reves-de-richesse id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? reves-de-richesse id) (err ERR-NOT-FOUND)))
...
;; Alt Minting Default
(define-data-var total-price-xbtc uint u24184)
...
;; Alt Minting Default
(define-data-var total-price-usda uint u6000000)
...
;; Alt Minting Default
(define-data-var total-price-mia2 uint u14591000000)
...
;; Alt Minting Default
(define-data-var total-price-nyc2 uint u10938000000)
...
;; Alt Minting Default
(define-data-var total-price-banana uint u43000000)
...
;; Alt Minting Default
(define-data-var total-price-slime uint u594000000)
...
;; Alt Minting Default
(define-data-var total-price-alex uint u5700000000)
...
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u0) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u1) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u2) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u3) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u4) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u5) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u6) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u7) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u8) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u9) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u10) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u11) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u12) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u13) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u14) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u15) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u16) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u17) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u18) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u19) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u20) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u21) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u22) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u23) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u24) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u25) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u26) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u27) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u28) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u29) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u30) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u31) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u32) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u33) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u34) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u35) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u36) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u37) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u38) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u39) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u40) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u41) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u42) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u43) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u44) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u45) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u46) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u47) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u48) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u49) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u50) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u51) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u52) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u53) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u54) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u55) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u56) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u57) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u58) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u59) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u60) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u61) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u62) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u63) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u64) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u65) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u66) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u67) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u68) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u69) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u70) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u71) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u72) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u73) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u74) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u75) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u76) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u77) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u78) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u79) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u80) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u81) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u82) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u83) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u84) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u85) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u86) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u87) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u88) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u89) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u90) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u91) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u92) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u93) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u94) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u95) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u96) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u97) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))
      (try! (nft-mint? reves-de-richesse (+ last-nft-id u98) 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8))
      (map-set token-count 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8 (+ (get-balance 'SP3QA18DHJ8Y7SBD47KNEWF7VRA6F672S5GSND2C8) u1))

      (var-set last-id (+ last-nft-id u99))
