...
(define-data-var base-uri (string-ascii 80) "bafybeidxws6d6qtilya6uk2usqd6qolswwtuwjzpaongf3tgsccuacg4ue/")
(define-data-var mint-price uint u3040000)
;; Percent u100 = 1%
(define-data-var royalty-percent uint u259)
    ...
    (
      ...
      (current-balance (get-balance tx-sender))
        ...
        (begin 
          ...
          (try! (nft-mint? hello next-id tx-sender))
...
(define-public (airdrop (recipient principal))
    ...
    (
      ...
      (current-balance (get-balance tx-sender))
        ...
        (begin
          (unwrap! (stx-transfer? fee tx-sender LMNFT) ERR_TRANSFER_FAIL)
          (try! (nft-mint? hello next-id recipient))
...
(define-private (is-sender-owner (id uint))
  (let 
    (
      (owner (unwrap! (nft-get-owner? hello id) false))
    )
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let 
    (
      (owner (unwrap! (nft-get-owner? hello id) ERR_NO_OWNER))
