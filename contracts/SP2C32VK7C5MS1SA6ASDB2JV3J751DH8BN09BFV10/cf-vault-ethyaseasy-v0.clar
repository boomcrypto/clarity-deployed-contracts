...
(define-constant CLIENT 0x22d3008cb54222b18300b1a27d7011a550261ab040fa0cc34360c7b13b6d42e3)
...
(define-public (execute-deposit
    ...
    (let (
            ;; Fetch & check for valid policy
            (policy (unwrap!
                (contract-call? 'SP2C32VK7C5MS1SA6ASDB2JV3J751DH8BN09BFV10.cf-helpers-state-v0 get-policy CLIENT policy-id)
                ERR_INVALID_POLICY
            ))
            ;; Unwrap transfer properties
            (transfer-policy (unwrap! (get transfer policy) ERR_INVALID_TYPE))
...
(define-private (verify-transaction-signature
    ...
    (begin
        ...
        (asserts!
            (is-none (contract-call? 'SP2C32VK7C5MS1SA6ASDB2JV3J751DH8BN09BFV10.cf-helpers-state-v0 get-used-auth-ids CLIENT auth-id))
            ERR_AUTH_ID_REPLAY
        )
        ;; Check that all signatures are valid & all signers are in the policy
        ...
        ;; update auth-id
        (unwrap!
            (contract-call? 'SP2C32VK7C5MS1SA6ASDB2JV3J751DH8BN09BFV10.cf-helpers-state-v0 set-auth-id CLIENT "users"
                auth-id
            )
            ERR_AUTH_ID_REPLAY
        )
...
(contract-call? 'SP2C32VK7C5MS1SA6ASDB2JV3J751DH8BN09BFV10.cf-helpers-state-v0 new-client CLIENT 0xe521ce92b6f2e08390a3c258c023b0d20f7fdb7621d72823c3d117e5dcf08f60 "f7759c41-2fac-4f25-baf7-fe7e34cf7406")
