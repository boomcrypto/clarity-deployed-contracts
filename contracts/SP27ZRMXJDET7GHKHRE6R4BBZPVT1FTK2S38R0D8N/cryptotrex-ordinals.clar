...
(define-non-fungible-token cryptotrex-ordinals uint)
...
(define-data-var artist-address principal 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N)
(define-data-var ipfs-root (string-ascii 80) "ipfs://ipfs/QmWhm6jGvitPVDqqEuwMcN6mogJe1iTEniYwE4NKznw4Hr/json/")
...
(define-private (mint-many-iter (ignore bool) (next-id uint))
  (if (<= next-id (var-get mint-limit))
    (begin
      (unwrap! (nft-mint? cryptotrex-ordinals next-id tx-sender) next-id)
      (+ next-id u1)    
    )
    next-id))
...
(define-public (burn (token-id uint))
  (begin 
    ...
    (nft-burn? cryptotrex-ordinals token-id tx-sender)))

(define-private (is-owner (token-id uint) (user principal))
    (is-eq user (unwrap! (nft-get-owner? cryptotrex-ordinals token-id) false)))
...
(define-read-only (get-owner (token-id uint))
  (ok (nft-get-owner? cryptotrex-ordinals token-id)))
...
(define-private (trnsfr (id uint) (sender principal) (recipient principal))
  (match (nft-transfer? cryptotrex-ordinals id sender recipient)
    success
      (let
...
(define-private (is-sender-owner (id uint))
  (let ((owner (unwrap! (nft-get-owner? cryptotrex-ordinals id) false)))
...
(define-public (buy-in-ustx (id uint) (comm-trait <commission-trait>))
  (let ((owner (unwrap! (nft-get-owner? cryptotrex-ordinals id) (err ERR-NOT-FOUND)))
...
(define-data-var total-price-xbtc uint u43772)
...
;; Alt Minting Mintpass
(define-data-var total-price-mia2 uint u25076000000)
...
;; Alt Minting Mintpass
(define-data-var total-price-nyc2 uint u23094000000)
...
;; Alt Minting Mintpass
(define-data-var total-price-banana uint u99000000)
...
;; Alt Minting Mintpass
(define-data-var total-price-slime uint u1361000000)
...
;; Alt Minting Mintpass
(define-data-var total-price-alex uint u13800000000)
...
(map-set mint-passes 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N u11)
;; Airdrop
(define-public (admin-airdrop)
  (let
    ...
    (begin
      ...
      (try! (nft-mint? cryptotrex-ordinals (+ last-nft-id u0) 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N))
      (map-set token-count 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N (+ (get-balance 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N) u1))
      (try! (nft-mint? cryptotrex-ordinals (+ last-nft-id u1) 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N))
      (map-set token-count 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N (+ (get-balance 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N) u1))
      (try! (nft-mint? cryptotrex-ordinals (+ last-nft-id u2) 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N))
      (map-set token-count 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N (+ (get-balance 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N) u1))
      (try! (nft-mint? cryptotrex-ordinals (+ last-nft-id u3) 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N))
      (map-set token-count 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N (+ (get-balance 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N) u1))
      (try! (nft-mint? cryptotrex-ordinals (+ last-nft-id u4) 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N))
      (map-set token-count 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N (+ (get-balance 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N) u1))
      (try! (nft-mint? cryptotrex-ordinals (+ last-nft-id u5) 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N))
      (map-set token-count 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N (+ (get-balance 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N) u1))
      (try! (nft-mint? cryptotrex-ordinals (+ last-nft-id u6) 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N))
      (map-set token-count 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N (+ (get-balance 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N) u1))
      (try! (nft-mint? cryptotrex-ordinals (+ last-nft-id u7) 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N))
      (map-set token-count 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N (+ (get-balance 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N) u1))
      (try! (nft-mint? cryptotrex-ordinals (+ last-nft-id u8) 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N))
      (map-set token-count 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N (+ (get-balance 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N) u1))
      (try! (nft-mint? cryptotrex-ordinals (+ last-nft-id u9) 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N))
      (map-set token-count 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N (+ (get-balance 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N) u1))
      (try! (nft-mint? cryptotrex-ordinals (+ last-nft-id u10) 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N))
      (map-set token-count 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N (+ (get-balance 'SP27ZRMXJDET7GHKHRE6R4BBZPVT1FTK2S38R0D8N) u1))
