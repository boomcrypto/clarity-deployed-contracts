...
(define-read-only (get-market-state)
  (let (
    (accrue-interest-params (unwrap! (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.state-v1 get-accrue-interest-params) ERR-INTEREST-PARAMS))
    (accrued-interest (try! (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.linear-kinked-ir-v1 accrue-interest
      ...
      (try! (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.staking-reward-v1 calculate-staking-reward-percentage (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.staking-v1 get-active-staked-lp-tokens)))
    ...
    (reserve-balance (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.state-v1 get-reserve-balance ))
    (asset-cap (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.state-v1 get-asset-cap ))
    (borrowable-balance (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.state-v1 get-borrowable-balance ))
    (total-debt-shares (get total-debt-shares (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.state-v1 get-debt-params )))
    (market-token-balance (unwrap-panic (contract-call? 'SP3Y2ZSH8P7D50B0VBTSX11S7XSG24M1VB9YFQA4K.token-aeusdc get-balance 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.state-v1)))
    (sbtc-balance (unwrap-panic (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token get-balance 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.state-v1)))
    (total-lp-shares (unwrap! (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.state-v1 get-total-supply ) ERR-FAILED-TO-GET-BALANCE))
    (total-staked-shares (unwrap! (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.staking-v1 get-total-supply ) ERR-FAILED-TO-GET-BALANCE))
    (active-staked-lp-tokens (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.staking-v1 get-active-staked-lp-tokens ))
    (total-staked-lp-tokens (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.staking-v1 get-total-staked-lp-tokens )))
...
(define-private (refill-bucket-amount (last-updated-at uint) (time-now uint) (max-bucket uint) (current-bucket uint) (inflow uint))
  (let (
      (refill-window (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.withdrawal-caps-v1 get-refill-time-window))
...
(define-private (decay-bucket-amount (last-updated-at uint) (time-now uint) (max-bucket uint) (current-bucket uint) (inflow uint))
  (let (
      ...
      (decay-window (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.withdrawal-caps-v1 get-decay-time-window))
...
(define-private (get-lp-bucket (inflow uint))
  (let
    (
      ...
      (last-ts (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.withdrawal-caps-v1 get-last-lp-bucket-update))
      ...
      (lp-cap-factor (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.withdrawal-caps-v1 get-lp-cap-factor))
      (max-lp-bucket (/ (* total-liquidity lp-cap-factor) SCALING-FACTOR))
      (current-bucket (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.withdrawal-caps-v1 get-lp-bucket))
...
(define-private (get-debt-bucket (inflow uint))
  (let
    (
      (time-now (get-time-now))
      (last-ts (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.withdrawal-caps-v1 get-last-debt-bucket-update))
      (total-liquidity (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.state-v1 get-borrowable-balance))
      (debt-cap-factor (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.withdrawal-caps-v1 get-debt-cap-factor))
      (max-debt-bucket (/ (* total-liquidity debt-cap-factor) SCALING-FACTOR))
      (current-bucket (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.withdrawal-caps-v1 get-debt-bucket))
...
(define-private (get-collateral-bucket (inflow uint))
  (let
    (
      ...
      (last-ts (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.withdrawal-caps-v1 get-last-collateral-bucket-update collateral-token))
      (total-liquidity (unwrap! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token get-balance 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.state-v1) ERR-FAILED-TO-GET-BALANCE))
      (collateral-cap-factor (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.withdrawal-caps-v1 get-collateral-cap-factor collateral-token))
      (max-collateral-bucket (/ (* total-liquidity collateral-cap-factor) SCALING-FACTOR))
      (current-bucket (contract-call? 'SP3Y6GFKWN50HPA8RKRXMY0EXAJR9VXPY899P88JN.withdrawal-caps-v1 get-collateral-bucket collateral-token))
